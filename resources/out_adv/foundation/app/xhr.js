...
}catch (e637749){if((e637749 instanceof Error))
{var e = e637749;return null;
} else
...
var assoc_in_cache_BANG___delegate = function (k,v,p__637750){var map__637753 = p__637750;var map__637753__$1 = ((cljs.core.seq_QMARK_(map__637753))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__637753):map__637753);var expiry = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__637753__$1,cljs.core.constant$keyword$352);try{return foundation.app.xhr.localstorage.set(cljs.core.name(k),cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([v], 0)),expiry);
}catch (e637754){if((e637754 instanceof Error))
{var e = e637754;return null;
} else
{if(cljs.core.constant$keyword$286)
{throw e637754;
} else
...
var p__637750 = null;if (arguments.length > 2) {
  p__637750 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return assoc_in_cache_BANG___delegate.call(this,k,v,p__637750);};
assoc_in_cache_BANG_.cljs$lang$maxFixedArity = 2;
assoc_in_cache_BANG_.cljs$lang$applyTo = (function (arglist__637755){
var k = cljs.core.first(arglist__637755);
arglist__637755 = cljs.core.next(arglist__637755);
var v = cljs.core.first(arglist__637755);
var p__637750 = cljs.core.rest(arglist__637755);
return assoc_in_cache_BANG___delegate(k,v,p__637750);
});
...
foundation.app.xhr.clojurify_keys = (function clojurify_keys(m){var f = (function (p__637758){var vec__637759 = p__637758;var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__637759,0,null);var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__637759,1,null);if(typeof k === 'string')
...
foundation.app.xhr.handle_response = (function handle_response(res){var content_type = cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(res.getResponseHeader("Content-Type"),/;/));var body = (function (){var pred__637763 = cljs.core._EQ_;var expr__637764 = content_type;if(cljs.core.truth_((pred__637763.cljs$core$IFn$_invoke$arity$2 ? pred__637763.cljs$core$IFn$_invoke$arity$2("application/json",expr__637764) : pred__637763.call(null,"application/json",expr__637764))))
{return foundation.app.xhr.clojurify_keys(cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(res.getResponseJson()));
} else
{if(cljs.core.truth_((pred__637763.cljs$core$IFn$_invoke$arity$2 ? pred__637763.cljs$core$IFn$_invoke$arity$2("application/edn",expr__637764) : pred__637763.call(null,"application/edn",expr__637764))))
...
{try{foundation.app.xhr.xhr_pool.send(uri,uri,method,(((!(typeof content === 'string')) && (!((content == null))))?foundation.app.xhr.stringify(content):content),cljs.core.clj__GT_js(headers),50,(function (p1__637766_SHARP_){cljs.core.async.put_BANG_.cljs$core$IFn$_invoke$arity$2(c,foundation.app.xhr.handle_response(p1__637766_SHARP_.target));
...
}catch (e637768){if((e637768 instanceof Error))
{var e = e637768;return null;
} else
{if(cljs.core.constant$keyword$286)
{throw e637768;
} else
...
var GET__delegate = function (uri,p__637769){var map__637771 = p__637769;var map__637771__$1 = ((cljs.core.seq_QMARK_(map__637771))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__637771):map__637771);var headers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__637771__$1,cljs.core.constant$keyword$357);return foundation.app.xhr.xhr(uri,"GET",null,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([foundation.app.xhr._STAR_headers_STAR_,headers], 0)));
};
var GET = function (uri,var_args){
var p__637769 = null;if (arguments.length > 1) {
  p__637769 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return GET__delegate.call(this,uri,p__637769);};
GET.cljs$lang$maxFixedArity = 1;
GET.cljs$lang$applyTo = (function (arglist__637772){
var uri = cljs.core.first(arglist__637772);
var p__637769 = cljs.core.rest(arglist__637772);
return GET__delegate(uri,p__637769);
});
...
var POST__delegate = function (uri,p__637773){var map__637775 = p__637773;var map__637775__$1 = ((cljs.core.seq_QMARK_(map__637775))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__637775):map__637775);var headers = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__637775__$1,cljs.core.constant$keyword$357,cljs.core.PersistentArrayMap.EMPTY);var body = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__637775__$1,cljs.core.constant$keyword$359,null);return foundation.app.xhr.xhr(uri,"POST",body,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([foundation.app.xhr._STAR_headers_STAR_,headers], 0)));
};
var POST = function (uri,var_args){
var p__637773 = null;if (arguments.length > 1) {
  p__637773 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return POST__delegate.call(this,uri,p__637773);};
POST.cljs$lang$maxFixedArity = 1;
POST.cljs$lang$applyTo = (function (arglist__637776){
var uri = cljs.core.first(arglist__637776);
var p__637773 = cljs.core.rest(arglist__637776);
return POST__delegate(uri,p__637773);
});
...
var PUT__delegate = function (uri,p__637777){var map__637779 = p__637777;var map__637779__$1 = ((cljs.core.seq_QMARK_(map__637779))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__637779):map__637779);var headers = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__637779__$1,cljs.core.constant$keyword$357,cljs.core.PersistentArrayMap.EMPTY);var body = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__637779__$1,cljs.core.constant$keyword$359,null);return foundation.app.xhr.xhr(uri,"PUT",body,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([foundation.app.xhr._STAR_headers_STAR_,headers], 0)));
};
var PUT = function (uri,var_args){
var p__637777 = null;if (arguments.length > 1) {
  p__637777 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return PUT__delegate.call(this,uri,p__637777);};
PUT.cljs$lang$maxFixedArity = 1;
PUT.cljs$lang$applyTo = (function (arglist__637780){
var uri = cljs.core.first(arglist__637780);
var p__637777 = cljs.core.rest(arglist__637780);
return PUT__delegate(uri,p__637777);
});
...
var DELETE__delegate = function (uri,p__637781){var map__637783 = p__637781;var map__637783__$1 = ((cljs.core.seq_QMARK_(map__637783))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__637783):map__637783);var headers = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__637783__$1,cljs.core.constant$keyword$357,cljs.core.PersistentArrayMap.EMPTY);var body = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__637783__$1,cljs.core.constant$keyword$359,null);return foundation.app.xhr.xhr(uri,"DELETE",null,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([foundation.app.xhr._STAR_headers_STAR_,headers], 0)));
};
var DELETE = function (uri,var_args){
var p__637781 = null;if (arguments.length > 1) {
  p__637781 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return DELETE__delegate.call(this,uri,p__637781);};
DELETE.cljs$lang$maxFixedArity = 1;
DELETE.cljs$lang$applyTo = (function (arglist__637784){
var uri = cljs.core.first(arglist__637784);
var p__637781 = cljs.core.rest(arglist__637784);
return DELETE__delegate(uri,p__637781);
});
