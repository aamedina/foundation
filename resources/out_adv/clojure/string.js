...
{{
var G__157052 = cljs.core.pop(v__$1);
v__$1 = G__157052;
continue;
}
} else
...
{var pred__157056 = cljs.core._EQ_;var expr__157057 = limit;if(cljs.core.truth_((pred__157056.cljs$core$IFn$_invoke$arity$2 ? pred__157056.cljs$core$IFn$_invoke$arity$2(1,expr__157057) : pred__157056.call(null,1,expr__157057))))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_((pred__157056.cljs$core$IFn$_invoke$arity$2 ? pred__157056.cljs$core$IFn$_invoke$arity$2(2,expr__157057) : pred__157056.call(null,2,expr__157057))))
...
{var temp__4096__auto__ = cljs.core.re_find(re,s__$1);if(cljs.core.truth_(temp__4096__auto__))
{var m = temp__4096__auto__;var index = s__$1.indexOf(m);{
var G__157059 = s__$1.substring((index + cljs.core.count(m)));
var G__157060 = (limit__$1 - 1);
var G__157061 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring(0,index));
s__$1 = G__157059;
limit__$1 = G__157060;
parts = G__157061;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___157063 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);if(cljs.core.truth_(temp__4096__auto___157063))
{var replacement_157064 = temp__4096__auto___157063;buffer.append([cljs.core.str(replacement_157064)].join(''));
} else
{buffer.append(ch);
}
{
var G__157065 = (index + 1);
index = G__157065;
continue;
}
}
