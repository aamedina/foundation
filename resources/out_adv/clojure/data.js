...
{return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__156699){var vec__156700 = p__156699;var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__156700,0,null);var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__156700,1,null);return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(result,k,v);
...
*/
clojure.data.diff_associative_key = (function diff_associative_key(a,b,k){var va = cljs.core.get.cljs$core$IFn$_invoke$arity$2(a,k);var vb = cljs.core.get.cljs$core$IFn$_invoke$arity$2(b,k);var vec__156702 = (clojure.data.diff.cljs$core$IFn$_invoke$arity$2 ? clojure.data.diff.cljs$core$IFn$_invoke$arity$2(va,vb) : clojure.data.diff.call(null,va,vb));var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__156702,0,null);var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__156702,1,null);var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__156702,2,null);var in_a = cljs.core.contains_QMARK_(a,k);var in_b = cljs.core.contains_QMARK_(b,k);var same = (in_a) && (in_b) && ((!((ab == null))) || (((va == null)) && ((vb == null))));return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((in_a) && ((!((a_STAR_ == null))) || (!(same))))?new cljs.core.PersistentArrayMap.fromArray([k,a_STAR_], true, false):null),(((in_b) && ((!((b_STAR_ == null))) || (!(same))))?new cljs.core.PersistentArrayMap.fromArray([k,b_STAR_], true, false):null),((same)?new cljs.core.PersistentArrayMap.fromArray([k,ab], true, false):null)], null);
});
/**
...
clojure.data.EqualityPartition = (function (){var obj156704 = {};return obj156704;
})();
...
clojure.data.Diff = (function (){var obj156706 = {};return obj156706;
})();
...
(clojure.data.equality_partition["_"] = (function (x){if((function (){var G__156707 = x;if(G__156707)
{var bit__8356__auto__ = (G__156707.cljs$lang$protocol_mask$partition0$ & 1024);if((bit__8356__auto__) || (G__156707.cljs$core$IMap$))
{return true;
} else
{if((!G__156707.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_(cljs.core.IMap,G__156707);
} else
{return false;
}
}
...
{if((function (){var G__156708 = x;if(G__156708)
{var bit__8356__auto__ = (G__156708.cljs$lang$protocol_mask$partition0$ & 4096);if((bit__8356__auto__) || (G__156708.cljs$core$ISet$))
{return true;
} else
{if((!G__156708.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_(cljs.core.ISet,G__156708);
} else
{return false;
}
}
...
{if((function (){var G__156709 = x;if(G__156709)
{var bit__8356__auto__ = (G__156709.cljs$lang$protocol_mask$partition0$ & 16777216);if((bit__8356__auto__) || (G__156709.cljs$core$ISequential$))
{return true;
} else
{if((!G__156709.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_(cljs.core.ISequential,G__156709);
} else
{return false;
}
}
...
(clojure.data.diff_similar["_"] = (function (a,b){return (function (){var G__156710 = clojure.data.equality_partition(a);if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$381,G__156710))
{return clojure.data.diff_associative;
} else
{if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$383,G__156710))
{return clojure.data.diff_sequential;
} else
{if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$382,G__156710))
{return clojure.data.diff_set;
} else
{if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$384,G__156710))
