...
{var vec__219135 = loc;var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__219135,0,null);var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__219135,1,null);var vec__219136 = clojure.zip.children(loc);var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__219136,0,null);var cnext = cljs.core.nthnext(vec__219136,1);var cs = vec__219136;if(cljs.core.truth_(cs))
...
* the top
*/
clojure.zip.up = (function up(loc){var vec__219139 = loc;var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__219139,0,null);var map__219140 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__219139,1,null);var map__219140__$1 = ((cljs.core.seq_QMARK_(map__219140))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__219140):map__219140);var path = map__219140__$1;var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__219140__$1,cljs.core.constant$keyword$401);var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__219140__$1,cljs.core.constant$keyword$403);var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__219140__$1,cljs.core.constant$keyword$400);var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__219140__$1,cljs.core.constant$keyword$402);var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__219140__$1,cljs.core.constant$keyword$404);if(cljs.core.truth_(pnodes))
...
*/
clojure.zip.right = (function right(loc){var vec__219145 = loc;var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__219145,0,null);var map__219146 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__219145,1,null);var map__219146__$1 = ((cljs.core.seq_QMARK_(map__219146))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__219146):map__219146);var path = map__219146__$1;var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__219146__$1,cljs.core.constant$keyword$401);var vec__219147 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__219146__$1,cljs.core.constant$keyword$402);var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__219147,0,null);var rnext = cljs.core.nthnext(vec__219147,1);var rs = vec__219147;if(cljs.core.truth_((function (){var and__7718__auto__ = path;if(cljs.core.truth_(and__7718__auto__))
{return rs;
} else
{return and__7718__auto__;
}
...
*/
clojure.zip.rightmost = (function rightmost(loc){var vec__219150 = loc;var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__219150,0,null);var map__219151 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__219150,1,null);var map__219151__$1 = ((cljs.core.seq_QMARK_(map__219151))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__219151):map__219151);var path = map__219151__$1;var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__219151__$1,cljs.core.constant$keyword$401);var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__219151__$1,cljs.core.constant$keyword$402);if(cljs.core.truth_((function (){var and__7718__auto__ = path;if(cljs.core.truth_(and__7718__auto__))
{return r;
} else
{return and__7718__auto__;
}
...
*/
clojure.zip.left = (function left(loc){var vec__219154 = loc;var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__219154,0,null);var map__219155 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__219154,1,null);var map__219155__$1 = ((cljs.core.seq_QMARK_(map__219155))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__219155):map__219155);var path = map__219155__$1;var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__219155__$1,cljs.core.constant$keyword$401);var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__219155__$1,cljs.core.constant$keyword$402);if(cljs.core.truth_((function (){var and__7718__auto__ = path;if(cljs.core.truth_(and__7718__auto__))
...
*/
clojure.zip.leftmost = (function leftmost(loc){var vec__219158 = loc;var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__219158,0,null);var map__219159 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__219158,1,null);var map__219159__$1 = ((cljs.core.seq_QMARK_(map__219159))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__219159):map__219159);var path = map__219159__$1;var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__219159__$1,cljs.core.constant$keyword$401);var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__219159__$1,cljs.core.constant$keyword$402);if(cljs.core.truth_((function (){var and__7718__auto__ = path;if(cljs.core.truth_(and__7718__auto__))
{return cljs.core.seq(l);
} else
{return and__7718__auto__;
}
...
* without moving
*/
clojure.zip.insert_left = (function insert_left(loc,item){var vec__219162 = loc;var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__219162,0,null);var map__219163 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__219162,1,null);var map__219163__$1 = ((cljs.core.seq_QMARK_(map__219163))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__219163):map__219163);var path = map__219163__$1;var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__219163__$1,cljs.core.constant$keyword$401);if((path == null))
{throw "Insert at top";
} else
...
* without moving
*/
clojure.zip.insert_right = (function insert_right(loc,item){var vec__219166 = loc;var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__219166,0,null);var map__219167 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__219166,1,null);var map__219167__$1 = ((cljs.core.seq_QMARK_(map__219167))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__219167):map__219167);var path = map__219167__$1;var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__219167__$1,cljs.core.constant$keyword$402);if((path == null))
{throw "Insert at top";
} else
...
*/
clojure.zip.replace = (function replace(loc,node){var vec__219169 = loc;var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__219169,0,null);var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__219169,1,null);return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [node,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(path,cljs.core.constant$keyword$404,true)], null),cljs.core.meta(loc));
});
/**
...
edit.cljs$lang$applyTo = (function (arglist__219170){
var loc = cljs.core.first(arglist__219170);
arglist__219170 = cljs.core.next(arglist__219170);
var f = cljs.core.first(arglist__219170);
var args = cljs.core.rest(arglist__219170);
...
{{
var G__219171 = clojure.zip.up(p);
p = G__219171;
continue;
}
}
...
var G__219172 = clojure.zip.rightmost(child);
loc__$1 = G__219172;
continue;
}
} else
...
*/
clojure.zip.remove = (function remove(loc){var vec__219175 = loc;var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__219175,0,null);var map__219176 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__219175,1,null);var map__219176__$1 = ((cljs.core.seq_QMARK_(map__219176))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__219176):map__219176);var path = map__219176__$1;var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__219176__$1,cljs.core.constant$keyword$401);var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__219176__$1,cljs.core.constant$keyword$403);var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__219176__$1,cljs.core.constant$keyword$400);var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__219176__$1,cljs.core.constant$keyword$402);if((path == null))
{throw "Remove at top";
} else
...
var G__219177 = clojure.zip.rightmost(child);
loc__$1 = G__219177;
continue;
}
} else
