...
{var vec__322836 = loc;var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__322836,0,null);var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__322836,1,null);var vec__322837 = clojure.zip.children(loc);var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__322837,0,null);var cnext = cljs.core.nthnext(vec__322837,1);var cs = vec__322837;if(cljs.core.truth_(cs))
...
* the top
*/
clojure.zip.up = (function up(loc){var vec__322840 = loc;var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__322840,0,null);var map__322841 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__322840,1,null);var map__322841__$1 = ((cljs.core.seq_QMARK_(map__322841))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__322841):map__322841);var path = map__322841__$1;var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__322841__$1,cljs.core.constant$keyword$401);var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__322841__$1,cljs.core.constant$keyword$403);var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__322841__$1,cljs.core.constant$keyword$400);var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__322841__$1,cljs.core.constant$keyword$402);var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__322841__$1,cljs.core.constant$keyword$404);if(cljs.core.truth_(pnodes))
...
*/
clojure.zip.right = (function right(loc){var vec__322846 = loc;var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__322846,0,null);var map__322847 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__322846,1,null);var map__322847__$1 = ((cljs.core.seq_QMARK_(map__322847))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__322847):map__322847);var path = map__322847__$1;var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__322847__$1,cljs.core.constant$keyword$401);var vec__322848 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__322847__$1,cljs.core.constant$keyword$402);var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__322848,0,null);var rnext = cljs.core.nthnext(vec__322848,1);var rs = vec__322848;if(cljs.core.truth_((function (){var and__7718__auto__ = path;if(cljs.core.truth_(and__7718__auto__))
{return rs;
} else
{return and__7718__auto__;
}
...
*/
clojure.zip.rightmost = (function rightmost(loc){var vec__322851 = loc;var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__322851,0,null);var map__322852 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__322851,1,null);var map__322852__$1 = ((cljs.core.seq_QMARK_(map__322852))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__322852):map__322852);var path = map__322852__$1;var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__322852__$1,cljs.core.constant$keyword$401);var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__322852__$1,cljs.core.constant$keyword$402);if(cljs.core.truth_((function (){var and__7718__auto__ = path;if(cljs.core.truth_(and__7718__auto__))
{return r;
} else
{return and__7718__auto__;
}
...
*/
clojure.zip.left = (function left(loc){var vec__322855 = loc;var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__322855,0,null);var map__322856 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__322855,1,null);var map__322856__$1 = ((cljs.core.seq_QMARK_(map__322856))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__322856):map__322856);var path = map__322856__$1;var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__322856__$1,cljs.core.constant$keyword$401);var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__322856__$1,cljs.core.constant$keyword$402);if(cljs.core.truth_((function (){var and__7718__auto__ = path;if(cljs.core.truth_(and__7718__auto__))
...
*/
clojure.zip.leftmost = (function leftmost(loc){var vec__322859 = loc;var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__322859,0,null);var map__322860 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__322859,1,null);var map__322860__$1 = ((cljs.core.seq_QMARK_(map__322860))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__322860):map__322860);var path = map__322860__$1;var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__322860__$1,cljs.core.constant$keyword$401);var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__322860__$1,cljs.core.constant$keyword$402);if(cljs.core.truth_((function (){var and__7718__auto__ = path;if(cljs.core.truth_(and__7718__auto__))
{return cljs.core.seq(l);
} else
{return and__7718__auto__;
}
...
* without moving
*/
clojure.zip.insert_left = (function insert_left(loc,item){var vec__322863 = loc;var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__322863,0,null);var map__322864 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__322863,1,null);var map__322864__$1 = ((cljs.core.seq_QMARK_(map__322864))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__322864):map__322864);var path = map__322864__$1;var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__322864__$1,cljs.core.constant$keyword$401);if((path == null))
{throw "Insert at top";
} else
...
* without moving
*/
clojure.zip.insert_right = (function insert_right(loc,item){var vec__322867 = loc;var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__322867,0,null);var map__322868 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__322867,1,null);var map__322868__$1 = ((cljs.core.seq_QMARK_(map__322868))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__322868):map__322868);var path = map__322868__$1;var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__322868__$1,cljs.core.constant$keyword$402);if((path == null))
{throw "Insert at top";
} else
...
*/
clojure.zip.replace = (function replace(loc,node){var vec__322870 = loc;var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__322870,0,null);var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__322870,1,null);return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [node,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(path,cljs.core.constant$keyword$404,true)], null),cljs.core.meta(loc));
});
/**
...
edit.cljs$lang$applyTo = (function (arglist__322871){
var loc = cljs.core.first(arglist__322871);
arglist__322871 = cljs.core.next(arglist__322871);
var f = cljs.core.first(arglist__322871);
var args = cljs.core.rest(arglist__322871);
...
{{
var G__322872 = clojure.zip.up(p);
p = G__322872;
continue;
}
}
...
var G__322873 = clojure.zip.rightmost(child);
loc__$1 = G__322873;
continue;
}
} else
...
*/
clojure.zip.remove = (function remove(loc){var vec__322876 = loc;var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__322876,0,null);var map__322877 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__322876,1,null);var map__322877__$1 = ((cljs.core.seq_QMARK_(map__322877))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__322877):map__322877);var path = map__322877__$1;var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__322877__$1,cljs.core.constant$keyword$401);var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__322877__$1,cljs.core.constant$keyword$403);var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__322877__$1,cljs.core.constant$keyword$400);var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__322877__$1,cljs.core.constant$keyword$402);if((path == null))
{throw "Remove at top";
} else
...
var G__322878 = clojure.zip.rightmost(child);
loc__$1 = G__322878;
continue;
}
} else
