...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__8274__auto__,writer__8275__auto__,opt__8276__auto__){return cljs.core._write(writer__8275__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_321925 = 0;while(true){
if((i_321925 < arr.length))
{(arr[i_321925] = null);
{
var G__321926 = (i_321925 + 1);
i_321925 = G__321926;
continue;
}
} else
...
var G__321928 = x__$1;
var G__321929 = k;
var G__321930 = (level - 1);
var G__321931 = update;
x = G__321928;
k = G__321929;
level = G__321930;
update = G__321931;
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__8274__auto__,writer__8275__auto__,opt__8276__auto__){return cljs.core._write(writer__8275__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_321932 = (self__.level + 1);while(true){
if((i_321932 <= (new_level + 1)))
{(update[i_321932] = self__.header);
{
var G__321933 = (i_321932 + 1);
i_321932 = G__321933;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_321934 = 0;while(true){
if((i_321934 <= self__.level))
{var links_321935 = (update[i_321934]).forward;if(((links_321935[i_321934]) === x__$1))
{(links_321935[i_321934] = (x__$1.forward[i_321934]));
{
var G__321936 = (i_321934 + 1);
i_321934 = G__321936;
continue;
}
} else
{{
var G__321937 = (i_321934 + 1);
i_321934 = G__321937;
continue;
}
}
