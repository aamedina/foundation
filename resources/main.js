...
goog.addDependency("../foundation/rendering.js", ['foundation.rendering'], ['cljs_time.coerce', 'cljs.core', 'foundation.app.message', 'enfocus.events', 'foundation.behavior', 'clojure.zip', 'goog.dom', 'foundation.app.xhr', 'enfocus.core', 'foundation.app.util', 'foundation.chart', 'clojure.string', 'foundation.app', 'foundation.templates', 'cljs.core.match', 'clojure.browser.repl', 'clojure.set', 'cljs.core.async', 'goog.style', 'foundation.app.render', 'dommy.core', 'foundation.models']);
