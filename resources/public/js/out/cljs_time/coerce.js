...
goog.require('goog.date.DateTime');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj29280 = {};return obj29280;
})();
...
* which parses
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__8926__auto__ = (function iter__29289(s__29290){return (new cljs.core.LazySeq(null,(function (){var s__29290__$1 = s__29290;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__29290__$1);if(temp__4092__auto__)
{var s__29290__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__29290__$2))
{var c__8924__auto__ = cljs.core.chunk_first.call(null,s__29290__$2);var size__8925__auto__ = cljs.core.count.call(null,c__8924__auto__);var b__29292 = cljs.core.chunk_buffer.call(null,size__8925__auto__);if((function (){var i__29291 = 0;while(true){
if((i__29291 < size__8925__auto__))
{var f = cljs.core._nth.call(null,c__8924__auto__,i__29291);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e29295){if((e29295 instanceof Error))
{var e = e29295;return null;
} else
...
{cljs.core.chunk_append.call(null,b__29292,d);
{
var G__29297 = (i__29291 + 1);
i__29291 = G__29297;
continue;
}
} else
{{
var G__29298 = (i__29291 + 1);
i__29291 = G__29298;
continue;
}
}
...
{var f = cljs.core.first.call(null,s__29290__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e29296){if((e29296 instanceof Error))
{var e = e29296;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e29296;
} else
...
{return cljs.core.cons.call(null,d,iter__29289.call(null,cljs.core.rest.call(null,s__29290__$2)));
} else
{{
var G__29299 = cljs.core.rest.call(null,s__29290__$2);
s__29290__$1 = G__29299;
continue;
}
}
}
