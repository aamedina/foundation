...
var unparse__delegate = function (fmt,dt,p__29460){var map__29462 = p__29460;var map__29462__$1 = ((cljs.core.seq_QMARK_.call(null,map__29462))?cljs.core.apply.call(null,cljs.core.hash_map,map__29462):map__29462);var tz = cljs.core.get.call(null,map__29462__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__29460 = null;if (arguments.length > 2) {
  p__29460 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__29460);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__29463){
var fmt = cljs.core.first(arglist__29463);
arglist__29463 = cljs.core.next(arglist__29463);
var dt = cljs.core.first(arglist__29463);
var p__29460 = cljs.core.rest(arglist__29463);
return unparse__delegate(fmt,dt,p__29460);
});
...
var show_formatters__delegate = function (p__29464){var map__29470 = p__29464;var map__29470__$1 = ((cljs.core.seq_QMARK_.call(null,map__29470))?cljs.core.apply.call(null,cljs.core.hash_map,map__29470):map__29470);var date_like = cljs.core.get.call(null,map__29470__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__8926__auto__ = (function iter__29471(s__29472){return (new cljs.core.LazySeq(null,(function (){var s__29472__$1 = s__29472;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__29472__$1);if(temp__4092__auto__)
{var s__29472__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__29472__$2))
{var c__8924__auto__ = cljs.core.chunk_first.call(null,s__29472__$2);var size__8925__auto__ = cljs.core.count.call(null,c__8924__auto__);var b__29474 = cljs.core.chunk_buffer.call(null,size__8925__auto__);if((function (){var i__29473 = 0;while(true){
if((i__29473 < size__8925__auto__))
{var i = cljs.core._nth.call(null,c__8924__auto__,i__29473);cljs.core.chunk_append.call(null,b__29474,cljs_time.format.unparse.call(null,i,date_like));
{
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__29474),iter__29471.call(null,cljs.core.chunk_rest.call(null,s__29472__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__29474),null);
}
} else
{var i = cljs.core.first.call(null,s__29472__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__29471.call(null,cljs.core.rest.call(null,s__29472__$2)));
}
} else
{return null;
}
...
var p__29464 = null;if (arguments.length > 0) {
  p__29464 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__29464);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__29476){
var p__29464 = cljs.core.seq(arglist__29476);
return show_formatters__delegate(p__29464);
});
