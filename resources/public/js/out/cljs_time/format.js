...
var unparse__delegate = function (fmt,dt,p__406079){var map__406081 = p__406079;var map__406081__$1 = ((cljs.core.seq_QMARK_.call(null,map__406081))?cljs.core.apply.call(null,cljs.core.hash_map,map__406081):map__406081);var tz = cljs.core.get.call(null,map__406081__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__406079 = null;if (arguments.length > 2) {
  p__406079 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__406079);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__406082){
var fmt = cljs.core.first(arglist__406082);
arglist__406082 = cljs.core.next(arglist__406082);
var dt = cljs.core.first(arglist__406082);
var p__406079 = cljs.core.rest(arglist__406082);
return unparse__delegate(fmt,dt,p__406079);
});
...
var show_formatters__delegate = function (p__406083){var map__406089 = p__406083;var map__406089__$1 = ((cljs.core.seq_QMARK_.call(null,map__406089))?cljs.core.apply.call(null,cljs.core.hash_map,map__406089):map__406089);var date_like = cljs.core.get.call(null,map__406089__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__8921__auto__ = (function iter__406090(s__406091){return (new cljs.core.LazySeq(null,(function (){var s__406091__$1 = s__406091;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__406091__$1);if(temp__4092__auto__)
{var s__406091__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__406091__$2))
{var c__8919__auto__ = cljs.core.chunk_first.call(null,s__406091__$2);var size__8920__auto__ = cljs.core.count.call(null,c__8919__auto__);var b__406093 = cljs.core.chunk_buffer.call(null,size__8920__auto__);if((function (){var i__406092 = 0;while(true){
if((i__406092 < size__8920__auto__))
{var i = cljs.core._nth.call(null,c__8919__auto__,i__406092);cljs.core.chunk_append.call(null,b__406093,cljs_time.format.unparse.call(null,i,date_like));
{
var G__406094 = (i__406092 + 1);
i__406092 = G__406094;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__406093),iter__406090.call(null,cljs.core.chunk_rest.call(null,s__406091__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__406093),null);
}
} else
{var i = cljs.core.first.call(null,s__406091__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__406090.call(null,cljs.core.rest.call(null,s__406091__$2)));
}
} else
{return null;
}
...
var p__406083 = null;if (arguments.length > 0) {
  p__406083 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__406083);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__406095){
var p__406083 = cljs.core.seq(arglist__406095);
return show_formatters__delegate(p__406083);
});
