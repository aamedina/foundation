...
var unparse__delegate = function (fmt,dt,p__275304){var map__275306 = p__275304;var map__275306__$1 = ((cljs.core.seq_QMARK_.call(null,map__275306))?cljs.core.apply.call(null,cljs.core.hash_map,map__275306):map__275306);var tz = cljs.core.get.call(null,map__275306__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__275304 = null;if (arguments.length > 2) {
  p__275304 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__275304);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__275307){
var fmt = cljs.core.first(arglist__275307);
arglist__275307 = cljs.core.next(arglist__275307);
var dt = cljs.core.first(arglist__275307);
var p__275304 = cljs.core.rest(arglist__275307);
return unparse__delegate(fmt,dt,p__275304);
});
...
var show_formatters__delegate = function (p__275308){var map__275314 = p__275308;var map__275314__$1 = ((cljs.core.seq_QMARK_.call(null,map__275314))?cljs.core.apply.call(null,cljs.core.hash_map,map__275314):map__275314);var date_like = cljs.core.get.call(null,map__275314__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__8921__auto__ = (function iter__275315(s__275316){return (new cljs.core.LazySeq(null,(function (){var s__275316__$1 = s__275316;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__275316__$1);if(temp__4092__auto__)
{var s__275316__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__275316__$2))
{var c__8919__auto__ = cljs.core.chunk_first.call(null,s__275316__$2);var size__8920__auto__ = cljs.core.count.call(null,c__8919__auto__);var b__275318 = cljs.core.chunk_buffer.call(null,size__8920__auto__);if((function (){var i__275317 = 0;while(true){
if((i__275317 < size__8920__auto__))
{var i = cljs.core._nth.call(null,c__8919__auto__,i__275317);cljs.core.chunk_append.call(null,b__275318,cljs_time.format.unparse.call(null,i,date_like));
{
var G__275319 = (i__275317 + 1);
i__275317 = G__275319;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__275318),iter__275315.call(null,cljs.core.chunk_rest.call(null,s__275316__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__275318),null);
}
} else
{var i = cljs.core.first.call(null,s__275316__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__275315.call(null,cljs.core.rest.call(null,s__275316__$2)));
}
} else
{return null;
}
...
var p__275308 = null;if (arguments.length > 0) {
  p__275308 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__275308);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__275320){
var p__275308 = cljs.core.seq(arglist__275320);
return show_formatters__delegate(p__275308);
});
