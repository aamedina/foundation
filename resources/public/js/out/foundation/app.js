...
foundation.app.input_queue = (function input_queue(app_state){var input_queue__$1 = cljs.core.async.chan.call(null,cljs.core.async.sliding_buffer.call(null,32));var c__12185__auto___91658 = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__12186__auto__ = (function (){var switch__12115__auto__ = (function (state_91646){var state_val_91647 = (state_91646[1]);if((state_val_91647 === 4))
{var inst_91640 = (state_91646[2]);var inst_91641 = cljs.core.println.call(null,inst_91640);var state_91646__$1 = (function (){var statearr_91648 = state_91646;(statearr_91648[7] = inst_91641);
return statearr_91648;
})();var statearr_91649_91659 = state_91646__$1;(statearr_91649_91659[2] = null);
(statearr_91649_91659[1] = 2);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_91647 === 3))
{var inst_91644 = (state_91646[2]);var state_91646__$1 = state_91646;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_91646__$1,inst_91644);
} else
{if((state_val_91647 === 2))
{var state_91646__$1 = state_91646;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_91646__$1,4,input_queue__$1);
} else
{if((state_val_91647 === 1))
{var state_91646__$1 = state_91646;var statearr_91650_91660 = state_91646__$1;(statearr_91650_91660[2] = null);
(statearr_91650_91660[1] = 2);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{return null;
}
...
var state_machine__12116__auto____0 = (function (){var statearr_91654 = [null,null,null,null,null,null,null,null];(statearr_91654[0] = state_machine__12116__auto__);
(statearr_91654[1] = 1);
return statearr_91654;
});
var state_machine__12116__auto____1 = (function (state_91646){while(true){
var ret_value__12117__auto__ = (function (){try{while(true){
var result__12118__auto__ = switch__12115__auto__.call(null,state_91646);if(cljs.core.keyword_identical_QMARK_.call(null,result__12118__auto__,new cljs.core.Keyword(null,"recur","recur",1122293407)))
{{
continue;
}
} else
...
}catch (e91655){if((e91655 instanceof Object))
{var ex__12119__auto__ = e91655;var statearr_91656_91661 = state_91646;(statearr_91656_91661[5] = ex__12119__auto__);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_91646);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
...
{{
var G__91662 = state_91646;
state_91646 = G__91662;
continue;
}
} else
...
state_machine__12116__auto__ = function(state_91646){
switch(arguments.length){
case 0:
return state_machine__12116__auto____0.call(this);
case 1:
return state_machine__12116__auto____1.call(this,state_91646);
}
...
})();var state__12187__auto__ = (function (){var statearr_91657 = f__12186__auto__.call(null);(statearr_91657[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__12185__auto___91658);
return statearr_91657;
...
var df__$1 = this;return foundation.app.data.component.start_system.call(null,df__$1,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"renderer","renderer",519058485),null,new cljs.core.Keyword(null,"router","router",4383738555),null], null), null));
});
...
foundation.app.Dataflow.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8797__auto__,k91664,else__8798__auto__){var self__ = this;
var this__8797__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k91664,new cljs.core.Keyword(null,"state","state",1123661827)))
{return self__.state;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k91664,new cljs.core.Keyword(null,"input","input",1114262332)))
{return self__.input;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k91664,new cljs.core.Keyword(null,"output","output",4303359091)))
{return self__.output;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k91664,new cljs.core.Keyword(null,"renderer","renderer",519058485)))
{return self__.renderer;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k91664,new cljs.core.Keyword(null,"render-queue","render-queue",665147788)))
{return self__.render_queue;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k91664,new cljs.core.Keyword(null,"router","router",4383738555)))
{return self__.router;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k91664,else__8798__auto__);
} else
{return null;
}
}
...
foundation.app.Dataflow.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8802__auto__,k__8803__auto__,G__91663){var self__ = this;
var this__8802__auto____$1 = this;var pred__91666 = cljs.core.keyword_identical_QMARK_;var expr__91667 = k__8803__auto__;if(cljs.core.truth_(pred__91666.call(null,new cljs.core.Keyword(null,"state","state",1123661827),expr__91667)))
{return (new foundation.app.Dataflow(G__91663,self__.input,self__.output,self__.renderer,self__.render_queue,self__.router,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__91666.call(null,new cljs.core.Keyword(null,"input","input",1114262332),expr__91667)))
{return (new foundation.app.Dataflow(self__.state,G__91663,self__.output,self__.renderer,self__.render_queue,self__.router,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__91666.call(null,new cljs.core.Keyword(null,"output","output",4303359091),expr__91667)))
{return (new foundation.app.Dataflow(self__.state,self__.input,G__91663,self__.renderer,self__.render_queue,self__.router,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__91666.call(null,new cljs.core.Keyword(null,"renderer","renderer",519058485),expr__91667)))
{return (new foundation.app.Dataflow(self__.state,self__.input,self__.output,G__91663,self__.render_queue,self__.router,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__91666.call(null,new cljs.core.Keyword(null,"render-queue","render-queue",665147788),expr__91667)))
{return (new foundation.app.Dataflow(self__.state,self__.input,self__.output,self__.renderer,G__91663,self__.router,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__91666.call(null,new cljs.core.Keyword(null,"router","router",4383738555),expr__91667)))
{return (new foundation.app.Dataflow(self__.state,self__.input,self__.output,self__.renderer,self__.render_queue,G__91663,self__.__meta,self__.__extmap,null));
} else
{return (new foundation.app.Dataflow(self__.state,self__.input,self__.output,self__.renderer,self__.render_queue,self__.router,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__8803__auto__,G__91663),null));
}
}
}
}
...
foundation.app.Dataflow.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8794__auto__,G__91663){var self__ = this;
var this__8794__auto____$1 = this;return (new foundation.app.Dataflow(self__.state,self__.input,self__.output,self__.renderer,self__.render_queue,self__.router,G__91663,self__.__extmap,self__.__hash));
});
...
var p__91669 = null;if (arguments.length > 0) {
  p__91669 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return build__delegate.call(this,p__91669);};
build.cljs$lang$maxFixedArity = 0;
build.cljs$lang$applyTo = (function (arglist__91674){
var p__91669 = cljs.core.seq(arglist__91674);
return build__delegate(p__91669);
});
