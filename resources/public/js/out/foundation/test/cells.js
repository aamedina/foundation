...
goog.require('dommy.core');
goog.require('cljs_time.core');
foundation.test.cells.date_picker_cell = (function date_picker_cell(date_str){var dom80360 = document.createElement("input");dom80360.className = "date-picker";
if(true)
{dom80360.setAttribute("readonly",true);
} else
{}
dom80360.appendChild(dommy.template.__GT_node_like.call(null,cljs_time.format.parse.call(null,new cljs.core.Keyword(null,"long-date","long-date",1095363537),date_str)));
return dom80360;
});
...
cljs.core._add_method.call(null,foundation.test.cells.th,new cljs.core.Keyword(null,"select-all","select-all",3651745986),(function (column){var dom80361 = document.createElement("th");if(cljs.core.truth_(new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(column)))
{dom80361.setAttribute("id",new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(column));
} else
{}
dom80361.appendChild((function (){var dom80362 = document.createElement("input");dom80362.setAttribute("id","select-all");
if("checkbox")
{dom80362.setAttribute("type","checkbox");
} else
{}
return dom80362;
})());
...
cljs.core._add_method.call(null,foundation.test.cells.th,new cljs.core.Keyword(null,"default","default",2558708147),(function (column){var dom80363 = document.createElement("th");if(cljs.core.truth_(new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(column)))
{dom80363.setAttribute("id",new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(column));
} else
{}
dom80363.appendChild(dommy.template.__GT_node_like.call(null,new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(column)));
return dom80363;
}));
cljs.core._add_method.call(null,foundation.test.cells.td,new cljs.core.Keyword(null,"select","select",4402849902),(function (column,record){var dom80364 = document.createElement("td");dom80364.appendChild((function (){var dom80365 = document.createElement("input");dom80365.className = "select";
if("checkbox")
{dom80365.setAttribute("type","checkbox");
} else
{}
return dom80365;
})());
