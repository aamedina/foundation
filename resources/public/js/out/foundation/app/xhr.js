...
var assoc_in_cache_BANG___delegate = function (k,v,p__22612){var map__22615 = p__22612;var map__22615__$1 = ((cljs.core.seq_QMARK_.call(null,map__22615))?cljs.core.apply.call(null,cljs.core.hash_map,map__22615):map__22615);var expiry = cljs.core.get.call(null,map__22615__$1,new cljs.core.Keyword(null,"expiry","expiry",4019712165));try{return foundation.app.xhr.localstorage.set(cljs.core.name.call(null,k),cljs.core.pr_str.call(null,v),expiry);
}catch (e22616){if((e22616 instanceof Error))
{var e = e22616;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e22616;
} else
...
var p__22612 = null;if (arguments.length > 2) {
  p__22612 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return assoc_in_cache_BANG___delegate.call(this,k,v,p__22612);};
assoc_in_cache_BANG_.cljs$lang$maxFixedArity = 2;
assoc_in_cache_BANG_.cljs$lang$applyTo = (function (arglist__22617){
var k = cljs.core.first(arglist__22617);
arglist__22617 = cljs.core.next(arglist__22617);
var v = cljs.core.first(arglist__22617);
var p__22612 = cljs.core.rest(arglist__22617);
return assoc_in_cache_BANG___delegate(k,v,p__22612);
});
...
foundation.app.xhr.clojurify_keys = (function clojurify_keys(m){var f = (function (p__22620){var vec__22621 = p__22620;var k = cljs.core.nth.call(null,vec__22621,0,null);var v = cljs.core.nth.call(null,vec__22621,1,null);if(typeof k === 'string')
...
{try{foundation.app.xhr.xhr_pool.send(uri,uri,method,(((!(typeof content === 'string')) && (!((content == null))))?foundation.app.xhr.stringify.call(null,content):content),cljs.core.clj__GT_js.call(null,headers),50,(function (p1__22628_SHARP_){cljs.core.async.put_BANG_.call(null,c,foundation.app.xhr.handle_response.call(null,p1__22628_SHARP_.target));
...
}catch (e22630){if((e22630 instanceof Error))
{var e = e22630;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e22630;
} else
...
var GET__delegate = function (uri,p__22631){var map__22633 = p__22631;var map__22633__$1 = ((cljs.core.seq_QMARK_.call(null,map__22633))?cljs.core.apply.call(null,cljs.core.hash_map,map__22633):map__22633);var headers = cljs.core.get.call(null,map__22633__$1,new cljs.core.Keyword(null,"headers","headers",1809212152));return foundation.app.xhr.xhr.call(null,uri,"GET",null,cljs.core.merge.call(null,foundation.app.xhr._STAR_headers_STAR_,headers));
};
var GET = function (uri,var_args){
var p__22631 = null;if (arguments.length > 1) {
  p__22631 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return GET__delegate.call(this,uri,p__22631);};
GET.cljs$lang$maxFixedArity = 1;
GET.cljs$lang$applyTo = (function (arglist__22634){
var uri = cljs.core.first(arglist__22634);
var p__22631 = cljs.core.rest(arglist__22634);
return GET__delegate(uri,p__22631);
});
...
var POST__delegate = function (uri,p__22635){var map__22637 = p__22635;var map__22637__$1 = ((cljs.core.seq_QMARK_.call(null,map__22637))?cljs.core.apply.call(null,cljs.core.hash_map,map__22637):map__22637);var headers = cljs.core.get.call(null,map__22637__$1,new cljs.core.Keyword(null,"headers","headers",1809212152),cljs.core.PersistentArrayMap.EMPTY);var body = cljs.core.get.call(null,map__22637__$1,new cljs.core.Keyword(null,"body","body",1016933652),null);return foundation.app.xhr.xhr.call(null,uri,"POST",body,cljs.core.merge.call(null,foundation.app.xhr._STAR_headers_STAR_,headers));
};
var POST = function (uri,var_args){
var p__22635 = null;if (arguments.length > 1) {
  p__22635 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return POST__delegate.call(this,uri,p__22635);};
POST.cljs$lang$maxFixedArity = 1;
POST.cljs$lang$applyTo = (function (arglist__22638){
var uri = cljs.core.first(arglist__22638);
var p__22635 = cljs.core.rest(arglist__22638);
return POST__delegate(uri,p__22635);
});
...
var PUT__delegate = function (uri,p__22639){var map__22641 = p__22639;var map__22641__$1 = ((cljs.core.seq_QMARK_.call(null,map__22641))?cljs.core.apply.call(null,cljs.core.hash_map,map__22641):map__22641);var headers = cljs.core.get.call(null,map__22641__$1,new cljs.core.Keyword(null,"headers","headers",1809212152),cljs.core.PersistentArrayMap.EMPTY);var body = cljs.core.get.call(null,map__22641__$1,new cljs.core.Keyword(null,"body","body",1016933652),null);return foundation.app.xhr.xhr.call(null,uri,"PUT",body,cljs.core.merge.call(null,foundation.app.xhr._STAR_headers_STAR_,headers));
};
var PUT = function (uri,var_args){
var p__22639 = null;if (arguments.length > 1) {
  p__22639 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return PUT__delegate.call(this,uri,p__22639);};
PUT.cljs$lang$maxFixedArity = 1;
PUT.cljs$lang$applyTo = (function (arglist__22642){
var uri = cljs.core.first(arglist__22642);
var p__22639 = cljs.core.rest(arglist__22642);
return PUT__delegate(uri,p__22639);
});
...
var DELETE__delegate = function (uri,p__22643){var map__22645 = p__22643;var map__22645__$1 = ((cljs.core.seq_QMARK_.call(null,map__22645))?cljs.core.apply.call(null,cljs.core.hash_map,map__22645):map__22645);var headers = cljs.core.get.call(null,map__22645__$1,new cljs.core.Keyword(null,"headers","headers",1809212152),cljs.core.PersistentArrayMap.EMPTY);var body = cljs.core.get.call(null,map__22645__$1,new cljs.core.Keyword(null,"body","body",1016933652),null);return foundation.app.xhr.xhr.call(null,uri,"DELETE",null,cljs.core.merge.call(null,foundation.app.xhr._STAR_headers_STAR_,headers));
};
var DELETE = function (uri,var_args){
var p__22643 = null;if (arguments.length > 1) {
  p__22643 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return DELETE__delegate.call(this,uri,p__22643);};
DELETE.cljs$lang$maxFixedArity = 1;
DELETE.cljs$lang$applyTo = (function (arglist__22646){
var uri = cljs.core.first(arglist__22646);
var p__22643 = cljs.core.rest(arglist__22646);
return DELETE__delegate(uri,p__22643);
});
