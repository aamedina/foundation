...
}catch (e21058){if((e21058 instanceof Error))
{var e = e21058;return null;
} else
...
var assoc_in_cache_BANG___delegate = function (k,v,p__21059){var map__21062 = p__21059;var map__21062__$1 = ((cljs.core.seq_QMARK_.call(null,map__21062))?cljs.core.apply.call(null,cljs.core.hash_map,map__21062):map__21062);var expiry = cljs.core.get.call(null,map__21062__$1,new cljs.core.Keyword(null,"expiry","expiry",4019712165));try{return foundation.app.xhr.localstorage.set(cljs.core.name.call(null,k),cljs.core.pr_str.call(null,v),expiry);
}catch (e21063){if((e21063 instanceof Error))
{var e = e21063;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e21063;
} else
...
var p__21059 = null;if (arguments.length > 2) {
  p__21059 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return assoc_in_cache_BANG___delegate.call(this,k,v,p__21059);};
assoc_in_cache_BANG_.cljs$lang$maxFixedArity = 2;
assoc_in_cache_BANG_.cljs$lang$applyTo = (function (arglist__21064){
var k = cljs.core.first(arglist__21064);
arglist__21064 = cljs.core.next(arglist__21064);
var v = cljs.core.first(arglist__21064);
var p__21059 = cljs.core.rest(arglist__21064);
return assoc_in_cache_BANG___delegate(k,v,p__21059);
});
...
foundation.app.xhr.clojurify_keys = (function clojurify_keys(m){var f = (function (p__21067){var vec__21068 = p__21067;var k = cljs.core.nth.call(null,vec__21068,0,null);var v = cljs.core.nth.call(null,vec__21068,1,null);if(typeof k === 'string')
...
{try{foundation.app.xhr.xhr_pool.send(uri,uri,method,(((!(typeof content === 'string')) && (!((content == null))))?foundation.app.xhr.stringify.call(null,content):content),cljs.core.clj__GT_js.call(null,headers),50,(function (p1__21075_SHARP_){cljs.core.async.put_BANG_.call(null,c,foundation.app.xhr.handle_response.call(null,p1__21075_SHARP_.target));
...
}catch (e21077){if((e21077 instanceof Error))
{var e = e21077;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e21077;
} else
...
var GET__delegate = function (uri,p__21078){var map__21080 = p__21078;var map__21080__$1 = ((cljs.core.seq_QMARK_.call(null,map__21080))?cljs.core.apply.call(null,cljs.core.hash_map,map__21080):map__21080);var headers = cljs.core.get.call(null,map__21080__$1,new cljs.core.Keyword(null,"headers","headers",1809212152));return foundation.app.xhr.xhr.call(null,uri,"GET",null,cljs.core.merge.call(null,foundation.app.xhr._STAR_headers_STAR_,headers));
};
var GET = function (uri,var_args){
var p__21078 = null;if (arguments.length > 1) {
  p__21078 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return GET__delegate.call(this,uri,p__21078);};
GET.cljs$lang$maxFixedArity = 1;
GET.cljs$lang$applyTo = (function (arglist__21081){
var uri = cljs.core.first(arglist__21081);
var p__21078 = cljs.core.rest(arglist__21081);
return GET__delegate(uri,p__21078);
});
...
var POST__delegate = function (uri,p__21082){var map__21084 = p__21082;var map__21084__$1 = ((cljs.core.seq_QMARK_.call(null,map__21084))?cljs.core.apply.call(null,cljs.core.hash_map,map__21084):map__21084);var headers = cljs.core.get.call(null,map__21084__$1,new cljs.core.Keyword(null,"headers","headers",1809212152),cljs.core.PersistentArrayMap.EMPTY);var body = cljs.core.get.call(null,map__21084__$1,new cljs.core.Keyword(null,"body","body",1016933652),null);return foundation.app.xhr.xhr.call(null,uri,"POST",body,cljs.core.merge.call(null,foundation.app.xhr._STAR_headers_STAR_,headers));
};
var POST = function (uri,var_args){
var p__21082 = null;if (arguments.length > 1) {
  p__21082 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return POST__delegate.call(this,uri,p__21082);};
POST.cljs$lang$maxFixedArity = 1;
POST.cljs$lang$applyTo = (function (arglist__21085){
var uri = cljs.core.first(arglist__21085);
var p__21082 = cljs.core.rest(arglist__21085);
return POST__delegate(uri,p__21082);
});
...
var PUT__delegate = function (uri,p__21086){var map__21088 = p__21086;var map__21088__$1 = ((cljs.core.seq_QMARK_.call(null,map__21088))?cljs.core.apply.call(null,cljs.core.hash_map,map__21088):map__21088);var headers = cljs.core.get.call(null,map__21088__$1,new cljs.core.Keyword(null,"headers","headers",1809212152),cljs.core.PersistentArrayMap.EMPTY);var body = cljs.core.get.call(null,map__21088__$1,new cljs.core.Keyword(null,"body","body",1016933652),null);return foundation.app.xhr.xhr.call(null,uri,"PUT",body,cljs.core.merge.call(null,foundation.app.xhr._STAR_headers_STAR_,headers));
};
var PUT = function (uri,var_args){
var p__21086 = null;if (arguments.length > 1) {
  p__21086 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return PUT__delegate.call(this,uri,p__21086);};
PUT.cljs$lang$maxFixedArity = 1;
PUT.cljs$lang$applyTo = (function (arglist__21089){
var uri = cljs.core.first(arglist__21089);
var p__21086 = cljs.core.rest(arglist__21089);
return PUT__delegate(uri,p__21086);
});
...
var DELETE__delegate = function (uri,p__21090){var map__21092 = p__21090;var map__21092__$1 = ((cljs.core.seq_QMARK_.call(null,map__21092))?cljs.core.apply.call(null,cljs.core.hash_map,map__21092):map__21092);var headers = cljs.core.get.call(null,map__21092__$1,new cljs.core.Keyword(null,"headers","headers",1809212152),cljs.core.PersistentArrayMap.EMPTY);var body = cljs.core.get.call(null,map__21092__$1,new cljs.core.Keyword(null,"body","body",1016933652),null);return foundation.app.xhr.xhr.call(null,uri,"DELETE",null,cljs.core.merge.call(null,foundation.app.xhr._STAR_headers_STAR_,headers));
};
var DELETE = function (uri,var_args){
var p__21090 = null;if (arguments.length > 1) {
  p__21090 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return DELETE__delegate.call(this,uri,p__21090);};
DELETE.cljs$lang$maxFixedArity = 1;
DELETE.cljs$lang$applyTo = (function (arglist__21093){
var uri = cljs.core.first(arglist__21093);
var p__21090 = cljs.core.rest(arglist__21093);
return DELETE__delegate(uri,p__21090);
});
