...
goog.require('foundation.app.data.dependency');
foundation.app.data.component.Lifecycle = (function (){var obj46309 = {};return obj46309;
})();
foundation.app.data.component.start = (function start(component){if((function (){var and__8186__auto__ = component;if(and__8186__auto__)
...
{var x__8806__auto__ = (((component == null))?null:component);return (function (){var or__8198__auto__ = (foundation.app.data.component.start[goog.typeOf(x__8806__auto__)]);if(or__8198__auto__)
{return or__8198__auto__;
} else
{var or__8198__auto____$1 = (foundation.app.data.component.start["_"]);if(or__8198__auto____$1)
...
foundation.app.data.component.stop = (function stop(component){if((function (){var and__8186__auto__ = component;if(and__8186__auto__)
...
{var x__8806__auto__ = (((component == null))?null:component);return (function (){var or__8198__auto__ = (foundation.app.data.component.stop[goog.typeOf(x__8806__auto__)]);if(or__8198__auto__)
{return or__8198__auto__;
} else
{var or__8198__auto____$1 = (foundation.app.data.component.stop["_"]);if(or__8198__auto____$1)
{return or__8198__auto____$1;
} else
...
*/
foundation.app.data.component.dependency_graph = (function dependency_graph(system,component_keys){return cljs.core.reduce_kv.call(null,(function (graph,key,component){return cljs.core.reduce.call(null,(function (p1__46310_SHARP_,p2__46311_SHARP_){return foundation.app.data.dependency.depend.call(null,p1__46310_SHARP_,key,p2__46311_SHARP_);
...
foundation.app.data.component.assoc_dependencies = (function assoc_dependencies(component,system){return cljs.core.reduce_kv.call(null,(function (p1__46312_SHARP_,p2__46313_SHARP_,p3__46314_SHARP_){return foundation.app.data.component.assoc_dependency.call(null,system,p1__46312_SHARP_,p2__46313_SHARP_,p3__46314_SHARP_);
...
foundation.app.data.component.get_component = (function get_component(system,key){var or__8198__auto__ = cljs.core.get.call(null,system,key);if(cljs.core.truth_(or__8198__auto__))
{return or__8198__auto__;
} else
{throw cljs.core.ex_info.call(null,"Missing component from system",new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"reason","reason",4373906870),new cljs.core.Keyword("foundation.app.data.component","missing-component","foundation.app.data.component/missing-component",3557566423),new cljs.core.Keyword(null,"component-key","component-key",2719177985),key,new cljs.core.Keyword(null,"system","system",4421543329),system], null));
}
...
update_system.cljs$lang$applyTo = (function (arglist__46317){
var system = cljs.core.first(arglist__46317);
arglist__46317 = cljs.core.next(arglist__46317);
var component_keys = cljs.core.first(arglist__46317);
arglist__46317 = cljs.core.next(arglist__46317);
var f = cljs.core.first(arglist__46317);
var args = cljs.core.rest(arglist__46317);
...
update_system_reverse.cljs$lang$applyTo = (function (arglist__46318){
var system = cljs.core.first(arglist__46318);
arglist__46318 = cljs.core.next(arglist__46318);
var component_keys = cljs.core.first(arglist__46318);
arglist__46318 = cljs.core.next(arglist__46318);
var f = cljs.core.first(arglist__46318);
var args = cljs.core.rest(arglist__46318);
