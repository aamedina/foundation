...
goog.require('foundation.app.data.dependency');
foundation.app.data.component.Lifecycle = (function (){var obj398937 = {};return obj398937;
})();
...
*/
foundation.app.data.component.dependency_graph = (function dependency_graph(system,component_keys){return cljs.core.reduce_kv.call(null,(function (graph,key,component){return cljs.core.reduce.call(null,(function (p1__398938_SHARP_,p2__398939_SHARP_){return foundation.app.data.dependency.depend.call(null,p1__398938_SHARP_,key,p2__398939_SHARP_);
...
foundation.app.data.component.assoc_dependencies = (function assoc_dependencies(component,system){return cljs.core.reduce_kv.call(null,(function (p1__398940_SHARP_,p2__398941_SHARP_,p3__398942_SHARP_){return foundation.app.data.component.assoc_dependency.call(null,system,p1__398940_SHARP_,p2__398941_SHARP_,p3__398942_SHARP_);
...
update_system.cljs$lang$applyTo = (function (arglist__398945){
var system = cljs.core.first(arglist__398945);
arglist__398945 = cljs.core.next(arglist__398945);
var component_keys = cljs.core.first(arglist__398945);
arglist__398945 = cljs.core.next(arglist__398945);
var f = cljs.core.first(arglist__398945);
var args = cljs.core.rest(arglist__398945);
...
update_system_reverse.cljs$lang$applyTo = (function (arglist__398946){
var system = cljs.core.first(arglist__398946);
arglist__398946 = cljs.core.next(arglist__398946);
var component_keys = cljs.core.first(arglist__398946);
arglist__398946 = cljs.core.next(arglist__398946);
var f = cljs.core.first(arglist__398946);
var args = cljs.core.rest(arglist__398946);
...
foundation.app.data.component.SystemMap.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8792__auto__,k398948,else__8793__auto__){var self__ = this;
var this__8792__auto____$1 = this;if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k398948,else__8793__auto__);
} else
{return null;
}
});
foundation.app.data.component.SystemMap.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8797__auto__,k__8798__auto__,G__398947){var self__ = this;
var this__8797__auto____$1 = this;var pred__398950 = cljs.core.keyword_identical_QMARK_;var expr__398951 = k__8798__auto__;return (new foundation.app.data.component.SystemMap(self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__8798__auto__,G__398947),null));
});
...
foundation.app.data.component.SystemMap.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8789__auto__,G__398947){var self__ = this;
var this__8789__auto____$1 = this;return (new foundation.app.data.component.SystemMap(G__398947,self__.__extmap,self__.__hash));
});
...
foundation.app.data.component.map__GT_SystemMap = (function map__GT_SystemMap(G__398949){return (new foundation.app.data.component.SystemMap(null,cljs.core.dissoc.call(null,G__398949)));
});
/**
...
system_map.cljs$lang$applyTo = (function (arglist__398953){
var keyvals = cljs.core.seq(arglist__398953);
