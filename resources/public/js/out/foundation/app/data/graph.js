...
foundation.app.data.graph.DirectedGraph.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8792__auto__,k398977,else__8793__auto__){var self__ = this;
var this__8792__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k398977,new cljs.core.Keyword(null,"nodes","nodes",1118897699)))
{return self__.nodes;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k398977,new cljs.core.Keyword(null,"neighbors","neighbors",1439078195)))
{return self__.neighbors;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k398977,else__8793__auto__);
} else
{return null;
}
}
...
foundation.app.data.graph.DirectedGraph.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8797__auto__,k__8798__auto__,G__398976){var self__ = this;
var this__8797__auto____$1 = this;var pred__398979 = cljs.core.keyword_identical_QMARK_;var expr__398980 = k__8798__auto__;if(cljs.core.truth_(pred__398979.call(null,new cljs.core.Keyword(null,"nodes","nodes",1118897699),expr__398980)))
{return (new foundation.app.data.graph.DirectedGraph(G__398976,self__.neighbors,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__398979.call(null,new cljs.core.Keyword(null,"neighbors","neighbors",1439078195),expr__398980)))
{return (new foundation.app.data.graph.DirectedGraph(self__.nodes,G__398976,self__.__meta,self__.__extmap,null));
} else
{return (new foundation.app.data.graph.DirectedGraph(self__.nodes,self__.neighbors,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__8798__auto__,G__398976),null));
}
}
});
...
foundation.app.data.graph.DirectedGraph.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8789__auto__,G__398976){var self__ = this;
var this__8789__auto____$1 = this;return (new foundation.app.data.graph.DirectedGraph(self__.nodes,self__.neighbors,G__398976,self__.__extmap,self__.__hash));
});
...
foundation.app.data.graph.map__GT_DirectedGraph = (function map__GT_DirectedGraph(G__398978){return (new foundation.app.data.graph.DirectedGraph(new cljs.core.Keyword(null,"nodes","nodes",1118897699).cljs$core$IFn$_invoke$arity$1(G__398978),new cljs.core.Keyword(null,"neighbors","neighbors",1439078195).cljs$core$IFn$_invoke$arity$1(G__398978),null,cljs.core.dissoc.call(null,G__398978,new cljs.core.Keyword(null,"nodes","nodes",1118897699),new cljs.core.Keyword(null,"neighbors","neighbors",1439078195))));
});
/**
...
*/
foundation.app.data.graph.post_ordered_visit = (function post_ordered_visit(g,n,p__398982){var vec__398985 = p__398982;var visited = cljs.core.nth.call(null,vec__398985,0,null);var acc = cljs.core.nth.call(null,vec__398985,1,null);var state = vec__398985;if(cljs.core.truth_(visited.call(null,n)))
{return state;
} else
{var vec__398986 = cljs.core.reduce.call(null,(function (st,nd){return post_ordered_visit.call(null,g,nd,st);
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.conj.call(null,visited,n),acc], null),foundation.app.data.graph.get_neighbors.call(null,g,n));var v2 = cljs.core.nth.call(null,vec__398986,0,null);var acc2 = cljs.core.nth.call(null,vec__398986,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [v2,cljs.core.conj.call(null,acc2,n)], null);
}
});
/**
* Return a sequence of indexes of a post-ordered walk of the graph.
*/
foundation.app.data.graph.post_ordered_nodes = (function post_ordered_nodes(g){return cljs.core.fnext.call(null,cljs.core.reduce.call(null,(function (p1__398988_SHARP_,p2__398987_SHARP_){return foundation.app.data.graph.post_ordered_visit.call(null,g,p2__398987_SHARP_,p1__398988_SHARP_);
...
{var vec__398990 = foundation.app.data.graph.post_ordered_visit.call(null,rev,cljs.core.first.call(null,stack),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [visited,cljs.core.PersistentHashSet.EMPTY], null));var nv = cljs.core.nth.call(null,vec__398990,0,null);var comp = cljs.core.nth.call(null,vec__398990,1,null);var ns = cljs.core.remove.call(null,nv,stack);{
var G__398991 = ns;
var G__398992 = nv;
var G__398993 = cljs.core.conj.call(null,acc,comp);
stack = G__398991;
visited = G__398992;
acc = G__398993;
continue;
...
var component_graph__2 = (function (g,sccs){var find_node_set = (function (n){return cljs.core.some.call(null,(function (p1__398994_SHARP_){if(cljs.core.truth_(p1__398994_SHARP_.call(null,n)))
{return p1__398994_SHARP_;
} else
{return null;
}
}),sccs);
...
{var n = cljs.core.first.call(null,ns);return cljs.core.some.call(null,(function (p1__398995_SHARP_){return cljs.core._EQ_.call(null,p1__398995_SHARP_,n);
...
{{
var G__398996 = new_data;
var G__398997 = (function (){var and__8211__auto__ = idx;if(cljs.core.truth_(and__8211__auto__))
{return (idx - 1);
} else
{return and__8211__auto__;
}
...
return (function (acc,p__399000){var vec__399001 = p__399000;var n = cljs.core.nth.call(null,vec__399001,0,null);var dep = cljs.core.nth.call(null,vec__399001,1,null);return cljs.core.assoc.call(null,acc,dep,cljs.core.conj.call(null,acc.call(null,dep),n));
});})(max))
...
return (function (p__399004){var vec__399005 = p__399004;var k = cljs.core.nth.call(null,vec__399005,0,null);var v = cljs.core.nth.call(null,vec__399005,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,update.call(null,k)], null);
});})(update))
,d));
...
return (function (p__399008){var vec__399009 = p__399008;var k = cljs.core.nth.call(null,vec__399009,0,null);var v = cljs.core.nth.call(null,vec__399009,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,update.call(null,k)], null);
});})(update))
,d));
