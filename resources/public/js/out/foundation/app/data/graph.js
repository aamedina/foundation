...
foundation.app.data.graph.DirectedGraph.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8792__auto__,k176510,else__8793__auto__){var self__ = this;
var this__8792__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k176510,new cljs.core.Keyword(null,"nodes","nodes",1118897699)))
{return self__.nodes;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k176510,new cljs.core.Keyword(null,"neighbors","neighbors",1439078195)))
{return self__.neighbors;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k176510,else__8793__auto__);
} else
{return null;
}
}
...
foundation.app.data.graph.DirectedGraph.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8797__auto__,k__8798__auto__,G__176509){var self__ = this;
var this__8797__auto____$1 = this;var pred__176512 = cljs.core.keyword_identical_QMARK_;var expr__176513 = k__8798__auto__;if(cljs.core.truth_(pred__176512.call(null,new cljs.core.Keyword(null,"nodes","nodes",1118897699),expr__176513)))
{return (new foundation.app.data.graph.DirectedGraph(G__176509,self__.neighbors,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__176512.call(null,new cljs.core.Keyword(null,"neighbors","neighbors",1439078195),expr__176513)))
{return (new foundation.app.data.graph.DirectedGraph(self__.nodes,G__176509,self__.__meta,self__.__extmap,null));
} else
{return (new foundation.app.data.graph.DirectedGraph(self__.nodes,self__.neighbors,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__8798__auto__,G__176509),null));
}
}
});
...
foundation.app.data.graph.DirectedGraph.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8789__auto__,G__176509){var self__ = this;
var this__8789__auto____$1 = this;return (new foundation.app.data.graph.DirectedGraph(self__.nodes,self__.neighbors,G__176509,self__.__extmap,self__.__hash));
});
...
foundation.app.data.graph.map__GT_DirectedGraph = (function map__GT_DirectedGraph(G__176511){return (new foundation.app.data.graph.DirectedGraph(new cljs.core.Keyword(null,"nodes","nodes",1118897699).cljs$core$IFn$_invoke$arity$1(G__176511),new cljs.core.Keyword(null,"neighbors","neighbors",1439078195).cljs$core$IFn$_invoke$arity$1(G__176511),null,cljs.core.dissoc.call(null,G__176511,new cljs.core.Keyword(null,"nodes","nodes",1118897699),new cljs.core.Keyword(null,"neighbors","neighbors",1439078195))));
});
/**
...
*/
foundation.app.data.graph.post_ordered_visit = (function post_ordered_visit(g,n,p__176515){var vec__176518 = p__176515;var visited = cljs.core.nth.call(null,vec__176518,0,null);var acc = cljs.core.nth.call(null,vec__176518,1,null);var state = vec__176518;if(cljs.core.truth_(visited.call(null,n)))
{return state;
} else
{var vec__176519 = cljs.core.reduce.call(null,(function (st,nd){return post_ordered_visit.call(null,g,nd,st);
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.conj.call(null,visited,n),acc], null),foundation.app.data.graph.get_neighbors.call(null,g,n));var v2 = cljs.core.nth.call(null,vec__176519,0,null);var acc2 = cljs.core.nth.call(null,vec__176519,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [v2,cljs.core.conj.call(null,acc2,n)], null);
}
});
/**
* Return a sequence of indexes of a post-ordered walk of the graph.
*/
foundation.app.data.graph.post_ordered_nodes = (function post_ordered_nodes(g){return cljs.core.fnext.call(null,cljs.core.reduce.call(null,(function (p1__176521_SHARP_,p2__176520_SHARP_){return foundation.app.data.graph.post_ordered_visit.call(null,g,p2__176520_SHARP_,p1__176521_SHARP_);
...
{var vec__176523 = foundation.app.data.graph.post_ordered_visit.call(null,rev,cljs.core.first.call(null,stack),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [visited,cljs.core.PersistentHashSet.EMPTY], null));var nv = cljs.core.nth.call(null,vec__176523,0,null);var comp = cljs.core.nth.call(null,vec__176523,1,null);var ns = cljs.core.remove.call(null,nv,stack);{
var G__176524 = ns;
var G__176525 = nv;
var G__176526 = cljs.core.conj.call(null,acc,comp);
stack = G__176524;
visited = G__176525;
acc = G__176526;
continue;
...
var component_graph__2 = (function (g,sccs){var find_node_set = (function (n){return cljs.core.some.call(null,(function (p1__176527_SHARP_){if(cljs.core.truth_(p1__176527_SHARP_.call(null,n)))
{return p1__176527_SHARP_;
} else
{return null;
}
}),sccs);
...
{var n = cljs.core.first.call(null,ns);return cljs.core.some.call(null,(function (p1__176528_SHARP_){return cljs.core._EQ_.call(null,p1__176528_SHARP_,n);
...
{{
var G__176529 = new_data;
var G__176530 = (function (){var and__8211__auto__ = idx;if(cljs.core.truth_(and__8211__auto__))
{return (idx - 1);
} else
{return and__8211__auto__;
}
...
return (function (acc,p__176533){var vec__176534 = p__176533;var n = cljs.core.nth.call(null,vec__176534,0,null);var dep = cljs.core.nth.call(null,vec__176534,1,null);return cljs.core.assoc.call(null,acc,dep,cljs.core.conj.call(null,acc.call(null,dep),n));
});})(max))
...
return (function (p__176537){var vec__176538 = p__176537;var k = cljs.core.nth.call(null,vec__176538,0,null);var v = cljs.core.nth.call(null,vec__176538,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,update.call(null,k)], null);
});})(update))
,d));
...
return (function (p__176541){var vec__176542 = p__176541;var k = cljs.core.nth.call(null,vec__176542,0,null);var v = cljs.core.nth.call(null,vec__176542,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,update.call(null,k)], null);
});})(update))
,d));
