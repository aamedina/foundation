...
foundation.app.router.re_chars = cljs.core.reduce.call(null,(function (p1__38654_SHARP_,p2__38655_SHARP_){return cljs.core.assoc.call(null,p1__38654_SHARP_,p2__38655_SHARP_,[cljs.core.str("\\"),cljs.core.str(p2__38655_SHARP_)].join(''));
...
* keywords.
*/
foundation.app.router.assoc_keys_with_groups = (function assoc_keys_with_groups(groups,keys){return cljs.core.reduce.call(null,(function (m,p__38658){var vec__38659 = p__38658;var k = cljs.core.nth.call(null,vec__38659,0,null);var v = cljs.core.nth.call(null,vec__38659,1,null);return foundation.app.router.assoc_vec.call(null,m,k,v);
...
foundation.app.router.Route = (function (){var obj38661 = {};return obj38661;
})();
...
foundation.app.router.CompiledRoute.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8797__auto__,k38663,else__8798__auto__){var self__ = this;
var this__8797__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k38663,new cljs.core.Keyword(null,"re","re",1013907877)))
{return self__.re;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k38663,new cljs.core.Keyword(null,"keys","keys",1017192806)))
{return self__.keys;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k38663,new cljs.core.Keyword(null,"absolute?","absolute?",3046085914)))
{return self__.absolute_QMARK_;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k38663,else__8798__auto__);
} else
{return null;
}
}
...
foundation.app.router.CompiledRoute.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8802__auto__,k__8803__auto__,G__38662){var self__ = this;
var this__8802__auto____$1 = this;var pred__38665 = cljs.core.keyword_identical_QMARK_;var expr__38666 = k__8803__auto__;if(cljs.core.truth_(pred__38665.call(null,new cljs.core.Keyword(null,"re","re",1013907877),expr__38666)))
{return (new foundation.app.router.CompiledRoute(G__38662,self__.keys,self__.absolute_QMARK_,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__38665.call(null,new cljs.core.Keyword(null,"keys","keys",1017192806),expr__38666)))
{return (new foundation.app.router.CompiledRoute(self__.re,G__38662,self__.absolute_QMARK_,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__38665.call(null,new cljs.core.Keyword(null,"absolute?","absolute?",3046085914),expr__38666)))
{return (new foundation.app.router.CompiledRoute(self__.re,self__.keys,G__38662,self__.__meta,self__.__extmap,null));
} else
{return (new foundation.app.router.CompiledRoute(self__.re,self__.keys,self__.absolute_QMARK_,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__8803__auto__,G__38662),null));
}
}
}
});
...
foundation.app.router.CompiledRoute.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8794__auto__,G__38662){var self__ = this;
var this__8794__auto____$1 = this;return (new foundation.app.router.CompiledRoute(self__.re,self__.keys,self__.absolute_QMARK_,G__38662,self__.__extmap,self__.__hash));
});
...
foundation.app.router.map__GT_CompiledRoute = (function map__GT_CompiledRoute(G__38664){return (new foundation.app.router.CompiledRoute(new cljs.core.Keyword(null,"re","re",1013907877).cljs$core$IFn$_invoke$arity$1(G__38664),new cljs.core.Keyword(null,"keys","keys",1017192806).cljs$core$IFn$_invoke$arity$1(G__38664),new cljs.core.Keyword(null,"absolute?","absolute?",3046085914).cljs$core$IFn$_invoke$arity$1(G__38664),null,cljs.core.dissoc.call(null,G__38664,new cljs.core.Keyword(null,"re","re",1013907877),new cljs.core.Keyword(null,"keys","keys",1017192806),new cljs.core.Keyword(null,"absolute?","absolute?",3046085914))));
});
/**
* Lex one symbol from a string, and return the symbol and trailing source.
*/
foundation.app.router.lex_1 = (function lex_1(src,clauses){return cljs.core.some.call(null,(function (p__38670){var vec__38671 = p__38670;var re = cljs.core.nth.call(null,vec__38671,0,null);var action = cljs.core.nth.call(null,vec__38671,1,null);var matches = re.exec(src);if(cljs.core.truth_(goog.string.startsWith(src,cljs.core.first.call(null,matches))))
...
{var vec__38673 = temp__4090__auto__;var result = cljs.core.nth.call(null,vec__38673,0,null);var src__$2 = cljs.core.nth.call(null,vec__38673,1,null);var results__$1 = cljs.core.conj.call(null,results,result);if(cljs.core._EQ_.call(null,src__$2,""))
{return results__$1;
} else
{{
var G__38674 = results__$1;
var G__38675 = src__$2;
var G__38676 = clauses__$1;
results = G__38674;
src__$1 = G__38675;
clauses__$1 = G__38676;
continue;
}
}
} else
...
lex.cljs$lang$applyTo = (function (arglist__38677){
var src = cljs.core.first(arglist__38677);
var clauses = cljs.core.rest(arglist__38677);
...
return (function (p1__38678_SHARP_){return cljs.core.keyword.call(null,cljs.core.nth.call(null,p1__38678_SHARP_,1));
});})(splat,word,literal))
;var word_regex = ((function (splat,word,literal,word_group){
return (function (p1__38679_SHARP_){return regexs.call(null,word_group.call(null,p1__38679_SHARP_),/[^\/,;?]+/);
});})(splat,word,literal,word_group))
;return (new foundation.app.router.CompiledRoute(cljs.core.re_pattern.call(null,cljs.core.apply.call(null,cljs.core.str,foundation.app.router.lex.call(null,path,splat,"(.*)",/^\/\//,"https?://",word,(function (p1__38680_SHARP_){return [cljs.core.str("("),cljs.core.str(word_regex.call(null,p1__38680_SHARP_).source),cljs.core.str(")")].join('');
}),literal,(function (p1__38681_SHARP_){return foundation.app.router.re_escape.call(null,cljs.core.first.call(null,p1__38681_SHARP_));
...
foundation.app.router.IResponse = (function (){var obj38683 = {};return obj38683;
})();
...
(foundation.app.router._response["_"] = (function (o,req){if((function (){var G__38686 = o;if(G__38686)
...
{return G__38686.foundation$app$ui$IComponent$;
}
})()))
{return true;
} else
...
{return cljs.core.map.call(null,(function (p1__38685_SHARP_){return foundation.app.router._response.call(null,p1__38685_SHARP_,req);
}),o);
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return o;
...
cljs.core.async.impl.channels.ManyToManyChannel.prototype.foundation$app$router$IResponse$_response$arity$2 = (function (c,request){var c__$1 = this;return cljs.core.async.map_GT_.call(null,(function (p1__38684_SHARP_){return foundation.app.router._response.call(null,p1__38684_SHARP_,request);
}),c__$1);
});
cljs.core.PersistentVector.prototype.foundation$app$router$IResponse$ = true;
cljs.core.PersistentVector.prototype.foundation$app$router$IResponse$_response$arity$2 = (function (messages,_){var messages__$1 = this;var temp__4092__auto__ = new cljs.core.Keyword(null,"input","input",1114262332).cljs$core$IFn$_invoke$arity$1(messages__$1);if(cljs.core.truth_(temp__4092__auto__))
{var input_queue = temp__4092__auto__;var seq__38687 = cljs.core.seq.call(null,messages__$1);var chunk__38688 = null;var count__38689 = 0;var i__38690 = 0;while(true){
if((i__38690 < count__38689))
{var message = cljs.core._nth.call(null,chunk__38688,i__38690);cljs.core.async.put_BANG_.call(null,new cljs.core.Keyword(null,"input","input",1114262332).cljs$core$IFn$_invoke$arity$1(messages__$1),message);
{
var G__38691 = seq__38687;
var G__38692 = chunk__38688;
var G__38693 = count__38689;
var G__38694 = (i__38690 + 1);
seq__38687 = G__38691;
chunk__38688 = G__38692;
count__38689 = G__38693;
i__38690 = G__38694;
continue;
}
} else
{var temp__4092__auto____$1 = cljs.core.seq.call(null,seq__38687);if(temp__4092__auto____$1)
{var seq__38687__$1 = temp__4092__auto____$1;if(cljs.core.chunked_seq_QMARK_.call(null,seq__38687__$1))
{var c__8957__auto__ = cljs.core.chunk_first.call(null,seq__38687__$1);{
var G__38695 = cljs.core.chunk_rest.call(null,seq__38687__$1);
var G__38696 = c__8957__auto__;
var G__38697 = cljs.core.count.call(null,c__8957__auto__);
var G__38698 = 0;
seq__38687 = G__38695;
chunk__38688 = G__38696;
count__38689 = G__38697;
i__38690 = G__38698;
continue;
}
} else
{var message = cljs.core.first.call(null,seq__38687__$1);cljs.core.async.put_BANG_.call(null,new cljs.core.Keyword(null,"input","input",1114262332).cljs$core$IFn$_invoke$arity$1(messages__$1),message);
{
var G__38699 = cljs.core.next.call(null,seq__38687__$1);
var G__38700 = null;
var G__38701 = 0;
var G__38702 = 0;
seq__38687 = G__38699;
chunk__38688 = G__38700;
count__38689 = G__38701;
i__38690 = G__38702;
continue;
}
}
...
{var G__38704 = handler.call(null,request);var G__38704__$1 = (((G__38704 == null))?null:cljs.core.assoc.call(null,G__38704,new cljs.core.Keyword(null,"body","body",1016933652),null));return G__38704__$1;
} else
{return null;
}
}
...
var routing__delegate = function (request,handlers){return cljs.core.some.call(null,(function (p1__38705_SHARP_){return p1__38705_SHARP_.call(null,request);
}),handlers);
};
...
routing.cljs$lang$applyTo = (function (arglist__38706){
var request = cljs.core.first(arglist__38706);
var handlers = cljs.core.rest(arglist__38706);
...
var routes__delegate = function (handlers){return (function (p1__38707_SHARP_){return cljs.core.apply.call(null,foundation.app.router.routing,p1__38707_SHARP_,handlers);
});
};
...
routes.cljs$lang$applyTo = (function (arglist__38708){
var handlers = cljs.core.seq(arglist__38708);
...
foundation.app.router.IRouter = (function (){var obj38710 = {};return obj38710;
})();
...
* @param {*=} __extmap
*/
foundation.app.router.Router = (function (router,routes,app,__meta,__extmap){
this.router = router;
this.routes = routes;
this.app = app;
this.__meta = __meta;
...
var router__$2 = this;var G__38714_38719 = router__$2.router;G__38714_38719.setUseFragment(false);
G__38714_38719.addEventListener(goog.history.EventType.NAVIGATE,cljs.core.partial.call(null,foundation.app.router._on_navigation,router__$2));
G__38714_38719.setEnabled(true);
return router__$2;
});
...
var router__$2 = this;var G__38715_38720 = router__$2.router;G__38715_38720.setEnabled(false);
return router__$2;
});
...
foundation.app.router.Router.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8797__auto__,k38712,else__8798__auto__){var self__ = this;
var this__8797__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k38712,new cljs.core.Keyword(null,"router","router",4383738555)))
{return self__.router;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k38712,new cljs.core.Keyword(null,"routes","routes",4383738556)))
{return self__.routes;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k38712,new cljs.core.Keyword(null,"app","app",1014001043)))
{return self__.app;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k38712,else__8798__auto__);
} else
{return null;
}
}
...
foundation.app.router.Router.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8802__auto__,k__8803__auto__,G__38711){var self__ = this;
var this__8802__auto____$1 = this;var pred__38716 = cljs.core.keyword_identical_QMARK_;var expr__38717 = k__8803__auto__;if(cljs.core.truth_(pred__38716.call(null,new cljs.core.Keyword(null,"router","router",4383738555),expr__38717)))
{return (new foundation.app.router.Router(G__38711,self__.routes,self__.app,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__38716.call(null,new cljs.core.Keyword(null,"routes","routes",4383738556),expr__38717)))
{return (new foundation.app.router.Router(self__.router,G__38711,self__.app,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__38716.call(null,new cljs.core.Keyword(null,"app","app",1014001043),expr__38717)))
{return (new foundation.app.router.Router(self__.router,self__.routes,G__38711,self__.__meta,self__.__extmap,null));
} else
{return (new foundation.app.router.Router(self__.router,self__.routes,self__.app,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__8803__auto__,G__38711),null));
}
}
}
});
foundation.app.router.Router.prototype.foundation$app$router$IRouter$ = true;
foundation.app.router.Router.prototype.foundation$app$router$IRouter$_navigate$arity$4 = (function (_,uri,method,params){var self__ = this;
var ___$1 = this;var uri__$1 = (new goog.Uri(uri));var path = clojure.string.replace.call(null,uri__$1.getPath(),/^\//,"");self__.router.setToken(path);
return self__.routes.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"uri","uri",1014020318),uri__$1.getPath(),new cljs.core.Keyword(null,"method","method",4231316563),method,new cljs.core.Keyword(null,"params","params",4313443576),clojure.walk.keywordize_keys.call(null,cljs.core.apply.call(null,cljs.core.hash_map,clojure.string.split.call(null,[cljs.core.str(uri__$1.getQuery())].join(''),/=/)))], null));
});
...
var this__8809__auto____$1 = this;var pr_pair__8812__auto__ = (function (keyval__8813__auto__){return cljs.core.pr_sequential_writer.call(null,writer__8810__auto__,cljs.core.pr_writer,""," ","",opts__8811__auto__,keyval__8813__auto__);
});return cljs.core.pr_sequential_writer.call(null,writer__8810__auto__,pr_pair__8812__auto__,"#foundation.app.router.Router{",", ","}",opts__8811__auto__,cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,5,cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"router","router",4383738555),self__.router],null)),(new cljs.core.PersistentVector(null,2,5,cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"routes","routes",4383738556),self__.routes],null)),(new cljs.core.PersistentVector(null,2,5,cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"app","app",1014001043),self__.app],null))], null),self__.__extmap));
});
...
foundation.app.router.Router.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8794__auto__,G__38711){var self__ = this;
var this__8794__auto____$1 = this;return (new foundation.app.router.Router(self__.router,self__.routes,self__.app,G__38711,self__.__extmap,self__.__hash));
});
...
var this__8804__auto____$1 = this;if(cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"app","app",1014001043),null,new cljs.core.Keyword(null,"routes","routes",4383738556),null,new cljs.core.Keyword(null,"router","router",4383738555),null], null), null),k__8805__auto__))
{return cljs.core.dissoc.call(null,cljs.core.with_meta.call(null,cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,this__8804__auto____$1),self__.__meta),k__8805__auto__);
} else
{return (new foundation.app.router.Router(self__.router,self__.routes,self__.app,self__.__meta,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,self__.__extmap,k__8805__auto__)),null));
}
});
...
foundation.app.router.__GT_Router = (function __GT_Router(router,routes,app){return (new foundation.app.router.Router(router,routes,app));
});
foundation.app.router.map__GT_Router = (function map__GT_Router(G__38713){return (new foundation.app.router.Router(new cljs.core.Keyword(null,"router","router",4383738555).cljs$core$IFn$_invoke$arity$1(G__38713),new cljs.core.Keyword(null,"routes","routes",4383738556).cljs$core$IFn$_invoke$arity$1(G__38713),new cljs.core.Keyword(null,"app","app",1014001043).cljs$core$IFn$_invoke$arity$1(G__38713),null,cljs.core.dissoc.call(null,G__38713,new cljs.core.Keyword(null,"router","router",4383738555),new cljs.core.Keyword(null,"routes","routes",4383738556),new cljs.core.Keyword(null,"app","app",1014001043))));
});
foundation.app.router.router = (function router(app,routes){return foundation.app.data.component.start.call(null,foundation.app.router.map__GT_Router.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"routes","routes",4383738556),routes,new cljs.core.Keyword(null,"router","router",4383738555),(new goog.history.Html5History()),new cljs.core.Keyword(null,"app","app",1014001043),app], null)));
});
/**
* @param {...*} var_args
*/
foundation.app.router.navigate_BANG_ = (function() { 
var navigate_BANG___delegate = function (router,uri,p__38721){var map__38723 = p__38721;var map__38723__$1 = ((cljs.core.seq_QMARK_.call(null,map__38723))?cljs.core.apply.call(null,cljs.core.hash_map,map__38723):map__38723);var args = map__38723__$1;var params = cljs.core.get.call(null,map__38723__$1,new cljs.core.Keyword(null,"params","params",4313443576));var method = cljs.core.get.call(null,map__38723__$1,new cljs.core.Keyword(null,"method","method",4231316563));return foundation.app.router._navigate.call(null,router,uri,method,params);
};
...
return navigate_BANG___delegate.call(this,router,uri,p__38721);};
navigate_BANG_.cljs$lang$maxFixedArity = 2;
navigate_BANG_.cljs$lang$applyTo = (function (arglist__38724){
var router = cljs.core.first(arglist__38724);
arglist__38724 = cljs.core.next(arglist__38724);
var uri = cljs.core.first(arglist__38724);
var p__38721 = cljs.core.rest(arglist__38724);
return navigate_BANG___delegate(router,uri,p__38721);
});
