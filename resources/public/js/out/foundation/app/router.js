...
goog.require('dommy.core');
goog.require('goog.string');
foundation.app.router.re_chars = cljs.core.reduce.call(null,(function (p1__26446_SHARP_,p2__26447_SHARP_){return cljs.core.assoc.call(null,p1__26446_SHARP_,p2__26447_SHARP_,[cljs.core.str("\\"),cljs.core.str(p2__26447_SHARP_)].join(''));
...
* keywords.
*/
foundation.app.router.assoc_keys_with_groups = (function assoc_keys_with_groups(groups,keys){return cljs.core.reduce.call(null,(function (m,p__26450){var vec__26451 = p__26450;var k = cljs.core.nth.call(null,vec__26451,0,null);var v = cljs.core.nth.call(null,vec__26451,1,null);return foundation.app.router.assoc_vec.call(null,m,k,v);
...
foundation.app.router.Route = (function (){var obj26453 = {};return obj26453;
})();
...
foundation.app.router.CompiledRoute.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8767__auto__,k26455,else__8768__auto__){var self__ = this;
var this__8767__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k26455,new cljs.core.Keyword(null,"re","re",1013907877)))
{return self__.re;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k26455,new cljs.core.Keyword(null,"keys","keys",1017192806)))
{return self__.keys;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k26455,new cljs.core.Keyword(null,"absolute?","absolute?",3046085914)))
{return self__.absolute_QMARK_;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k26455,else__8768__auto__);
} else
{return null;
}
}
...
foundation.app.router.CompiledRoute.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8772__auto__,k__8773__auto__,G__26454){var self__ = this;
var this__8772__auto____$1 = this;var pred__26457 = cljs.core.keyword_identical_QMARK_;var expr__26458 = k__8773__auto__;if(cljs.core.truth_(pred__26457.call(null,new cljs.core.Keyword(null,"re","re",1013907877),expr__26458)))
{return (new foundation.app.router.CompiledRoute(G__26454,self__.keys,self__.absolute_QMARK_,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__26457.call(null,new cljs.core.Keyword(null,"keys","keys",1017192806),expr__26458)))
{return (new foundation.app.router.CompiledRoute(self__.re,G__26454,self__.absolute_QMARK_,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__26457.call(null,new cljs.core.Keyword(null,"absolute?","absolute?",3046085914),expr__26458)))
{return (new foundation.app.router.CompiledRoute(self__.re,self__.keys,G__26454,self__.__meta,self__.__extmap,null));
} else
{return (new foundation.app.router.CompiledRoute(self__.re,self__.keys,self__.absolute_QMARK_,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__8773__auto__,G__26454),null));
}
}
}
});
...
foundation.app.router.CompiledRoute.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8764__auto__,G__26454){var self__ = this;
var this__8764__auto____$1 = this;return (new foundation.app.router.CompiledRoute(self__.re,self__.keys,self__.absolute_QMARK_,G__26454,self__.__extmap,self__.__hash));
});
...
foundation.app.router.map__GT_CompiledRoute = (function map__GT_CompiledRoute(G__26456){return (new foundation.app.router.CompiledRoute(new cljs.core.Keyword(null,"re","re",1013907877).cljs$core$IFn$_invoke$arity$1(G__26456),new cljs.core.Keyword(null,"keys","keys",1017192806).cljs$core$IFn$_invoke$arity$1(G__26456),new cljs.core.Keyword(null,"absolute?","absolute?",3046085914).cljs$core$IFn$_invoke$arity$1(G__26456),null,cljs.core.dissoc.call(null,G__26456,new cljs.core.Keyword(null,"re","re",1013907877),new cljs.core.Keyword(null,"keys","keys",1017192806),new cljs.core.Keyword(null,"absolute?","absolute?",3046085914))));
});
/**
* Lex one symbol from a string, and return the symbol and trailing source.
*/
foundation.app.router.lex_1 = (function lex_1(src,clauses){return cljs.core.some.call(null,(function (p__26462){var vec__26463 = p__26462;var re = cljs.core.nth.call(null,vec__26463,0,null);var action = cljs.core.nth.call(null,vec__26463,1,null);var matches = re.exec(src);if(cljs.core.truth_(goog.string.startsWith(src,cljs.core.first.call(null,matches))))
...
{var vec__26465 = temp__4090__auto__;var result = cljs.core.nth.call(null,vec__26465,0,null);var src__$2 = cljs.core.nth.call(null,vec__26465,1,null);var results__$1 = cljs.core.conj.call(null,results,result);if(cljs.core._EQ_.call(null,src__$2,""))
{return results__$1;
} else
{{
var G__26466 = results__$1;
var G__26467 = src__$2;
var G__26468 = clauses__$1;
results = G__26466;
src__$1 = G__26467;
clauses__$1 = G__26468;
continue;
}
}
} else
...
lex.cljs$lang$applyTo = (function (arglist__26469){
var src = cljs.core.first(arglist__26469);
var clauses = cljs.core.rest(arglist__26469);
...
return (function (p1__26470_SHARP_){return cljs.core.keyword.call(null,cljs.core.nth.call(null,p1__26470_SHARP_,1));
});})(splat,word,literal))
;var word_regex = ((function (splat,word,literal,word_group){
return (function (p1__26471_SHARP_){return regexs.call(null,word_group.call(null,p1__26471_SHARP_),/[^\/,;?]+/);
});})(splat,word,literal,word_group))
;return (new foundation.app.router.CompiledRoute(cljs.core.re_pattern.call(null,cljs.core.apply.call(null,cljs.core.str,foundation.app.router.lex.call(null,path,splat,"(.*)",/^\/\//,"https?://",word,(function (p1__26472_SHARP_){return [cljs.core.str("("),cljs.core.str(word_regex.call(null,p1__26472_SHARP_).source),cljs.core.str(")")].join('');
}),literal,(function (p1__26473_SHARP_){return foundation.app.router.re_escape.call(null,cljs.core.first.call(null,p1__26473_SHARP_));
...
foundation.app.router.IRenderable = (function (){var obj26475 = {};return obj26475;
})();
...
{var G__26477 = handler.call(null,request);var G__26477__$1 = (((G__26477 == null))?null:cljs.core.assoc.call(null,G__26477,new cljs.core.Keyword(null,"body","body",1016933652),null));return G__26477__$1;
} else
{return null;
}
}
...
var routing__delegate = function (request,handlers){return cljs.core.some.call(null,(function (p1__26478_SHARP_){return p1__26478_SHARP_.call(null,request);
}),handlers);
};
...
routing.cljs$lang$applyTo = (function (arglist__26479){
var request = cljs.core.first(arglist__26479);
var handlers = cljs.core.rest(arglist__26479);
...
var routes__delegate = function (handlers){return (function (p1__26480_SHARP_){return cljs.core.apply.call(null,foundation.app.router.routing,p1__26480_SHARP_,handlers);
});
};
...
routes.cljs$lang$applyTo = (function (arglist__26481){
var handlers = cljs.core.seq(arglist__26481);
...
foundation.app.router.on_navigate = (function on_navigate(e){cljs.core.println.call(null,e);
...
foundation.app.router.router = (function (){var G__26482 = (new goog.history.Html5History());G__26482.setUseFragment(false);
dommy.core.listen_BANG_.call(null,G__26482,goog.history.EventType.NAVIGATE,foundation.app.router.on_navigate);
return G__26482;
})();
/**
* @param {...*} var_args
...
var route_BANG___delegate = function (method,uri,p__26483){var map__26485 = p__26483;var map__26485__$1 = ((cljs.core.seq_QMARK_.call(null,map__26485))?cljs.core.apply.call(null,cljs.core.hash_map,map__26485):map__26485);var params = cljs.core.get.call(null,map__26485__$1,new cljs.core.Keyword(null,"params","params",4313443576));return foundation.app.router.router.setToken(uri);
};
var route_BANG_ = function (method,uri,var_args){
var p__26483 = null;if (arguments.length > 2) {
  p__26483 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return route_BANG___delegate.call(this,method,uri,p__26483);};
route_BANG_.cljs$lang$maxFixedArity = 2;
route_BANG_.cljs$lang$applyTo = (function (arglist__26486){
var method = cljs.core.first(arglist__26486);
arglist__26486 = cljs.core.next(arglist__26486);
var uri = cljs.core.first(arglist__26486);
var p__26483 = cljs.core.rest(arglist__26486);
return route_BANG___delegate(method,uri,p__26483);
});
