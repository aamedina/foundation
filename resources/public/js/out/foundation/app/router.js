...
foundation.app.router.re_chars = cljs.core.reduce.call(null,(function (p1__36474_SHARP_,p2__36475_SHARP_){return cljs.core.assoc.call(null,p1__36474_SHARP_,p2__36475_SHARP_,[cljs.core.str("\\"),cljs.core.str(p2__36475_SHARP_)].join(''));
...
* keywords.
*/
foundation.app.router.assoc_keys_with_groups = (function assoc_keys_with_groups(groups,keys){return cljs.core.reduce.call(null,(function (m,p__36478){var vec__36479 = p__36478;var k = cljs.core.nth.call(null,vec__36479,0,null);var v = cljs.core.nth.call(null,vec__36479,1,null);return foundation.app.router.assoc_vec.call(null,m,k,v);
...
foundation.app.router.Route = (function (){var obj36481 = {};return obj36481;
})();
...
foundation.app.router.CompiledRoute.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8797__auto__,k36483,else__8798__auto__){var self__ = this;
var this__8797__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k36483,new cljs.core.Keyword(null,"re","re",1013907877)))
{return self__.re;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k36483,new cljs.core.Keyword(null,"keys","keys",1017192806)))
{return self__.keys;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k36483,new cljs.core.Keyword(null,"absolute?","absolute?",3046085914)))
{return self__.absolute_QMARK_;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k36483,else__8798__auto__);
} else
{return null;
}
}
...
foundation.app.router.CompiledRoute.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8802__auto__,k__8803__auto__,G__36482){var self__ = this;
var this__8802__auto____$1 = this;var pred__36485 = cljs.core.keyword_identical_QMARK_;var expr__36486 = k__8803__auto__;if(cljs.core.truth_(pred__36485.call(null,new cljs.core.Keyword(null,"re","re",1013907877),expr__36486)))
{return (new foundation.app.router.CompiledRoute(G__36482,self__.keys,self__.absolute_QMARK_,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__36485.call(null,new cljs.core.Keyword(null,"keys","keys",1017192806),expr__36486)))
{return (new foundation.app.router.CompiledRoute(self__.re,G__36482,self__.absolute_QMARK_,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__36485.call(null,new cljs.core.Keyword(null,"absolute?","absolute?",3046085914),expr__36486)))
{return (new foundation.app.router.CompiledRoute(self__.re,self__.keys,G__36482,self__.__meta,self__.__extmap,null));
} else
{return (new foundation.app.router.CompiledRoute(self__.re,self__.keys,self__.absolute_QMARK_,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__8803__auto__,G__36482),null));
}
}
}
});
...
foundation.app.router.CompiledRoute.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8794__auto__,G__36482){var self__ = this;
var this__8794__auto____$1 = this;return (new foundation.app.router.CompiledRoute(self__.re,self__.keys,self__.absolute_QMARK_,G__36482,self__.__extmap,self__.__hash));
});
...
foundation.app.router.map__GT_CompiledRoute = (function map__GT_CompiledRoute(G__36484){return (new foundation.app.router.CompiledRoute(new cljs.core.Keyword(null,"re","re",1013907877).cljs$core$IFn$_invoke$arity$1(G__36484),new cljs.core.Keyword(null,"keys","keys",1017192806).cljs$core$IFn$_invoke$arity$1(G__36484),new cljs.core.Keyword(null,"absolute?","absolute?",3046085914).cljs$core$IFn$_invoke$arity$1(G__36484),null,cljs.core.dissoc.call(null,G__36484,new cljs.core.Keyword(null,"re","re",1013907877),new cljs.core.Keyword(null,"keys","keys",1017192806),new cljs.core.Keyword(null,"absolute?","absolute?",3046085914))));
});
/**
* Lex one symbol from a string, and return the symbol and trailing source.
*/
foundation.app.router.lex_1 = (function lex_1(src,clauses){return cljs.core.some.call(null,(function (p__36490){var vec__36491 = p__36490;var re = cljs.core.nth.call(null,vec__36491,0,null);var action = cljs.core.nth.call(null,vec__36491,1,null);var matches = re.exec(src);if(cljs.core.truth_(goog.string.startsWith(src,cljs.core.first.call(null,matches))))
...
{var vec__36493 = temp__4090__auto__;var result = cljs.core.nth.call(null,vec__36493,0,null);var src__$2 = cljs.core.nth.call(null,vec__36493,1,null);var results__$1 = cljs.core.conj.call(null,results,result);if(cljs.core._EQ_.call(null,src__$2,""))
{return results__$1;
} else
{{
var G__36494 = results__$1;
var G__36495 = src__$2;
var G__36496 = clauses__$1;
results = G__36494;
src__$1 = G__36495;
clauses__$1 = G__36496;
continue;
}
}
} else
...
lex.cljs$lang$applyTo = (function (arglist__36497){
var src = cljs.core.first(arglist__36497);
var clauses = cljs.core.rest(arglist__36497);
...
return (function (p1__36498_SHARP_){return cljs.core.keyword.call(null,cljs.core.nth.call(null,p1__36498_SHARP_,1));
});})(splat,word,literal))
;var word_regex = ((function (splat,word,literal,word_group){
return (function (p1__36499_SHARP_){return regexs.call(null,word_group.call(null,p1__36499_SHARP_),/[^\/,;?]+/);
});})(splat,word,literal,word_group))
;return (new foundation.app.router.CompiledRoute(cljs.core.re_pattern.call(null,cljs.core.apply.call(null,cljs.core.str,foundation.app.router.lex.call(null,path,splat,"(.*)",/^\/\//,"https?://",word,(function (p1__36500_SHARP_){return [cljs.core.str("("),cljs.core.str(word_regex.call(null,p1__36500_SHARP_).source),cljs.core.str(")")].join('');
}),literal,(function (p1__36501_SHARP_){return foundation.app.router.re_escape.call(null,cljs.core.first.call(null,p1__36501_SHARP_));
...
foundation.app.router.IResponse = (function (){var obj36503 = {};return obj36503;
})();
...
(foundation.app.router._response["_"] = (function (o,_){if((function (){var G__36504 = o;if(G__36504)
...
{return G__36504.foundation$app$ui$IComponent$;
}
})()))
{return true;
} else
...
{return cljs.core.map.call(null,foundation.app.router._response,o);
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return o;
} else
...
cljs.core.async.impl.channels.ManyToManyChannel.prototype.foundation$app$router$IResponse$_response$arity$2 = (function (c,_){var c__$1 = this;return cljs.core.async.map_GT_.call(null,foundation.app.router._response,c__$1);
});
...
{var input_queue = temp__4092__auto__;var seq__36505 = cljs.core.seq.call(null,messages__$1);var chunk__36506 = null;var count__36507 = 0;var i__36508 = 0;while(true){
if((i__36508 < count__36507))
{var message = cljs.core._nth.call(null,chunk__36506,i__36508);cljs.core.async.put_BANG_.call(null,new cljs.core.Keyword(null,"input","input",1114262332).cljs$core$IFn$_invoke$arity$1(foundation.app._STAR_app_STAR_),message);
{
var G__36509 = seq__36505;
var G__36510 = chunk__36506;
var G__36511 = count__36507;
var G__36512 = (i__36508 + 1);
seq__36505 = G__36509;
chunk__36506 = G__36510;
count__36507 = G__36511;
i__36508 = G__36512;
continue;
}
} else
{var temp__4092__auto____$1 = cljs.core.seq.call(null,seq__36505);if(temp__4092__auto____$1)
{var seq__36505__$1 = temp__4092__auto____$1;if(cljs.core.chunked_seq_QMARK_.call(null,seq__36505__$1))
{var c__8957__auto__ = cljs.core.chunk_first.call(null,seq__36505__$1);{
var G__36513 = cljs.core.chunk_rest.call(null,seq__36505__$1);
var G__36514 = c__8957__auto__;
var G__36515 = cljs.core.count.call(null,c__8957__auto__);
var G__36516 = 0;
seq__36505 = G__36513;
chunk__36506 = G__36514;
count__36507 = G__36515;
i__36508 = G__36516;
continue;
}
} else
{var message = cljs.core.first.call(null,seq__36505__$1);cljs.core.async.put_BANG_.call(null,new cljs.core.Keyword(null,"input","input",1114262332).cljs$core$IFn$_invoke$arity$1(foundation.app._STAR_app_STAR_),message);
{
var G__36517 = cljs.core.next.call(null,seq__36505__$1);
var G__36518 = null;
var G__36519 = 0;
var G__36520 = 0;
seq__36505 = G__36517;
chunk__36506 = G__36518;
count__36507 = G__36519;
i__36508 = G__36520;
continue;
}
}
...
{var G__36522 = handler.call(null,request);var G__36522__$1 = (((G__36522 == null))?null:cljs.core.assoc.call(null,G__36522,new cljs.core.Keyword(null,"body","body",1016933652),null));return G__36522__$1;
} else
{return null;
}
}
...
var routing__delegate = function (request,handlers){return cljs.core.some.call(null,(function (p1__36523_SHARP_){return p1__36523_SHARP_.call(null,request);
}),handlers);
};
...
routing.cljs$lang$applyTo = (function (arglist__36524){
var request = cljs.core.first(arglist__36524);
var handlers = cljs.core.rest(arglist__36524);
...
var routes__delegate = function (handlers){return (function (p1__36525_SHARP_){return cljs.core.apply.call(null,foundation.app.router.routing,p1__36525_SHARP_,handlers);
});
};
...
routes.cljs$lang$applyTo = (function (arglist__36526){
var handlers = cljs.core.seq(arglist__36526);
...
foundation.app.router.router = (cljs.core.truth_(goog.history.Html5History.isSupported())?(function (){var G__36527 = (new goog.history.Html5History());G__36527.setUseFragment(false);
G__36527.addEventListener(goog.history.EventType.NAVIGATE,foundation.app.router.on_navigate);
G__36527.setEnabled(true);
return G__36527;
})():null);
/**
* @param {...*} var_args
...
var navigate_BANG___delegate = function (uri,p__36528){var map__36530 = p__36528;var map__36530__$1 = ((cljs.core.seq_QMARK_.call(null,map__36530))?cljs.core.apply.call(null,cljs.core.hash_map,map__36530):map__36530);var params = cljs.core.get.call(null,map__36530__$1,new cljs.core.Keyword(null,"params","params",4313443576));var method = cljs.core.get.call(null,map__36530__$1,new cljs.core.Keyword(null,"method","method",4231316563));var uri__$1 = (new goog.Uri(uri));var path = clojure.string.replace.call(null,uri__$1.getPath(),/^\//,"");foundation.app.router.router.setToken(path);
...
var p__36528 = null;if (arguments.length > 1) {
  p__36528 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return navigate_BANG___delegate.call(this,uri,p__36528);};
navigate_BANG_.cljs$lang$maxFixedArity = 1;
navigate_BANG_.cljs$lang$applyTo = (function (arglist__36531){
var uri = cljs.core.first(arglist__36531);
var p__36528 = cljs.core.rest(arglist__36531);
return navigate_BANG___delegate(uri,p__36528);
});
