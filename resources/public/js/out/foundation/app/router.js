...
foundation.app.router.re_chars = cljs.core.reduce.call(null,(function (p1__92645_SHARP_,p2__92646_SHARP_){return cljs.core.assoc.call(null,p1__92645_SHARP_,p2__92646_SHARP_,[cljs.core.str("\\"),cljs.core.str(p2__92646_SHARP_)].join(''));
...
* keywords.
*/
foundation.app.router.assoc_keys_with_groups = (function assoc_keys_with_groups(groups,keys){return cljs.core.reduce.call(null,(function (m,p__92649){var vec__92650 = p__92649;var k = cljs.core.nth.call(null,vec__92650,0,null);var v = cljs.core.nth.call(null,vec__92650,1,null);return foundation.app.router.assoc_vec.call(null,m,k,v);
...
foundation.app.router.Route = (function (){var obj92652 = {};return obj92652;
})();
...
foundation.app.router.CompiledRoute.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8797__auto__,k92654,else__8798__auto__){var self__ = this;
var this__8797__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k92654,new cljs.core.Keyword(null,"re","re",1013907877)))
{return self__.re;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k92654,new cljs.core.Keyword(null,"keys","keys",1017192806)))
{return self__.keys;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k92654,new cljs.core.Keyword(null,"absolute?","absolute?",3046085914)))
{return self__.absolute_QMARK_;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k92654,else__8798__auto__);
} else
{return null;
}
}
...
foundation.app.router.CompiledRoute.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8802__auto__,k__8803__auto__,G__92653){var self__ = this;
var this__8802__auto____$1 = this;var pred__92656 = cljs.core.keyword_identical_QMARK_;var expr__92657 = k__8803__auto__;if(cljs.core.truth_(pred__92656.call(null,new cljs.core.Keyword(null,"re","re",1013907877),expr__92657)))
{return (new foundation.app.router.CompiledRoute(G__92653,self__.keys,self__.absolute_QMARK_,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__92656.call(null,new cljs.core.Keyword(null,"keys","keys",1017192806),expr__92657)))
{return (new foundation.app.router.CompiledRoute(self__.re,G__92653,self__.absolute_QMARK_,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__92656.call(null,new cljs.core.Keyword(null,"absolute?","absolute?",3046085914),expr__92657)))
{return (new foundation.app.router.CompiledRoute(self__.re,self__.keys,G__92653,self__.__meta,self__.__extmap,null));
} else
{return (new foundation.app.router.CompiledRoute(self__.re,self__.keys,self__.absolute_QMARK_,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__8803__auto__,G__92653),null));
}
}
}
});
...
foundation.app.router.CompiledRoute.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8794__auto__,G__92653){var self__ = this;
var this__8794__auto____$1 = this;return (new foundation.app.router.CompiledRoute(self__.re,self__.keys,self__.absolute_QMARK_,G__92653,self__.__extmap,self__.__hash));
});
...
foundation.app.router.map__GT_CompiledRoute = (function map__GT_CompiledRoute(G__92655){return (new foundation.app.router.CompiledRoute(new cljs.core.Keyword(null,"re","re",1013907877).cljs$core$IFn$_invoke$arity$1(G__92655),new cljs.core.Keyword(null,"keys","keys",1017192806).cljs$core$IFn$_invoke$arity$1(G__92655),new cljs.core.Keyword(null,"absolute?","absolute?",3046085914).cljs$core$IFn$_invoke$arity$1(G__92655),null,cljs.core.dissoc.call(null,G__92655,new cljs.core.Keyword(null,"re","re",1013907877),new cljs.core.Keyword(null,"keys","keys",1017192806),new cljs.core.Keyword(null,"absolute?","absolute?",3046085914))));
});
/**
* Lex one symbol from a string, and return the symbol and trailing source.
*/
foundation.app.router.lex_1 = (function lex_1(src,clauses){return cljs.core.some.call(null,(function (p__92661){var vec__92662 = p__92661;var re = cljs.core.nth.call(null,vec__92662,0,null);var action = cljs.core.nth.call(null,vec__92662,1,null);var matches = re.exec(src);if(cljs.core.truth_(goog.string.startsWith(src,cljs.core.first.call(null,matches))))
...
{var vec__92664 = temp__4090__auto__;var result = cljs.core.nth.call(null,vec__92664,0,null);var src__$2 = cljs.core.nth.call(null,vec__92664,1,null);var results__$1 = cljs.core.conj.call(null,results,result);if(cljs.core._EQ_.call(null,src__$2,""))
{return results__$1;
} else
{{
var G__92665 = results__$1;
var G__92666 = src__$2;
var G__92667 = clauses__$1;
results = G__92665;
src__$1 = G__92666;
clauses__$1 = G__92667;
continue;
}
}
} else
...
lex.cljs$lang$applyTo = (function (arglist__92668){
var src = cljs.core.first(arglist__92668);
var clauses = cljs.core.rest(arglist__92668);
...
return (function (p1__92669_SHARP_){return cljs.core.keyword.call(null,cljs.core.nth.call(null,p1__92669_SHARP_,1));
});})(splat,word,literal))
;var word_regex = ((function (splat,word,literal,word_group){
return (function (p1__92670_SHARP_){return regexs.call(null,word_group.call(null,p1__92670_SHARP_),/[^\/,;?]+/);
});})(splat,word,literal,word_group))
;return (new foundation.app.router.CompiledRoute(cljs.core.re_pattern.call(null,cljs.core.apply.call(null,cljs.core.str,foundation.app.router.lex.call(null,path,splat,"(.*)",/^\/\//,"https?://",word,(function (p1__92671_SHARP_){return [cljs.core.str("("),cljs.core.str(word_regex.call(null,p1__92671_SHARP_).source),cljs.core.str(")")].join('');
}),literal,(function (p1__92672_SHARP_){return foundation.app.router.re_escape.call(null,cljs.core.first.call(null,p1__92672_SHARP_));
...
foundation.app.router.IResponse = (function (){var obj92674 = {};return obj92674;
})();
...
(foundation.app.router._response["_"] = (function (o,req){if((function (){var G__92677 = o;if(G__92677)
...
{return G__92677.foundation$app$ui$IComponent$;
}
})()))
{return true;
} else
...
{return cljs.core.map.call(null,(function (p1__92676_SHARP_){return foundation.app.router._response.call(null,p1__92676_SHARP_,req);
}),o);
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return o;
...
cljs.core.async.impl.channels.ManyToManyChannel.prototype.foundation$app$router$IResponse$_response$arity$2 = (function (c,request){var c__$1 = this;return cljs.core.async.map_GT_.call(null,(function (p1__92675_SHARP_){return foundation.app.router._response.call(null,p1__92675_SHARP_,request);
}),c__$1);
});
...
{var input_queue = temp__4092__auto__;var seq__92678 = cljs.core.seq.call(null,messages__$1);var chunk__92679 = null;var count__92680 = 0;var i__92681 = 0;while(true){
if((i__92681 < count__92680))
{var message = cljs.core._nth.call(null,chunk__92679,i__92681);cljs.core.async.put_BANG_.call(null,input_queue,message);
{
var G__92682 = seq__92678;
var G__92683 = chunk__92679;
var G__92684 = count__92680;
var G__92685 = (i__92681 + 1);
seq__92678 = G__92682;
chunk__92679 = G__92683;
count__92680 = G__92684;
i__92681 = G__92685;
continue;
}
} else
{var temp__4092__auto____$1 = cljs.core.seq.call(null,seq__92678);if(temp__4092__auto____$1)
{var seq__92678__$1 = temp__4092__auto____$1;if(cljs.core.chunked_seq_QMARK_.call(null,seq__92678__$1))
{var c__8957__auto__ = cljs.core.chunk_first.call(null,seq__92678__$1);{
var G__92686 = cljs.core.chunk_rest.call(null,seq__92678__$1);
var G__92687 = c__8957__auto__;
var G__92688 = cljs.core.count.call(null,c__8957__auto__);
var G__92689 = 0;
seq__92678 = G__92686;
chunk__92679 = G__92687;
count__92680 = G__92688;
i__92681 = G__92689;
continue;
}
} else
{var message = cljs.core.first.call(null,seq__92678__$1);cljs.core.async.put_BANG_.call(null,input_queue,message);
{
var G__92690 = cljs.core.next.call(null,seq__92678__$1);
var G__92691 = null;
var G__92692 = 0;
var G__92693 = 0;
seq__92678 = G__92690;
chunk__92679 = G__92691;
count__92680 = G__92692;
i__92681 = G__92693;
continue;
}
}
...
{var G__92695 = handler.call(null,request);var G__92695__$1 = (((G__92695 == null))?null:cljs.core.assoc.call(null,G__92695,new cljs.core.Keyword(null,"body","body",1016933652),null));return G__92695__$1;
} else
{return null;
}
}
...
var routing__delegate = function (request,handlers){return cljs.core.some.call(null,(function (p1__92696_SHARP_){return p1__92696_SHARP_.call(null,request);
}),handlers);
};
...
routing.cljs$lang$applyTo = (function (arglist__92697){
var request = cljs.core.first(arglist__92697);
var handlers = cljs.core.rest(arglist__92697);
...
var routes__delegate = function (handlers){return (function (p1__92698_SHARP_){return cljs.core.apply.call(null,foundation.app.router.routing,p1__92698_SHARP_,handlers);
});
};
...
routes.cljs$lang$applyTo = (function (arglist__92699){
var handlers = cljs.core.seq(arglist__92699);
...
foundation.app.router.IRouter = (function (){var obj92701 = {};return obj92701;
})();
...
var router__$2 = this;var G__92705_92710 = router__$2.router;G__92705_92710.setUseFragment(false);
G__92705_92710.addEventListener(goog.history.EventType.NAVIGATE,cljs.core.partial.call(null,foundation.app.router._on_navigation,router__$2));
G__92705_92710.setEnabled(true);
...
var router__$2 = this;var G__92706_92711 = router__$2.router;G__92706_92711.setEnabled(false);
return router__$2;
});
...
foundation.app.router.Router.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8797__auto__,k92703,else__8798__auto__){var self__ = this;
var this__8797__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k92703,new cljs.core.Keyword(null,"router","router",4383738555)))
{return self__.router;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k92703,new cljs.core.Keyword(null,"routes","routes",4383738556)))
{return self__.routes;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k92703,else__8798__auto__);
} else
{return null;
}
}
...
foundation.app.router.Router.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8802__auto__,k__8803__auto__,G__92702){var self__ = this;
var this__8802__auto____$1 = this;var pred__92707 = cljs.core.keyword_identical_QMARK_;var expr__92708 = k__8803__auto__;if(cljs.core.truth_(pred__92707.call(null,new cljs.core.Keyword(null,"router","router",4383738555),expr__92708)))
{return (new foundation.app.router.Router(G__92702,self__.routes,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__92707.call(null,new cljs.core.Keyword(null,"routes","routes",4383738556),expr__92708)))
{return (new foundation.app.router.Router(self__.router,G__92702,self__.__meta,self__.__extmap,null));
} else
{return (new foundation.app.router.Router(self__.router,self__.routes,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__8803__auto__,G__92702),null));
}
}
});
...
foundation.app.router.Router.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8794__auto__,G__92702){var self__ = this;
var this__8794__auto____$1 = this;return (new foundation.app.router.Router(self__.router,self__.routes,G__92702,self__.__extmap,self__.__hash));
});
...
foundation.app.router.map__GT_Router = (function map__GT_Router(G__92704){return (new foundation.app.router.Router(new cljs.core.Keyword(null,"router","router",4383738555).cljs$core$IFn$_invoke$arity$1(G__92704),new cljs.core.Keyword(null,"routes","routes",4383738556).cljs$core$IFn$_invoke$arity$1(G__92704),null,cljs.core.dissoc.call(null,G__92704,new cljs.core.Keyword(null,"router","router",4383738555),new cljs.core.Keyword(null,"routes","routes",4383738556))));
});
...
var navigate_BANG___delegate = function (router,uri,p__92712){var map__92714 = p__92712;var map__92714__$1 = ((cljs.core.seq_QMARK_.call(null,map__92714))?cljs.core.apply.call(null,cljs.core.hash_map,map__92714):map__92714);var args = map__92714__$1;var params = cljs.core.get.call(null,map__92714__$1,new cljs.core.Keyword(null,"params","params",4313443576));var method = cljs.core.get.call(null,map__92714__$1,new cljs.core.Keyword(null,"method","method",4231316563));return foundation.app.router._navigate.call(null,router,uri,method,params);
};
var navigate_BANG_ = function (router,uri,var_args){
var p__92712 = null;if (arguments.length > 2) {
  p__92712 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return navigate_BANG___delegate.call(this,router,uri,p__92712);};
navigate_BANG_.cljs$lang$maxFixedArity = 2;
navigate_BANG_.cljs$lang$applyTo = (function (arglist__92715){
var router = cljs.core.first(arglist__92715);
arglist__92715 = cljs.core.next(arglist__92715);
var uri = cljs.core.first(arglist__92715);
var p__92712 = cljs.core.rest(arglist__92715);
return navigate_BANG___delegate(router,uri,p__92712);
});
