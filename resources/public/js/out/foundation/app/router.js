...
foundation.app.router.re_chars = cljs.core.reduce.call(null,(function (p1__195573_SHARP_,p2__195574_SHARP_){return cljs.core.assoc.call(null,p1__195573_SHARP_,p2__195574_SHARP_,[cljs.core.str("\\"),cljs.core.str(p2__195574_SHARP_)].join(''));
...
* keywords.
*/
foundation.app.router.assoc_keys_with_groups = (function assoc_keys_with_groups(groups,keys){return cljs.core.reduce.call(null,(function (m,p__195577){var vec__195578 = p__195577;var k = cljs.core.nth.call(null,vec__195578,0,null);var v = cljs.core.nth.call(null,vec__195578,1,null);return foundation.app.router.assoc_vec.call(null,m,k,v);
...
foundation.app.router.Route = (function (){var obj195580 = {};return obj195580;
})();
...
foundation.app.router.CompiledRoute.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8792__auto__,k195582,else__8793__auto__){var self__ = this;
var this__8792__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k195582,new cljs.core.Keyword(null,"re","re",1013907877)))
{return self__.re;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k195582,new cljs.core.Keyword(null,"keys","keys",1017192806)))
{return self__.keys;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k195582,new cljs.core.Keyword(null,"absolute?","absolute?",3046085914)))
{return self__.absolute_QMARK_;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k195582,else__8793__auto__);
} else
{return null;
}
}
...
foundation.app.router.CompiledRoute.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8797__auto__,k__8798__auto__,G__195581){var self__ = this;
var this__8797__auto____$1 = this;var pred__195584 = cljs.core.keyword_identical_QMARK_;var expr__195585 = k__8798__auto__;if(cljs.core.truth_(pred__195584.call(null,new cljs.core.Keyword(null,"re","re",1013907877),expr__195585)))
{return (new foundation.app.router.CompiledRoute(G__195581,self__.keys,self__.absolute_QMARK_,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__195584.call(null,new cljs.core.Keyword(null,"keys","keys",1017192806),expr__195585)))
{return (new foundation.app.router.CompiledRoute(self__.re,G__195581,self__.absolute_QMARK_,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__195584.call(null,new cljs.core.Keyword(null,"absolute?","absolute?",3046085914),expr__195585)))
{return (new foundation.app.router.CompiledRoute(self__.re,self__.keys,G__195581,self__.__meta,self__.__extmap,null));
} else
{return (new foundation.app.router.CompiledRoute(self__.re,self__.keys,self__.absolute_QMARK_,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__8798__auto__,G__195581),null));
}
}
}
});
...
foundation.app.router.CompiledRoute.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8789__auto__,G__195581){var self__ = this;
var this__8789__auto____$1 = this;return (new foundation.app.router.CompiledRoute(self__.re,self__.keys,self__.absolute_QMARK_,G__195581,self__.__extmap,self__.__hash));
});
...
foundation.app.router.map__GT_CompiledRoute = (function map__GT_CompiledRoute(G__195583){return (new foundation.app.router.CompiledRoute(new cljs.core.Keyword(null,"re","re",1013907877).cljs$core$IFn$_invoke$arity$1(G__195583),new cljs.core.Keyword(null,"keys","keys",1017192806).cljs$core$IFn$_invoke$arity$1(G__195583),new cljs.core.Keyword(null,"absolute?","absolute?",3046085914).cljs$core$IFn$_invoke$arity$1(G__195583),null,cljs.core.dissoc.call(null,G__195583,new cljs.core.Keyword(null,"re","re",1013907877),new cljs.core.Keyword(null,"keys","keys",1017192806),new cljs.core.Keyword(null,"absolute?","absolute?",3046085914))));
});
/**
* Lex one symbol from a string, and return the symbol and trailing source.
*/
foundation.app.router.lex_1 = (function lex_1(src,clauses){return cljs.core.some.call(null,(function (p__195589){var vec__195590 = p__195589;var re = cljs.core.nth.call(null,vec__195590,0,null);var action = cljs.core.nth.call(null,vec__195590,1,null);var matches = re.exec(src);if(cljs.core.truth_(goog.string.startsWith(src,cljs.core.first.call(null,matches))))
...
{var vec__195592 = temp__4090__auto__;var result = cljs.core.nth.call(null,vec__195592,0,null);var src__$2 = cljs.core.nth.call(null,vec__195592,1,null);var results__$1 = cljs.core.conj.call(null,results,result);if(cljs.core._EQ_.call(null,src__$2,""))
{return results__$1;
} else
{{
var G__195593 = results__$1;
var G__195594 = src__$2;
var G__195595 = clauses__$1;
results = G__195593;
src__$1 = G__195594;
clauses__$1 = G__195595;
continue;
}
}
} else
...
lex.cljs$lang$applyTo = (function (arglist__195596){
var src = cljs.core.first(arglist__195596);
var clauses = cljs.core.rest(arglist__195596);
...
return (function (p1__195597_SHARP_){return cljs.core.keyword.call(null,cljs.core.nth.call(null,p1__195597_SHARP_,1));
});})(splat,word,literal))
;var word_regex = ((function (splat,word,literal,word_group){
return (function (p1__195598_SHARP_){return regexs.call(null,word_group.call(null,p1__195598_SHARP_),/[^\/,;?]+/);
});})(splat,word,literal,word_group))
;return (new foundation.app.router.CompiledRoute(cljs.core.re_pattern.call(null,cljs.core.apply.call(null,cljs.core.str,foundation.app.router.lex.call(null,path,splat,"(.*)",/^\/\//,"https?://",word,(function (p1__195599_SHARP_){return [cljs.core.str("("),cljs.core.str(word_regex.call(null,p1__195599_SHARP_).source),cljs.core.str(")")].join('');
}),literal,(function (p1__195600_SHARP_){return foundation.app.router.re_escape.call(null,cljs.core.first.call(null,p1__195600_SHARP_));
...
foundation.app.router.IResponse = (function (){var obj195602 = {};return obj195602;
})();
...
(foundation.app.router._response["_"] = (function (o,req){if((function (){var G__195604 = o;if(G__195604)
...
{return G__195604.foundation$app$ui$IComponent$;
}
})()))
{return true;
} else
...
{return cljs.core.map.call(null,(function (p1__195603_SHARP_){return foundation.app.router._response.call(null,p1__195603_SHARP_,req);
}),o);
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return o;
...
cljs.core.async.impl.channels.ManyToManyChannel.prototype.foundation$app$router$IResponse$_response$arity$2 = (function (c,request){var c__$1 = this;var c__12187__auto__ = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__12188__auto__ = (function (){var switch__12117__auto__ = (function (state_195609){var state_val_195610 = (state_195609[1]);if((state_val_195610 === 2))
{var inst_195606 = (state_195609[2]);var inst_195607 = foundation.app.router._response.call(null,inst_195606,request);var state_195609__$1 = state_195609;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_195609__$1,inst_195607);
} else
{if((state_val_195610 === 1))
{var state_195609__$1 = state_195609;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_195609__$1,2,c__$1);
} else
{return null;
}
}
...
var state_machine__12118__auto____0 = (function (){var statearr_195614 = [null,null,null,null,null,null,null];(statearr_195614[0] = state_machine__12118__auto__);
(statearr_195614[1] = 1);
return statearr_195614;
});
var state_machine__12118__auto____1 = (function (state_195609){while(true){
var ret_value__12119__auto__ = (function (){try{while(true){
var result__12120__auto__ = switch__12117__auto__.call(null,state_195609);if(cljs.core.keyword_identical_QMARK_.call(null,result__12120__auto__,new cljs.core.Keyword(null,"recur","recur",1122293407)))
{{
continue;
}
} else
...
}catch (e195615){if((e195615 instanceof Object))
{var ex__12121__auto__ = e195615;var statearr_195616_195618 = state_195609;(statearr_195616_195618[5] = ex__12121__auto__);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_195609);
...
{{
var G__195619 = state_195609;
state_195609 = G__195619;
continue;
}
} else
...
state_machine__12118__auto__ = function(state_195609){
switch(arguments.length){
case 0:
return state_machine__12118__auto____0.call(this);
case 1:
return state_machine__12118__auto____1.call(this,state_195609);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
})();var state__12189__auto__ = (function (){var statearr_195617 = f__12188__auto__.call(null);(statearr_195617[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__12187__auto__);
return statearr_195617;
...
cljs.core.PersistentVector.prototype.foundation$app$router$IResponse$_response$arity$2 = (function (messages,request){var messages__$1 = this;cljs.core.println.call(null,messages__$1);
var temp__4092__auto__ = (function (){var or__8223__auto__ = cljs.core.get_in.call(null,request,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"router","router",4383738555),new cljs.core.Keyword(null,"input","input",1114262332)], null));if(cljs.core.truth_(or__8223__auto__))
{return or__8223__auto__;
} else
...
var routing__delegate = function (request,handlers){return cljs.core.some.call(null,(function (p1__195620_SHARP_){return p1__195620_SHARP_.call(null,request);
}),handlers);
};
...
routing.cljs$lang$applyTo = (function (arglist__195621){
var request = cljs.core.first(arglist__195621);
var handlers = cljs.core.rest(arglist__195621);
...
var routes__delegate = function (handlers){return (function (p1__195622_SHARP_){return cljs.core.apply.call(null,foundation.app.router.routing,p1__195622_SHARP_,handlers);
});
};
...
routes.cljs$lang$applyTo = (function (arglist__195623){
var handlers = cljs.core.seq(arglist__195623);
...
foundation.app.router.IRouter = (function (){var obj195625 = {};return obj195625;
})();
...
var router__$2 = this;var G__195629_195634 = router__$2.router;G__195629_195634.setUseFragment(false);
G__195629_195634.addEventListener(goog.history.EventType.NAVIGATE,cljs.core.partial.call(null,foundation.app.router._on_navigation,router__$2));
G__195629_195634.setEnabled(true);
...
var router__$2 = this;var G__195630_195635 = router__$2.router;G__195630_195635.setEnabled(false);
return router__$2;
});
...
foundation.app.router.Router.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8792__auto__,k195627,else__8793__auto__){var self__ = this;
var this__8792__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k195627,new cljs.core.Keyword(null,"router","router",4383738555)))
{return self__.router;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k195627,new cljs.core.Keyword(null,"routes","routes",4383738556)))
{return self__.routes;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k195627,else__8793__auto__);
} else
{return null;
}
}
...
foundation.app.router.Router.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8797__auto__,k__8798__auto__,G__195626){var self__ = this;
var this__8797__auto____$1 = this;var pred__195631 = cljs.core.keyword_identical_QMARK_;var expr__195632 = k__8798__auto__;if(cljs.core.truth_(pred__195631.call(null,new cljs.core.Keyword(null,"router","router",4383738555),expr__195632)))
{return (new foundation.app.router.Router(G__195626,self__.routes,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__195631.call(null,new cljs.core.Keyword(null,"routes","routes",4383738556),expr__195632)))
{return (new foundation.app.router.Router(self__.router,G__195626,self__.__meta,self__.__extmap,null));
} else
{return (new foundation.app.router.Router(self__.router,self__.routes,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__8798__auto__,G__195626),null));
}
}
});
...
foundation.app.router.Router.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8789__auto__,G__195626){var self__ = this;
var this__8789__auto____$1 = this;return (new foundation.app.router.Router(self__.router,self__.routes,G__195626,self__.__extmap,self__.__hash));
});
...
foundation.app.router.map__GT_Router = (function map__GT_Router(G__195628){return (new foundation.app.router.Router(new cljs.core.Keyword(null,"router","router",4383738555).cljs$core$IFn$_invoke$arity$1(G__195628),new cljs.core.Keyword(null,"routes","routes",4383738556).cljs$core$IFn$_invoke$arity$1(G__195628),null,cljs.core.dissoc.call(null,G__195628,new cljs.core.Keyword(null,"router","router",4383738555),new cljs.core.Keyword(null,"routes","routes",4383738556))));
});
...
var navigate_BANG___delegate = function (router,uri,p__195636){var map__195638 = p__195636;var map__195638__$1 = ((cljs.core.seq_QMARK_.call(null,map__195638))?cljs.core.apply.call(null,cljs.core.hash_map,map__195638):map__195638);var args = map__195638__$1;var params = cljs.core.get.call(null,map__195638__$1,new cljs.core.Keyword(null,"params","params",4313443576));var method = cljs.core.get.call(null,map__195638__$1,new cljs.core.Keyword(null,"method","method",4231316563));return foundation.app.router._navigate.call(null,router,uri,method,params);
};
var navigate_BANG_ = function (router,uri,var_args){
var p__195636 = null;if (arguments.length > 2) {
  p__195636 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return navigate_BANG___delegate.call(this,router,uri,p__195636);};
navigate_BANG_.cljs$lang$maxFixedArity = 2;
navigate_BANG_.cljs$lang$applyTo = (function (arglist__195639){
var router = cljs.core.first(arglist__195639);
arglist__195639 = cljs.core.next(arglist__195639);
var uri = cljs.core.first(arglist__195639);
var p__195636 = cljs.core.rest(arglist__195639);
return navigate_BANG___delegate(router,uri,p__195636);
});
