...
foundation.app.router.re_chars = cljs.core.reduce.call(null,(function (p1__94604_SHARP_,p2__94605_SHARP_){return cljs.core.assoc.call(null,p1__94604_SHARP_,p2__94605_SHARP_,[cljs.core.str("\\"),cljs.core.str(p2__94605_SHARP_)].join(''));
...
* keywords.
*/
foundation.app.router.assoc_keys_with_groups = (function assoc_keys_with_groups(groups,keys){return cljs.core.reduce.call(null,(function (m,p__94608){var vec__94609 = p__94608;var k = cljs.core.nth.call(null,vec__94609,0,null);var v = cljs.core.nth.call(null,vec__94609,1,null);return foundation.app.router.assoc_vec.call(null,m,k,v);
...
foundation.app.router.Route = (function (){var obj94611 = {};return obj94611;
})();
...
foundation.app.router.CompiledRoute.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8797__auto__,k94613,else__8798__auto__){var self__ = this;
var this__8797__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k94613,new cljs.core.Keyword(null,"re","re",1013907877)))
{return self__.re;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k94613,new cljs.core.Keyword(null,"keys","keys",1017192806)))
{return self__.keys;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k94613,new cljs.core.Keyword(null,"absolute?","absolute?",3046085914)))
{return self__.absolute_QMARK_;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k94613,else__8798__auto__);
} else
{return null;
}
}
...
foundation.app.router.CompiledRoute.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8802__auto__,k__8803__auto__,G__94612){var self__ = this;
var this__8802__auto____$1 = this;var pred__94615 = cljs.core.keyword_identical_QMARK_;var expr__94616 = k__8803__auto__;if(cljs.core.truth_(pred__94615.call(null,new cljs.core.Keyword(null,"re","re",1013907877),expr__94616)))
{return (new foundation.app.router.CompiledRoute(G__94612,self__.keys,self__.absolute_QMARK_,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__94615.call(null,new cljs.core.Keyword(null,"keys","keys",1017192806),expr__94616)))
{return (new foundation.app.router.CompiledRoute(self__.re,G__94612,self__.absolute_QMARK_,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__94615.call(null,new cljs.core.Keyword(null,"absolute?","absolute?",3046085914),expr__94616)))
{return (new foundation.app.router.CompiledRoute(self__.re,self__.keys,G__94612,self__.__meta,self__.__extmap,null));
} else
{return (new foundation.app.router.CompiledRoute(self__.re,self__.keys,self__.absolute_QMARK_,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__8803__auto__,G__94612),null));
}
}
}
});
...
foundation.app.router.CompiledRoute.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8794__auto__,G__94612){var self__ = this;
var this__8794__auto____$1 = this;return (new foundation.app.router.CompiledRoute(self__.re,self__.keys,self__.absolute_QMARK_,G__94612,self__.__extmap,self__.__hash));
});
...
foundation.app.router.map__GT_CompiledRoute = (function map__GT_CompiledRoute(G__94614){return (new foundation.app.router.CompiledRoute(new cljs.core.Keyword(null,"re","re",1013907877).cljs$core$IFn$_invoke$arity$1(G__94614),new cljs.core.Keyword(null,"keys","keys",1017192806).cljs$core$IFn$_invoke$arity$1(G__94614),new cljs.core.Keyword(null,"absolute?","absolute?",3046085914).cljs$core$IFn$_invoke$arity$1(G__94614),null,cljs.core.dissoc.call(null,G__94614,new cljs.core.Keyword(null,"re","re",1013907877),new cljs.core.Keyword(null,"keys","keys",1017192806),new cljs.core.Keyword(null,"absolute?","absolute?",3046085914))));
});
/**
* Lex one symbol from a string, and return the symbol and trailing source.
*/
foundation.app.router.lex_1 = (function lex_1(src,clauses){return cljs.core.some.call(null,(function (p__94620){var vec__94621 = p__94620;var re = cljs.core.nth.call(null,vec__94621,0,null);var action = cljs.core.nth.call(null,vec__94621,1,null);var matches = re.exec(src);if(cljs.core.truth_(goog.string.startsWith(src,cljs.core.first.call(null,matches))))
...
{var vec__94623 = temp__4090__auto__;var result = cljs.core.nth.call(null,vec__94623,0,null);var src__$2 = cljs.core.nth.call(null,vec__94623,1,null);var results__$1 = cljs.core.conj.call(null,results,result);if(cljs.core._EQ_.call(null,src__$2,""))
{return results__$1;
} else
{{
var G__94624 = results__$1;
var G__94625 = src__$2;
var G__94626 = clauses__$1;
results = G__94624;
src__$1 = G__94625;
clauses__$1 = G__94626;
continue;
}
}
} else
...
lex.cljs$lang$applyTo = (function (arglist__94627){
var src = cljs.core.first(arglist__94627);
var clauses = cljs.core.rest(arglist__94627);
...
return (function (p1__94628_SHARP_){return cljs.core.keyword.call(null,cljs.core.nth.call(null,p1__94628_SHARP_,1));
});})(splat,word,literal))
;var word_regex = ((function (splat,word,literal,word_group){
return (function (p1__94629_SHARP_){return regexs.call(null,word_group.call(null,p1__94629_SHARP_),/[^\/,;?]+/);
});})(splat,word,literal,word_group))
;return (new foundation.app.router.CompiledRoute(cljs.core.re_pattern.call(null,cljs.core.apply.call(null,cljs.core.str,foundation.app.router.lex.call(null,path,splat,"(.*)",/^\/\//,"https?://",word,(function (p1__94630_SHARP_){return [cljs.core.str("("),cljs.core.str(word_regex.call(null,p1__94630_SHARP_).source),cljs.core.str(")")].join('');
}),literal,(function (p1__94631_SHARP_){return foundation.app.router.re_escape.call(null,cljs.core.first.call(null,p1__94631_SHARP_));
...
foundation.app.router.IResponse = (function (){var obj94633 = {};return obj94633;
})();
...
(foundation.app.router._response["_"] = (function (o,req){if((function (){var G__94636 = o;if(G__94636)
...
{return G__94636.foundation$app$ui$IComponent$;
}
})()))
{return true;
} else
...
{return cljs.core.map.call(null,(function (p1__94635_SHARP_){return foundation.app.router._response.call(null,p1__94635_SHARP_,req);
}),o);
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return o;
...
cljs.core.async.impl.channels.ManyToManyChannel.prototype.foundation$app$router$IResponse$_response$arity$2 = (function (c,request){var c__$1 = this;return cljs.core.async.map_GT_.call(null,(function (p1__94634_SHARP_){return foundation.app.router._response.call(null,p1__94634_SHARP_,request);
}),c__$1);
});
...
{var G__94638 = handler.call(null,request);var G__94638__$1 = (((G__94638 == null))?null:cljs.core.assoc.call(null,G__94638,new cljs.core.Keyword(null,"body","body",1016933652),null));return G__94638__$1;
} else
{return null;
}
}
...
var routing__delegate = function (request,handlers){return cljs.core.some.call(null,(function (p1__94639_SHARP_){return p1__94639_SHARP_.call(null,request);
}),handlers);
};
...
routing.cljs$lang$applyTo = (function (arglist__94640){
var request = cljs.core.first(arglist__94640);
var handlers = cljs.core.rest(arglist__94640);
...
var routes__delegate = function (handlers){return (function (p1__94641_SHARP_){return cljs.core.apply.call(null,foundation.app.router.routing,p1__94641_SHARP_,handlers);
});
};
...
routes.cljs$lang$applyTo = (function (arglist__94642){
var handlers = cljs.core.seq(arglist__94642);
...
foundation.app.router.IRouter = (function (){var obj94644 = {};return obj94644;
})();
...
var router__$2 = this;var G__94648_94653 = router__$2.router;G__94648_94653.setUseFragment(false);
G__94648_94653.addEventListener(goog.history.EventType.NAVIGATE,cljs.core.partial.call(null,foundation.app.router._on_navigation,router__$2));
G__94648_94653.setEnabled(true);
...
var router__$2 = this;var G__94649_94654 = router__$2.router;G__94649_94654.setEnabled(false);
return router__$2;
});
...
foundation.app.router.Router.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8797__auto__,k94646,else__8798__auto__){var self__ = this;
var this__8797__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k94646,new cljs.core.Keyword(null,"router","router",4383738555)))
{return self__.router;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k94646,new cljs.core.Keyword(null,"routes","routes",4383738556)))
{return self__.routes;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k94646,else__8798__auto__);
} else
{return null;
}
}
...
foundation.app.router.Router.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8802__auto__,k__8803__auto__,G__94645){var self__ = this;
var this__8802__auto____$1 = this;var pred__94650 = cljs.core.keyword_identical_QMARK_;var expr__94651 = k__8803__auto__;if(cljs.core.truth_(pred__94650.call(null,new cljs.core.Keyword(null,"router","router",4383738555),expr__94651)))
{return (new foundation.app.router.Router(G__94645,self__.routes,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__94650.call(null,new cljs.core.Keyword(null,"routes","routes",4383738556),expr__94651)))
{return (new foundation.app.router.Router(self__.router,G__94645,self__.__meta,self__.__extmap,null));
} else
{return (new foundation.app.router.Router(self__.router,self__.routes,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__8803__auto__,G__94645),null));
}
}
});
...
foundation.app.router.Router.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8794__auto__,G__94645){var self__ = this;
var this__8794__auto____$1 = this;return (new foundation.app.router.Router(self__.router,self__.routes,G__94645,self__.__extmap,self__.__hash));
});
...
foundation.app.router.map__GT_Router = (function map__GT_Router(G__94647){return (new foundation.app.router.Router(new cljs.core.Keyword(null,"router","router",4383738555).cljs$core$IFn$_invoke$arity$1(G__94647),new cljs.core.Keyword(null,"routes","routes",4383738556).cljs$core$IFn$_invoke$arity$1(G__94647),null,cljs.core.dissoc.call(null,G__94647,new cljs.core.Keyword(null,"router","router",4383738555),new cljs.core.Keyword(null,"routes","routes",4383738556))));
});
...
var navigate_BANG___delegate = function (router,uri,p__94655){var map__94657 = p__94655;var map__94657__$1 = ((cljs.core.seq_QMARK_.call(null,map__94657))?cljs.core.apply.call(null,cljs.core.hash_map,map__94657):map__94657);var args = map__94657__$1;var params = cljs.core.get.call(null,map__94657__$1,new cljs.core.Keyword(null,"params","params",4313443576));var method = cljs.core.get.call(null,map__94657__$1,new cljs.core.Keyword(null,"method","method",4231316563));return foundation.app.router._navigate.call(null,router,uri,method,params);
};
var navigate_BANG_ = function (router,uri,var_args){
var p__94655 = null;if (arguments.length > 2) {
  p__94655 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return navigate_BANG___delegate.call(this,router,uri,p__94655);};
navigate_BANG_.cljs$lang$maxFixedArity = 2;
navigate_BANG_.cljs$lang$applyTo = (function (arglist__94658){
var router = cljs.core.first(arglist__94658);
arglist__94658 = cljs.core.next(arglist__94658);
var uri = cljs.core.first(arglist__94658);
var p__94655 = cljs.core.rest(arglist__94658);
return navigate_BANG___delegate(router,uri,p__94655);
});
