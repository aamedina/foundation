...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_189491 = 0;while(true){
var m_189492 = cljs.core.async.impl.dispatch.tasks.pop();if((m_189492 == null))
{} else
{m_189492.call(null);
if((count_189491 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__189493 = (count_189491 + 1);
count_189491 = G__189493;
continue;
}
} else
{}
