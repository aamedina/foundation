...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_181615 = 0;while(true){
var m_181616 = cljs.core.async.impl.dispatch.tasks.pop();if((m_181616 == null))
{} else
{m_181616.call(null);
if((count_181615 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__181617 = (count_181615 + 1);
count_181615 = G__181617;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__8211__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__8211__auto__)
