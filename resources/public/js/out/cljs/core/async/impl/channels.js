...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t28558 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t28558 = (function (val,box,meta28559){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t28558.cljs$lang$type = true;
cljs.core.async.impl.channels.t28558.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t28558";
cljs.core.async.impl.channels.t28558.cljs$lang$ctorPrWriter = (function (this__8772__auto__,writer__8773__auto__,opt__8774__auto__){return cljs.core._write.call(null,writer__8773__auto__,"cljs.core.async.impl.channels/t28558");
});
cljs.core.async.impl.channels.t28558.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t28558.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_28560){var self__ = this;
var _28560__$1 = this;return self__.meta28559;
});
cljs.core.async.impl.channels.t28558.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_28560,meta28559__$1){var self__ = this;
var _28560__$1 = this;return (new cljs.core.async.impl.channels.t28558(self__.val,self__.box,meta28559__$1));
});
cljs.core.async.impl.channels.__GT_t28558 = (function __GT_t28558(val__$1,box__$1,meta28559){return (new cljs.core.async.impl.channels.t28558(val__$1,box__$1,meta28559));
});
}
return (new cljs.core.async.impl.channels.t28558(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_28561 = self__.takes.pop();if((taker_28561 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_28561))
{var take_cb_28562 = cljs.core.async.impl.protocols.commit.call(null,taker_28561);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_28562,taker_28561){
return (function (){return take_cb_28562.call(null,null);
});})(take_cb_28562,taker_28561))
);
} else
{}
{
