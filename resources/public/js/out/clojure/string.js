...
{{
var G__28541 = cljs.core.pop.call(null,v__$1);
v__$1 = G__28541;
continue;
}
} else
...
{var pred__28545 = cljs.core._EQ_;var expr__28546 = limit;if(cljs.core.truth_(pred__28545.call(null,1,expr__28546)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__28545.call(null,2,expr__28546)))
...
var G__28548 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__28549 = (limit__$1 - 1);
var G__28550 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__28548;
limit__$1 = G__28549;
parts = G__28550;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___28552 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___28552))
{var replacement_28553 = temp__4090__auto___28552;buffer.append([cljs.core.str(replacement_28553)].join(''));
} else
{buffer.append(ch);
}
{
var G__28554 = (index + 1);
index = G__28554;
continue;
}
}
