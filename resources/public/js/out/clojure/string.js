...
{{
var G__45001 = cljs.core.pop.call(null,v__$1);
v__$1 = G__45001;
continue;
}
} else
...
{var pred__45005 = cljs.core._EQ_;var expr__45006 = limit;if(cljs.core.truth_(pred__45005.call(null,1,expr__45006)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__45005.call(null,2,expr__45006)))
...
var G__45008 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__45009 = (limit__$1 - 1);
var G__45010 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__45008;
limit__$1 = G__45009;
parts = G__45010;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___45012 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___45012))
{var replacement_45013 = temp__4090__auto___45012;buffer.append([cljs.core.str(replacement_45013)].join(''));
} else
{buffer.append(ch);
}
{
var G__45014 = (index + 1);
index = G__45014;
continue;
}
}
