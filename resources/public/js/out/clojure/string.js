...
{var pred__25327 = cljs.core._EQ_;var expr__25328 = limit;if(cljs.core.truth_(pred__25327.call(null,1,expr__25328)))
...
var G__25330 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__25331 = (limit__$1 - 1);
var G__25332 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__25330;
limit__$1 = G__25331;
parts = G__25332;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___25334 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___25334))
{var replacement_25335 = temp__4090__auto___25334;buffer.append([cljs.core.str(replacement_25335)].join(''));
} else
{buffer.append(ch);
}
{
