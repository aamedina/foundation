...
{{
var G__13126 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13126;
continue;
}
} else
...
{var pred__13130 = cljs.core._EQ_;var expr__13131 = limit;if(cljs.core.truth_(pred__13130.call(null,1,expr__13131)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13130.call(null,2,expr__13131)))
...
var G__13133 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13134 = (limit__$1 - 1);
var G__13135 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13133;
limit__$1 = G__13134;
parts = G__13135;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13137 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13137))
{var replacement_13138 = temp__4090__auto___13137;buffer.append([cljs.core.str(replacement_13138)].join(''));
} else
{buffer.append(ch);
}
{
var G__13139 = (index + 1);
index = G__13139;
continue;
}
}
