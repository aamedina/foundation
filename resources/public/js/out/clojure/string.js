...
{{
var G__28012 = cljs.core.pop.call(null,v__$1);
v__$1 = G__28012;
continue;
}
} else
...
{var pred__28016 = cljs.core._EQ_;var expr__28017 = limit;if(cljs.core.truth_(pred__28016.call(null,1,expr__28017)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__28016.call(null,2,expr__28017)))
...
var G__28019 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__28020 = (limit__$1 - 1);
var G__28021 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__28019;
limit__$1 = G__28020;
parts = G__28021;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___28023 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___28023))
{var replacement_28024 = temp__4090__auto___28023;buffer.append([cljs.core.str(replacement_28024)].join(''));
} else
{buffer.append(ch);
}
{
var G__28025 = (index + 1);
index = G__28025;
continue;
}
}
