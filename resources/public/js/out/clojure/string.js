...
{{
var G__25340 = cljs.core.pop.call(null,v__$1);
v__$1 = G__25340;
continue;
}
} else
...
{var pred__25344 = cljs.core._EQ_;var expr__25345 = limit;if(cljs.core.truth_(pred__25344.call(null,1,expr__25345)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__25344.call(null,2,expr__25345)))
...
var G__25347 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__25348 = (limit__$1 - 1);
var G__25349 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__25347;
limit__$1 = G__25348;
parts = G__25349;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___25351 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___25351))
{var replacement_25352 = temp__4090__auto___25351;buffer.append([cljs.core.str(replacement_25352)].join(''));
} else
{buffer.append(ch);
}
{
var G__25353 = (index + 1);
index = G__25353;
continue;
}
}
