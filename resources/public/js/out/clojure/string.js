...
{{
var G__44840 = cljs.core.pop.call(null,v__$1);
v__$1 = G__44840;
continue;
}
} else
...
{var pred__44844 = cljs.core._EQ_;var expr__44845 = limit;if(cljs.core.truth_(pred__44844.call(null,1,expr__44845)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__44844.call(null,2,expr__44845)))
...
var G__44847 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__44848 = (limit__$1 - 1);
var G__44849 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__44847;
limit__$1 = G__44848;
parts = G__44849;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___44851 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___44851))
{var replacement_44852 = temp__4090__auto___44851;buffer.append([cljs.core.str(replacement_44852)].join(''));
} else
{buffer.append(ch);
}
{
var G__44853 = (index + 1);
index = G__44853;
continue;
}
}
