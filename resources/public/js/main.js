...
goog.addDependency("../foundation/app.js", ['foundation.app'], ['cljs.core', 'clojure.string', 'cljs.core.match', 'clojure.set', 'cljs.core.async', 'foundation.app.data.tracking_map', 'foundation.app.render']);
...
goog.addDependency("../foundation/app/router.js", ['foundation.app.router'], ['cljs.core', 'cljs.core.async.impl.channels', 'goog.history.Html5History', 'goog.string', 'foundation.app.xhr', 'clojure.string', 'clojure.set', 'cljs.core.async', 'foundation.app.ui', 'goog.Uri', 'dommy.core']);
goog.addDependency("../foundation/test/services.js", ['foundation.test.services'], ['cljs.core', 'foundation.app.models', 'foundation.app.xhr', 'foundation.test.models', 'foundation.app', 'cljs.core.async', 'foundation.app.router', 'goog.date']);
...
goog.addDependency("../foundation/test.js", ['foundation.test'], ['cljs.core', 'foundation.app.util', 'clojure.string', 'foundation.app', 'foundation.test.services', 'clojure.browser.repl', 'foundation.test.routes', 'foundation.app.router']);
