...
goog.addDependency("../foundation/test/templates.js", ['foundation.test.templates'], ['cljs.core', 'enfocus.events', 'cljs_time.format', 'enfocus.core', 'foundation.test.models', 'goog.i18n.DateTimeFormat', 'goog.i18n.NumberFormat', 'goog.i18n.currency', 'goog.i18n.DateTimeParse', 'goog.date', 'goog.ui.InputDatePicker', 'dommy.core', 'cljs_time.core']);
goog.addDependency("../foundation/test/cells.js", ['foundation.test.cells'], ['cljs.core', 'enfocus.events', 'foundation.app.xhr', 'cljs_time.format', 'enfocus.core', 'foundation.test.templates', 'cljs.core.async', 'goog.date', 'dommy.core', 'cljs_time.core']);
...
goog.addDependency("../foundation/test/stats.js", ['foundation.test.stats'], ['cljs.core', 'foundation.test.templates', 'foundation.test.models', 'clojure.string']);
goog.addDependency("../foundation/test/components/dashboard.js", ['foundation.test.components.dashboard'], ['cljs.core', 'dommy.template', 'foundation.test.stats', 'enfocus.core', 'foundation.test.templates', 'foundation.test.models', 'clojure.string', 'cljs.core.async', 'foundation.app.ui', 'foundation.app.render', 'dommy.core']);
