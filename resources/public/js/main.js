...
goog.addDependency("../foundation/app/render.js", ['foundation.app.render'], ['goog.events.EventHandler', 'goog.events.KeyEvent', 'cljs.core', 'goog.events.ActionEvent', 'foundation.app.data.component', 'goog.events.EventType', 'goog.events.InputHandler', 'goog.events.FocusHandler', 'foundation.app.util', 'goog.ui.IdGenerator', 'goog.events.MouseWheelHandler', 'goog.events.ActionHandler', 'cljs.core.async', 'goog.events', 'foundation.app.data.dependency', 'dommy.core', 'goog.events.KeyHandler']);
