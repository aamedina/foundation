...
goog.addDependency("../foundation/app/router.js", ['foundation.app.router'], ['cljs.core', 'cljs.core.async.impl.channels', 'goog.history.Html5History', 'goog.string', 'foundation.app.data.component', 'foundation.app.xhr', 'clojure.string', 'foundation.app', 'clojure.set', 'cljs.core.async', 'foundation.app.ui', 'goog.Uri', 'dommy.core']);
