...
goog.addDependency("../foundation/test/routes.js", ['foundation.test.routes'], ['foudnation.app.xhr', 'cljs.core', 'foundation.app.models', 'foundation.test.models', 'clojure.string', 'clojure.set', 'cljs.core.async', 'foundation.app.router']);
