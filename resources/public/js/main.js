...
goog.addDependency("../foundation/test.js", ['foundation.test'], ['cljs.core', 'foundation.app.util', 'foundation.app', 'clojure.browser.repl', 'foundation.test.routes', 'foundation.app.router', 'goog.Uri']);
