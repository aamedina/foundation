...
var unparse__delegate = function (fmt,dt,p__312747){var map__312749 = p__312747;var map__312749__$1 = ((cljs.core.seq_QMARK_.call(null,map__312749))?cljs.core.apply.call(null,cljs.core.hash_map,map__312749):map__312749);var tz = cljs.core.get.call(null,map__312749__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__312747 = null;if (arguments.length > 2) {
  p__312747 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__312747);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__312750){
var fmt = cljs.core.first(arglist__312750);
arglist__312750 = cljs.core.next(arglist__312750);
var dt = cljs.core.first(arglist__312750);
var p__312747 = cljs.core.rest(arglist__312750);
return unparse__delegate(fmt,dt,p__312747);
});
...
var show_formatters__delegate = function (p__312751){var map__312757 = p__312751;var map__312757__$1 = ((cljs.core.seq_QMARK_.call(null,map__312757))?cljs.core.apply.call(null,cljs.core.hash_map,map__312757):map__312757);var date_like = cljs.core.get.call(null,map__312757__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__8423__auto__ = (function iter__312758(s__312759){return (new cljs.core.LazySeq(null,(function (){var s__312759__$1 = s__312759;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__312759__$1);if(temp__4098__auto__)
{var s__312759__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__312759__$2))
{var c__8421__auto__ = cljs.core.chunk_first.call(null,s__312759__$2);var size__8422__auto__ = cljs.core.count.call(null,c__8421__auto__);var b__312761 = cljs.core.chunk_buffer.call(null,size__8422__auto__);if((function (){var i__312760 = 0;while(true){
if((i__312760 < size__8422__auto__))
{var i = cljs.core._nth.call(null,c__8421__auto__,i__312760);cljs.core.chunk_append.call(null,b__312761,cljs_time.format.unparse.call(null,i,date_like));
{
var G__312762 = (i__312760 + 1);
i__312760 = G__312762;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__312761),iter__312758.call(null,cljs.core.chunk_rest.call(null,s__312759__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__312761),null);
}
} else
{var i = cljs.core.first.call(null,s__312759__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__312758.call(null,cljs.core.rest.call(null,s__312759__$2)));
}
} else
{return null;
}
...
var p__312751 = null;if (arguments.length > 0) {
  p__312751 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__312751);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__312763){
var p__312751 = cljs.core.seq(arglist__312763);
return show_formatters__delegate(p__312751);
});
