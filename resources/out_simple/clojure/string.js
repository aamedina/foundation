...
{{
var G__39795 = cljs.core.pop.call(null,v__$1);
v__$1 = G__39795;
continue;
}
} else
...
{var pred__39799 = cljs.core._EQ_;var expr__39800 = limit;if(cljs.core.truth_(pred__39799.call(null,1,expr__39800)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__39799.call(null,2,expr__39800)))
...
var G__39802 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__39803 = (limit__$1 - 1);
var G__39804 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__39802;
limit__$1 = G__39803;
parts = G__39804;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___39806 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___39806))
{var replacement_39807 = temp__4096__auto___39806;buffer.append([cljs.core.str(replacement_39807)].join(''));
} else
{buffer.append(ch);
}
{
var G__39808 = (index + 1);
index = G__39808;
continue;
}
}
