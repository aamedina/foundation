...
{{
var G__627230 = cljs.core.pop.call(null,v__$1);
v__$1 = G__627230;
continue;
}
} else
...
{var pred__627234 = cljs.core._EQ_;var expr__627235 = limit;if(cljs.core.truth_(pred__627234.call(null,1,expr__627235)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__627234.call(null,2,expr__627235)))
...
var G__627237 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__627238 = (limit__$1 - 1);
var G__627239 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__627237;
limit__$1 = G__627238;
parts = G__627239;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___627241 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___627241))
{var replacement_627242 = temp__4096__auto___627241;buffer.append([cljs.core.str(replacement_627242)].join(''));
} else
{buffer.append(ch);
}
{
var G__627243 = (index + 1);
index = G__627243;
continue;
}
}
