...
{{
var G__79413 = cljs.core.pop.call(null,v__$1);
v__$1 = G__79413;
continue;
}
} else
...
{var pred__79417 = cljs.core._EQ_;var expr__79418 = limit;if(cljs.core.truth_(pred__79417.call(null,1,expr__79418)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__79417.call(null,2,expr__79418)))
...
var G__79420 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__79421 = (limit__$1 - 1);
var G__79422 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__79420;
limit__$1 = G__79421;
parts = G__79422;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___79424 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___79424))
{var replacement_79425 = temp__4096__auto___79424;buffer.append([cljs.core.str(replacement_79425)].join(''));
} else
{buffer.append(ch);
}
{
var G__79426 = (index + 1);
index = G__79426;
continue;
}
}
