...
{{
var G__214012 = cljs.core.pop.call(null,v__$1);
v__$1 = G__214012;
continue;
}
} else
...
{var pred__214016 = cljs.core._EQ_;var expr__214017 = limit;if(cljs.core.truth_(pred__214016.call(null,1,expr__214017)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__214016.call(null,2,expr__214017)))
...
var G__214019 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__214020 = (limit__$1 - 1);
var G__214021 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__214019;
limit__$1 = G__214020;
parts = G__214021;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___214023 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___214023))
{var replacement_214024 = temp__4096__auto___214023;buffer.append([cljs.core.str(replacement_214024)].join(''));
} else
{buffer.append(ch);
}
{
var G__214025 = (index + 1);
index = G__214025;
continue;
}
}
