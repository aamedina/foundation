...
{{
var G__146586 = cljs.core.pop.call(null,v__$1);
v__$1 = G__146586;
continue;
}
} else
...
{var pred__146590 = cljs.core._EQ_;var expr__146591 = limit;if(cljs.core.truth_(pred__146590.call(null,1,expr__146591)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__146590.call(null,2,expr__146591)))
...
var G__146593 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__146594 = (limit__$1 - 1);
var G__146595 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__146593;
limit__$1 = G__146594;
parts = G__146595;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___146597 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___146597))
{var replacement_146598 = temp__4096__auto___146597;buffer.append([cljs.core.str(replacement_146598)].join(''));
} else
{buffer.append(ch);
}
{
var G__146599 = (index + 1);
index = G__146599;
continue;
}
}
