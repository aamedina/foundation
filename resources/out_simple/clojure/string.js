...
{{
var G__317686 = cljs.core.pop.call(null,v__$1);
v__$1 = G__317686;
continue;
}
} else
...
{var pred__317690 = cljs.core._EQ_;var expr__317691 = limit;if(cljs.core.truth_(pred__317690.call(null,1,expr__317691)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__317690.call(null,2,expr__317691)))
...
var G__317693 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__317694 = (limit__$1 - 1);
var G__317695 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__317693;
limit__$1 = G__317694;
parts = G__317695;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___317697 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___317697))
{var replacement_317698 = temp__4096__auto___317697;buffer.append([cljs.core.str(replacement_317698)].join(''));
} else
{buffer.append(ch);
}
{
var G__317699 = (index + 1);
index = G__317699;
continue;
}
}
