...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t636705 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t636705 = (function (val,box,meta636706){
this.val = val;
this.box = box;
this.meta636706 = meta636706;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t636705.cljs$lang$type = true;
cljs.core.async.impl.channels.t636705.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t636705";
cljs.core.async.impl.channels.t636705.cljs$lang$ctorPrWriter = (function (this__8274__auto__,writer__8275__auto__,opt__8276__auto__){return cljs.core._write.call(null,writer__8275__auto__,"cljs.core.async.impl.channels/t636705");
});
cljs.core.async.impl.channels.t636705.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t636705.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_636707){var self__ = this;
var _636707__$1 = this;return self__.meta636706;
});
cljs.core.async.impl.channels.t636705.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_636707,meta636706__$1){var self__ = this;
var _636707__$1 = this;return (new cljs.core.async.impl.channels.t636705(self__.val,self__.box,meta636706__$1));
});
cljs.core.async.impl.channels.__GT_t636705 = (function __GT_t636705(val__$1,box__$1,meta636706){return (new cljs.core.async.impl.channels.t636705(val__$1,box__$1,meta636706));
});
}
return (new cljs.core.async.impl.channels.t636705(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_636708 = self__.takes.pop();if((taker_636708 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_636708))
{var take_cb_636709 = cljs.core.async.impl.protocols.commit.call(null,taker_636708);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_636709,taker_636708){
return (function (){return take_cb_636709.call(null,null);
});})(take_cb_636709,taker_636708))
);
} else
{}
{
