...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t78500 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t78500 = (function (val,box,meta78501){
this.val = val;
this.box = box;
this.meta78501 = meta78501;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t78500.cljs$lang$type = true;
cljs.core.async.impl.channels.t78500.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t78500";
cljs.core.async.impl.channels.t78500.cljs$lang$ctorPrWriter = (function (this__8274__auto__,writer__8275__auto__,opt__8276__auto__){return cljs.core._write.call(null,writer__8275__auto__,"cljs.core.async.impl.channels/t78500");
});
cljs.core.async.impl.channels.t78500.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t78500.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_78502){var self__ = this;
var _78502__$1 = this;return self__.meta78501;
});
cljs.core.async.impl.channels.t78500.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_78502,meta78501__$1){var self__ = this;
var _78502__$1 = this;return (new cljs.core.async.impl.channels.t78500(self__.val,self__.box,meta78501__$1));
});
cljs.core.async.impl.channels.__GT_t78500 = (function __GT_t78500(val__$1,box__$1,meta78501){return (new cljs.core.async.impl.channels.t78500(val__$1,box__$1,meta78501));
});
}
return (new cljs.core.async.impl.channels.t78500(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_78503 = self__.takes.pop();if((taker_78503 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_78503))
{var take_cb_78504 = cljs.core.async.impl.protocols.commit.call(null,taker_78503);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_78504,taker_78503){
return (function (){return take_cb_78504.call(null,null);
});})(take_cb_78504,taker_78503))
);
} else
{}
{
