...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t145673 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t145673 = (function (val,box,meta145674){
this.val = val;
this.box = box;
this.meta145674 = meta145674;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t145673.cljs$lang$type = true;
cljs.core.async.impl.channels.t145673.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t145673";
cljs.core.async.impl.channels.t145673.cljs$lang$ctorPrWriter = (function (this__8274__auto__,writer__8275__auto__,opt__8276__auto__){return cljs.core._write.call(null,writer__8275__auto__,"cljs.core.async.impl.channels/t145673");
});
cljs.core.async.impl.channels.t145673.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t145673.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_145675){var self__ = this;
var _145675__$1 = this;return self__.meta145674;
});
cljs.core.async.impl.channels.t145673.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_145675,meta145674__$1){var self__ = this;
var _145675__$1 = this;return (new cljs.core.async.impl.channels.t145673(self__.val,self__.box,meta145674__$1));
});
cljs.core.async.impl.channels.__GT_t145673 = (function __GT_t145673(val__$1,box__$1,meta145674){return (new cljs.core.async.impl.channels.t145673(val__$1,box__$1,meta145674));
});
}
return (new cljs.core.async.impl.channels.t145673(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_145676 = self__.takes.pop();if((taker_145676 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_145676))
{var take_cb_145677 = cljs.core.async.impl.protocols.commit.call(null,taker_145676);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_145677,taker_145676){
return (function (){return take_cb_145677.call(null,null);
});})(take_cb_145677,taker_145676))
);
} else
{}
{
