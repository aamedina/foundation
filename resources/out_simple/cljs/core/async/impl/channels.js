...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t39512 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t39512 = (function (val,box,meta39513){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t39512.cljs$lang$type = true;
cljs.core.async.impl.channels.t39512.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t39512";
cljs.core.async.impl.channels.t39512.cljs$lang$ctorPrWriter = (function (this__11441__auto__,writer__11442__auto__,opt__11443__auto__){return cljs.core._write.call(null,writer__11442__auto__,"cljs.core.async.impl.channels/t39512");
});
cljs.core.async.impl.channels.t39512.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t39512.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39514){var self__ = this;
var _39514__$1 = this;return self__.meta39513;
});
cljs.core.async.impl.channels.t39512.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39514,meta39513__$1){var self__ = this;
var _39514__$1 = this;return (new cljs.core.async.impl.channels.t39512(self__.val,self__.box,meta39513__$1));
});
cljs.core.async.impl.channels.__GT_t39512 = (function __GT_t39512(val__$1,box__$1,meta39513){return (new cljs.core.async.impl.channels.t39512(val__$1,box__$1,meta39513));
});
}
return (new cljs.core.async.impl.channels.t39512(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__11444__auto__,writer__11445__auto__,opts__11446__auto__){return cljs.core._write.call(null,writer__11445__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__11441__auto__,writer__11442__auto__,opt__11443__auto__){return cljs.core._write.call(null,writer__11442__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_39515 = self__.takes.pop();if((taker_39515 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_39515))
{var take_cb_39516 = cljs.core.async.impl.protocols.commit.call(null,taker_39515);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_39516,taker_39515){
return (function (){return take_cb_39516.call(null,null);
});})(take_cb_39516,taker_39515))
);
} else
{}
{
