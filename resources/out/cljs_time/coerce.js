...
goog.require('goog.date.DateTime');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj331731 = {};return obj331731;
})();
...
* which parses
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__14516__auto__ = (function iter__331740(s__331741){return (new cljs.core.LazySeq(null,(function (){var s__331741__$1 = s__331741;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__331741__$1);if(temp__4092__auto__)
{var s__331741__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__331741__$2))
{var c__14514__auto__ = cljs.core.chunk_first.call(null,s__331741__$2);var size__14515__auto__ = cljs.core.count.call(null,c__14514__auto__);var b__331743 = cljs.core.chunk_buffer.call(null,size__14515__auto__);if((function (){var i__331742 = 0;while(true){
if((i__331742 < size__14515__auto__))
{var f = cljs.core._nth.call(null,c__14514__auto__,i__331742);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e331746){if((e331746 instanceof Error))
{var e = e331746;return null;
} else
...
{cljs.core.chunk_append.call(null,b__331743,d);
{
var G__331748 = (i__331742 + 1);
i__331742 = G__331748;
continue;
}
} else
{{
var G__331749 = (i__331742 + 1);
i__331742 = G__331749;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__331743),iter__331740.call(null,cljs.core.chunk_rest.call(null,s__331741__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__331743),null);
}
} else
{var f = cljs.core.first.call(null,s__331741__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e331747){if((e331747 instanceof Error))
{var e = e331747;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e331747;
} else
...
{return cljs.core.cons.call(null,d,iter__331740.call(null,cljs.core.rest.call(null,s__331741__$2)));
} else
{{
var G__331750 = cljs.core.rest.call(null,s__331741__$2);
s__331741__$1 = G__331750;
continue;
}
}
}
