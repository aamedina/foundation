...
var unparse__delegate = function (fmt,dt,p__104082){var map__104084 = p__104082;var map__104084__$1 = ((cljs.core.seq_QMARK_.call(null,map__104084))?cljs.core.apply.call(null,cljs.core.hash_map,map__104084):map__104084);var tz = cljs.core.get.call(null,map__104084__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__104082 = null;if (arguments.length > 2) {
  p__104082 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__104082);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__104085){
var fmt = cljs.core.first(arglist__104085);
arglist__104085 = cljs.core.next(arglist__104085);
var dt = cljs.core.first(arglist__104085);
var p__104082 = cljs.core.rest(arglist__104085);
return unparse__delegate(fmt,dt,p__104082);
});
...
var show_formatters__delegate = function (p__104086){var map__104092 = p__104086;var map__104092__$1 = ((cljs.core.seq_QMARK_.call(null,map__104092))?cljs.core.apply.call(null,cljs.core.hash_map,map__104092):map__104092);var date_like = cljs.core.get.call(null,map__104092__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__14515__auto__ = (function iter__104093(s__104094){return (new cljs.core.LazySeq(null,(function (){var s__104094__$1 = s__104094;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__104094__$1);if(temp__4092__auto__)
{var s__104094__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__104094__$2))
{var c__14513__auto__ = cljs.core.chunk_first.call(null,s__104094__$2);var size__14514__auto__ = cljs.core.count.call(null,c__14513__auto__);var b__104096 = cljs.core.chunk_buffer.call(null,size__14514__auto__);if((function (){var i__104095 = 0;while(true){
if((i__104095 < size__14514__auto__))
{var i = cljs.core._nth.call(null,c__14513__auto__,i__104095);cljs.core.chunk_append.call(null,b__104096,cljs_time.format.unparse.call(null,i,date_like));
{
var G__104097 = (i__104095 + 1);
i__104095 = G__104097;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__104096),iter__104093.call(null,cljs.core.chunk_rest.call(null,s__104094__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__104096),null);
}
} else
{var i = cljs.core.first.call(null,s__104094__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__104093.call(null,cljs.core.rest.call(null,s__104094__$2)));
}
} else
{return null;
}
...
});return iter__14515__auto__.call(null,cljs.core.sort.call(null,cljs.core.vals.call(null,cljs_time.format.formatters)));
};
var show_formatters = function (var_args){
var p__104086 = null;if (arguments.length > 0) {
  p__104086 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__104086);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__104098){
var p__104086 = cljs.core.seq(arglist__104098);
return show_formatters__delegate(p__104086);
});
