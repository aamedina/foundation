...
var unparse__delegate = function (fmt,dt,p__341024){var map__341026 = p__341024;var map__341026__$1 = ((cljs.core.seq_QMARK_.call(null,map__341026))?cljs.core.apply.call(null,cljs.core.hash_map,map__341026):map__341026);var tz = cljs.core.get.call(null,map__341026__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__341024 = null;if (arguments.length > 2) {
  p__341024 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__341024);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__341027){
var fmt = cljs.core.first(arglist__341027);
arglist__341027 = cljs.core.next(arglist__341027);
var dt = cljs.core.first(arglist__341027);
var p__341024 = cljs.core.rest(arglist__341027);
return unparse__delegate(fmt,dt,p__341024);
});
...
var show_formatters__delegate = function (p__341028){var map__341034 = p__341028;var map__341034__$1 = ((cljs.core.seq_QMARK_.call(null,map__341034))?cljs.core.apply.call(null,cljs.core.hash_map,map__341034):map__341034);var date_like = cljs.core.get.call(null,map__341034__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__14516__auto__ = (function iter__341035(s__341036){return (new cljs.core.LazySeq(null,(function (){var s__341036__$1 = s__341036;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__341036__$1);if(temp__4092__auto__)
{var s__341036__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__341036__$2))
{var c__14514__auto__ = cljs.core.chunk_first.call(null,s__341036__$2);var size__14515__auto__ = cljs.core.count.call(null,c__14514__auto__);var b__341038 = cljs.core.chunk_buffer.call(null,size__14515__auto__);if((function (){var i__341037 = 0;while(true){
if((i__341037 < size__14515__auto__))
{var i = cljs.core._nth.call(null,c__14514__auto__,i__341037);cljs.core.chunk_append.call(null,b__341038,cljs_time.format.unparse.call(null,i,date_like));
{
var G__341039 = (i__341037 + 1);
i__341037 = G__341039;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__341038),iter__341035.call(null,cljs.core.chunk_rest.call(null,s__341036__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__341038),null);
}
} else
{var i = cljs.core.first.call(null,s__341036__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__341035.call(null,cljs.core.rest.call(null,s__341036__$2)));
}
} else
{return null;
}
...
});return iter__14516__auto__.call(null,cljs.core.sort.call(null,cljs.core.vals.call(null,cljs_time.format.formatters)));
};
var show_formatters = function (var_args){
var p__341028 = null;if (arguments.length > 0) {
  p__341028 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__341028);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__341040){
var p__341028 = cljs.core.seq(arglist__341040);
return show_formatters__delegate(p__341028);
});
