...
var unparse__delegate = function (fmt,dt,p__203907){var map__203909 = p__203907;var map__203909__$1 = ((cljs.core.seq_QMARK_.call(null,map__203909))?cljs.core.apply.call(null,cljs.core.hash_map,map__203909):map__203909);var tz = cljs.core.get.call(null,map__203909__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__203907 = null;if (arguments.length > 2) {
  p__203907 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__203907);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__203910){
var fmt = cljs.core.first(arglist__203910);
arglist__203910 = cljs.core.next(arglist__203910);
var dt = cljs.core.first(arglist__203910);
var p__203907 = cljs.core.rest(arglist__203910);
return unparse__delegate(fmt,dt,p__203907);
});
...
var show_formatters__delegate = function (p__203911){var map__203917 = p__203911;var map__203917__$1 = ((cljs.core.seq_QMARK_.call(null,map__203917))?cljs.core.apply.call(null,cljs.core.hash_map,map__203917):map__203917);var date_like = cljs.core.get.call(null,map__203917__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__8423__auto__ = (function iter__203918(s__203919){return (new cljs.core.LazySeq(null,(function (){var s__203919__$1 = s__203919;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__203919__$1);if(temp__4098__auto__)
{var s__203919__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__203919__$2))
{var c__8421__auto__ = cljs.core.chunk_first.call(null,s__203919__$2);var size__8422__auto__ = cljs.core.count.call(null,c__8421__auto__);var b__203921 = cljs.core.chunk_buffer.call(null,size__8422__auto__);if((function (){var i__203920 = 0;while(true){
if((i__203920 < size__8422__auto__))
{var i = cljs.core._nth.call(null,c__8421__auto__,i__203920);cljs.core.chunk_append.call(null,b__203921,cljs_time.format.unparse.call(null,i,date_like));
{
var G__203922 = (i__203920 + 1);
i__203920 = G__203922;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__203921),iter__203918.call(null,cljs.core.chunk_rest.call(null,s__203919__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__203921),null);
}
} else
{var i = cljs.core.first.call(null,s__203919__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__203918.call(null,cljs.core.rest.call(null,s__203919__$2)));
}
} else
{return null;
}
...
var p__203911 = null;if (arguments.length > 0) {
  p__203911 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__203911);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__203923){
var p__203911 = cljs.core.seq(arglist__203923);
return show_formatters__delegate(p__203911);
});
