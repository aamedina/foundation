...
var unparse__delegate = function (fmt,dt,p__477416){var map__477418 = p__477416;var map__477418__$1 = ((cljs.core.seq_QMARK_.call(null,map__477418))?cljs.core.apply.call(null,cljs.core.hash_map,map__477418):map__477418);var tz = cljs.core.get.call(null,map__477418__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__477416 = null;if (arguments.length > 2) {
  p__477416 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__477416);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__477419){
var fmt = cljs.core.first(arglist__477419);
arglist__477419 = cljs.core.next(arglist__477419);
var dt = cljs.core.first(arglist__477419);
var p__477416 = cljs.core.rest(arglist__477419);
return unparse__delegate(fmt,dt,p__477416);
});
...
var show_formatters__delegate = function (p__477420){var map__477426 = p__477420;var map__477426__$1 = ((cljs.core.seq_QMARK_.call(null,map__477426))?cljs.core.apply.call(null,cljs.core.hash_map,map__477426):map__477426);var date_like = cljs.core.get.call(null,map__477426__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__8423__auto__ = (function iter__477427(s__477428){return (new cljs.core.LazySeq(null,(function (){var s__477428__$1 = s__477428;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__477428__$1);if(temp__4098__auto__)
{var s__477428__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__477428__$2))
{var c__8421__auto__ = cljs.core.chunk_first.call(null,s__477428__$2);var size__8422__auto__ = cljs.core.count.call(null,c__8421__auto__);var b__477430 = cljs.core.chunk_buffer.call(null,size__8422__auto__);if((function (){var i__477429 = 0;while(true){
if((i__477429 < size__8422__auto__))
{var i = cljs.core._nth.call(null,c__8421__auto__,i__477429);cljs.core.chunk_append.call(null,b__477430,cljs_time.format.unparse.call(null,i,date_like));
{
var G__477431 = (i__477429 + 1);
i__477429 = G__477431;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__477430),iter__477427.call(null,cljs.core.chunk_rest.call(null,s__477428__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__477430),null);
}
} else
{var i = cljs.core.first.call(null,s__477428__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__477427.call(null,cljs.core.rest.call(null,s__477428__$2)));
}
} else
{return null;
}
...
var p__477420 = null;if (arguments.length > 0) {
  p__477420 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__477420);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__477432){
var p__477420 = cljs.core.seq(arglist__477432);
return show_formatters__delegate(p__477420);
});
