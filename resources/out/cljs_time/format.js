...
var unparse__delegate = function (fmt,dt,p__627485){var map__627487 = p__627485;var map__627487__$1 = ((cljs.core.seq_QMARK_.call(null,map__627487))?cljs.core.apply.call(null,cljs.core.hash_map,map__627487):map__627487);var tz = cljs.core.get.call(null,map__627487__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__627485 = null;if (arguments.length > 2) {
  p__627485 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__627485);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__627488){
var fmt = cljs.core.first(arglist__627488);
arglist__627488 = cljs.core.next(arglist__627488);
var dt = cljs.core.first(arglist__627488);
var p__627485 = cljs.core.rest(arglist__627488);
return unparse__delegate(fmt,dt,p__627485);
});
...
var show_formatters__delegate = function (p__627489){var map__627495 = p__627489;var map__627495__$1 = ((cljs.core.seq_QMARK_.call(null,map__627495))?cljs.core.apply.call(null,cljs.core.hash_map,map__627495):map__627495);var date_like = cljs.core.get.call(null,map__627495__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__8423__auto__ = (function iter__627496(s__627497){return (new cljs.core.LazySeq(null,(function (){var s__627497__$1 = s__627497;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__627497__$1);if(temp__4098__auto__)
{var s__627497__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__627497__$2))
{var c__8421__auto__ = cljs.core.chunk_first.call(null,s__627497__$2);var size__8422__auto__ = cljs.core.count.call(null,c__8421__auto__);var b__627499 = cljs.core.chunk_buffer.call(null,size__8422__auto__);if((function (){var i__627498 = 0;while(true){
if((i__627498 < size__8422__auto__))
{var i = cljs.core._nth.call(null,c__8421__auto__,i__627498);cljs.core.chunk_append.call(null,b__627499,cljs_time.format.unparse.call(null,i,date_like));
{
var G__627500 = (i__627498 + 1);
i__627498 = G__627500;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__627499),iter__627496.call(null,cljs.core.chunk_rest.call(null,s__627497__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__627499),null);
}
} else
{var i = cljs.core.first.call(null,s__627497__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__627496.call(null,cljs.core.rest.call(null,s__627497__$2)));
}
} else
{return null;
}
...
var p__627489 = null;if (arguments.length > 0) {
  p__627489 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__627489);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__627501){
var p__627489 = cljs.core.seq(arglist__627501);
return show_formatters__delegate(p__627489);
});
