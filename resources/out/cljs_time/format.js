...
var unparse__delegate = function (fmt,dt,p__302197){var map__302199 = p__302197;var map__302199__$1 = ((cljs.core.seq_QMARK_.call(null,map__302199))?cljs.core.apply.call(null,cljs.core.hash_map,map__302199):map__302199);var tz = cljs.core.get.call(null,map__302199__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__302197 = null;if (arguments.length > 2) {
  p__302197 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__302197);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__302200){
var fmt = cljs.core.first(arglist__302200);
arglist__302200 = cljs.core.next(arglist__302200);
var dt = cljs.core.first(arglist__302200);
var p__302197 = cljs.core.rest(arglist__302200);
return unparse__delegate(fmt,dt,p__302197);
});
...
var show_formatters__delegate = function (p__302201){var map__302207 = p__302201;var map__302207__$1 = ((cljs.core.seq_QMARK_.call(null,map__302207))?cljs.core.apply.call(null,cljs.core.hash_map,map__302207):map__302207);var date_like = cljs.core.get.call(null,map__302207__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__14518__auto__ = (function iter__302208(s__302209){return (new cljs.core.LazySeq(null,(function (){var s__302209__$1 = s__302209;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__302209__$1);if(temp__4092__auto__)
{var s__302209__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__302209__$2))
{var c__14516__auto__ = cljs.core.chunk_first.call(null,s__302209__$2);var size__14517__auto__ = cljs.core.count.call(null,c__14516__auto__);var b__302211 = cljs.core.chunk_buffer.call(null,size__14517__auto__);if((function (){var i__302210 = 0;while(true){
if((i__302210 < size__14517__auto__))
{var i = cljs.core._nth.call(null,c__14516__auto__,i__302210);cljs.core.chunk_append.call(null,b__302211,cljs_time.format.unparse.call(null,i,date_like));
{
var G__302212 = (i__302210 + 1);
i__302210 = G__302212;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__302211),iter__302208.call(null,cljs.core.chunk_rest.call(null,s__302209__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__302211),null);
}
} else
{var i = cljs.core.first.call(null,s__302209__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__302208.call(null,cljs.core.rest.call(null,s__302209__$2)));
}
} else
{return null;
}
...
});return iter__14518__auto__.call(null,cljs.core.sort.call(null,cljs.core.vals.call(null,cljs_time.format.formatters)));
};
var show_formatters = function (var_args){
var p__302201 = null;if (arguments.length > 0) {
  p__302201 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__302201);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__302213){
var p__302201 = cljs.core.seq(arglist__302213);
return show_formatters__delegate(p__302201);
});
