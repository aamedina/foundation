...
goog.require('goog.date.DateTime');
goog.require('goog.i18n.TimeZone');
cljs_time.core.DateTimeProtocol = (function (){var obj340929 = {};return obj340929;
})();
...
*/
cljs_time.core.today_at_midnight = (function today_at_midnight(){var G__340931 = (new goog.date.UtcDateTime());G__340931.setHours(0);
G__340931.setMinutes(0);
G__340931.setSeconds(0);
G__340931.setMilliseconds(0);
return G__340931;
});
/**
* Returns a DateTime for the begining of the Unix epoch in the UTC time zone.
*/
cljs_time.core.epoch = (function epoch(){var G__340933 = (new goog.date.UtcDateTime());G__340933.setTime(0);
return G__340933;
});
/**
...
var G__340934__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.plus_,cljs_time.core.plus_.call(null,dt,p),ps);
};
var G__340934 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__340934__delegate.call(this,dt,p,ps);};
G__340934.cljs$lang$maxFixedArity = 2;
G__340934.cljs$lang$applyTo = (function (arglist__340935){
var dt = cljs.core.first(arglist__340935);
arglist__340935 = cljs.core.next(arglist__340935);
var p = cljs.core.first(arglist__340935);
var ps = cljs.core.rest(arglist__340935);
return G__340934__delegate(dt,p,ps);
});
G__340934.cljs$core$IFn$_invoke$arity$variadic = G__340934__delegate;
return G__340934;
})()
;
...
var G__340936__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.minus_,cljs_time.core.minus_.call(null,dt,p),ps);
};
var G__340936 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__340936__delegate.call(this,dt,p,ps);};
G__340936.cljs$lang$maxFixedArity = 2;
G__340936.cljs$lang$applyTo = (function (arglist__340937){
var dt = cljs.core.first(arglist__340937);
arglist__340937 = cljs.core.next(arglist__340937);
var p = cljs.core.first(arglist__340937);
var ps = cljs.core.rest(arglist__340937);
return G__340936__delegate(dt,p,ps);
});
G__340936.cljs$core$IFn$_invoke$arity$variadic = G__340936__delegate;
return G__340936;
})()
;
...
extend.cljs$lang$applyTo = (function (arglist__340938){
var in$ = cljs.core.first(arglist__340938);
var by = cljs.core.rest(arglist__340938);
...
cljs_time.core.to_period = (function to_period(in$){var pred__340942 = cljs.core._EQ_;var expr__340943 = cljs.core.type.call(null,in$);if(cljs.core.truth_(pred__340942.call(null,goog.date.Interval,expr__340943)))
{return in$;
} else
{if(cljs.core.truth_(pred__340942.call(null,goog.date.DateRange,expr__340943)))
{return (new goog.date.Interval(0,0,0,0,0,((cljs_time.core.in_millis.call(null,in$) / 1000) | 0)));
} else
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__340943)].join('')));
}
}
});
/**
...
;
cljs_time.core.last_day_of_the_month = (function last_day_of_the_month(dt){var G__340946 = dt;G__340946.setDate(cljs_time.core.number_of_days_in_the_month.call(null,dt));
return G__340946;
});
cljs_time.core.first_day_of_the_month = (function first_day_of_the_month(dt){var G__340948 = dt;G__340948.setDate(1);
return G__340948;
});
...
var today_at__4 = (function (hours,minutes,seconds,millis){return cljs_time.core.date_time.call(null,(function (){var G__340950 = cljs_time.core.now.call(null);G__340950.setHourOfDay(hours);
G__340950.setMinuteOfHour(minutes);
G__340950.setSecondOfMinute(seconds);
G__340950.setMillisOfSecond(millis);
return G__340950;
})());
});
...
;
cljs_time.core.do_at_STAR_ = (function do_at_STAR_(base_date_time,body_fn){var ms = (base_date_time.getTime() - cljs_time.core.now.call(null).getTime());var c__18051__auto__ = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__18052__auto__ = (function (){var switch__17981__auto__ = (function (state_340987){var state_val_340988 = (state_340987[1]);if((state_val_340988 === 5))
{var _ = cljs.core.async.impl.ioc_helpers.add_exception_frame.call(null,state_340987,4,Error,null,3);var inst_340983 = body_fn.call(null);var state_340987__$1 = state_340987;var statearr_340989_341001 = state_340987__$1;(statearr_340989_341001[2] = inst_340983);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_340987__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_340988 === 4))
{var inst_340979 = (state_340987[2]);var state_340987__$1 = (function (){var statearr_340990 = state_340987;(statearr_340990[7] = inst_340979);
return statearr_340990;
})();var statearr_340991_341002 = state_340987__$1;(statearr_340991_341002[2] = null);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_340987__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_340988 === 3))
{var inst_340985 = (state_340987[2]);var state_340987__$1 = state_340987;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_340987__$1,inst_340985);
} else
{if((state_val_340988 === 2))
{var inst_340978 = (state_340987[2]);var state_340987__$1 = (function (){var statearr_340992 = state_340987;(statearr_340992[8] = inst_340978);
return statearr_340992;
})();var statearr_340993_341003 = state_340987__$1;(statearr_340993_341003[2] = null);
(statearr_340993_341003[1] = 5);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_340988 === 1))
{var inst_340976 = cljs.core.async.timeout.call(null,ms);var state_340987__$1 = state_340987;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_340987__$1,2,inst_340976);
} else
{return null;
}
}
...
var state_machine__17982__auto____0 = (function (){var statearr_340997 = (new Array(9));(statearr_340997[0] = state_machine__17982__auto__);
(statearr_340997[1] = 1);
return statearr_340997;
});
var state_machine__17982__auto____1 = (function (state_340987){while(true){
var ret_value__17983__auto__ = (function (){try{while(true){
var result__17984__auto__ = switch__17981__auto__.call(null,state_340987);if(cljs.core.keyword_identical_QMARK_.call(null,result__17984__auto__,new cljs.core.Keyword(null,"recur","recur",1122293407)))
{{
continue;
}
} else
...
}catch (e340998){if((e340998 instanceof Object))
{var ex__17985__auto__ = e340998;var statearr_340999_341004 = state_340987;(statearr_340999_341004[5] = ex__17985__auto__);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_340987);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
...
{{
var G__341005 = state_340987;
state_340987 = G__341005;
continue;
}
} else
...
state_machine__17982__auto__ = function(state_340987){
switch(arguments.length){
case 0:
return state_machine__17982__auto____0.call(this);
case 1:
return state_machine__17982__auto____1.call(this,state_340987);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
})();var state__18053__auto__ = (function (){var statearr_341000 = f__18052__auto__.call(null);(statearr_341000[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__18051__auto__);
return statearr_341000;
})();return cljs.core.async.impl.ioc_helpers.run_state_machine_wrapped.call(null,state__18053__auto__);
}));
return c__18051__auto__;
});
cljs_time.core.Mappable = (function (){var obj341007 = {};return obj341007;
})();
...
{{
var G__341008 = [cljs.core.str("0"),cljs.core.str(ns)].join('');
ns = G__341008;
continue;
}
} else
...
var G__341009__delegate = function (arg,more){return cljs.core.apply.call(null,f,arg,cljs.core.concat.call(null,args,more));
};
var G__341009 = function (arg,var_args){
var more = null;if (arguments.length > 1) {
  more = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__341009__delegate.call(this,arg,more);};
G__341009.cljs$lang$maxFixedArity = 1;
G__341009.cljs$lang$applyTo = (function (arglist__341010){
var arg = cljs.core.first(arglist__341010);
var more = cljs.core.rest(arglist__341010);
return G__341009__delegate(arg,more);
});
G__341009.cljs$core$IFn$_invoke$arity$variadic = G__341009__delegate;
return G__341009;
})()
;
};
...
fpartial.cljs$lang$applyTo = (function (arglist__341011){
var f = cljs.core.first(arglist__341011);
var args = cljs.core.rest(arglist__341011);
