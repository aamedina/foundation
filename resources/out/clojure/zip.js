...
{var vec__338955 = loc;var node = cljs.core.nth.call(null,vec__338955,0,null);var path = cljs.core.nth.call(null,vec__338955,1,null);var vec__338956 = clojure.zip.children.call(null,loc);var c = cljs.core.nth.call(null,vec__338956,0,null);var cnext = cljs.core.nthnext.call(null,vec__338956,1);var cs = vec__338956;if(cljs.core.truth_(cs))
...
* the top
*/
clojure.zip.up = (function up(loc){var vec__338959 = loc;var node = cljs.core.nth.call(null,vec__338959,0,null);var map__338960 = cljs.core.nth.call(null,vec__338959,1,null);var map__338960__$1 = ((cljs.core.seq_QMARK_.call(null,map__338960))?cljs.core.apply.call(null,cljs.core.hash_map,map__338960):map__338960);var path = map__338960__$1;var l = cljs.core.get.call(null,map__338960__$1,new cljs.core.Keyword(null,"l","l",1013904350));var ppath = cljs.core.get.call(null,map__338960__$1,new cljs.core.Keyword(null,"ppath","ppath",1120772103));var pnodes = cljs.core.get.call(null,map__338960__$1,new cljs.core.Keyword(null,"pnodes","pnodes",4325362611));var r = cljs.core.get.call(null,map__338960__$1,new cljs.core.Keyword(null,"r","r",1013904356));var changed_QMARK_ = cljs.core.get.call(null,map__338960__$1,new cljs.core.Keyword(null,"changed?","changed?",2446321533));if(cljs.core.truth_(pnodes))
{var pnode = cljs.core.peek.call(null,pnodes);return cljs.core.with_meta.call(null,(cljs.core.truth_(changed_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.zip.make_node.call(null,loc,pnode,cljs.core.concat.call(null,l,cljs.core.cons.call(null,node,r))),(function (){var and__13811__auto__ = ppath;if(cljs.core.truth_(and__13811__auto__))
...
*/
clojure.zip.right = (function right(loc){var vec__338965 = loc;var node = cljs.core.nth.call(null,vec__338965,0,null);var map__338966 = cljs.core.nth.call(null,vec__338965,1,null);var map__338966__$1 = ((cljs.core.seq_QMARK_.call(null,map__338966))?cljs.core.apply.call(null,cljs.core.hash_map,map__338966):map__338966);var path = map__338966__$1;var l = cljs.core.get.call(null,map__338966__$1,new cljs.core.Keyword(null,"l","l",1013904350));var vec__338967 = cljs.core.get.call(null,map__338966__$1,new cljs.core.Keyword(null,"r","r",1013904356));var r = cljs.core.nth.call(null,vec__338967,0,null);var rnext = cljs.core.nthnext.call(null,vec__338967,1);var rs = vec__338967;if(cljs.core.truth_((function (){var and__13811__auto__ = path;if(cljs.core.truth_(and__13811__auto__))
{return rs;
} else
{return and__13811__auto__;
}
...
*/
clojure.zip.rightmost = (function rightmost(loc){var vec__338970 = loc;var node = cljs.core.nth.call(null,vec__338970,0,null);var map__338971 = cljs.core.nth.call(null,vec__338970,1,null);var map__338971__$1 = ((cljs.core.seq_QMARK_.call(null,map__338971))?cljs.core.apply.call(null,cljs.core.hash_map,map__338971):map__338971);var path = map__338971__$1;var l = cljs.core.get.call(null,map__338971__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__338971__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__13811__auto__ = path;if(cljs.core.truth_(and__13811__auto__))
{return r;
} else
{return and__13811__auto__;
}
...
*/
clojure.zip.left = (function left(loc){var vec__338974 = loc;var node = cljs.core.nth.call(null,vec__338974,0,null);var map__338975 = cljs.core.nth.call(null,vec__338974,1,null);var map__338975__$1 = ((cljs.core.seq_QMARK_.call(null,map__338975))?cljs.core.apply.call(null,cljs.core.hash_map,map__338975):map__338975);var path = map__338975__$1;var l = cljs.core.get.call(null,map__338975__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__338975__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__13811__auto__ = path;if(cljs.core.truth_(and__13811__auto__))
...
*/
clojure.zip.leftmost = (function leftmost(loc){var vec__338978 = loc;var node = cljs.core.nth.call(null,vec__338978,0,null);var map__338979 = cljs.core.nth.call(null,vec__338978,1,null);var map__338979__$1 = ((cljs.core.seq_QMARK_.call(null,map__338979))?cljs.core.apply.call(null,cljs.core.hash_map,map__338979):map__338979);var path = map__338979__$1;var l = cljs.core.get.call(null,map__338979__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__338979__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__13811__auto__ = path;if(cljs.core.truth_(and__13811__auto__))
{return cljs.core.seq.call(null,l);
} else
{return and__13811__auto__;
}
...
* without moving
*/
clojure.zip.insert_left = (function insert_left(loc,item){var vec__338982 = loc;var node = cljs.core.nth.call(null,vec__338982,0,null);var map__338983 = cljs.core.nth.call(null,vec__338982,1,null);var map__338983__$1 = ((cljs.core.seq_QMARK_.call(null,map__338983))?cljs.core.apply.call(null,cljs.core.hash_map,map__338983):map__338983);var path = map__338983__$1;var l = cljs.core.get.call(null,map__338983__$1,new cljs.core.Keyword(null,"l","l",1013904350));if((path == null))
{throw "Insert at top";
} else
...
* without moving
*/
clojure.zip.insert_right = (function insert_right(loc,item){var vec__338986 = loc;var node = cljs.core.nth.call(null,vec__338986,0,null);var map__338987 = cljs.core.nth.call(null,vec__338986,1,null);var map__338987__$1 = ((cljs.core.seq_QMARK_.call(null,map__338987))?cljs.core.apply.call(null,cljs.core.hash_map,map__338987):map__338987);var path = map__338987__$1;var r = cljs.core.get.call(null,map__338987__$1,new cljs.core.Keyword(null,"r","r",1013904356));if((path == null))
{throw "Insert at top";
} else
...
*/
clojure.zip.replace = (function replace(loc,node){var vec__338989 = loc;var _ = cljs.core.nth.call(null,vec__338989,0,null);var path = cljs.core.nth.call(null,vec__338989,1,null);return cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [node,cljs.core.assoc.call(null,path,new cljs.core.Keyword(null,"changed?","changed?",2446321533),true)], null),cljs.core.meta.call(null,loc));
});
/**
...
edit.cljs$lang$applyTo = (function (arglist__338990){
var loc = cljs.core.first(arglist__338990);
arglist__338990 = cljs.core.next(arglist__338990);
var f = cljs.core.first(arglist__338990);
var args = cljs.core.rest(arglist__338990);
...
{var or__13823__auto__ = (function (){var and__13811__auto__ = clojure.zip.branch_QMARK_.call(null,loc);if(cljs.core.truth_(and__13811__auto__))
...
{var or__13823__auto____$1 = clojure.zip.right.call(null,loc);if(cljs.core.truth_(or__13823__auto____$1))
{return or__13823__auto____$1;
} else
{var p = loc;while(true){
if(cljs.core.truth_(clojure.zip.up.call(null,p)))
{var or__13823__auto____$2 = clojure.zip.right.call(null,clojure.zip.up.call(null,p));if(cljs.core.truth_(or__13823__auto____$2))
{return or__13823__auto____$2;
} else
{{
var G__338991 = clojure.zip.up.call(null,p);
p = G__338991;
continue;
}
}
...
var temp__4090__auto____$1 = (function (){var and__13811__auto__ = clojure.zip.branch_QMARK_.call(null,loc__$1);if(cljs.core.truth_(and__13811__auto__))
...
var G__338992 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__338992;
continue;
}
} else
...
*/
clojure.zip.remove = (function remove(loc){var vec__338995 = loc;var node = cljs.core.nth.call(null,vec__338995,0,null);var map__338996 = cljs.core.nth.call(null,vec__338995,1,null);var map__338996__$1 = ((cljs.core.seq_QMARK_.call(null,map__338996))?cljs.core.apply.call(null,cljs.core.hash_map,map__338996):map__338996);var path = map__338996__$1;var l = cljs.core.get.call(null,map__338996__$1,new cljs.core.Keyword(null,"l","l",1013904350));var ppath = cljs.core.get.call(null,map__338996__$1,new cljs.core.Keyword(null,"ppath","ppath",1120772103));var pnodes = cljs.core.get.call(null,map__338996__$1,new cljs.core.Keyword(null,"pnodes","pnodes",4325362611));var rs = cljs.core.get.call(null,map__338996__$1,new cljs.core.Keyword(null,"r","r",1013904356));if((path == null))
{throw "Remove at top";
} else
...
var temp__4090__auto__ = (function (){var and__13811__auto__ = clojure.zip.branch_QMARK_.call(null,loc__$1);if(cljs.core.truth_(and__13811__auto__))
{return clojure.zip.down.call(null,loc__$1);
} else
{return and__13811__auto__;
}
...
var G__338997 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__338997;
continue;
}
} else
...
{return cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.zip.make_node.call(null,loc,cljs.core.peek.call(null,pnodes),rs),(function (){var and__13811__auto__ = ppath;if(cljs.core.truth_(and__13811__auto__))
{return cljs.core.assoc.call(null,ppath,new cljs.core.Keyword(null,"changed?","changed?",2446321533),true);
} else
{return and__13811__auto__;
}
