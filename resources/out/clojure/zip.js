...
{var vec__477132 = loc;var node = cljs.core.nth.call(null,vec__477132,0,null);var path = cljs.core.nth.call(null,vec__477132,1,null);var vec__477133 = clojure.zip.children.call(null,loc);var c = cljs.core.nth.call(null,vec__477133,0,null);var cnext = cljs.core.nthnext.call(null,vec__477133,1);var cs = vec__477133;if(cljs.core.truth_(cs))
...
* the top
*/
clojure.zip.up = (function up(loc){var vec__477136 = loc;var node = cljs.core.nth.call(null,vec__477136,0,null);var map__477137 = cljs.core.nth.call(null,vec__477136,1,null);var map__477137__$1 = ((cljs.core.seq_QMARK_.call(null,map__477137))?cljs.core.apply.call(null,cljs.core.hash_map,map__477137):map__477137);var path = map__477137__$1;var l = cljs.core.get.call(null,map__477137__$1,new cljs.core.Keyword(null,"l","l",1013904350));var ppath = cljs.core.get.call(null,map__477137__$1,new cljs.core.Keyword(null,"ppath","ppath",1120772103));var pnodes = cljs.core.get.call(null,map__477137__$1,new cljs.core.Keyword(null,"pnodes","pnodes",4325362611));var r = cljs.core.get.call(null,map__477137__$1,new cljs.core.Keyword(null,"r","r",1013904356));var changed_QMARK_ = cljs.core.get.call(null,map__477137__$1,new cljs.core.Keyword(null,"changed?","changed?",2446321533));if(cljs.core.truth_(pnodes))
...
*/
clojure.zip.right = (function right(loc){var vec__477142 = loc;var node = cljs.core.nth.call(null,vec__477142,0,null);var map__477143 = cljs.core.nth.call(null,vec__477142,1,null);var map__477143__$1 = ((cljs.core.seq_QMARK_.call(null,map__477143))?cljs.core.apply.call(null,cljs.core.hash_map,map__477143):map__477143);var path = map__477143__$1;var l = cljs.core.get.call(null,map__477143__$1,new cljs.core.Keyword(null,"l","l",1013904350));var vec__477144 = cljs.core.get.call(null,map__477143__$1,new cljs.core.Keyword(null,"r","r",1013904356));var r = cljs.core.nth.call(null,vec__477144,0,null);var rnext = cljs.core.nthnext.call(null,vec__477144,1);var rs = vec__477144;if(cljs.core.truth_((function (){var and__7718__auto__ = path;if(cljs.core.truth_(and__7718__auto__))
{return rs;
} else
{return and__7718__auto__;
}
...
*/
clojure.zip.rightmost = (function rightmost(loc){var vec__477147 = loc;var node = cljs.core.nth.call(null,vec__477147,0,null);var map__477148 = cljs.core.nth.call(null,vec__477147,1,null);var map__477148__$1 = ((cljs.core.seq_QMARK_.call(null,map__477148))?cljs.core.apply.call(null,cljs.core.hash_map,map__477148):map__477148);var path = map__477148__$1;var l = cljs.core.get.call(null,map__477148__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__477148__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__7718__auto__ = path;if(cljs.core.truth_(and__7718__auto__))
{return r;
} else
{return and__7718__auto__;
}
...
*/
clojure.zip.left = (function left(loc){var vec__477151 = loc;var node = cljs.core.nth.call(null,vec__477151,0,null);var map__477152 = cljs.core.nth.call(null,vec__477151,1,null);var map__477152__$1 = ((cljs.core.seq_QMARK_.call(null,map__477152))?cljs.core.apply.call(null,cljs.core.hash_map,map__477152):map__477152);var path = map__477152__$1;var l = cljs.core.get.call(null,map__477152__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__477152__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__7718__auto__ = path;if(cljs.core.truth_(and__7718__auto__))
...
*/
clojure.zip.leftmost = (function leftmost(loc){var vec__477155 = loc;var node = cljs.core.nth.call(null,vec__477155,0,null);var map__477156 = cljs.core.nth.call(null,vec__477155,1,null);var map__477156__$1 = ((cljs.core.seq_QMARK_.call(null,map__477156))?cljs.core.apply.call(null,cljs.core.hash_map,map__477156):map__477156);var path = map__477156__$1;var l = cljs.core.get.call(null,map__477156__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__477156__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__7718__auto__ = path;if(cljs.core.truth_(and__7718__auto__))
{return cljs.core.seq.call(null,l);
} else
{return and__7718__auto__;
}
...
* without moving
*/
clojure.zip.insert_left = (function insert_left(loc,item){var vec__477159 = loc;var node = cljs.core.nth.call(null,vec__477159,0,null);var map__477160 = cljs.core.nth.call(null,vec__477159,1,null);var map__477160__$1 = ((cljs.core.seq_QMARK_.call(null,map__477160))?cljs.core.apply.call(null,cljs.core.hash_map,map__477160):map__477160);var path = map__477160__$1;var l = cljs.core.get.call(null,map__477160__$1,new cljs.core.Keyword(null,"l","l",1013904350));if((path == null))
{throw "Insert at top";
} else
...
* without moving
*/
clojure.zip.insert_right = (function insert_right(loc,item){var vec__477163 = loc;var node = cljs.core.nth.call(null,vec__477163,0,null);var map__477164 = cljs.core.nth.call(null,vec__477163,1,null);var map__477164__$1 = ((cljs.core.seq_QMARK_.call(null,map__477164))?cljs.core.apply.call(null,cljs.core.hash_map,map__477164):map__477164);var path = map__477164__$1;var r = cljs.core.get.call(null,map__477164__$1,new cljs.core.Keyword(null,"r","r",1013904356));if((path == null))
{throw "Insert at top";
} else
...
*/
clojure.zip.replace = (function replace(loc,node){var vec__477166 = loc;var _ = cljs.core.nth.call(null,vec__477166,0,null);var path = cljs.core.nth.call(null,vec__477166,1,null);return cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [node,cljs.core.assoc.call(null,path,new cljs.core.Keyword(null,"changed?","changed?",2446321533),true)], null),cljs.core.meta.call(null,loc));
});
/**
...
edit.cljs$lang$applyTo = (function (arglist__477167){
var loc = cljs.core.first(arglist__477167);
arglist__477167 = cljs.core.next(arglist__477167);
var f = cljs.core.first(arglist__477167);
var args = cljs.core.rest(arglist__477167);
...
{{
var G__477168 = clojure.zip.up.call(null,p);
p = G__477168;
continue;
}
}
...
var G__477169 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__477169;
continue;
}
} else
...
*/
clojure.zip.remove = (function remove(loc){var vec__477172 = loc;var node = cljs.core.nth.call(null,vec__477172,0,null);var map__477173 = cljs.core.nth.call(null,vec__477172,1,null);var map__477173__$1 = ((cljs.core.seq_QMARK_.call(null,map__477173))?cljs.core.apply.call(null,cljs.core.hash_map,map__477173):map__477173);var path = map__477173__$1;var l = cljs.core.get.call(null,map__477173__$1,new cljs.core.Keyword(null,"l","l",1013904350));var ppath = cljs.core.get.call(null,map__477173__$1,new cljs.core.Keyword(null,"ppath","ppath",1120772103));var pnodes = cljs.core.get.call(null,map__477173__$1,new cljs.core.Keyword(null,"pnodes","pnodes",4325362611));var rs = cljs.core.get.call(null,map__477173__$1,new cljs.core.Keyword(null,"r","r",1013904356));if((path == null))
{throw "Remove at top";
} else
...
var G__477174 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__477174;
continue;
}
} else
