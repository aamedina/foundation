...
{var vec__208803 = loc;var node = cljs.core.nth.call(null,vec__208803,0,null);var path = cljs.core.nth.call(null,vec__208803,1,null);var vec__208804 = clojure.zip.children.call(null,loc);var c = cljs.core.nth.call(null,vec__208804,0,null);var cnext = cljs.core.nthnext.call(null,vec__208804,1);var cs = vec__208804;if(cljs.core.truth_(cs))
...
* the top
*/
clojure.zip.up = (function up(loc){var vec__208807 = loc;var node = cljs.core.nth.call(null,vec__208807,0,null);var map__208808 = cljs.core.nth.call(null,vec__208807,1,null);var map__208808__$1 = ((cljs.core.seq_QMARK_.call(null,map__208808))?cljs.core.apply.call(null,cljs.core.hash_map,map__208808):map__208808);var path = map__208808__$1;var l = cljs.core.get.call(null,map__208808__$1,new cljs.core.Keyword(null,"l","l",1013904350));var ppath = cljs.core.get.call(null,map__208808__$1,new cljs.core.Keyword(null,"ppath","ppath",1120772103));var pnodes = cljs.core.get.call(null,map__208808__$1,new cljs.core.Keyword(null,"pnodes","pnodes",4325362611));var r = cljs.core.get.call(null,map__208808__$1,new cljs.core.Keyword(null,"r","r",1013904356));var changed_QMARK_ = cljs.core.get.call(null,map__208808__$1,new cljs.core.Keyword(null,"changed?","changed?",2446321533));if(cljs.core.truth_(pnodes))
...
*/
clojure.zip.right = (function right(loc){var vec__208813 = loc;var node = cljs.core.nth.call(null,vec__208813,0,null);var map__208814 = cljs.core.nth.call(null,vec__208813,1,null);var map__208814__$1 = ((cljs.core.seq_QMARK_.call(null,map__208814))?cljs.core.apply.call(null,cljs.core.hash_map,map__208814):map__208814);var path = map__208814__$1;var l = cljs.core.get.call(null,map__208814__$1,new cljs.core.Keyword(null,"l","l",1013904350));var vec__208815 = cljs.core.get.call(null,map__208814__$1,new cljs.core.Keyword(null,"r","r",1013904356));var r = cljs.core.nth.call(null,vec__208815,0,null);var rnext = cljs.core.nthnext.call(null,vec__208815,1);var rs = vec__208815;if(cljs.core.truth_((function (){var and__7718__auto__ = path;if(cljs.core.truth_(and__7718__auto__))
{return rs;
} else
{return and__7718__auto__;
}
...
*/
clojure.zip.rightmost = (function rightmost(loc){var vec__208818 = loc;var node = cljs.core.nth.call(null,vec__208818,0,null);var map__208819 = cljs.core.nth.call(null,vec__208818,1,null);var map__208819__$1 = ((cljs.core.seq_QMARK_.call(null,map__208819))?cljs.core.apply.call(null,cljs.core.hash_map,map__208819):map__208819);var path = map__208819__$1;var l = cljs.core.get.call(null,map__208819__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__208819__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__7718__auto__ = path;if(cljs.core.truth_(and__7718__auto__))
{return r;
} else
{return and__7718__auto__;
}
...
*/
clojure.zip.left = (function left(loc){var vec__208822 = loc;var node = cljs.core.nth.call(null,vec__208822,0,null);var map__208823 = cljs.core.nth.call(null,vec__208822,1,null);var map__208823__$1 = ((cljs.core.seq_QMARK_.call(null,map__208823))?cljs.core.apply.call(null,cljs.core.hash_map,map__208823):map__208823);var path = map__208823__$1;var l = cljs.core.get.call(null,map__208823__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__208823__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__7718__auto__ = path;if(cljs.core.truth_(and__7718__auto__))
...
*/
clojure.zip.leftmost = (function leftmost(loc){var vec__208826 = loc;var node = cljs.core.nth.call(null,vec__208826,0,null);var map__208827 = cljs.core.nth.call(null,vec__208826,1,null);var map__208827__$1 = ((cljs.core.seq_QMARK_.call(null,map__208827))?cljs.core.apply.call(null,cljs.core.hash_map,map__208827):map__208827);var path = map__208827__$1;var l = cljs.core.get.call(null,map__208827__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__208827__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__7718__auto__ = path;if(cljs.core.truth_(and__7718__auto__))
{return cljs.core.seq.call(null,l);
} else
{return and__7718__auto__;
}
...
* without moving
*/
clojure.zip.insert_left = (function insert_left(loc,item){var vec__208830 = loc;var node = cljs.core.nth.call(null,vec__208830,0,null);var map__208831 = cljs.core.nth.call(null,vec__208830,1,null);var map__208831__$1 = ((cljs.core.seq_QMARK_.call(null,map__208831))?cljs.core.apply.call(null,cljs.core.hash_map,map__208831):map__208831);var path = map__208831__$1;var l = cljs.core.get.call(null,map__208831__$1,new cljs.core.Keyword(null,"l","l",1013904350));if((path == null))
{throw "Insert at top";
} else
...
* without moving
*/
clojure.zip.insert_right = (function insert_right(loc,item){var vec__208834 = loc;var node = cljs.core.nth.call(null,vec__208834,0,null);var map__208835 = cljs.core.nth.call(null,vec__208834,1,null);var map__208835__$1 = ((cljs.core.seq_QMARK_.call(null,map__208835))?cljs.core.apply.call(null,cljs.core.hash_map,map__208835):map__208835);var path = map__208835__$1;var r = cljs.core.get.call(null,map__208835__$1,new cljs.core.Keyword(null,"r","r",1013904356));if((path == null))
{throw "Insert at top";
} else
...
*/
clojure.zip.replace = (function replace(loc,node){var vec__208837 = loc;var _ = cljs.core.nth.call(null,vec__208837,0,null);var path = cljs.core.nth.call(null,vec__208837,1,null);return cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [node,cljs.core.assoc.call(null,path,new cljs.core.Keyword(null,"changed?","changed?",2446321533),true)], null),cljs.core.meta.call(null,loc));
});
/**
...
edit.cljs$lang$applyTo = (function (arglist__208838){
var loc = cljs.core.first(arglist__208838);
arglist__208838 = cljs.core.next(arglist__208838);
var f = cljs.core.first(arglist__208838);
var args = cljs.core.rest(arglist__208838);
...
{{
var G__208839 = clojure.zip.up.call(null,p);
p = G__208839;
continue;
}
}
...
var G__208840 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__208840;
continue;
}
} else
...
*/
clojure.zip.remove = (function remove(loc){var vec__208843 = loc;var node = cljs.core.nth.call(null,vec__208843,0,null);var map__208844 = cljs.core.nth.call(null,vec__208843,1,null);var map__208844__$1 = ((cljs.core.seq_QMARK_.call(null,map__208844))?cljs.core.apply.call(null,cljs.core.hash_map,map__208844):map__208844);var path = map__208844__$1;var l = cljs.core.get.call(null,map__208844__$1,new cljs.core.Keyword(null,"l","l",1013904350));var ppath = cljs.core.get.call(null,map__208844__$1,new cljs.core.Keyword(null,"ppath","ppath",1120772103));var pnodes = cljs.core.get.call(null,map__208844__$1,new cljs.core.Keyword(null,"pnodes","pnodes",4325362611));var rs = cljs.core.get.call(null,map__208844__$1,new cljs.core.Keyword(null,"r","r",1013904356));if((path == null))
{throw "Remove at top";
} else
...
var G__208845 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__208845;
continue;
}
} else
