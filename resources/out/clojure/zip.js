...
{var vec__384293 = loc;var node = cljs.core.nth.call(null,vec__384293,0,null);var path = cljs.core.nth.call(null,vec__384293,1,null);var vec__384294 = clojure.zip.children.call(null,loc);var c = cljs.core.nth.call(null,vec__384294,0,null);var cnext = cljs.core.nthnext.call(null,vec__384294,1);var cs = vec__384294;if(cljs.core.truth_(cs))
...
* the top
*/
clojure.zip.up = (function up(loc){var vec__384297 = loc;var node = cljs.core.nth.call(null,vec__384297,0,null);var map__384298 = cljs.core.nth.call(null,vec__384297,1,null);var map__384298__$1 = ((cljs.core.seq_QMARK_.call(null,map__384298))?cljs.core.apply.call(null,cljs.core.hash_map,map__384298):map__384298);var path = map__384298__$1;var l = cljs.core.get.call(null,map__384298__$1,new cljs.core.Keyword(null,"l","l",1013904350));var ppath = cljs.core.get.call(null,map__384298__$1,new cljs.core.Keyword(null,"ppath","ppath",1120772103));var pnodes = cljs.core.get.call(null,map__384298__$1,new cljs.core.Keyword(null,"pnodes","pnodes",4325362611));var r = cljs.core.get.call(null,map__384298__$1,new cljs.core.Keyword(null,"r","r",1013904356));var changed_QMARK_ = cljs.core.get.call(null,map__384298__$1,new cljs.core.Keyword(null,"changed?","changed?",2446321533));if(cljs.core.truth_(pnodes))
...
*/
clojure.zip.right = (function right(loc){var vec__384303 = loc;var node = cljs.core.nth.call(null,vec__384303,0,null);var map__384304 = cljs.core.nth.call(null,vec__384303,1,null);var map__384304__$1 = ((cljs.core.seq_QMARK_.call(null,map__384304))?cljs.core.apply.call(null,cljs.core.hash_map,map__384304):map__384304);var path = map__384304__$1;var l = cljs.core.get.call(null,map__384304__$1,new cljs.core.Keyword(null,"l","l",1013904350));var vec__384305 = cljs.core.get.call(null,map__384304__$1,new cljs.core.Keyword(null,"r","r",1013904356));var r = cljs.core.nth.call(null,vec__384305,0,null);var rnext = cljs.core.nthnext.call(null,vec__384305,1);var rs = vec__384305;if(cljs.core.truth_((function (){var and__13967__auto__ = path;if(cljs.core.truth_(and__13967__auto__))
{return rs;
} else
{return and__13967__auto__;
}
...
*/
clojure.zip.rightmost = (function rightmost(loc){var vec__384308 = loc;var node = cljs.core.nth.call(null,vec__384308,0,null);var map__384309 = cljs.core.nth.call(null,vec__384308,1,null);var map__384309__$1 = ((cljs.core.seq_QMARK_.call(null,map__384309))?cljs.core.apply.call(null,cljs.core.hash_map,map__384309):map__384309);var path = map__384309__$1;var l = cljs.core.get.call(null,map__384309__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__384309__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__13967__auto__ = path;if(cljs.core.truth_(and__13967__auto__))
{return r;
} else
{return and__13967__auto__;
}
...
*/
clojure.zip.left = (function left(loc){var vec__384312 = loc;var node = cljs.core.nth.call(null,vec__384312,0,null);var map__384313 = cljs.core.nth.call(null,vec__384312,1,null);var map__384313__$1 = ((cljs.core.seq_QMARK_.call(null,map__384313))?cljs.core.apply.call(null,cljs.core.hash_map,map__384313):map__384313);var path = map__384313__$1;var l = cljs.core.get.call(null,map__384313__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__384313__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__13967__auto__ = path;if(cljs.core.truth_(and__13967__auto__))
...
*/
clojure.zip.leftmost = (function leftmost(loc){var vec__384316 = loc;var node = cljs.core.nth.call(null,vec__384316,0,null);var map__384317 = cljs.core.nth.call(null,vec__384316,1,null);var map__384317__$1 = ((cljs.core.seq_QMARK_.call(null,map__384317))?cljs.core.apply.call(null,cljs.core.hash_map,map__384317):map__384317);var path = map__384317__$1;var l = cljs.core.get.call(null,map__384317__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__384317__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__13967__auto__ = path;if(cljs.core.truth_(and__13967__auto__))
{return cljs.core.seq.call(null,l);
} else
{return and__13967__auto__;
}
...
* without moving
*/
clojure.zip.insert_left = (function insert_left(loc,item){var vec__384320 = loc;var node = cljs.core.nth.call(null,vec__384320,0,null);var map__384321 = cljs.core.nth.call(null,vec__384320,1,null);var map__384321__$1 = ((cljs.core.seq_QMARK_.call(null,map__384321))?cljs.core.apply.call(null,cljs.core.hash_map,map__384321):map__384321);var path = map__384321__$1;var l = cljs.core.get.call(null,map__384321__$1,new cljs.core.Keyword(null,"l","l",1013904350));if((path == null))
{throw "Insert at top";
} else
...
* without moving
*/
clojure.zip.insert_right = (function insert_right(loc,item){var vec__384324 = loc;var node = cljs.core.nth.call(null,vec__384324,0,null);var map__384325 = cljs.core.nth.call(null,vec__384324,1,null);var map__384325__$1 = ((cljs.core.seq_QMARK_.call(null,map__384325))?cljs.core.apply.call(null,cljs.core.hash_map,map__384325):map__384325);var path = map__384325__$1;var r = cljs.core.get.call(null,map__384325__$1,new cljs.core.Keyword(null,"r","r",1013904356));if((path == null))
{throw "Insert at top";
} else
...
*/
clojure.zip.replace = (function replace(loc,node){var vec__384327 = loc;var _ = cljs.core.nth.call(null,vec__384327,0,null);var path = cljs.core.nth.call(null,vec__384327,1,null);return cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [node,cljs.core.assoc.call(null,path,new cljs.core.Keyword(null,"changed?","changed?",2446321533),true)], null),cljs.core.meta.call(null,loc));
});
/**
...
edit.cljs$lang$applyTo = (function (arglist__384328){
var loc = cljs.core.first(arglist__384328);
arglist__384328 = cljs.core.next(arglist__384328);
var f = cljs.core.first(arglist__384328);
var args = cljs.core.rest(arglist__384328);
...
{{
var G__384329 = clojure.zip.up.call(null,p);
p = G__384329;
continue;
}
}
...
var G__384330 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__384330;
continue;
}
} else
...
*/
clojure.zip.remove = (function remove(loc){var vec__384333 = loc;var node = cljs.core.nth.call(null,vec__384333,0,null);var map__384334 = cljs.core.nth.call(null,vec__384333,1,null);var map__384334__$1 = ((cljs.core.seq_QMARK_.call(null,map__384334))?cljs.core.apply.call(null,cljs.core.hash_map,map__384334):map__384334);var path = map__384334__$1;var l = cljs.core.get.call(null,map__384334__$1,new cljs.core.Keyword(null,"l","l",1013904350));var ppath = cljs.core.get.call(null,map__384334__$1,new cljs.core.Keyword(null,"ppath","ppath",1120772103));var pnodes = cljs.core.get.call(null,map__384334__$1,new cljs.core.Keyword(null,"pnodes","pnodes",4325362611));var rs = cljs.core.get.call(null,map__384334__$1,new cljs.core.Keyword(null,"r","r",1013904356));if((path == null))
{throw "Remove at top";
} else
...
var G__384335 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__384335;
continue;
}
} else
