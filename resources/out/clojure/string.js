...
{{
var G__363645 = cljs.core.pop.call(null,v__$1);
v__$1 = G__363645;
continue;
}
} else
...
{var pred__363649 = cljs.core._EQ_;var expr__363650 = limit;if(cljs.core.truth_(pred__363649.call(null,1,expr__363650)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__363649.call(null,2,expr__363650)))
...
var G__363652 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__363653 = (limit__$1 - 1);
var G__363654 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__363652;
limit__$1 = G__363653;
parts = G__363654;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___363656 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___363656))
{var replacement_363657 = temp__4090__auto___363656;buffer.append([cljs.core.str(replacement_363657)].join(''));
} else
{buffer.append(ch);
}
{
var G__363658 = (index + 1);
index = G__363658;
continue;
}
}
