...
{{
var G__31620 = cljs.core.pop.call(null,v__$1);
v__$1 = G__31620;
continue;
}
} else
...
{var pred__31624 = cljs.core._EQ_;var expr__31625 = limit;if(cljs.core.truth_(pred__31624.call(null,1,expr__31625)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__31624.call(null,2,expr__31625)))
...
var G__31627 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__31628 = (limit__$1 - 1);
var G__31629 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__31627;
limit__$1 = G__31628;
parts = G__31629;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___31631 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___31631))
{var replacement_31632 = temp__4090__auto___31631;buffer.append([cljs.core.str(replacement_31632)].join(''));
} else
{buffer.append(ch);
}
{
var G__31633 = (index + 1);
index = G__31633;
continue;
}
}
