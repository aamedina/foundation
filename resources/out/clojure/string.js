...
{{
var G__336196 = cljs.core.pop.call(null,v__$1);
v__$1 = G__336196;
continue;
}
} else
...
{var pred__336200 = cljs.core._EQ_;var expr__336201 = limit;if(cljs.core.truth_(pred__336200.call(null,1,expr__336201)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__336200.call(null,2,expr__336201)))
...
var G__336203 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__336204 = (limit__$1 - 1);
var G__336205 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__336203;
limit__$1 = G__336204;
parts = G__336205;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___336207 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___336207))
{var replacement_336208 = temp__4090__auto___336207;buffer.append([cljs.core.str(replacement_336208)].join(''));
} else
{buffer.append(ch);
}
{
var G__336209 = (index + 1);
index = G__336209;
continue;
}
}
