...
{{
var G__88157 = cljs.core.pop.call(null,v__$1);
v__$1 = G__88157;
continue;
}
} else
...
{var pred__88161 = cljs.core._EQ_;var expr__88162 = limit;if(cljs.core.truth_(pred__88161.call(null,1,expr__88162)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__88161.call(null,2,expr__88162)))
...
var G__88164 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__88165 = (limit__$1 - 1);
var G__88166 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__88164;
limit__$1 = G__88165;
parts = G__88166;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___88168 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___88168))
{var replacement_88169 = temp__4090__auto___88168;buffer.append([cljs.core.str(replacement_88169)].join(''));
} else
{buffer.append(ch);
}
{
var G__88170 = (index + 1);
index = G__88170;
continue;
}
}
