...
{{
var G__27891 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27891;
continue;
}
} else
...
{var pred__27895 = cljs.core._EQ_;var expr__27896 = limit;if(cljs.core.truth_(pred__27895.call(null,1,expr__27896)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__27895.call(null,2,expr__27896)))
...
var G__27898 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__27899 = (limit__$1 - 1);
var G__27900 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__27898;
limit__$1 = G__27899;
parts = G__27900;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___27902 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___27902))
{var replacement_27903 = temp__4096__auto___27902;buffer.append([cljs.core.str(replacement_27903)].join(''));
} else
{buffer.append(ch);
}
{
var G__27904 = (index + 1);
index = G__27904;
continue;
}
}
