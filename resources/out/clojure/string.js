...
{{
var G__327019 = cljs.core.pop.call(null,v__$1);
v__$1 = G__327019;
continue;
}
} else
...
{var pred__327023 = cljs.core._EQ_;var expr__327024 = limit;if(cljs.core.truth_(pred__327023.call(null,1,expr__327024)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__327023.call(null,2,expr__327024)))
...
var G__327026 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__327027 = (limit__$1 - 1);
var G__327028 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__327026;
limit__$1 = G__327027;
parts = G__327028;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___327030 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___327030))
{var replacement_327031 = temp__4090__auto___327030;buffer.append([cljs.core.str(replacement_327031)].join(''));
} else
{buffer.append(ch);
}
{
var G__327032 = (index + 1);
index = G__327032;
continue;
}
}
