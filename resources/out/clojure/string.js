...
{{
var G__39457 = cljs.core.pop.call(null,v__$1);
v__$1 = G__39457;
continue;
}
} else
...
{var pred__39461 = cljs.core._EQ_;var expr__39462 = limit;if(cljs.core.truth_(pred__39461.call(null,1,expr__39462)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__39461.call(null,2,expr__39462)))
...
var G__39464 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__39465 = (limit__$1 - 1);
var G__39466 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__39464;
limit__$1 = G__39465;
parts = G__39466;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___39468 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___39468))
{var replacement_39469 = temp__4090__auto___39468;buffer.append([cljs.core.str(replacement_39469)].join(''));
} else
{buffer.append(ch);
}
{
var G__39470 = (index + 1);
index = G__39470;
continue;
}
}
