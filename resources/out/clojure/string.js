...
{{
var G__26212 = cljs.core.pop.call(null,v__$1);
v__$1 = G__26212;
continue;
}
} else
...
{var pred__26216 = cljs.core._EQ_;var expr__26217 = limit;if(cljs.core.truth_(pred__26216.call(null,1,expr__26217)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__26216.call(null,2,expr__26217)))
...
var G__26219 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__26220 = (limit__$1 - 1);
var G__26221 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__26219;
limit__$1 = G__26220;
parts = G__26221;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___26223 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___26223))
{var replacement_26224 = temp__4096__auto___26223;buffer.append([cljs.core.str(replacement_26224)].join(''));
} else
{buffer.append(ch);
}
{
var G__26225 = (index + 1);
index = G__26225;
continue;
}
}
