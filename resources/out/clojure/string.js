...
{{
var G__32409 = cljs.core.pop.call(null,v__$1);
v__$1 = G__32409;
continue;
}
} else
...
{var pred__32413 = cljs.core._EQ_;var expr__32414 = limit;if(cljs.core.truth_(pred__32413.call(null,1,expr__32414)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__32413.call(null,2,expr__32414)))
...
var G__32416 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__32417 = (limit__$1 - 1);
var G__32418 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__32416;
limit__$1 = G__32417;
parts = G__32418;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___32420 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___32420))
{var replacement_32421 = temp__4090__auto___32420;buffer.append([cljs.core.str(replacement_32421)].join(''));
} else
{buffer.append(ch);
}
{
var G__32422 = (index + 1);
index = G__32422;
continue;
}
}
