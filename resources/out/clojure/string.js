...
{{
var G__297369 = cljs.core.pop.call(null,v__$1);
v__$1 = G__297369;
continue;
}
} else
...
{var pred__297373 = cljs.core._EQ_;var expr__297374 = limit;if(cljs.core.truth_(pred__297373.call(null,1,expr__297374)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__297373.call(null,2,expr__297374)))
...
var G__297376 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__297377 = (limit__$1 - 1);
var G__297378 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__297376;
limit__$1 = G__297377;
parts = G__297378;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___297380 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___297380))
{var replacement_297381 = temp__4090__auto___297380;buffer.append([cljs.core.str(replacement_297381)].join(''));
} else
{buffer.append(ch);
}
{
var G__297382 = (index + 1);
index = G__297382;
continue;
}
}
