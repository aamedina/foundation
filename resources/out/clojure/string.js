...
{{
var G__324554 = cljs.core.pop.call(null,v__$1);
v__$1 = G__324554;
continue;
}
} else
...
{var pred__324558 = cljs.core._EQ_;var expr__324559 = limit;if(cljs.core.truth_(pred__324558.call(null,1,expr__324559)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__324558.call(null,2,expr__324559)))
...
var G__324561 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__324562 = (limit__$1 - 1);
var G__324563 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__324561;
limit__$1 = G__324562;
parts = G__324563;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___324565 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___324565))
{var replacement_324566 = temp__4090__auto___324565;buffer.append([cljs.core.str(replacement_324566)].join(''));
} else
{buffer.append(ch);
}
{
var G__324567 = (index + 1);
index = G__324567;
continue;
}
}
