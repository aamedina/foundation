...
{{
var G__100302 = cljs.core.pop.call(null,v__$1);
v__$1 = G__100302;
continue;
}
} else
...
{var pred__100306 = cljs.core._EQ_;var expr__100307 = limit;if(cljs.core.truth_(pred__100306.call(null,1,expr__100307)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__100306.call(null,2,expr__100307)))
...
var G__100309 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__100310 = (limit__$1 - 1);
var G__100311 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__100309;
limit__$1 = G__100310;
parts = G__100311;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___100313 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___100313))
{var replacement_100314 = temp__4090__auto___100313;buffer.append([cljs.core.str(replacement_100314)].join(''));
} else
{buffer.append(ch);
}
{
var G__100315 = (index + 1);
index = G__100315;
continue;
}
}
