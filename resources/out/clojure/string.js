...
{{
var G__14724 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14724;
continue;
}
} else
...
{var pred__14728 = cljs.core._EQ_;var expr__14729 = limit;if(cljs.core.truth_(pred__14728.call(null,1,expr__14729)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14728.call(null,2,expr__14729)))
...
var G__14731 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14732 = (limit__$1 - 1);
var G__14733 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14731;
limit__$1 = G__14732;
parts = G__14733;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14735 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14735))
{var replacement_14736 = temp__4090__auto___14735;buffer.append([cljs.core.str(replacement_14736)].join(''));
} else
{buffer.append(ch);
}
{
var G__14737 = (index + 1);
index = G__14737;
continue;
}
}
