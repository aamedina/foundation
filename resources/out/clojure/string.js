...
{{
var G__31841 = cljs.core.pop.call(null,v__$1);
v__$1 = G__31841;
continue;
}
} else
...
{var pred__31845 = cljs.core._EQ_;var expr__31846 = limit;if(cljs.core.truth_(pred__31845.call(null,1,expr__31846)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__31845.call(null,2,expr__31846)))
...
var G__31848 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__31849 = (limit__$1 - 1);
var G__31850 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__31848;
limit__$1 = G__31849;
parts = G__31850;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___31852 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___31852))
{var replacement_31853 = temp__4090__auto___31852;buffer.append([cljs.core.str(replacement_31853)].join(''));
} else
{buffer.append(ch);
}
{
var G__31854 = (index + 1);
index = G__31854;
continue;
}
}
