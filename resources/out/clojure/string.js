...
{{
var G__632424 = cljs.core.pop.call(null,v__$1);
v__$1 = G__632424;
continue;
}
} else
...
{var pred__632428 = cljs.core._EQ_;var expr__632429 = limit;if(cljs.core.truth_(pred__632428.call(null,1,expr__632429)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__632428.call(null,2,expr__632429)))
...
var G__632431 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__632432 = (limit__$1 - 1);
var G__632433 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__632431;
limit__$1 = G__632432;
parts = G__632433;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___632435 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___632435))
{var replacement_632436 = temp__4096__auto___632435;buffer.append([cljs.core.str(replacement_632436)].join(''));
} else
{buffer.append(ch);
}
{
var G__632437 = (index + 1);
index = G__632437;
continue;
}
}
