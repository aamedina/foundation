...
{{
var G__81367 = cljs.core.pop.call(null,v__$1);
v__$1 = G__81367;
continue;
}
} else
...
{var pred__81371 = cljs.core._EQ_;var expr__81372 = limit;if(cljs.core.truth_(pred__81371.call(null,1,expr__81372)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__81371.call(null,2,expr__81372)))
...
var G__81374 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__81375 = (limit__$1 - 1);
var G__81376 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__81374;
limit__$1 = G__81375;
parts = G__81376;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___81378 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___81378))
{var replacement_81379 = temp__4090__auto___81378;buffer.append([cljs.core.str(replacement_81379)].join(''));
} else
{buffer.append(ch);
}
{
var G__81380 = (index + 1);
index = G__81380;
continue;
}
}
