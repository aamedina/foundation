...
{{
var G__31772 = cljs.core.pop.call(null,v__$1);
v__$1 = G__31772;
continue;
}
} else
...
{var pred__31776 = cljs.core._EQ_;var expr__31777 = limit;if(cljs.core.truth_(pred__31776.call(null,1,expr__31777)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__31776.call(null,2,expr__31777)))
...
var G__31779 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__31780 = (limit__$1 - 1);
var G__31781 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__31779;
limit__$1 = G__31780;
parts = G__31781;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___31783 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___31783))
{var replacement_31784 = temp__4096__auto___31783;buffer.append([cljs.core.str(replacement_31784)].join(''));
} else
{buffer.append(ch);
}
{
var G__31785 = (index + 1);
index = G__31785;
continue;
}
}
