...
{return cljs.core.reduce.call(null,(function (result,p__26440){var vec__26441 = p__26440;var k = cljs.core.nth.call(null,vec__26441,0,null);var v = cljs.core.nth.call(null,vec__26441,1,null);return cljs.core.assoc.call(null,result,k,v);
...
*/
clojure.data.diff_associative_key = (function diff_associative_key(a,b,k){var va = cljs.core.get.call(null,a,k);var vb = cljs.core.get.call(null,b,k);var vec__26443 = clojure.data.diff.call(null,va,vb);var a_STAR_ = cljs.core.nth.call(null,vec__26443,0,null);var b_STAR_ = cljs.core.nth.call(null,vec__26443,1,null);var ab = cljs.core.nth.call(null,vec__26443,2,null);var in_a = cljs.core.contains_QMARK_.call(null,a,k);var in_b = cljs.core.contains_QMARK_.call(null,b,k);var same = (in_a) && (in_b) && ((!((ab == null))) || (((va == null)) && ((vb == null))));return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((in_a) && ((!((a_STAR_ == null))) || (!(same))))?new cljs.core.PersistentArrayMap.fromArray([k,a_STAR_], true, false):null),(((in_b) && ((!((b_STAR_ == null))) || (!(same))))?new cljs.core.PersistentArrayMap.fromArray([k,b_STAR_], true, false):null),((same)?new cljs.core.PersistentArrayMap.fromArray([k,ab], true, false):null)], null);
});
/**
...
clojure.data.EqualityPartition = (function (){var obj26445 = {};return obj26445;
})();
...
clojure.data.Diff = (function (){var obj26447 = {};return obj26447;
})();
...
(clojure.data.equality_partition["_"] = (function (x){if((function (){var G__26448 = x;if(G__26448)
{var bit__8356__auto__ = (G__26448.cljs$lang$protocol_mask$partition0$ & 1024);if((bit__8356__auto__) || (G__26448.cljs$core$IMap$))
{return true;
} else
{if((!G__26448.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__26448);
} else
{return false;
}
}
...
{if((function (){var G__26449 = x;if(G__26449)
{var bit__8356__auto__ = (G__26449.cljs$lang$protocol_mask$partition0$ & 4096);if((bit__8356__auto__) || (G__26449.cljs$core$ISet$))
{return true;
} else
{if((!G__26449.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISet,G__26449);
} else
{return false;
}
}
...
{if((function (){var G__26450 = x;if(G__26450)
{var bit__8356__auto__ = (G__26450.cljs$lang$protocol_mask$partition0$ & 16777216);if((bit__8356__auto__) || (G__26450.cljs$core$ISequential$))
{return true;
} else
{if((!G__26450.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISequential,G__26450);
} else
{return false;
}
}
...
(clojure.data.diff_similar["_"] = (function (a,b){return (function (){var G__26451 = clojure.data.equality_partition.call(null,a);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"map","map",1014012110),G__26451))
{return clojure.data.diff_associative;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"sequential","sequential",849892465),G__26451))
{return clojure.data.diff_sequential;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"set","set",1014018004),G__26451))
{return clojure.data.diff_set;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"atom","atom",1016908995),G__26451))
