...
var assoc_in_cache_BANG___delegate = function (k,v,p__29052){var map__29055 = p__29052;var map__29055__$1 = ((cljs.core.seq_QMARK_.call(null,map__29055))?cljs.core.apply.call(null,cljs.core.hash_map,map__29055):map__29055);var expiry = cljs.core.get.call(null,map__29055__$1,new cljs.core.Keyword(null,"expiry","expiry",4019712165));try{return foundation.app.xhr.localstorage.set(cljs.core.name.call(null,k),cljs.core.pr_str.call(null,v),expiry);
}catch (e29056){if((e29056 instanceof Error))
{var e = e29056;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e29056;
} else
...
var p__29052 = null;if (arguments.length > 2) {
  p__29052 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return assoc_in_cache_BANG___delegate.call(this,k,v,p__29052);};
assoc_in_cache_BANG_.cljs$lang$maxFixedArity = 2;
assoc_in_cache_BANG_.cljs$lang$applyTo = (function (arglist__29057){
var k = cljs.core.first(arglist__29057);
arglist__29057 = cljs.core.next(arglist__29057);
var v = cljs.core.first(arglist__29057);
var p__29052 = cljs.core.rest(arglist__29057);
return assoc_in_cache_BANG___delegate(k,v,p__29052);
});
...
foundation.app.xhr.clojurify_keys = (function clojurify_keys(m){var f = (function (p__29060){var vec__29061 = p__29060;var k = cljs.core.nth.call(null,vec__29061,0,null);var v = cljs.core.nth.call(null,vec__29061,1,null);if(typeof k === 'string')
...
{try{foundation.app.xhr.xhr_pool.send(uri,uri,method,(((!(typeof content === 'string')) && (!((content == null))))?foundation.app.xhr.stringify.call(null,content):content),cljs.core.clj__GT_js.call(null,headers),50,(function (p1__29068_SHARP_){cljs.core.async.put_BANG_.call(null,c,foundation.app.xhr.handle_response.call(null,p1__29068_SHARP_.target));
...
}catch (e29070){if((e29070 instanceof Error))
{var e = e29070;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e29070;
} else
...
var GET__delegate = function (uri,p__29071){var map__29073 = p__29071;var map__29073__$1 = ((cljs.core.seq_QMARK_.call(null,map__29073))?cljs.core.apply.call(null,cljs.core.hash_map,map__29073):map__29073);var headers = cljs.core.get.call(null,map__29073__$1,new cljs.core.Keyword(null,"headers","headers",1809212152));return foundation.app.xhr.xhr.call(null,uri,"GET",null,cljs.core.merge.call(null,foundation.app.xhr._STAR_headers_STAR_,headers));
};
var GET = function (uri,var_args){
var p__29071 = null;if (arguments.length > 1) {
  p__29071 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return GET__delegate.call(this,uri,p__29071);};
GET.cljs$lang$maxFixedArity = 1;
GET.cljs$lang$applyTo = (function (arglist__29074){
var uri = cljs.core.first(arglist__29074);
var p__29071 = cljs.core.rest(arglist__29074);
return GET__delegate(uri,p__29071);
});
...
var POST__delegate = function (uri,p__29075){var map__29077 = p__29075;var map__29077__$1 = ((cljs.core.seq_QMARK_.call(null,map__29077))?cljs.core.apply.call(null,cljs.core.hash_map,map__29077):map__29077);var headers = cljs.core.get.call(null,map__29077__$1,new cljs.core.Keyword(null,"headers","headers",1809212152),cljs.core.PersistentArrayMap.EMPTY);var body = cljs.core.get.call(null,map__29077__$1,new cljs.core.Keyword(null,"body","body",1016933652),null);return foundation.app.xhr.xhr.call(null,uri,"POST",body,cljs.core.merge.call(null,foundation.app.xhr._STAR_headers_STAR_,headers));
};
var POST = function (uri,var_args){
var p__29075 = null;if (arguments.length > 1) {
  p__29075 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return POST__delegate.call(this,uri,p__29075);};
POST.cljs$lang$maxFixedArity = 1;
POST.cljs$lang$applyTo = (function (arglist__29078){
var uri = cljs.core.first(arglist__29078);
var p__29075 = cljs.core.rest(arglist__29078);
return POST__delegate(uri,p__29075);
});
...
var PUT__delegate = function (uri,p__29079){var map__29081 = p__29079;var map__29081__$1 = ((cljs.core.seq_QMARK_.call(null,map__29081))?cljs.core.apply.call(null,cljs.core.hash_map,map__29081):map__29081);var headers = cljs.core.get.call(null,map__29081__$1,new cljs.core.Keyword(null,"headers","headers",1809212152),cljs.core.PersistentArrayMap.EMPTY);var body = cljs.core.get.call(null,map__29081__$1,new cljs.core.Keyword(null,"body","body",1016933652),null);return foundation.app.xhr.xhr.call(null,uri,"PUT",body,cljs.core.merge.call(null,foundation.app.xhr._STAR_headers_STAR_,headers));
};
var PUT = function (uri,var_args){
var p__29079 = null;if (arguments.length > 1) {
  p__29079 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return PUT__delegate.call(this,uri,p__29079);};
PUT.cljs$lang$maxFixedArity = 1;
PUT.cljs$lang$applyTo = (function (arglist__29082){
var uri = cljs.core.first(arglist__29082);
var p__29079 = cljs.core.rest(arglist__29082);
return PUT__delegate(uri,p__29079);
});
...
var DELETE__delegate = function (uri,p__29083){var map__29085 = p__29083;var map__29085__$1 = ((cljs.core.seq_QMARK_.call(null,map__29085))?cljs.core.apply.call(null,cljs.core.hash_map,map__29085):map__29085);var headers = cljs.core.get.call(null,map__29085__$1,new cljs.core.Keyword(null,"headers","headers",1809212152),cljs.core.PersistentArrayMap.EMPTY);var body = cljs.core.get.call(null,map__29085__$1,new cljs.core.Keyword(null,"body","body",1016933652),null);return foundation.app.xhr.xhr.call(null,uri,"DELETE",null,cljs.core.merge.call(null,foundation.app.xhr._STAR_headers_STAR_,headers));
};
var DELETE = function (uri,var_args){
var p__29083 = null;if (arguments.length > 1) {
  p__29083 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return DELETE__delegate.call(this,uri,p__29083);};
DELETE.cljs$lang$maxFixedArity = 1;
DELETE.cljs$lang$applyTo = (function (arglist__29086){
var uri = cljs.core.first(arglist__29086);
var p__29083 = cljs.core.rest(arglist__29086);
return DELETE__delegate(uri,p__29083);
});
