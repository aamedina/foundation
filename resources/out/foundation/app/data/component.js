...
goog.require('foundation.app.data.dependency');
foundation.app.data.component.Lifecycle = (function (){var obj17712 = {};return obj17712;
})();
foundation.app.data.component.start = (function start(component){if((function (){var and__15129__auto__ = component;if(and__15129__auto__)
...
{var x__15744__auto__ = (((component == null))?null:component);return (function (){var or__15141__auto__ = (foundation.app.data.component.start[goog.typeOf(x__15744__auto__)]);if(or__15141__auto__)
{return or__15141__auto__;
} else
{var or__15141__auto____$1 = (foundation.app.data.component.start["_"]);if(or__15141__auto____$1)
...
foundation.app.data.component.stop = (function stop(component){if((function (){var and__15129__auto__ = component;if(and__15129__auto__)
...
{var x__15744__auto__ = (((component == null))?null:component);return (function (){var or__15141__auto__ = (foundation.app.data.component.stop[goog.typeOf(x__15744__auto__)]);if(or__15141__auto__)
{return or__15141__auto__;
} else
{var or__15141__auto____$1 = (foundation.app.data.component.stop["_"]);if(or__15141__auto____$1)
{return or__15141__auto____$1;
} else
...
*/
foundation.app.data.component.dependency_graph = (function dependency_graph(system,component_keys){return cljs.core.reduce_kv.call(null,(function (graph,key,component){return cljs.core.reduce.call(null,(function (p1__17713_SHARP_,p2__17714_SHARP_){return foundation.app.data.dependency.depend.call(null,p1__17713_SHARP_,key,p2__17714_SHARP_);
...
foundation.app.data.component.assoc_dependencies = (function assoc_dependencies(component,system){return cljs.core.reduce_kv.call(null,(function (p1__17715_SHARP_,p2__17716_SHARP_,p3__17717_SHARP_){return foundation.app.data.component.assoc_dependency.call(null,system,p1__17715_SHARP_,p2__17716_SHARP_,p3__17717_SHARP_);
...
foundation.app.data.component.get_component = (function get_component(system,key){var or__15141__auto__ = cljs.core.get.call(null,system,key);if(cljs.core.truth_(or__15141__auto__))
{return or__15141__auto__;
} else
{throw cljs.core.ex_info.call(null,"Missing component from system",new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"reason","reason",4373906870),new cljs.core.Keyword("foundation.app.data.component","missing-component","foundation.app.data.component/missing-component",3557566423),new cljs.core.Keyword(null,"component-key","component-key",2719177985),key,new cljs.core.Keyword(null,"system","system",4421543329),system], null));
}
...
update_system.cljs$lang$applyTo = (function (arglist__17720){
var system = cljs.core.first(arglist__17720);
arglist__17720 = cljs.core.next(arglist__17720);
var component_keys = cljs.core.first(arglist__17720);
arglist__17720 = cljs.core.next(arglist__17720);
var f = cljs.core.first(arglist__17720);
var args = cljs.core.rest(arglist__17720);
...
update_system_reverse.cljs$lang$applyTo = (function (arglist__17721){
var system = cljs.core.first(arglist__17721);
arglist__17721 = cljs.core.next(arglist__17721);
var component_keys = cljs.core.first(arglist__17721);
arglist__17721 = cljs.core.next(arglist__17721);
