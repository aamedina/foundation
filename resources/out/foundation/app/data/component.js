...
goog.require('foundation.app.data.dependency');
foundation.app.data.component.Lifecycle = (function (){var obj96262 = {};return obj96262;
})();
foundation.app.data.component.start = (function start(component){if((function (){var and__13810__auto__ = component;if(and__13810__auto__)
...
{var x__14425__auto__ = (((component == null))?null:component);return (function (){var or__13822__auto__ = (foundation.app.data.component.start[goog.typeOf(x__14425__auto__)]);if(or__13822__auto__)
{return or__13822__auto__;
} else
{var or__13822__auto____$1 = (foundation.app.data.component.start["_"]);if(or__13822__auto____$1)
...
foundation.app.data.component.stop = (function stop(component){if((function (){var and__13810__auto__ = component;if(and__13810__auto__)
...
{var x__14425__auto__ = (((component == null))?null:component);return (function (){var or__13822__auto__ = (foundation.app.data.component.stop[goog.typeOf(x__14425__auto__)]);if(or__13822__auto__)
{return or__13822__auto__;
} else
{var or__13822__auto____$1 = (foundation.app.data.component.stop["_"]);if(or__13822__auto____$1)
{return or__13822__auto____$1;
} else
...
*/
foundation.app.data.component.dependency_graph = (function dependency_graph(system,component_keys){return cljs.core.reduce_kv.call(null,(function (graph,key,component){return cljs.core.reduce.call(null,(function (p1__96263_SHARP_,p2__96264_SHARP_){return foundation.app.data.dependency.depend.call(null,p1__96263_SHARP_,key,p2__96264_SHARP_);
...
foundation.app.data.component.assoc_dependencies = (function assoc_dependencies(component,system){return cljs.core.reduce_kv.call(null,(function (p1__96265_SHARP_,p2__96266_SHARP_,p3__96267_SHARP_){return foundation.app.data.component.assoc_dependency.call(null,system,p1__96265_SHARP_,p2__96266_SHARP_,p3__96267_SHARP_);
...
foundation.app.data.component.get_component = (function get_component(system,key){var or__13822__auto__ = cljs.core.get.call(null,system,key);if(cljs.core.truth_(or__13822__auto__))
{return or__13822__auto__;
} else
{throw cljs.core.ex_info.call(null,"Missing component from system",new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"reason","reason",4373906870),new cljs.core.Keyword("foundation.app.data.component","missing-component","foundation.app.data.component/missing-component",3557566423),new cljs.core.Keyword(null,"component-key","component-key",2719177985),key,new cljs.core.Keyword(null,"system","system",4421543329),system], null));
}
...
update_system.cljs$lang$applyTo = (function (arglist__96270){
var system = cljs.core.first(arglist__96270);
arglist__96270 = cljs.core.next(arglist__96270);
var component_keys = cljs.core.first(arglist__96270);
arglist__96270 = cljs.core.next(arglist__96270);
var f = cljs.core.first(arglist__96270);
var args = cljs.core.rest(arglist__96270);
...
update_system_reverse.cljs$lang$applyTo = (function (arglist__96271){
var system = cljs.core.first(arglist__96271);
arglist__96271 = cljs.core.next(arglist__96271);
var component_keys = cljs.core.first(arglist__96271);
arglist__96271 = cljs.core.next(arglist__96271);
var f = cljs.core.first(arglist__96271);
var args = cljs.core.rest(arglist__96271);
