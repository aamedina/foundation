...
goog.require('foundation.app.data.dependency');
foundation.app.data.component.Lifecycle = (function (){var obj321287 = {};return obj321287;
})();
foundation.app.data.component.start = (function start(component){if((function (){var and__13813__auto__ = component;if(and__13813__auto__)
...
{var x__14428__auto__ = (((component == null))?null:component);return (function (){var or__13825__auto__ = (foundation.app.data.component.start[goog.typeOf(x__14428__auto__)]);if(or__13825__auto__)
{return or__13825__auto__;
} else
{var or__13825__auto____$1 = (foundation.app.data.component.start["_"]);if(or__13825__auto____$1)
...
foundation.app.data.component.stop = (function stop(component){if((function (){var and__13813__auto__ = component;if(and__13813__auto__)
...
{var x__14428__auto__ = (((component == null))?null:component);return (function (){var or__13825__auto__ = (foundation.app.data.component.stop[goog.typeOf(x__14428__auto__)]);if(or__13825__auto__)
{return or__13825__auto__;
} else
{var or__13825__auto____$1 = (foundation.app.data.component.stop["_"]);if(or__13825__auto____$1)
{return or__13825__auto____$1;
} else
...
*/
foundation.app.data.component.dependency_graph = (function dependency_graph(system,component_keys){return cljs.core.reduce_kv.call(null,(function (graph,key,component){return cljs.core.reduce.call(null,(function (p1__321288_SHARP_,p2__321289_SHARP_){return foundation.app.data.dependency.depend.call(null,p1__321288_SHARP_,key,p2__321289_SHARP_);
...
foundation.app.data.component.assoc_dependencies = (function assoc_dependencies(component,system){return cljs.core.reduce_kv.call(null,(function (p1__321290_SHARP_,p2__321291_SHARP_,p3__321292_SHARP_){return foundation.app.data.component.assoc_dependency.call(null,system,p1__321290_SHARP_,p2__321291_SHARP_,p3__321292_SHARP_);
...
foundation.app.data.component.get_component = (function get_component(system,key){var or__13825__auto__ = cljs.core.get.call(null,system,key);if(cljs.core.truth_(or__13825__auto__))
{return or__13825__auto__;
} else
{throw cljs.core.ex_info.call(null,"Missing component from system",new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"reason","reason",4373906870),new cljs.core.Keyword("foundation.app.data.component","missing-component","foundation.app.data.component/missing-component",3557566423),new cljs.core.Keyword(null,"component-key","component-key",2719177985),key,new cljs.core.Keyword(null,"system","system",4421543329),system], null));
}
...
update_system.cljs$lang$applyTo = (function (arglist__321295){
var system = cljs.core.first(arglist__321295);
arglist__321295 = cljs.core.next(arglist__321295);
var component_keys = cljs.core.first(arglist__321295);
arglist__321295 = cljs.core.next(arglist__321295);
var f = cljs.core.first(arglist__321295);
var args = cljs.core.rest(arglist__321295);
...
update_system_reverse.cljs$lang$applyTo = (function (arglist__321296){
var system = cljs.core.first(arglist__321296);
arglist__321296 = cljs.core.next(arglist__321296);
var component_keys = cljs.core.first(arglist__321296);
arglist__321296 = cljs.core.next(arglist__321296);
var f = cljs.core.first(arglist__321296);
var args = cljs.core.rest(arglist__321296);
