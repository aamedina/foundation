...
foundation.app.data.tracking_map.TrackingMap.cljs$lang$ctorPrWriter = (function (this__15685__auto__,writer__15686__auto__,opt__15687__auto__){return cljs.core._write.call(null,writer__15686__auto__,"foundation.app.data.tracking-map/TrackingMap");
});
...
var ___$1 = this;var temp__4096__auto__ = cljs.core._lookup.call(null,self__.map,k);if(cljs.core.truth_(temp__4096__auto__))
{var v = temp__4096__auto__;if((v instanceof foundation.app.data.tracking_map.TrackingMap))
...
var G__17745 = null;
var G__17745__2 = (function (self__,k){var self__ = this;
var self____$1 = this;var _ = self____$1;return cljs.core._lookup.call(null,self__.map,k);
});
var G__17745__3 = (function (self__,k,not_found){var self__ = this;
var self____$1 = this;var _ = self____$1;return cljs.core._lookup.call(null,self__.map,k,not_found);
});
G__17745 = function(self__,k,not_found){
switch(arguments.length){
case 2:
return G__17745__2.call(this,self__,k);
case 3:
return G__17745__3.call(this,self__,k,not_found);
}
...
;
foundation.app.data.tracking_map.TrackingMap.prototype.apply = (function (self__,args17744){var self__ = this;
var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone.call(null,args17744)));
});
...
foundation.app.data.tracking_map.record_change = (function record_change(action,map,key,val,change_map){var map__17747 = change_map;var map__17747__$1 = ((cljs.core.seq_QMARK_.call(null,map__17747))?cljs.core.apply.call(null,cljs.core.hash_map,map__17747):map__17747);var cs = map__17747__$1;var updated = cljs.core.get.call(null,map__17747__$1,new cljs.core.Keyword(null,"updated","updated",779473965));var context = cljs.core.get.call(null,map__17747__$1,new cljs.core.Keyword(null,"context","context",1965435169));var change = ((cljs.core.seq.call(null,context))?cljs.core.conj.call(null,context,key):new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [key], null));var cs__$1 = ((cljs.core._EQ_.call(null,action,new cljs.core.Keyword(null,"dissoc","dissoc",3977329067)))?cljs.core.update_in.call(null,cs,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"removed","removed",2105740242)], null),cljs.core.fnil.call(null,cljs.core.conj,cljs.core.PersistentHashSet.EMPTY),change):(cljs.core.truth_((function (){var and__15129__auto__ = cljs.core.get.call(null,map,key);if(cljs.core.truth_(and__15129__auto__))
