...
foundation.app.data.graph.DirectedGraph.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__14389__auto__,k321320,else__14390__auto__){var self__ = this;
var this__14389__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k321320,new cljs.core.Keyword(null,"nodes","nodes",1118897699)))
{return self__.nodes;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k321320,new cljs.core.Keyword(null,"neighbors","neighbors",1439078195)))
{return self__.neighbors;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k321320,else__14390__auto__);
} else
{return null;
}
}
...
foundation.app.data.graph.DirectedGraph.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__14394__auto__,k__14395__auto__,G__321319){var self__ = this;
var this__14394__auto____$1 = this;var pred__321322 = cljs.core.keyword_identical_QMARK_;var expr__321323 = k__14395__auto__;if(cljs.core.truth_(pred__321322.call(null,new cljs.core.Keyword(null,"nodes","nodes",1118897699),expr__321323)))
{return (new foundation.app.data.graph.DirectedGraph(G__321319,self__.neighbors,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__321322.call(null,new cljs.core.Keyword(null,"neighbors","neighbors",1439078195),expr__321323)))
{return (new foundation.app.data.graph.DirectedGraph(self__.nodes,G__321319,self__.__meta,self__.__extmap,null));
} else
{return (new foundation.app.data.graph.DirectedGraph(self__.nodes,self__.neighbors,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__14395__auto__,G__321319),null));
}
}
});
...
foundation.app.data.graph.DirectedGraph.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__14386__auto__,G__321319){var self__ = this;
var this__14386__auto____$1 = this;return (new foundation.app.data.graph.DirectedGraph(self__.nodes,self__.neighbors,G__321319,self__.__extmap,self__.__hash));
});
...
foundation.app.data.graph.map__GT_DirectedGraph = (function map__GT_DirectedGraph(G__321321){return (new foundation.app.data.graph.DirectedGraph(new cljs.core.Keyword(null,"nodes","nodes",1118897699).cljs$core$IFn$_invoke$arity$1(G__321321),new cljs.core.Keyword(null,"neighbors","neighbors",1439078195).cljs$core$IFn$_invoke$arity$1(G__321321),null,cljs.core.dissoc.call(null,G__321321,new cljs.core.Keyword(null,"nodes","nodes",1118897699),new cljs.core.Keyword(null,"neighbors","neighbors",1439078195))));
});
/**
...
*/
foundation.app.data.graph.post_ordered_visit = (function post_ordered_visit(g,n,p__321325){var vec__321328 = p__321325;var visited = cljs.core.nth.call(null,vec__321328,0,null);var acc = cljs.core.nth.call(null,vec__321328,1,null);var state = vec__321328;if(cljs.core.truth_(visited.call(null,n)))
{return state;
} else
{var vec__321329 = cljs.core.reduce.call(null,(function (st,nd){return post_ordered_visit.call(null,g,nd,st);
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.conj.call(null,visited,n),acc], null),foundation.app.data.graph.get_neighbors.call(null,g,n));var v2 = cljs.core.nth.call(null,vec__321329,0,null);var acc2 = cljs.core.nth.call(null,vec__321329,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [v2,cljs.core.conj.call(null,acc2,n)], null);
}
});
/**
* Return a sequence of indexes of a post-ordered walk of the graph.
*/
foundation.app.data.graph.post_ordered_nodes = (function post_ordered_nodes(g){return cljs.core.fnext.call(null,cljs.core.reduce.call(null,(function (p1__321331_SHARP_,p2__321330_SHARP_){return foundation.app.data.graph.post_ordered_visit.call(null,g,p2__321330_SHARP_,p1__321331_SHARP_);
...
{var vec__321333 = foundation.app.data.graph.post_ordered_visit.call(null,rev,cljs.core.first.call(null,stack),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [visited,cljs.core.PersistentHashSet.EMPTY], null));var nv = cljs.core.nth.call(null,vec__321333,0,null);var comp = cljs.core.nth.call(null,vec__321333,1,null);var ns = cljs.core.remove.call(null,nv,stack);{
var G__321334 = ns;
var G__321335 = nv;
var G__321336 = cljs.core.conj.call(null,acc,comp);
stack = G__321334;
visited = G__321335;
acc = G__321336;
continue;
...
var component_graph__2 = (function (g,sccs){var find_node_set = (function (n){return cljs.core.some.call(null,(function (p1__321337_SHARP_){if(cljs.core.truth_(p1__321337_SHARP_.call(null,n)))
{return p1__321337_SHARP_;
} else
{return null;
}
}),sccs);
...
{var n = cljs.core.first.call(null,ns);return cljs.core.some.call(null,(function (p1__321338_SHARP_){return cljs.core._EQ_.call(null,p1__321338_SHARP_,n);
...
{{
var G__321339 = new_data;
var G__321340 = (function (){var and__13813__auto__ = idx;if(cljs.core.truth_(and__13813__auto__))
{return (idx - 1);
} else
{return and__13813__auto__;
}
...
return (function (acc,p__321343){var vec__321344 = p__321343;var n = cljs.core.nth.call(null,vec__321344,0,null);var dep = cljs.core.nth.call(null,vec__321344,1,null);return cljs.core.assoc.call(null,acc,dep,cljs.core.conj.call(null,acc.call(null,dep),n));
});})(max))
...
return (function (p__321347){var vec__321348 = p__321347;var k = cljs.core.nth.call(null,vec__321348,0,null);var v = cljs.core.nth.call(null,vec__321348,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,update.call(null,k)], null);
});})(update))
,d));
...
return (function (p__321351){var vec__321352 = p__321351;var k = cljs.core.nth.call(null,vec__321352,0,null);var v = cljs.core.nth.call(null,vec__321352,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,update.call(null,k)], null);
});})(update))
,d));
