...
foundation.app.data.graph.DirectedGraph.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__14548__auto__,k378253,else__14549__auto__){var self__ = this;
var this__14548__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k378253,new cljs.core.Keyword(null,"nodes","nodes",1118897699)))
{return self__.nodes;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k378253,new cljs.core.Keyword(null,"neighbors","neighbors",1439078195)))
{return self__.neighbors;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k378253,else__14549__auto__);
} else
{return null;
}
}
...
foundation.app.data.graph.DirectedGraph.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__14553__auto__,k__14554__auto__,G__378252){var self__ = this;
var this__14553__auto____$1 = this;var pred__378255 = cljs.core.keyword_identical_QMARK_;var expr__378256 = k__14554__auto__;if(cljs.core.truth_(pred__378255.call(null,new cljs.core.Keyword(null,"nodes","nodes",1118897699),expr__378256)))
{return (new foundation.app.data.graph.DirectedGraph(G__378252,self__.neighbors,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__378255.call(null,new cljs.core.Keyword(null,"neighbors","neighbors",1439078195),expr__378256)))
{return (new foundation.app.data.graph.DirectedGraph(self__.nodes,G__378252,self__.__meta,self__.__extmap,null));
} else
{return (new foundation.app.data.graph.DirectedGraph(self__.nodes,self__.neighbors,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__14554__auto__,G__378252),null));
}
}
});
...
foundation.app.data.graph.DirectedGraph.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__14545__auto__,G__378252){var self__ = this;
var this__14545__auto____$1 = this;return (new foundation.app.data.graph.DirectedGraph(self__.nodes,self__.neighbors,G__378252,self__.__extmap,self__.__hash));
});
...
foundation.app.data.graph.map__GT_DirectedGraph = (function map__GT_DirectedGraph(G__378254){return (new foundation.app.data.graph.DirectedGraph(new cljs.core.Keyword(null,"nodes","nodes",1118897699).cljs$core$IFn$_invoke$arity$1(G__378254),new cljs.core.Keyword(null,"neighbors","neighbors",1439078195).cljs$core$IFn$_invoke$arity$1(G__378254),null,cljs.core.dissoc.call(null,G__378254,new cljs.core.Keyword(null,"nodes","nodes",1118897699),new cljs.core.Keyword(null,"neighbors","neighbors",1439078195))));
});
/**
...
*/
foundation.app.data.graph.post_ordered_visit = (function post_ordered_visit(g,n,p__378258){var vec__378261 = p__378258;var visited = cljs.core.nth.call(null,vec__378261,0,null);var acc = cljs.core.nth.call(null,vec__378261,1,null);var state = vec__378261;if(cljs.core.truth_(visited.call(null,n)))
{return state;
} else
{var vec__378262 = cljs.core.reduce.call(null,(function (st,nd){return post_ordered_visit.call(null,g,nd,st);
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.conj.call(null,visited,n),acc], null),foundation.app.data.graph.get_neighbors.call(null,g,n));var v2 = cljs.core.nth.call(null,vec__378262,0,null);var acc2 = cljs.core.nth.call(null,vec__378262,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [v2,cljs.core.conj.call(null,acc2,n)], null);
}
});
/**
* Return a sequence of indexes of a post-ordered walk of the graph.
*/
foundation.app.data.graph.post_ordered_nodes = (function post_ordered_nodes(g){return cljs.core.fnext.call(null,cljs.core.reduce.call(null,(function (p1__378264_SHARP_,p2__378263_SHARP_){return foundation.app.data.graph.post_ordered_visit.call(null,g,p2__378263_SHARP_,p1__378264_SHARP_);
...
{var vec__378266 = foundation.app.data.graph.post_ordered_visit.call(null,rev,cljs.core.first.call(null,stack),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [visited,cljs.core.PersistentHashSet.EMPTY], null));var nv = cljs.core.nth.call(null,vec__378266,0,null);var comp = cljs.core.nth.call(null,vec__378266,1,null);var ns = cljs.core.remove.call(null,nv,stack);{
var G__378267 = ns;
var G__378268 = nv;
var G__378269 = cljs.core.conj.call(null,acc,comp);
stack = G__378267;
visited = G__378268;
acc = G__378269;
continue;
...
var component_graph__2 = (function (g,sccs){var find_node_set = (function (n){return cljs.core.some.call(null,(function (p1__378270_SHARP_){if(cljs.core.truth_(p1__378270_SHARP_.call(null,n)))
{return p1__378270_SHARP_;
} else
{return null;
}
}),sccs);
...
{var n = cljs.core.first.call(null,ns);return cljs.core.some.call(null,(function (p1__378271_SHARP_){return cljs.core._EQ_.call(null,p1__378271_SHARP_,n);
...
{{
var G__378272 = new_data;
var G__378273 = (function (){var and__13967__auto__ = idx;if(cljs.core.truth_(and__13967__auto__))
{return (idx - 1);
} else
{return and__13967__auto__;
}
...
return (function (acc,p__378276){var vec__378277 = p__378276;var n = cljs.core.nth.call(null,vec__378277,0,null);var dep = cljs.core.nth.call(null,vec__378277,1,null);return cljs.core.assoc.call(null,acc,dep,cljs.core.conj.call(null,acc.call(null,dep),n));
});})(max))
...
return (function (p__378280){var vec__378281 = p__378280;var k = cljs.core.nth.call(null,vec__378281,0,null);var v = cljs.core.nth.call(null,vec__378281,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,update.call(null,k)], null);
});})(update))
,d));
...
return (function (p__378284){var vec__378285 = p__378284;var k = cljs.core.nth.call(null,vec__378285,0,null);var v = cljs.core.nth.call(null,vec__378285,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,update.call(null,k)], null);
});})(update))
,d));
