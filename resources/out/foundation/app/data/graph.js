...
foundation.app.data.graph.DirectedGraph.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__14548__auto__,k350937,else__14549__auto__){var self__ = this;
var this__14548__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k350937,new cljs.core.Keyword(null,"nodes","nodes",1118897699)))
{return self__.nodes;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k350937,new cljs.core.Keyword(null,"neighbors","neighbors",1439078195)))
{return self__.neighbors;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k350937,else__14549__auto__);
} else
{return null;
}
}
...
foundation.app.data.graph.DirectedGraph.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__14553__auto__,k__14554__auto__,G__350936){var self__ = this;
var this__14553__auto____$1 = this;var pred__350939 = cljs.core.keyword_identical_QMARK_;var expr__350940 = k__14554__auto__;if(cljs.core.truth_(pred__350939.call(null,new cljs.core.Keyword(null,"nodes","nodes",1118897699),expr__350940)))
{return (new foundation.app.data.graph.DirectedGraph(G__350936,self__.neighbors,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__350939.call(null,new cljs.core.Keyword(null,"neighbors","neighbors",1439078195),expr__350940)))
{return (new foundation.app.data.graph.DirectedGraph(self__.nodes,G__350936,self__.__meta,self__.__extmap,null));
} else
{return (new foundation.app.data.graph.DirectedGraph(self__.nodes,self__.neighbors,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__14554__auto__,G__350936),null));
}
}
});
...
foundation.app.data.graph.DirectedGraph.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__14545__auto__,G__350936){var self__ = this;
var this__14545__auto____$1 = this;return (new foundation.app.data.graph.DirectedGraph(self__.nodes,self__.neighbors,G__350936,self__.__extmap,self__.__hash));
});
...
foundation.app.data.graph.map__GT_DirectedGraph = (function map__GT_DirectedGraph(G__350938){return (new foundation.app.data.graph.DirectedGraph(new cljs.core.Keyword(null,"nodes","nodes",1118897699).cljs$core$IFn$_invoke$arity$1(G__350938),new cljs.core.Keyword(null,"neighbors","neighbors",1439078195).cljs$core$IFn$_invoke$arity$1(G__350938),null,cljs.core.dissoc.call(null,G__350938,new cljs.core.Keyword(null,"nodes","nodes",1118897699),new cljs.core.Keyword(null,"neighbors","neighbors",1439078195))));
});
/**
...
*/
foundation.app.data.graph.post_ordered_visit = (function post_ordered_visit(g,n,p__350942){var vec__350945 = p__350942;var visited = cljs.core.nth.call(null,vec__350945,0,null);var acc = cljs.core.nth.call(null,vec__350945,1,null);var state = vec__350945;if(cljs.core.truth_(visited.call(null,n)))
{return state;
} else
{var vec__350946 = cljs.core.reduce.call(null,(function (st,nd){return post_ordered_visit.call(null,g,nd,st);
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.conj.call(null,visited,n),acc], null),foundation.app.data.graph.get_neighbors.call(null,g,n));var v2 = cljs.core.nth.call(null,vec__350946,0,null);var acc2 = cljs.core.nth.call(null,vec__350946,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [v2,cljs.core.conj.call(null,acc2,n)], null);
}
});
/**
* Return a sequence of indexes of a post-ordered walk of the graph.
*/
foundation.app.data.graph.post_ordered_nodes = (function post_ordered_nodes(g){return cljs.core.fnext.call(null,cljs.core.reduce.call(null,(function (p1__350948_SHARP_,p2__350947_SHARP_){return foundation.app.data.graph.post_ordered_visit.call(null,g,p2__350947_SHARP_,p1__350948_SHARP_);
...
var component_graph__2 = (function (g,sccs){var find_node_set = (function (n){return cljs.core.some.call(null,(function (p1__350954_SHARP_){if(cljs.core.truth_(p1__350954_SHARP_.call(null,n)))
{return p1__350954_SHARP_;
} else
{return null;
}
}),sccs);
...
{var n = cljs.core.first.call(null,ns);return cljs.core.some.call(null,(function (p1__350955_SHARP_){return cljs.core._EQ_.call(null,p1__350955_SHARP_,n);
...
{{
var G__350956 = new_data;
var G__350957 = (function (){var and__13967__auto__ = idx;if(cljs.core.truth_(and__13967__auto__))
{return (idx - 1);
} else
{return and__13967__auto__;
}
...
return (function (acc,p__350960){var vec__350961 = p__350960;var n = cljs.core.nth.call(null,vec__350961,0,null);var dep = cljs.core.nth.call(null,vec__350961,1,null);return cljs.core.assoc.call(null,acc,dep,cljs.core.conj.call(null,acc.call(null,dep),n));
});})(max))
...
return (function (p__350964){var vec__350965 = p__350964;var k = cljs.core.nth.call(null,vec__350965,0,null);var v = cljs.core.nth.call(null,vec__350965,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,update.call(null,k)], null);
});})(update))
,d));
...
return (function (p__350968){var vec__350969 = p__350968;var k = cljs.core.nth.call(null,vec__350969,0,null);var v = cljs.core.nth.call(null,vec__350969,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,update.call(null,k)], null);
});})(update))
,d));
