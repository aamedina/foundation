...
var G__96587__delegate = function (v1,v2,v3,v4,vn){return foundation.app.data.rrb_vector.protocols._splicev.call(null,foundation.app.data.rrb_vector.protocols._splicev.call(null,foundation.app.data.rrb_vector.protocols._splicev.call(null,v1,v2),foundation.app.data.rrb_vector.protocols._splicev.call(null,v3,v4)),cljs.core.apply.call(null,catvec,vn));
};
var G__96587 = function (v1,v2,v3,v4,var_args){
var vn = null;if (arguments.length > 4) {
  vn = cljs.core.array_seq(Array.prototype.slice.call(arguments, 4),0);} 
return G__96587__delegate.call(this,v1,v2,v3,v4,vn);};
G__96587.cljs$lang$maxFixedArity = 4;
G__96587.cljs$lang$applyTo = (function (arglist__96588){
var v1 = cljs.core.first(arglist__96588);
arglist__96588 = cljs.core.next(arglist__96588);
var v2 = cljs.core.first(arglist__96588);
arglist__96588 = cljs.core.next(arglist__96588);
var v3 = cljs.core.first(arglist__96588);
arglist__96588 = cljs.core.next(arglist__96588);
var v4 = cljs.core.first(arglist__96588);
var vn = cljs.core.rest(arglist__96588);
return G__96587__delegate(v1,v2,v3,v4,vn);
});
G__96587.cljs$core$IFn$_invoke$arity$variadic = G__96587__delegate;
return G__96587;
})()
;
...
var vector = null;
var vector__0 = (function (){var arr__96594 = (new Array(0));return (new cljs.core.rrb_vector.rrbt.Vector(0,5,cljs.core.PersistentVector.EMPTY_NODE,arr__96594,null,0));
});
var vector__1 = (function (x1){var arr__96595 = (new Array(1));(arr__96595[0] = x1);
return (new cljs.core.rrb_vector.rrbt.Vector(1,5,cljs.core.PersistentVector.EMPTY_NODE,arr__96595,null,null));
});
var vector__2 = (function (x1,x2){var arr__96596 = (new Array(2));(arr__96596[0] = x1);
(arr__96596[1] = x2);
return (new cljs.core.rrb_vector.rrbt.Vector(2,5,cljs.core.PersistentVector.EMPTY_NODE,arr__96596,null,null));
});
var vector__3 = (function (x1,x2,x3){var arr__96597 = (new Array(3));(arr__96597[0] = x1);
(arr__96597[1] = x2);
(arr__96597[2] = x3);
return (new cljs.core.rrb_vector.rrbt.Vector(3,5,cljs.core.PersistentVector.EMPTY_NODE,arr__96597,null,null));
});
var vector__4 = (function (x1,x2,x3,x4){var arr__96598 = (new Array(4));(arr__96598[0] = x1);
(arr__96598[1] = x2);
(arr__96598[2] = x3);
(arr__96598[3] = x4);
return (new cljs.core.rrb_vector.rrbt.Vector(4,5,cljs.core.PersistentVector.EMPTY_NODE,arr__96598,null,null));
});
var vector__5 = (function() { 
var G__96599__delegate = function (x1,x2,x3,x4,xn){return cljs.core.into.call(null,vector.call(null,x1,x2,x3,x4),xn);
};
var G__96599 = function (x1,x2,x3,x4,var_args){
var xn = null;if (arguments.length > 4) {
  xn = cljs.core.array_seq(Array.prototype.slice.call(arguments, 4),0);} 
return G__96599__delegate.call(this,x1,x2,x3,x4,xn);};
G__96599.cljs$lang$maxFixedArity = 4;
G__96599.cljs$lang$applyTo = (function (arglist__96600){
var x1 = cljs.core.first(arglist__96600);
arglist__96600 = cljs.core.next(arglist__96600);
var x2 = cljs.core.first(arglist__96600);
arglist__96600 = cljs.core.next(arglist__96600);
var x3 = cljs.core.first(arglist__96600);
arglist__96600 = cljs.core.next(arglist__96600);
var x4 = cljs.core.first(arglist__96600);
var xn = cljs.core.rest(arglist__96600);
return G__96599__delegate(x1,x2,x3,x4,xn);
});
G__96599.cljs$core$IFn$_invoke$arity$variadic = G__96599__delegate;
return G__96599;
})()
;
