...
var G__333003__delegate = function (v1,v2,v3,v4,vn){return foundation.app.data.rrb_vector.protocols._splicev.call(null,foundation.app.data.rrb_vector.protocols._splicev.call(null,foundation.app.data.rrb_vector.protocols._splicev.call(null,v1,v2),foundation.app.data.rrb_vector.protocols._splicev.call(null,v3,v4)),cljs.core.apply.call(null,catvec,vn));
};
var G__333003 = function (v1,v2,v3,v4,var_args){
var vn = null;if (arguments.length > 4) {
  vn = cljs.core.array_seq(Array.prototype.slice.call(arguments, 4),0);} 
return G__333003__delegate.call(this,v1,v2,v3,v4,vn);};
G__333003.cljs$lang$maxFixedArity = 4;
G__333003.cljs$lang$applyTo = (function (arglist__333004){
var v1 = cljs.core.first(arglist__333004);
arglist__333004 = cljs.core.next(arglist__333004);
var v2 = cljs.core.first(arglist__333004);
arglist__333004 = cljs.core.next(arglist__333004);
var v3 = cljs.core.first(arglist__333004);
arglist__333004 = cljs.core.next(arglist__333004);
var v4 = cljs.core.first(arglist__333004);
var vn = cljs.core.rest(arglist__333004);
return G__333003__delegate(v1,v2,v3,v4,vn);
});
G__333003.cljs$core$IFn$_invoke$arity$variadic = G__333003__delegate;
return G__333003;
})()
;
...
var vector = null;
var vector__0 = (function (){var arr__333010 = (new Array(0));return (new cljs.core.rrb_vector.rrbt.Vector(0,5,cljs.core.PersistentVector.EMPTY_NODE,arr__333010,null,0));
});
var vector__1 = (function (x1){var arr__333011 = (new Array(1));(arr__333011[0] = x1);
return (new cljs.core.rrb_vector.rrbt.Vector(1,5,cljs.core.PersistentVector.EMPTY_NODE,arr__333011,null,null));
});
var vector__2 = (function (x1,x2){var arr__333012 = (new Array(2));(arr__333012[0] = x1);
(arr__333012[1] = x2);
return (new cljs.core.rrb_vector.rrbt.Vector(2,5,cljs.core.PersistentVector.EMPTY_NODE,arr__333012,null,null));
});
var vector__3 = (function (x1,x2,x3){var arr__333013 = (new Array(3));(arr__333013[0] = x1);
(arr__333013[1] = x2);
(arr__333013[2] = x3);
return (new cljs.core.rrb_vector.rrbt.Vector(3,5,cljs.core.PersistentVector.EMPTY_NODE,arr__333013,null,null));
});
var vector__4 = (function (x1,x2,x3,x4){var arr__333014 = (new Array(4));(arr__333014[0] = x1);
(arr__333014[1] = x2);
(arr__333014[2] = x3);
(arr__333014[3] = x4);
return (new cljs.core.rrb_vector.rrbt.Vector(4,5,cljs.core.PersistentVector.EMPTY_NODE,arr__333014,null,null));
});
var vector__5 = (function() { 
var G__333015__delegate = function (x1,x2,x3,x4,xn){return cljs.core.into.call(null,vector.call(null,x1,x2,x3,x4),xn);
};
var G__333015 = function (x1,x2,x3,x4,var_args){
var xn = null;if (arguments.length > 4) {
  xn = cljs.core.array_seq(Array.prototype.slice.call(arguments, 4),0);} 
return G__333015__delegate.call(this,x1,x2,x3,x4,xn);};
G__333015.cljs$lang$maxFixedArity = 4;
G__333015.cljs$lang$applyTo = (function (arglist__333016){
var x1 = cljs.core.first(arglist__333016);
arglist__333016 = cljs.core.next(arglist__333016);
var x2 = cljs.core.first(arglist__333016);
arglist__333016 = cljs.core.next(arglist__333016);
var x3 = cljs.core.first(arglist__333016);
arglist__333016 = cljs.core.next(arglist__333016);
var x4 = cljs.core.first(arglist__333016);
var xn = cljs.core.rest(arglist__333016);
return G__333015__delegate(x1,x2,x3,x4,xn);
});
G__333015.cljs$core$IFn$_invoke$arity$variadic = G__333015__delegate;
return G__333015;
})()
;
