...
var G__321612__delegate = function (v1,v2,v3,v4,vn){return foundation.app.data.rrb_vector.protocols._splicev.call(null,foundation.app.data.rrb_vector.protocols._splicev.call(null,foundation.app.data.rrb_vector.protocols._splicev.call(null,v1,v2),foundation.app.data.rrb_vector.protocols._splicev.call(null,v3,v4)),cljs.core.apply.call(null,catvec,vn));
};
var G__321612 = function (v1,v2,v3,v4,var_args){
var vn = null;if (arguments.length > 4) {
  vn = cljs.core.array_seq(Array.prototype.slice.call(arguments, 4),0);} 
return G__321612__delegate.call(this,v1,v2,v3,v4,vn);};
G__321612.cljs$lang$maxFixedArity = 4;
G__321612.cljs$lang$applyTo = (function (arglist__321613){
var v1 = cljs.core.first(arglist__321613);
arglist__321613 = cljs.core.next(arglist__321613);
var v2 = cljs.core.first(arglist__321613);
arglist__321613 = cljs.core.next(arglist__321613);
var v3 = cljs.core.first(arglist__321613);
arglist__321613 = cljs.core.next(arglist__321613);
var v4 = cljs.core.first(arglist__321613);
var vn = cljs.core.rest(arglist__321613);
return G__321612__delegate(v1,v2,v3,v4,vn);
});
G__321612.cljs$core$IFn$_invoke$arity$variadic = G__321612__delegate;
return G__321612;
})()
;
...
var vector = null;
var vector__0 = (function (){var arr__321619 = (new Array(0));return (new cljs.core.rrb_vector.rrbt.Vector(0,5,cljs.core.PersistentVector.EMPTY_NODE,arr__321619,null,0));
});
var vector__1 = (function (x1){var arr__321620 = (new Array(1));(arr__321620[0] = x1);
return (new cljs.core.rrb_vector.rrbt.Vector(1,5,cljs.core.PersistentVector.EMPTY_NODE,arr__321620,null,null));
});
var vector__2 = (function (x1,x2){var arr__321621 = (new Array(2));(arr__321621[0] = x1);
(arr__321621[1] = x2);
return (new cljs.core.rrb_vector.rrbt.Vector(2,5,cljs.core.PersistentVector.EMPTY_NODE,arr__321621,null,null));
});
var vector__3 = (function (x1,x2,x3){var arr__321622 = (new Array(3));(arr__321622[0] = x1);
(arr__321622[1] = x2);
(arr__321622[2] = x3);
return (new cljs.core.rrb_vector.rrbt.Vector(3,5,cljs.core.PersistentVector.EMPTY_NODE,arr__321622,null,null));
});
var vector__4 = (function (x1,x2,x3,x4){var arr__321623 = (new Array(4));(arr__321623[0] = x1);
(arr__321623[1] = x2);
(arr__321623[2] = x3);
(arr__321623[3] = x4);
return (new cljs.core.rrb_vector.rrbt.Vector(4,5,cljs.core.PersistentVector.EMPTY_NODE,arr__321623,null,null));
});
var vector__5 = (function() { 
var G__321624__delegate = function (x1,x2,x3,x4,xn){return cljs.core.into.call(null,vector.call(null,x1,x2,x3,x4),xn);
};
var G__321624 = function (x1,x2,x3,x4,var_args){
var xn = null;if (arguments.length > 4) {
  xn = cljs.core.array_seq(Array.prototype.slice.call(arguments, 4),0);} 
return G__321624__delegate.call(this,x1,x2,x3,x4,xn);};
G__321624.cljs$lang$maxFixedArity = 4;
G__321624.cljs$lang$applyTo = (function (arglist__321625){
var x1 = cljs.core.first(arglist__321625);
arglist__321625 = cljs.core.next(arglist__321625);
var x2 = cljs.core.first(arglist__321625);
arglist__321625 = cljs.core.next(arglist__321625);
var x3 = cljs.core.first(arglist__321625);
arglist__321625 = cljs.core.next(arglist__321625);
var x4 = cljs.core.first(arglist__321625);
var xn = cljs.core.rest(arglist__321625);
return G__321624__delegate(x1,x2,x3,x4,xn);
});
G__321624.cljs$core$IFn$_invoke$arity$variadic = G__321624__delegate;
return G__321624;
})()
;
