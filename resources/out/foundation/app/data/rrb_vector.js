...
var G__369469__delegate = function (v1,v2,v3,v4,vn){return foundation.app.data.rrb_vector.protocols._splicev.call(null,foundation.app.data.rrb_vector.protocols._splicev.call(null,foundation.app.data.rrb_vector.protocols._splicev.call(null,v1,v2),foundation.app.data.rrb_vector.protocols._splicev.call(null,v3,v4)),cljs.core.apply.call(null,catvec,vn));
};
var G__369469 = function (v1,v2,v3,v4,var_args){
var vn = null;if (arguments.length > 4) {
  vn = cljs.core.array_seq(Array.prototype.slice.call(arguments, 4),0);} 
return G__369469__delegate.call(this,v1,v2,v3,v4,vn);};
G__369469.cljs$lang$maxFixedArity = 4;
G__369469.cljs$lang$applyTo = (function (arglist__369470){
var v1 = cljs.core.first(arglist__369470);
arglist__369470 = cljs.core.next(arglist__369470);
var v2 = cljs.core.first(arglist__369470);
arglist__369470 = cljs.core.next(arglist__369470);
var v3 = cljs.core.first(arglist__369470);
arglist__369470 = cljs.core.next(arglist__369470);
var v4 = cljs.core.first(arglist__369470);
var vn = cljs.core.rest(arglist__369470);
return G__369469__delegate(v1,v2,v3,v4,vn);
});
G__369469.cljs$core$IFn$_invoke$arity$variadic = G__369469__delegate;
return G__369469;
})()
;
...
var vector = null;
var vector__0 = (function (){var arr__369476 = [];return (new cljs.core.rrb_vector.rrbt.Vector(0,5,cljs.core.PersistentVector.EMPTY_NODE,arr__369476,null,0));
});
var vector__1 = (function (x1){var arr__369477 = [null];(arr__369477[0] = x1);
return (new cljs.core.rrb_vector.rrbt.Vector(1,5,cljs.core.PersistentVector.EMPTY_NODE,arr__369477,null,null));
});
var vector__2 = (function (x1,x2){var arr__369478 = [null,null];(arr__369478[0] = x1);
(arr__369478[1] = x2);
return (new cljs.core.rrb_vector.rrbt.Vector(2,5,cljs.core.PersistentVector.EMPTY_NODE,arr__369478,null,null));
});
var vector__3 = (function (x1,x2,x3){var arr__369479 = [null,null,null];(arr__369479[0] = x1);
(arr__369479[1] = x2);
(arr__369479[2] = x3);
return (new cljs.core.rrb_vector.rrbt.Vector(3,5,cljs.core.PersistentVector.EMPTY_NODE,arr__369479,null,null));
});
var vector__4 = (function (x1,x2,x3,x4){var arr__369480 = [null,null,null,null];(arr__369480[0] = x1);
(arr__369480[1] = x2);
(arr__369480[2] = x3);
(arr__369480[3] = x4);
return (new cljs.core.rrb_vector.rrbt.Vector(4,5,cljs.core.PersistentVector.EMPTY_NODE,arr__369480,null,null));
});
var vector__5 = (function() { 
var G__369481__delegate = function (x1,x2,x3,x4,xn){return cljs.core.into.call(null,vector.call(null,x1,x2,x3,x4),xn);
};
var G__369481 = function (x1,x2,x3,x4,var_args){
var xn = null;if (arguments.length > 4) {
  xn = cljs.core.array_seq(Array.prototype.slice.call(arguments, 4),0);} 
return G__369481__delegate.call(this,x1,x2,x3,x4,xn);};
G__369481.cljs$lang$maxFixedArity = 4;
G__369481.cljs$lang$applyTo = (function (arglist__369482){
var x1 = cljs.core.first(arglist__369482);
arglist__369482 = cljs.core.next(arglist__369482);
var x2 = cljs.core.first(arglist__369482);
arglist__369482 = cljs.core.next(arglist__369482);
var x3 = cljs.core.first(arglist__369482);
arglist__369482 = cljs.core.next(arglist__369482);
var x4 = cljs.core.first(arglist__369482);
var xn = cljs.core.rest(arglist__369482);
return G__369481__delegate(x1,x2,x3,x4,xn);
});
G__369481.cljs$core$IFn$_invoke$arity$variadic = G__369481__delegate;
return G__369481;
})()
;
