...
foundation.app.data.dependency.DependencyGraph = (function (){var obj378231 = {};return obj378231;
})();
...
foundation.app.data.dependency.DependencyGraphUpdate = (function (){var obj378233 = {};return obj378233;
})();
...
foundation.app.data.dependency.remove_from_map = (function remove_from_map(amap,x){return cljs.core.reduce.call(null,(function (m,p__378236){var vec__378237 = p__378236;var k = cljs.core.nth.call(null,vec__378237,0,null);var vs = cljs.core.nth.call(null,vec__378237,1,null);return cljs.core.assoc.call(null,m,k,cljs.core.disj.call(null,vs,x));
...
return (function (p1__378238_SHARP_){return cljs.core.empty_QMARK_.call(null,foundation.app.data.dependency.immediate_dependents.call(null,graph,p1__378238_SHARP_));
});})(sorted,g))
,foundation.app.data.dependency.nodes.call(null,graph)));while(true){
if(cljs.core.empty_QMARK_.call(null,todo))
{return sorted;
} else
{var vec__378241 = cljs.core.seq.call(null,todo);var node = cljs.core.nth.call(null,vec__378241,0,null);var more = cljs.core.nthnext.call(null,vec__378241,1);var deps = foundation.app.data.dependency.immediate_dependencies.call(null,g,node);var vec__378242 = (function (){var deps__$1 = deps;var g__$1 = g;var add = cljs.core.PersistentHashSet.EMPTY;while(true){
...
{{
var G__378243 = cljs.core.rest.call(null,deps__$1);
var G__378244 = g_SINGLEQUOTE_;
var G__378245 = cljs.core.conj.call(null,add,d);
deps__$1 = G__378243;
g__$1 = G__378244;
add = G__378245;
continue;
...
{{
var G__378246 = cljs.core.rest.call(null,deps__$1);
var G__378247 = g_SINGLEQUOTE_;
var G__378248 = add;
deps__$1 = G__378246;
g__$1 = G__378247;
add = G__378248;
...
})();var add = cljs.core.nth.call(null,vec__378242,0,null);var g_SINGLEQUOTE_ = cljs.core.nth.call(null,vec__378242,1,null);{
var G__378249 = cljs.core.cons.call(null,node,sorted);
var G__378250 = foundation.app.data.dependency.remove_node.call(null,g_SINGLEQUOTE_,node);
var G__378251 = clojure.set.union.call(null,cljs.core.set.call(null,more),cljs.core.set.call(null,add));
sorted = G__378249;
g = G__378250;
todo = G__378251;
continue;
