...
cljs.core._add_method.call(null,foundation.app.render.node_create,cljs.core.PersistentVector.EMPTY,(function (renderer,p__88173,input_queue,parent_id,id){var vec__88174 = p__88173;var _ = cljs.core.nth.call(null,vec__88174,0,null);var path = cljs.core.nth.call(null,vec__88174,1,null);var ___$1 = cljs.core.nth.call(null,vec__88174,2,null);var val = cljs.core.nth.call(null,vec__88174,3,null);return enfocus.core.at.call(null,document,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"body","body",1016933652)], null),enfocus.core.append.call(null,foundation.app.templates.twitter_power.call(null,id)));
}));
...
cljs.core._add_method.call(null,foundation.app.render.node_create,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"chart","chart",1108527952)], null),(function (renderer,p__88175,input_queue,parent_id,id){var vec__88176 = p__88175;var _ = cljs.core.nth.call(null,vec__88176,0,null);var path = cljs.core.nth.call(null,vec__88176,1,null);var ___$1 = cljs.core.nth.call(null,vec__88176,2,null);var val = cljs.core.nth.call(null,vec__88176,3,null);var chart = foundation.app.chart.highchart.call(null);return foundation.app.render.set_data_BANG_.call(null,renderer,path,chart);
}));
