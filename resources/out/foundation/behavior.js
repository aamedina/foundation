...
}finally {foundation.models._STAR_account_STAR_ = _STAR_account_STAR_77981;
}}));
...
foundation.behavior.total_stats = (function total_stats(stats){return cljs.core.zipmap.call(null,cljs.core.map.call(null,cljs.core.first,foundation.templates.dashboard_metrics),cljs.core.map.call(null,(function (ms){return cljs.core.reduce.call(null,cljs.core._PLUS_,cljs.core.reduce.call(null,cljs.core.into,cljs.core.map.call(null,stats,cljs.core.map.call(null,cljs.core.keyword,cljs.core.map.call(null,(function (p1__77982_SHARP_){return clojure.string.replace.call(null,p1__77982_SHARP_,/_/,"-");
}),ms)))));
...
foundation.behavior.js_number = (function js_number(n){if(cljs.core.truth_((function (){var or__13823__auto__ = isNaN(n);if(cljs.core.truth_(or__13823__auto__))
...
foundation.behavior.graph_stats = (function graph_stats(stats,metric,metric_type){var impressions = cljs.core.map.call(null,stats,cljs.core.map.call(null,cljs.core.keyword,cljs.core.map.call(null,(function (p1__77983_SHARP_){return clojure.string.replace.call(null,p1__77983_SHARP_,/_/,"-");
}),cljs.core.get.call(null,foundation.models.metrics.call(null,new cljs.core.Keyword(null,"default","default",2558708147)),"Impressions"))));return cljs.core.vec.call(null,(function (p1__77985_SHARP_){var G__77987 = metric_type;if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"rate","rate",1017397330),G__77987))
{return cljs.core.vec.call(null,cljs.core.map.call(null,foundation.behavior.js_number,cljs.core.map.call(null,cljs.core._SLASH_,cljs.core.first.call(null,impressions),cljs.core.apply.call(null,cljs.core.map,cljs.core._PLUS_,p1__77985_SHARP_))));
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"cpa","cpa",1014002950),G__77987))
{var billed = cljs.core.map.call(null,cljs.core._SLASH_,new cljs.core.Keyword(null,"estimated-charge-local-micro","estimated-charge-local-micro",2985516268).cljs$core$IFn$_invoke$arity$1(stats),cljs.core.repeat.call(null,1000000.0));return cljs.core.vec.call(null,cljs.core.map.call(null,foundation.behavior.js_number,cljs.core.map.call(null,cljs.core._SLASH_,billed,cljs.core.apply.call(null,cljs.core.map,cljs.core._PLUS_,p1__77985_SHARP_))));
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"total","total",1124454070),G__77987))
{return cljs.core.apply.call(null,cljs.core.map,cljs.core._PLUS_,p1__77985_SHARP_);
} else
...
}).call(null,cljs.core.map.call(null,stats,cljs.core.map.call(null,cljs.core.keyword,cljs.core.map.call(null,(function (p1__77984_SHARP_){return clojure.string.replace.call(null,p1__77984_SHARP_,/_/,"-");
}),cljs.core.get.call(null,foundation.models.metrics.call(null,new cljs.core.Keyword(null,"default","default",2558708147)),metric))))));
});
foundation.behavior.cpa_stats = (function cpa_stats(stats,billed){return cljs.core.zipmap.call(null,cljs.core.keys.call(null,stats),(function (p1__77988_SHARP_){return cljs.core.map.call(null,foundation.behavior.round,p1__77988_SHARP_,cljs.core.repeat.call(null,2));
...
foundation.behavior.rate_stats = (function rate_stats(stats){return cljs.core.zipmap.call(null,cljs.core.keys.call(null,stats),(function (p1__77989_SHARP_){return cljs.core.map.call(null,foundation.behavior.round,p1__77989_SHARP_,cljs.core.repeat.call(null,2));
...
{var model = temp__4090__auto__;var selected = clojure.set.select.call(null,(function (p1__77990_SHARP_){return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",1013907597).cljs$core$IFn$_invoke$arity$1(message),new cljs.core.Keyword(null,"id","id",1013907597).cljs$core$IFn$_invoke$arity$1(p1__77990_SHARP_));
