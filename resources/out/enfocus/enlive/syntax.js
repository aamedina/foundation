...
{return cljs.core.map.call(null,(function (p1__45102_SHARP_){return cljs.core.conj.call(null,p1__45102_SHARP_,cljs.core.name.call(null,item));
}),end);
} else
{if(typeof item === 'string')
{return cljs.core.map.call(null,(function (p1__45103_SHARP_){return cljs.core.conj.call(null,p1__45103_SHARP_,item);
}),end);
} else
{if(cljs.core.set_QMARK_.call(null,item))
{return cljs.core.reduce.call(null,(function (r1,it){return cljs.core.concat.call(null,r1,cljs.core.map.call(null,(function (p1__45104_SHARP_){return cljs.core.conj.call(null,p1__45104_SHARP_,it);
}),end));
...
return (function (p1__45105_SHARP_){return cljs.core.apply.call(null,cljs.core.str,p1__45105_SHARP_);
});})(x1))
,sel_to_str.call(null,item));var iter__14652__auto__ = (function iter__45112(s__45113){return (new cljs.core.LazySeq(null,(function (){var s__45113__$1 = s__45113;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__45113__$1);if(temp__4092__auto__)
{var xs__4579__auto__ = temp__4092__auto__;var s = cljs.core.first.call(null,xs__4579__auto__);var iterys__14648__auto__ = ((function (s__45113__$1,s,xs__4579__auto__,temp__4092__auto__){
return (function iter__45114(s__45115){return (new cljs.core.LazySeq(null,((function (s__45113__$1,s,xs__4579__auto__,temp__4092__auto__){
return (function (){var s__45115__$1 = s__45115;while(true){
var temp__4092__auto____$1 = cljs.core.seq.call(null,s__45115__$1);if(temp__4092__auto____$1)
{var s__45115__$2 = temp__4092__auto____$1;if(cljs.core.chunked_seq_QMARK_.call(null,s__45115__$2))
{var c__14650__auto__ = cljs.core.chunk_first.call(null,s__45115__$2);var size__14651__auto__ = cljs.core.count.call(null,c__14650__auto__);var b__45117 = cljs.core.chunk_buffer.call(null,size__14651__auto__);if((function (){var i__45116 = 0;while(true){
if((i__45116 < size__14651__auto__))
{var e = cljs.core._nth.call(null,c__14650__auto__,i__45116);cljs.core.chunk_append.call(null,b__45117,(function (){cljs.core.println.call(null,s,e);
return cljs.core.conj.call(null,e,s);
})());
{
var G__45118 = (i__45116 + 1);
i__45116 = G__45118;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__45117),iter__45114.call(null,cljs.core.chunk_rest.call(null,s__45115__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__45117),null);
}
} else
{var e = cljs.core.first.call(null,s__45115__$2);return cljs.core.cons.call(null,(function (){cljs.core.println.call(null,s,e);
return cljs.core.conj.call(null,e,s);
})(),iter__45114.call(null,cljs.core.rest.call(null,s__45115__$2)));
}
} else
{return null;
}
...
});})(s__45113__$1,s,xs__4579__auto__,temp__4092__auto__))
,null,null));
});})(s__45113__$1,s,xs__4579__auto__,temp__4092__auto__))
;var fs__14649__auto__ = cljs.core.seq.call(null,iterys__14648__auto__.call(null,end));if(fs__14649__auto__)
{return cljs.core.concat.call(null,fs__14649__auto__,iter__45112.call(null,cljs.core.rest.call(null,s__45113__$1)));
} else
{{
var G__45119 = cljs.core.rest.call(null,s__45113__$1);
s__45113__$1 = G__45119;
continue;
}
}
} else
...
});return iter__14652__auto__.call(null,sub);
} else
...
enfocus.enlive.syntax.attr_pairs = (function attr_pairs(op,elms){var ts = (function (p__45122){var vec__45123 = p__45122;var x = cljs.core.nth.call(null,vec__45123,0,null);var y = cljs.core.nth.call(null,vec__45123,1,null);return [cljs.core.str("["),cljs.core.str(cljs.core.name.call(null,x)),cljs.core.str(op),cljs.core.str("='"),cljs.core.str(y),cljs.core.str("']")].join('');
...
var attr_QMARK___delegate = function (elms){return cljs.core.apply.call(null,cljs.core.str,cljs.core.map.call(null,(function (p1__45124_SHARP_){return [cljs.core.str("["),cljs.core.str(cljs.core.name.call(null,p1__45124_SHARP_)),cljs.core.str("]")].join('');
}),elms));
};
...
attr_QMARK_.cljs$lang$applyTo = (function (arglist__45125){
var elms = cljs.core.seq(arglist__45125);
...
attr_EQ_.cljs$lang$applyTo = (function (arglist__45126){
var elms = cljs.core.seq(arglist__45126);
...
attr_has.cljs$lang$applyTo = (function (arglist__45127){
var x = cljs.core.first(arglist__45127);
var vals = cljs.core.rest(arglist__45127);
...
attr_starts.cljs$lang$applyTo = (function (arglist__45128){
var elms = cljs.core.seq(arglist__45128);
...
attr_ends.cljs$lang$applyTo = (function (arglist__45129){
var elms = cljs.core.seq(arglist__45129);
...
attr_contains.cljs$lang$applyTo = (function (arglist__45130){
var elms = cljs.core.seq(arglist__45130);
...
attr_BAR__EQ_.cljs$lang$applyTo = (function (arglist__45131){
var elms = cljs.core.seq(arglist__45131);
...
but.cljs$lang$applyTo = (function (arglist__45132){
var sel = cljs.core.seq(arglist__45132);
