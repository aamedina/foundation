...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj33720 = {};return obj33720;
})();
...
reader_error.cljs$lang$applyTo = (function (arglist__35998){
var rdr = cljs.core.first(arglist__35998);
var msg = cljs.core.rest(arglist__35998);
...
{{
var G__35999 = (function (){sb.append(ch);
return sb;
})();
var G__36000 = cljs.reader.read_char.call(null,rdr);
sb = G__35999;
ch = G__36000;
continue;
}
...
{{
var G__36001 = cljs.reader.read_char.call(null,rdr);
ch = G__36001;
continue;
}
} else
...
var G__36002 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__36002;
continue;
}
} else
...
var G__36003 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__36003;
continue;
}
}
...
{{
var G__36004 = (function (){buffer.append(ch);
return buffer;
})();
var G__36005 = cljs.reader.read_char.call(null,reader);
buffer = G__36004;
ch = G__36005;
continue;
}
...
{if(("\\" === ch))
{{
var G__36006 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__36007 = cljs.reader.read_char.call(null,reader);
buffer = G__36006;
ch = G__36007;
continue;
}
...
{{
var G__36008 = (function (){buffer.append(ch);
return buffer;
})();
var G__36009 = cljs.reader.read_char.call(null,reader);
buffer = G__36008;
ch = G__36009;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__36011 = o;if(G__36011)
{var bit__14447__auto__ = (G__36011.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__14447__auto__) || (G__36011.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__36011.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__36011);
} else
{return false;
}
}
...
{{
var G__36012 = reader;
var G__36013 = eof_is_error;
var G__36014 = sentinel;
var G__36015 = is_recursive;
reader = G__36012;
eof_is_error = G__36013;
sentinel = G__36014;
is_recursive = G__36015;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__36016 = cljs.reader.read_comment.call(null,reader,ch);
var G__36017 = eof_is_error;
var G__36018 = sentinel;
var G__36019 = is_recursive;
reader = G__36016;
eof_is_error = G__36017;
sentinel = G__36018;
is_recursive = G__36019;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__36020 = reader;
var G__36021 = eof_is_error;
var G__36022 = sentinel;
var G__36023 = is_recursive;
reader = G__36020;
eof_is_error = G__36021;
sentinel = G__36022;
is_recursive = G__36023;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__36026 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__36026,0,null);var years = cljs.core.nth.call(null,vec__36026,1,null);var months = cljs.core.nth.call(null,vec__36026,2,null);var days = cljs.core.nth.call(null,vec__36026,3,null);var hours = cljs.core.nth.call(null,vec__36026,4,null);var minutes = cljs.core.nth.call(null,vec__36026,5,null);var seconds = cljs.core.nth.call(null,vec__36026,6,null);var fraction = cljs.core.nth.call(null,vec__36026,7,null);var offset_sign = cljs.core.nth.call(null,vec__36026,8,null);var offset_hours = cljs.core.nth.call(null,vec__36026,9,null);var offset_minutes = cljs.core.nth.call(null,vec__36026,10,null);var v = vec__36026;if(cljs.core.not.call(null,v))
...
{var vec__36028 = temp__4090__auto__;var years = cljs.core.nth.call(null,vec__36028,0,null);var months = cljs.core.nth.call(null,vec__36028,1,null);var days = cljs.core.nth.call(null,vec__36028,2,null);var hours = cljs.core.nth.call(null,vec__36028,3,null);var minutes = cljs.core.nth.call(null,vec__36028,4,null);var seconds = cljs.core.nth.call(null,vec__36028,5,null);var ms = cljs.core.nth.call(null,vec__36028,6,null);var offset = cljs.core.nth.call(null,vec__36028,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
