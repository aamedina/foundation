...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_43210 = 0;while(true){
var m_43211 = cljs.core.async.impl.dispatch.tasks.pop();if((m_43211 == null))
{} else
{m_43211.call(null);
if((count_43210 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__43212 = (count_43210 + 1);
count_43210 = G__43212;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__13776__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__13776__auto__)
