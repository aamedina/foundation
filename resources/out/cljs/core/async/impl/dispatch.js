...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_338788 = 0;while(true){
var m_338789 = cljs.core.async.impl.dispatch.tasks.pop();if((m_338789 == null))
{} else
{m_338789.call(null);
if((count_338788 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__338790 = (count_338788 + 1);
count_338788 = G__338790;
continue;
}
} else
{}
