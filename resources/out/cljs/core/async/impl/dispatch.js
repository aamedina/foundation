...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_477063 = 0;while(true){
var m_477064 = cljs.core.async.impl.dispatch.tasks.pop();if((m_477064 == null))
{} else
{m_477064.call(null);
if((count_477063 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__477065 = (count_477063 + 1);
count_477063 = G__477065;
continue;
}
} else
{}
