...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_329611 = 0;while(true){
var m_329612 = cljs.core.async.impl.dispatch.tasks.pop();if((m_329612 == null))
{} else
{m_329612.call(null);
if((count_329611 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__329613 = (count_329611 + 1);
count_329611 = G__329613;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__13811__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__13811__auto__)
