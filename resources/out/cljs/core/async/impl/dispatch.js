...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_384148 = 0;while(true){
var m_384149 = cljs.core.async.impl.dispatch.tasks.pop();if((m_384149 == null))
{} else
{m_384149.call(null);
if((count_384148 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__384150 = (count_384148 + 1);
count_384148 = G__384150;
continue;
}
} else
{}
