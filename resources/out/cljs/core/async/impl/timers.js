...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__15727__auto__,writer__15728__auto__,opt__15729__auto__){return cljs.core._write.call(null,writer__15728__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_31541 = 0;while(true){
if((i_31541 < arr.length))
{(arr[i_31541] = null);
{
var G__31542 = (i_31541 + 1);
i_31541 = G__31542;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__15727__auto__,writer__15728__auto__,opt__15729__auto__){return cljs.core._write.call(null,writer__15728__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_31548 = (self__.level + 1);while(true){
if((i_31548 <= (new_level + 1)))
{(update[i_31548] = self__.header);
{
var G__31549 = (i_31548 + 1);
i_31548 = G__31549;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_31550 = 0;while(true){
if((i_31550 <= self__.level))
{var links_31551 = (update[i_31550]).forward;if(((links_31551[i_31550]) === x__$1))
{(links_31551[i_31550] = (x__$1.forward[i_31550]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__15183__auto__ = (cljs.core.truth_((function (){var and__15171__auto__ = me;if(cljs.core.truth_(and__15171__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__15171__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__15183__auto__))
