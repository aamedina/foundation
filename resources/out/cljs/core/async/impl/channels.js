...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t477069 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t477069 = (function (val,box,meta477070){
this.val = val;
this.box = box;
this.meta477070 = meta477070;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t477069.cljs$lang$type = true;
cljs.core.async.impl.channels.t477069.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t477069";
cljs.core.async.impl.channels.t477069.cljs$lang$ctorPrWriter = (function (this__8274__auto__,writer__8275__auto__,opt__8276__auto__){return cljs.core._write.call(null,writer__8275__auto__,"cljs.core.async.impl.channels/t477069");
});
cljs.core.async.impl.channels.t477069.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t477069.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_477071){var self__ = this;
var _477071__$1 = this;return self__.meta477070;
});
cljs.core.async.impl.channels.t477069.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_477071,meta477070__$1){var self__ = this;
var _477071__$1 = this;return (new cljs.core.async.impl.channels.t477069(self__.val,self__.box,meta477070__$1));
});
cljs.core.async.impl.channels.__GT_t477069 = (function __GT_t477069(val__$1,box__$1,meta477070){return (new cljs.core.async.impl.channels.t477069(val__$1,box__$1,meta477070));
});
}
return (new cljs.core.async.impl.channels.t477069(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_477072 = self__.takes.pop();if((taker_477072 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_477072))
{var take_cb_477073 = cljs.core.async.impl.protocols.commit.call(null,taker_477072);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_477073,taker_477072){
return (function (){return take_cb_477073.call(null,null);
});})(take_cb_477073,taker_477072))
);
} else
{}
{
