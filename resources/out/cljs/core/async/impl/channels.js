...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t311580 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t311580 = (function (val,box,meta311581){
this.val = val;
this.box = box;
this.meta311581 = meta311581;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t311580.cljs$lang$type = true;
cljs.core.async.impl.channels.t311580.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t311580";
cljs.core.async.impl.channels.t311580.cljs$lang$ctorPrWriter = (function (this__8274__auto__,writer__8275__auto__,opt__8276__auto__){return cljs.core._write.call(null,writer__8275__auto__,"cljs.core.async.impl.channels/t311580");
});
cljs.core.async.impl.channels.t311580.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t311580.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_311582){var self__ = this;
var _311582__$1 = this;return self__.meta311581;
});
cljs.core.async.impl.channels.t311580.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_311582,meta311581__$1){var self__ = this;
var _311582__$1 = this;return (new cljs.core.async.impl.channels.t311580(self__.val,self__.box,meta311581__$1));
});
cljs.core.async.impl.channels.__GT_t311580 = (function __GT_t311580(val__$1,box__$1,meta311581){return (new cljs.core.async.impl.channels.t311580(val__$1,box__$1,meta311581));
});
}
return (new cljs.core.async.impl.channels.t311580(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_311583 = self__.takes.pop();if((taker_311583 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_311583))
{var take_cb_311584 = cljs.core.async.impl.protocols.commit.call(null,taker_311583);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_311584,taker_311583){
return (function (){return take_cb_311584.call(null,null);
});})(take_cb_311584,taker_311583))
);
} else
{}
{
