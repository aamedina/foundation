...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t327152 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t327152 = (function (val,box,meta327153){
this.val = val;
this.box = box;
this.meta327153 = meta327153;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t327152.cljs$lang$type = true;
cljs.core.async.impl.channels.t327152.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t327152";
cljs.core.async.impl.channels.t327152.cljs$lang$ctorPrWriter = (function (this__14369__auto__,writer__14370__auto__,opt__14371__auto__){return cljs.core._write.call(null,writer__14370__auto__,"cljs.core.async.impl.channels/t327152");
});
cljs.core.async.impl.channels.t327152.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t327152.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_327154){var self__ = this;
var _327154__$1 = this;return self__.meta327153;
});
cljs.core.async.impl.channels.t327152.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_327154,meta327153__$1){var self__ = this;
var _327154__$1 = this;return (new cljs.core.async.impl.channels.t327152(self__.val,self__.box,meta327153__$1));
});
cljs.core.async.impl.channels.__GT_t327152 = (function __GT_t327152(val__$1,box__$1,meta327153){return (new cljs.core.async.impl.channels.t327152(val__$1,box__$1,meta327153));
});
}
return (new cljs.core.async.impl.channels.t327152(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__14372__auto__,writer__14373__auto__,opts__14374__auto__){return cljs.core._write.call(null,writer__14373__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__14369__auto__,writer__14370__auto__,opt__14371__auto__){return cljs.core._write.call(null,writer__14370__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_327155 = self__.takes.pop();if((taker_327155 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_327155))
{var take_cb_327156 = cljs.core.async.impl.protocols.commit.call(null,taker_327155);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_327156,taker_327155){
return (function (){return take_cb_327156.call(null,null);
});})(take_cb_327156,taker_327155))
);
} else
{}
{
