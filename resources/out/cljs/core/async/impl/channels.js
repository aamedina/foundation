...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t338794 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t338794 = (function (val,box,meta338795){
this.val = val;
this.box = box;
this.meta338795 = meta338795;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t338794.cljs$lang$type = true;
cljs.core.async.impl.channels.t338794.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t338794";
cljs.core.async.impl.channels.t338794.cljs$lang$ctorPrWriter = (function (this__14367__auto__,writer__14368__auto__,opt__14369__auto__){return cljs.core._write.call(null,writer__14368__auto__,"cljs.core.async.impl.channels/t338794");
});
cljs.core.async.impl.channels.t338794.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t338794.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_338796){var self__ = this;
var _338796__$1 = this;return self__.meta338795;
});
cljs.core.async.impl.channels.t338794.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_338796,meta338795__$1){var self__ = this;
var _338796__$1 = this;return (new cljs.core.async.impl.channels.t338794(self__.val,self__.box,meta338795__$1));
});
cljs.core.async.impl.channels.__GT_t338794 = (function __GT_t338794(val__$1,box__$1,meta338795){return (new cljs.core.async.impl.channels.t338794(val__$1,box__$1,meta338795));
});
}
return (new cljs.core.async.impl.channels.t338794(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_338797 = self__.takes.pop();if((taker_338797 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_338797))
{var take_cb_338798 = cljs.core.async.impl.protocols.commit.call(null,taker_338797);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_338798,taker_338797){
return (function (){return take_cb_338798.call(null,null);
});})(take_cb_338798,taker_338797))
);
} else
{}
{
