...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t299967 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t299967 = (function (val,box,meta299968){
this.val = val;
this.box = box;
this.meta299968 = meta299968;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t299967.cljs$lang$type = true;
cljs.core.async.impl.channels.t299967.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t299967";
cljs.core.async.impl.channels.t299967.cljs$lang$ctorPrWriter = (function (this__14369__auto__,writer__14370__auto__,opt__14371__auto__){return cljs.core._write.call(null,writer__14370__auto__,"cljs.core.async.impl.channels/t299967");
});
cljs.core.async.impl.channels.t299967.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t299967.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_299969){var self__ = this;
var _299969__$1 = this;return self__.meta299968;
});
cljs.core.async.impl.channels.t299967.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_299969,meta299968__$1){var self__ = this;
var _299969__$1 = this;return (new cljs.core.async.impl.channels.t299967(self__.val,self__.box,meta299968__$1));
});
cljs.core.async.impl.channels.__GT_t299967 = (function __GT_t299967(val__$1,box__$1,meta299968){return (new cljs.core.async.impl.channels.t299967(val__$1,box__$1,meta299968));
});
}
return (new cljs.core.async.impl.channels.t299967(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_299970 = self__.takes.pop();if((taker_299970 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_299970))
{var take_cb_299971 = cljs.core.async.impl.protocols.commit.call(null,taker_299970);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_299971,taker_299970){
return (function (){return take_cb_299971.call(null,null);
});})(take_cb_299971,taker_299970))
);
} else
{}
{
