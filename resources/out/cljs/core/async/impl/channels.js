...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t31582 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t31582 = (function (val,box,meta31583){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t31582.cljs$lang$type = true;
cljs.core.async.impl.channels.t31582.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t31582";
cljs.core.async.impl.channels.t31582.cljs$lang$ctorPrWriter = (function (this__15727__auto__,writer__15728__auto__,opt__15729__auto__){return cljs.core._write.call(null,writer__15728__auto__,"cljs.core.async.impl.channels/t31582");
});
cljs.core.async.impl.channels.t31582.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t31582.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_31584){var self__ = this;
var _31584__$1 = this;return self__.meta31583;
});
cljs.core.async.impl.channels.t31582.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_31584,meta31583__$1){var self__ = this;
var _31584__$1 = this;return (new cljs.core.async.impl.channels.t31582(self__.val,self__.box,meta31583__$1));
});
cljs.core.async.impl.channels.__GT_t31582 = (function __GT_t31582(val__$1,box__$1,meta31583){return (new cljs.core.async.impl.channels.t31582(val__$1,box__$1,meta31583));
});
}
return (new cljs.core.async.impl.channels.t31582(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__15730__auto__,writer__15731__auto__,opts__15732__auto__){return cljs.core._write.call(null,writer__15731__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__15727__auto__,writer__15728__auto__,opt__15729__auto__){return cljs.core._write.call(null,writer__15728__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_31585 = self__.takes.pop();if((taker_31585 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_31585))
{var take_cb_31586 = cljs.core.async.impl.protocols.commit.call(null,taker_31585);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_31586,taker_31585){
return (function (){return take_cb_31586.call(null,null);
});})(take_cb_31586,taker_31585))
);
} else
{}
{
