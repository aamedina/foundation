...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t631511 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t631511 = (function (val,box,meta631512){
this.val = val;
this.box = box;
this.meta631512 = meta631512;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t631511.cljs$lang$type = true;
cljs.core.async.impl.channels.t631511.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t631511";
cljs.core.async.impl.channels.t631511.cljs$lang$ctorPrWriter = (function (this__8274__auto__,writer__8275__auto__,opt__8276__auto__){return cljs.core._write.call(null,writer__8275__auto__,"cljs.core.async.impl.channels/t631511");
});
cljs.core.async.impl.channels.t631511.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t631511.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_631513){var self__ = this;
var _631513__$1 = this;return self__.meta631512;
});
cljs.core.async.impl.channels.t631511.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_631513,meta631512__$1){var self__ = this;
var _631513__$1 = this;return (new cljs.core.async.impl.channels.t631511(self__.val,self__.box,meta631512__$1));
});
cljs.core.async.impl.channels.__GT_t631511 = (function __GT_t631511(val__$1,box__$1,meta631512){return (new cljs.core.async.impl.channels.t631511(val__$1,box__$1,meta631512));
});
}
return (new cljs.core.async.impl.channels.t631511(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_631514 = self__.takes.pop();if((taker_631514 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_631514))
{var take_cb_631515 = cljs.core.async.impl.protocols.commit.call(null,taker_631514);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_631515,taker_631514){
return (function (){return take_cb_631515.call(null,null);
});})(take_cb_631515,taker_631514))
);
} else
{}
{
