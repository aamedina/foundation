...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t102970 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t102970 = (function (val,box,meta102971){
this.val = val;
this.box = box;
this.meta102971 = meta102971;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t102970.cljs$lang$type = true;
cljs.core.async.impl.channels.t102970.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t102970";
cljs.core.async.impl.channels.t102970.cljs$lang$ctorPrWriter = (function (this__14366__auto__,writer__14367__auto__,opt__14368__auto__){return cljs.core._write.call(null,writer__14367__auto__,"cljs.core.async.impl.channels/t102970");
});
cljs.core.async.impl.channels.t102970.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t102970.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_102972){var self__ = this;
var _102972__$1 = this;return self__.meta102971;
});
cljs.core.async.impl.channels.t102970.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_102972,meta102971__$1){var self__ = this;
var _102972__$1 = this;return (new cljs.core.async.impl.channels.t102970(self__.val,self__.box,meta102971__$1));
});
cljs.core.async.impl.channels.__GT_t102970 = (function __GT_t102970(val__$1,box__$1,meta102971){return (new cljs.core.async.impl.channels.t102970(val__$1,box__$1,meta102971));
});
}
return (new cljs.core.async.impl.channels.t102970(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__14369__auto__,writer__14370__auto__,opts__14371__auto__){return cljs.core._write.call(null,writer__14370__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__14366__auto__,writer__14367__auto__,opt__14368__auto__){return cljs.core._write.call(null,writer__14367__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_102973 = self__.takes.pop();if((taker_102973 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_102973))
{var take_cb_102974 = cljs.core.async.impl.protocols.commit.call(null,taker_102973);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_102974,taker_102973){
return (function (){return take_cb_102974.call(null,null);
});})(take_cb_102974,taker_102973))
);
} else
{}
{
