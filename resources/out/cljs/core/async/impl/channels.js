...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t34139 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t34139 = (function (val,box,meta34140){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t34139.cljs$lang$type = true;
cljs.core.async.impl.channels.t34139.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t34139";
cljs.core.async.impl.channels.t34139.cljs$lang$ctorPrWriter = (function (this__15685__auto__,writer__15686__auto__,opt__15687__auto__){return cljs.core._write.call(null,writer__15686__auto__,"cljs.core.async.impl.channels/t34139");
});
cljs.core.async.impl.channels.t34139.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t34139.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_34141){var self__ = this;
var _34141__$1 = this;return self__.meta34140;
});
cljs.core.async.impl.channels.t34139.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_34141,meta34140__$1){var self__ = this;
var _34141__$1 = this;return (new cljs.core.async.impl.channels.t34139(self__.val,self__.box,meta34140__$1));
});
cljs.core.async.impl.channels.__GT_t34139 = (function __GT_t34139(val__$1,box__$1,meta34140){return (new cljs.core.async.impl.channels.t34139(val__$1,box__$1,meta34140));
});
}
return (new cljs.core.async.impl.channels.t34139(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__15688__auto__,writer__15689__auto__,opts__15690__auto__){return cljs.core._write.call(null,writer__15689__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__15685__auto__,writer__15686__auto__,opt__15687__auto__){return cljs.core._write.call(null,writer__15686__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_34142 = self__.takes.pop();if((taker_34142 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_34142))
{var take_cb_34143 = cljs.core.async.impl.protocols.commit.call(null,taker_34142);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_34143,taker_34142){
return (function (){return take_cb_34143.call(null,null);
});})(take_cb_34143,taker_34142))
);
} else
{}
{
