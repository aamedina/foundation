...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_37349 = 0;while(true){
var m_37350 = cljs.core.async.impl.dispatch.tasks.pop();if((m_37350 == null))
{} else
{m_37350.call(null);
if((count_37349 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__37351 = (count_37349 + 1);
count_37349 = G__37351;
continue;
}
} else
{}
