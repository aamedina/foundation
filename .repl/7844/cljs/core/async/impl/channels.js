...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t37355 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t37355 = (function (val,box,meta37356){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t37355.cljs$lang$type = true;
cljs.core.async.impl.channels.t37355.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t37355";
cljs.core.async.impl.channels.t37355.cljs$lang$ctorPrWriter = (function (this__5701__auto__,writer__5702__auto__,opt__5703__auto__){return cljs.core._write.call(null,writer__5702__auto__,"cljs.core.async.impl.channels/t37355");
});
cljs.core.async.impl.channels.t37355.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t37355.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37357){var self__ = this;
var _37357__$1 = this;return self__.meta37356;
});
cljs.core.async.impl.channels.t37355.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37357,meta37356__$1){var self__ = this;
var _37357__$1 = this;return (new cljs.core.async.impl.channels.t37355(self__.val,self__.box,meta37356__$1));
});
cljs.core.async.impl.channels.__GT_t37355 = (function __GT_t37355(val__$1,box__$1,meta37356){return (new cljs.core.async.impl.channels.t37355(val__$1,box__$1,meta37356));
});
}
return (new cljs.core.async.impl.channels.t37355(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_37358 = self__.takes.pop();if((taker_37358 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_37358))
{var take_cb_37359 = cljs.core.async.impl.protocols.commit.call(null,taker_37358);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_37359,taker_37358){
return (function (){return take_cb_37359.call(null,null);
});})(take_cb_37359,taker_37358))
);
} else
{}
{
