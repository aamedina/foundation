...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_37314 = 0;while(true){
...
{var i_37321 = (self__.level + 1);while(true){
if((i_37321 <= (new_level + 1)))
{(update[i_37321] = self__.header);
{
var G__37322 = (i_37321 + 1);
i_37321 = G__37322;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_37323 = 0;while(true){
if((i_37323 <= self__.level))
{var links_37324 = (update[i_37323]).forward;if(((links_37324[i_37323]) === x__$1))
