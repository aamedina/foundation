...
{{
var G__37754 = cljs.core.pop.call(null,v__$1);
v__$1 = G__37754;
continue;
}
} else
...
{var pred__37758 = cljs.core._EQ_;var expr__37759 = limit;if(cljs.core.truth_(pred__37758.call(null,1,expr__37759)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__37758.call(null,2,expr__37759)))
...
var G__37761 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__37762 = (limit__$1 - 1);
var G__37763 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__37761;
limit__$1 = G__37762;
parts = G__37763;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___37765 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___37765))
{var replacement_37766 = temp__4096__auto___37765;buffer.append([cljs.core.str(replacement_37766)].join(''));
} else
{buffer.append(ch);
}
{
var G__37767 = (index + 1);
index = G__37767;
continue;
}
}
