...
goog.require('goog.date.DateTime');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj38753 = {};return obj38753;
})();
...
* which parses
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__5850__auto__ = (function iter__38762(s__38763){return (new cljs.core.LazySeq(null,(function (){var s__38763__$1 = s__38763;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__38763__$1);if(temp__4098__auto__)
{var s__38763__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__38763__$2))
{var c__5848__auto__ = cljs.core.chunk_first.call(null,s__38763__$2);var size__5849__auto__ = cljs.core.count.call(null,c__5848__auto__);var b__38765 = cljs.core.chunk_buffer.call(null,size__5849__auto__);if((function (){var i__38764 = 0;while(true){
if((i__38764 < size__5849__auto__))
{var f = cljs.core._nth.call(null,c__5848__auto__,i__38764);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e38768){if((e38768 instanceof Error))
{var e = e38768;return null;
} else
...
{cljs.core.chunk_append.call(null,b__38765,d);
{
var G__38770 = (i__38764 + 1);
i__38764 = G__38770;
continue;
}
} else
{{
var G__38771 = (i__38764 + 1);
i__38764 = G__38771;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__38765),iter__38762.call(null,cljs.core.chunk_rest.call(null,s__38763__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__38765),null);
}
} else
{var f = cljs.core.first.call(null,s__38763__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e38769){if((e38769 instanceof Error))
{var e = e38769;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e38769;
} else
...
{return cljs.core.cons.call(null,d,iter__38762.call(null,cljs.core.rest.call(null,s__38763__$2)));
} else
{{
var G__38772 = cljs.core.rest.call(null,s__38763__$2);
s__38763__$1 = G__38772;
continue;
}
}
}
