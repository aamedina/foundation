...
var unparse__delegate = function (fmt,dt,p__38773){var map__38775 = p__38773;var map__38775__$1 = ((cljs.core.seq_QMARK_.call(null,map__38775))?cljs.core.apply.call(null,cljs.core.hash_map,map__38775):map__38775);var tz = cljs.core.get.call(null,map__38775__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__38773 = null;if (arguments.length > 2) {
  p__38773 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__38773);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__38776){
var fmt = cljs.core.first(arglist__38776);
arglist__38776 = cljs.core.next(arglist__38776);
var dt = cljs.core.first(arglist__38776);
var p__38773 = cljs.core.rest(arglist__38776);
return unparse__delegate(fmt,dt,p__38773);
});
...
var show_formatters__delegate = function (p__38777){var map__38783 = p__38777;var map__38783__$1 = ((cljs.core.seq_QMARK_.call(null,map__38783))?cljs.core.apply.call(null,cljs.core.hash_map,map__38783):map__38783);var date_like = cljs.core.get.call(null,map__38783__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__5850__auto__ = (function iter__38784(s__38785){return (new cljs.core.LazySeq(null,(function (){var s__38785__$1 = s__38785;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__38785__$1);if(temp__4098__auto__)
{var s__38785__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__38785__$2))
{var c__5848__auto__ = cljs.core.chunk_first.call(null,s__38785__$2);var size__5849__auto__ = cljs.core.count.call(null,c__5848__auto__);var b__38787 = cljs.core.chunk_buffer.call(null,size__5849__auto__);if((function (){var i__38786 = 0;while(true){
if((i__38786 < size__5849__auto__))
{var i = cljs.core._nth.call(null,c__5848__auto__,i__38786);cljs.core.chunk_append.call(null,b__38787,cljs_time.format.unparse.call(null,i,date_like));
{
var G__38788 = (i__38786 + 1);
i__38786 = G__38788;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__38787),iter__38784.call(null,cljs.core.chunk_rest.call(null,s__38785__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__38787),null);
}
} else
{var i = cljs.core.first.call(null,s__38785__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__38784.call(null,cljs.core.rest.call(null,s__38785__$2)));
}
} else
{return null;
}
...
var p__38777 = null;if (arguments.length > 0) {
  p__38777 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__38777);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__38789){
var p__38777 = cljs.core.seq(arglist__38789);
return show_formatters__delegate(p__38777);
});
