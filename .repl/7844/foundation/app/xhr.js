...
var assoc_in_cache_BANG___delegate = function (k,v,p__38625){var map__38628 = p__38625;var map__38628__$1 = ((cljs.core.seq_QMARK_.call(null,map__38628))?cljs.core.apply.call(null,cljs.core.hash_map,map__38628):map__38628);var expiry = cljs.core.get.call(null,map__38628__$1,new cljs.core.Keyword(null,"expiry","expiry",4019712165));try{return foundation.app.xhr.localstorage.set(cljs.core.name.call(null,k),cljs.core.pr_str.call(null,v),expiry);
}catch (e38629){if((e38629 instanceof Error))
{var e = e38629;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e38629;
} else
...
var p__38625 = null;if (arguments.length > 2) {
  p__38625 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return assoc_in_cache_BANG___delegate.call(this,k,v,p__38625);};
assoc_in_cache_BANG_.cljs$lang$maxFixedArity = 2;
assoc_in_cache_BANG_.cljs$lang$applyTo = (function (arglist__38630){
var k = cljs.core.first(arglist__38630);
arglist__38630 = cljs.core.next(arglist__38630);
var v = cljs.core.first(arglist__38630);
var p__38625 = cljs.core.rest(arglist__38630);
return assoc_in_cache_BANG___delegate(k,v,p__38625);
});
...
foundation.app.xhr.clojurify_keys = (function clojurify_keys(m){var f = (function (p__38633){var vec__38634 = p__38633;var k = cljs.core.nth.call(null,vec__38634,0,null);var v = cljs.core.nth.call(null,vec__38634,1,null);if(typeof k === 'string')
...
{try{foundation.app.xhr.xhr_pool.send(uri,uri,method,(((!(typeof content === 'string')) && (!((content == null))))?foundation.app.xhr.stringify.call(null,content):content),cljs.core.clj__GT_js.call(null,headers),50,(function (p1__38641_SHARP_){cljs.core.async.put_BANG_.call(null,c,foundation.app.xhr.handle_response.call(null,p1__38641_SHARP_.target));
...
}catch (e38643){if((e38643 instanceof Error))
{var e = e38643;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e38643;
} else
...
var GET__delegate = function (uri,p__38644){var map__38646 = p__38644;var map__38646__$1 = ((cljs.core.seq_QMARK_.call(null,map__38646))?cljs.core.apply.call(null,cljs.core.hash_map,map__38646):map__38646);var headers = cljs.core.get.call(null,map__38646__$1,new cljs.core.Keyword(null,"headers","headers",1809212152));return foundation.app.xhr.xhr.call(null,uri,"GET",null,cljs.core.merge.call(null,foundation.app.xhr._STAR_headers_STAR_,headers));
};
var GET = function (uri,var_args){
var p__38644 = null;if (arguments.length > 1) {
  p__38644 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return GET__delegate.call(this,uri,p__38644);};
GET.cljs$lang$maxFixedArity = 1;
GET.cljs$lang$applyTo = (function (arglist__38647){
var uri = cljs.core.first(arglist__38647);
var p__38644 = cljs.core.rest(arglist__38647);
return GET__delegate(uri,p__38644);
});
...
var POST__delegate = function (uri,p__38648){var map__38650 = p__38648;var map__38650__$1 = ((cljs.core.seq_QMARK_.call(null,map__38650))?cljs.core.apply.call(null,cljs.core.hash_map,map__38650):map__38650);var headers = cljs.core.get.call(null,map__38650__$1,new cljs.core.Keyword(null,"headers","headers",1809212152),cljs.core.PersistentArrayMap.EMPTY);var body = cljs.core.get.call(null,map__38650__$1,new cljs.core.Keyword(null,"body","body",1016933652),null);return foundation.app.xhr.xhr.call(null,uri,"POST",body,cljs.core.merge.call(null,foundation.app.xhr._STAR_headers_STAR_,headers));
};
var POST = function (uri,var_args){
var p__38648 = null;if (arguments.length > 1) {
  p__38648 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return POST__delegate.call(this,uri,p__38648);};
POST.cljs$lang$maxFixedArity = 1;
POST.cljs$lang$applyTo = (function (arglist__38651){
var uri = cljs.core.first(arglist__38651);
var p__38648 = cljs.core.rest(arglist__38651);
return POST__delegate(uri,p__38648);
});
...
var PUT__delegate = function (uri,p__38652){var map__38654 = p__38652;var map__38654__$1 = ((cljs.core.seq_QMARK_.call(null,map__38654))?cljs.core.apply.call(null,cljs.core.hash_map,map__38654):map__38654);var headers = cljs.core.get.call(null,map__38654__$1,new cljs.core.Keyword(null,"headers","headers",1809212152),cljs.core.PersistentArrayMap.EMPTY);var body = cljs.core.get.call(null,map__38654__$1,new cljs.core.Keyword(null,"body","body",1016933652),null);return foundation.app.xhr.xhr.call(null,uri,"PUT",body,cljs.core.merge.call(null,foundation.app.xhr._STAR_headers_STAR_,headers));
};
var PUT = function (uri,var_args){
var p__38652 = null;if (arguments.length > 1) {
  p__38652 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return PUT__delegate.call(this,uri,p__38652);};
PUT.cljs$lang$maxFixedArity = 1;
PUT.cljs$lang$applyTo = (function (arglist__38655){
var uri = cljs.core.first(arglist__38655);
var p__38652 = cljs.core.rest(arglist__38655);
return PUT__delegate(uri,p__38652);
});
...
var DELETE__delegate = function (uri,p__38656){var map__38658 = p__38656;var map__38658__$1 = ((cljs.core.seq_QMARK_.call(null,map__38658))?cljs.core.apply.call(null,cljs.core.hash_map,map__38658):map__38658);var headers = cljs.core.get.call(null,map__38658__$1,new cljs.core.Keyword(null,"headers","headers",1809212152),cljs.core.PersistentArrayMap.EMPTY);var body = cljs.core.get.call(null,map__38658__$1,new cljs.core.Keyword(null,"body","body",1016933652),null);return foundation.app.xhr.xhr.call(null,uri,"DELETE",null,cljs.core.merge.call(null,foundation.app.xhr._STAR_headers_STAR_,headers));
};
var DELETE = function (uri,var_args){
var p__38656 = null;if (arguments.length > 1) {
  p__38656 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return DELETE__delegate.call(this,uri,p__38656);};
DELETE.cljs$lang$maxFixedArity = 1;
DELETE.cljs$lang$applyTo = (function (arglist__38659){
var uri = cljs.core.first(arglist__38659);
var p__38656 = cljs.core.rest(arglist__38659);
return DELETE__delegate(uri,p__38656);
});
