...
{{
var G__86769 = cljs.core.pop.call(null,v__$1);
v__$1 = G__86769;
continue;
}
} else
...
{var pred__86773 = cljs.core._EQ_;var expr__86774 = limit;if(cljs.core.truth_(pred__86773.call(null,1,expr__86774)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__86773.call(null,2,expr__86774)))
...
var G__86776 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__86777 = (limit__$1 - 1);
var G__86778 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__86776;
limit__$1 = G__86777;
parts = G__86778;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___86780 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___86780))
{var replacement_86781 = temp__4090__auto___86780;buffer.append([cljs.core.str(replacement_86781)].join(''));
} else
{buffer.append(ch);
}
{
var G__86782 = (index + 1);
index = G__86782;
continue;
}
}
