...
var unparse__delegate = function (fmt,dt,p__58795){var map__58797 = p__58795;var map__58797__$1 = ((cljs.core.seq_QMARK_.call(null,map__58797))?cljs.core.apply.call(null,cljs.core.hash_map,map__58797):map__58797);var tz = cljs.core.get.call(null,map__58797__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__58795 = null;if (arguments.length > 2) {
  p__58795 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__58795);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__58798){
var fmt = cljs.core.first(arglist__58798);
arglist__58798 = cljs.core.next(arglist__58798);
var dt = cljs.core.first(arglist__58798);
var p__58795 = cljs.core.rest(arglist__58798);
return unparse__delegate(fmt,dt,p__58795);
});
...
var show_formatters__delegate = function (p__58799){var map__58805 = p__58799;var map__58805__$1 = ((cljs.core.seq_QMARK_.call(null,map__58805))?cljs.core.apply.call(null,cljs.core.hash_map,map__58805):map__58805);var date_like = cljs.core.get.call(null,map__58805__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__6982__auto__ = (function iter__58806(s__58807){return (new cljs.core.LazySeq(null,(function (){var s__58807__$1 = s__58807;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__58807__$1);if(temp__4098__auto__)
{var s__58807__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__58807__$2))
{var c__6980__auto__ = cljs.core.chunk_first.call(null,s__58807__$2);var size__6981__auto__ = cljs.core.count.call(null,c__6980__auto__);var b__58809 = cljs.core.chunk_buffer.call(null,size__6981__auto__);if((function (){var i__58808 = 0;while(true){
if((i__58808 < size__6981__auto__))
{var i = cljs.core._nth.call(null,c__6980__auto__,i__58808);cljs.core.chunk_append.call(null,b__58809,cljs_time.format.unparse.call(null,i,date_like));
{
var G__58810 = (i__58808 + 1);
i__58808 = G__58810;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__58809),iter__58806.call(null,cljs.core.chunk_rest.call(null,s__58807__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__58809),null);
}
} else
{var i = cljs.core.first.call(null,s__58807__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__58806.call(null,cljs.core.rest.call(null,s__58807__$2)));
}
} else
{return null;
}
...
var p__58799 = null;if (arguments.length > 0) {
  p__58799 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__58799);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__58811){
var p__58799 = cljs.core.seq(arglist__58811);
return show_formatters__delegate(p__58799);
});
