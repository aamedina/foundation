...
{{
var G__58103 = cljs.core.pop.call(null,v__$1);
v__$1 = G__58103;
continue;
}
} else
...
{var pred__58107 = cljs.core._EQ_;var expr__58108 = limit;if(cljs.core.truth_(pred__58107.call(null,1,expr__58108)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__58107.call(null,2,expr__58108)))
...
var G__58110 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__58111 = (limit__$1 - 1);
var G__58112 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__58110;
limit__$1 = G__58111;
parts = G__58112;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___58114 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___58114))
{var replacement_58115 = temp__4096__auto___58114;buffer.append([cljs.core.str(replacement_58115)].join(''));
} else
{buffer.append(ch);
}
{
var G__58116 = (index + 1);
index = G__58116;
continue;
}
}
