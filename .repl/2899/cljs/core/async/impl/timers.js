...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_57665 = 0;while(true){
if((i_57665 < arr.length))
{(arr[i_57665] = null);
{
var G__57666 = (i_57665 + 1);
i_57665 = G__57666;
continue;
}
} else
...
{var i_57672 = (self__.level + 1);while(true){
if((i_57672 <= (new_level + 1)))
{(update[i_57672] = self__.header);
{
var G__57673 = (i_57672 + 1);
i_57672 = G__57673;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_57674 = 0;while(true){
if((i_57674 <= self__.level))
{var links_57675 = (update[i_57674]).forward;if(((links_57675[i_57674]) === x__$1))
{(links_57675[i_57674] = (x__$1.forward[i_57674]));
{
var G__57676 = (i_57674 + 1);
i_57674 = G__57676;
continue;
}
} else
{{
var G__57677 = (i_57674 + 1);
i_57674 = G__57677;
continue;
}
}
