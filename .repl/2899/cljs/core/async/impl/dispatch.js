...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_57700 = 0;while(true){
var m_57701 = cljs.core.async.impl.dispatch.tasks.pop();if((m_57701 == null))
{} else
{m_57701.call(null);
if((count_57700 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__57702 = (count_57700 + 1);
count_57700 = G__57702;
continue;
}
} else
{}
