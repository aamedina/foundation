...
var unparse__delegate = function (fmt,dt,p__22529){var map__22531 = p__22529;var map__22531__$1 = ((cljs.core.seq_QMARK_.call(null,map__22531))?cljs.core.apply.call(null,cljs.core.hash_map,map__22531):map__22531);var tz = cljs.core.get.call(null,map__22531__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__22529 = null;if (arguments.length > 2) {
  p__22529 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__22529);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__22532){
var fmt = cljs.core.first(arglist__22532);
arglist__22532 = cljs.core.next(arglist__22532);
var dt = cljs.core.first(arglist__22532);
var p__22529 = cljs.core.rest(arglist__22532);
return unparse__delegate(fmt,dt,p__22529);
});
...
var show_formatters__delegate = function (p__22533){var map__22539 = p__22533;var map__22539__$1 = ((cljs.core.seq_QMARK_.call(null,map__22539))?cljs.core.apply.call(null,cljs.core.hash_map,map__22539):map__22539);var date_like = cljs.core.get.call(null,map__22539__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__8519__auto__ = (function iter__22540(s__22541){return (new cljs.core.LazySeq(null,(function (){var s__22541__$1 = s__22541;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__22541__$1);if(temp__4092__auto__)
{var s__22541__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__22541__$2))
{var c__8517__auto__ = cljs.core.chunk_first.call(null,s__22541__$2);var size__8518__auto__ = cljs.core.count.call(null,c__8517__auto__);var b__22543 = cljs.core.chunk_buffer.call(null,size__8518__auto__);if((function (){var i__22542 = 0;while(true){
if((i__22542 < size__8518__auto__))
{var i = cljs.core._nth.call(null,c__8517__auto__,i__22542);cljs.core.chunk_append.call(null,b__22543,cljs_time.format.unparse.call(null,i,date_like));
{
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__22543),iter__22540.call(null,cljs.core.chunk_rest.call(null,s__22541__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__22543),null);
}
} else
{var i = cljs.core.first.call(null,s__22541__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__22540.call(null,cljs.core.rest.call(null,s__22541__$2)));
}
} else
{return null;
}
...
});return iter__8519__auto__.call(null,cljs.core.sort.call(null,cljs.core.vals.call(null,cljs_time.format.formatters)));
};
var show_formatters = function (var_args){
var p__22533 = null;if (arguments.length > 0) {
  p__22533 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__22533);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__22545){
var p__22533 = cljs.core.seq(arglist__22545);
return show_formatters__delegate(p__22533);
});
