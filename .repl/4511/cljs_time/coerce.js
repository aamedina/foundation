...
goog.require('goog.date.DateTime');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj22509 = {};return obj22509;
})();
cljs_time.coerce.to_date_time = (function to_date_time(obj){if((function (){var and__7814__auto__ = obj;if(and__7814__auto__)
...
{var x__8429__auto__ = (((obj == null))?null:obj);return (function (){var or__7826__auto__ = (cljs_time.coerce.to_date_time[goog.typeOf(x__8429__auto__)]);if(or__7826__auto__)
{return or__7826__auto__;
} else
{var or__7826__auto____$1 = (cljs_time.coerce.to_date_time["_"]);if(or__7826__auto____$1)
...
* which parses
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__8519__auto__ = (function iter__22518(s__22519){return (new cljs.core.LazySeq(null,(function (){var s__22519__$1 = s__22519;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__22519__$1);if(temp__4092__auto__)
{var s__22519__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__22519__$2))
{var c__8517__auto__ = cljs.core.chunk_first.call(null,s__22519__$2);var size__8518__auto__ = cljs.core.count.call(null,c__8517__auto__);var b__22521 = cljs.core.chunk_buffer.call(null,size__8518__auto__);if((function (){var i__22520 = 0;while(true){
if((i__22520 < size__8518__auto__))
{var f = cljs.core._nth.call(null,c__8517__auto__,i__22520);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e22524){if((e22524 instanceof Error))
{var e = e22524;return null;
} else
...
{cljs.core.chunk_append.call(null,b__22521,d);
{
var G__22526 = (i__22520 + 1);
i__22520 = G__22526;
continue;
}
} else
{{
var G__22527 = (i__22520 + 1);
i__22520 = G__22527;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__22521),iter__22518.call(null,cljs.core.chunk_rest.call(null,s__22519__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__22521),null);
}
} else
{var f = cljs.core.first.call(null,s__22519__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e22525){if((e22525 instanceof Error))
{var e = e22525;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e22525;
} else
...
{return cljs.core.cons.call(null,d,iter__22518.call(null,cljs.core.rest.call(null,s__22519__$2)));
} else
{{
var G__22528 = cljs.core.rest.call(null,s__22519__$2);
s__22519__$1 = G__22528;
continue;
}
}
}
...
});return iter__8519__auto__.call(null,cljs.core.vals.call(null,cljs_time.format.formatters));
})());
});
/**
* Returns a DateTime instance in the UTC time zone corresponding to the given
...
*/
cljs_time.coerce.to_epoch = (function to_epoch(obj){var millis = cljs_time.coerce.to_long.call(null,obj);var and__7814__auto__ = millis;if(cljs.core.truth_(and__7814__auto__))
{return (millis / 1000);
} else
{return and__7814__auto__;
}
