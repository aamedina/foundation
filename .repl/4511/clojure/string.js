...
{{
var G__22546 = cljs.core.pop.call(null,v__$1);
v__$1 = G__22546;
continue;
}
} else
...
{var pred__22550 = cljs.core._EQ_;var expr__22551 = limit;if(cljs.core.truth_(pred__22550.call(null,1,expr__22551)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__22550.call(null,2,expr__22551)))
...
var G__22553 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__22554 = (limit__$1 - 1);
var G__22555 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__22553;
limit__$1 = G__22554;
parts = G__22555;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___22557 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___22557))
{var replacement_22558 = temp__4090__auto___22557;buffer.append([cljs.core.str(replacement_22558)].join(''));
} else
{buffer.append(ch);
}
{
var G__22559 = (index + 1);
index = G__22559;
continue;
}
}
