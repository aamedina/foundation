...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_22227 = 0;while(true){
var m_22228 = cljs.core.async.impl.dispatch.tasks.pop();if((m_22228 == null))
{} else
{m_22228.call(null);
if((count_22227 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__22229 = (count_22227 + 1);
count_22227 = G__22229;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7814__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7814__auto__)
