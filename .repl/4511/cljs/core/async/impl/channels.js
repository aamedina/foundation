...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t22233 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t22233 = (function (val,box,meta22234){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t22233.cljs$lang$type = true;
cljs.core.async.impl.channels.t22233.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t22233";
cljs.core.async.impl.channels.t22233.cljs$lang$ctorPrWriter = (function (this__8370__auto__,writer__8371__auto__,opt__8372__auto__){return cljs.core._write.call(null,writer__8371__auto__,"cljs.core.async.impl.channels/t22233");
});
cljs.core.async.impl.channels.t22233.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t22233.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22235){var self__ = this;
var _22235__$1 = this;return self__.meta22234;
});
cljs.core.async.impl.channels.t22233.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22235,meta22234__$1){var self__ = this;
var _22235__$1 = this;return (new cljs.core.async.impl.channels.t22233(self__.val,self__.box,meta22234__$1));
});
cljs.core.async.impl.channels.__GT_t22233 = (function __GT_t22233(val__$1,box__$1,meta22234){return (new cljs.core.async.impl.channels.t22233(val__$1,box__$1,meta22234));
});
}
return (new cljs.core.async.impl.channels.t22233(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8373__auto__,writer__8374__auto__,opts__8375__auto__){return cljs.core._write.call(null,writer__8374__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8370__auto__,writer__8371__auto__,opt__8372__auto__){return cljs.core._write.call(null,writer__8371__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_22236 = self__.takes.pop();if((taker_22236 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_22236))
{var take_cb_22237 = cljs.core.async.impl.protocols.commit.call(null,taker_22236);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_22237,taker_22236){
return (function (){return take_cb_22237.call(null,null);
});})(take_cb_22237,taker_22236))
);
} else
{}
{
