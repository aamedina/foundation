...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__8370__auto__,writer__8371__auto__,opt__8372__auto__){return cljs.core._write.call(null,writer__8371__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_22192 = 0;while(true){
if((i_22192 < arr.length))
{(arr[i_22192] = null);
{
var G__22193 = (i_22192 + 1);
i_22192 = G__22193;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__8370__auto__,writer__8371__auto__,opt__8372__auto__){return cljs.core._write.call(null,writer__8371__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_22199 = (self__.level + 1);while(true){
if((i_22199 <= (new_level + 1)))
{(update[i_22199] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_22201 = 0;while(true){
if((i_22201 <= self__.level))
{var links_22202 = (update[i_22201]).forward;if(((links_22202[i_22201]) === x__$1))
{(links_22202[i_22201] = (x__$1.forward[i_22201]));
{
var G__22203 = (i_22201 + 1);
i_22201 = G__22203;
continue;
}
} else
{{
var G__22204 = (i_22201 + 1);
i_22201 = G__22204;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__7826__auto__ = (cljs.core.truth_((function (){var and__7814__auto__ = me;if(cljs.core.truth_(and__7814__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__7814__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__7826__auto__))
