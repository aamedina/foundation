...
{{
var G__37145 = cljs.core.pop.call(null,v__$1);
v__$1 = G__37145;
continue;
}
} else
...
{var pred__37149 = cljs.core._EQ_;var expr__37150 = limit;if(pred__37149.call(null,1,expr__37150))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__37149.call(null,2,expr__37150))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__37152 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__37153 = (limit__$1 - 1);
var G__37154 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__37152;
limit__$1 = G__37153;
parts = G__37154;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___37156 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___37156))
{var replacement_37157 = temp__4090__auto___37156;buffer.append([cljs.core.str(replacement_37157)].join(''));
} else
{buffer.append(ch);
}
{
var G__37158 = (index + 1);
index = G__37158;
continue;
}
}
