...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__8175__auto__,writer__8176__auto__,opt__8177__auto__){return cljs.core._write.call(null,writer__8176__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_36842 = 0;while(true){
if((i_36842 < arr.length))
{(arr[i_36842] = null);
{
var G__36843 = (i_36842 + 1);
i_36842 = G__36843;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__8175__auto__,writer__8176__auto__,opt__8177__auto__){return cljs.core._write.call(null,writer__8176__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_36849 = (self__.level + 1);while(true){
if((i_36849 <= (new_level + 1)))
{(update[i_36849] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_36851 = 0;while(true){
if((i_36851 <= self__.level))
{var links_36852 = (update[i_36851]).forward;if(((links_36852[i_36851]) === x__$1))
{(links_36852[i_36851] = (x__$1.forward[i_36851]));
{
var G__36853 = (i_36851 + 1);
i_36851 = G__36853;
continue;
}
} else
{{
var G__36854 = (i_36851 + 1);
i_36851 = G__36854;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__7638__auto__ = (cljs.core.truth_((function (){var and__7629__auto__ = me;if(cljs.core.truth_(and__7629__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__7629__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__7638__auto__))
