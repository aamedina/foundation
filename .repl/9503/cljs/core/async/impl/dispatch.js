...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_36865 = 0;while(true){
var m_36866 = cljs.core.async.impl.dispatch.tasks.pop();if((m_36866 == null))
{} else
{m_36866.call(null);
if((count_36865 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__36867 = (count_36865 + 1);
count_36865 = G__36867;
continue;
}
} else
{}
