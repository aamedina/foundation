...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t36871 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t36871 = (function (val,box,meta36872){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t36871.cljs$lang$type = true;
cljs.core.async.impl.channels.t36871.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t36871";
cljs.core.async.impl.channels.t36871.cljs$lang$ctorPrWriter = (function (this__8175__auto__,writer__8176__auto__,opt__8177__auto__){return cljs.core._write.call(null,writer__8176__auto__,"cljs.core.async.impl.channels/t36871");
});
cljs.core.async.impl.channels.t36871.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t36871.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_36873){var self__ = this;
var _36873__$1 = this;return self__.meta36872;
});
cljs.core.async.impl.channels.t36871.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_36873,meta36872__$1){var self__ = this;
var _36873__$1 = this;return (new cljs.core.async.impl.channels.t36871(self__.val,self__.box,meta36872__$1));
});
cljs.core.async.impl.channels.__GT_t36871 = (function __GT_t36871(val__$1,box__$1,meta36872){return (new cljs.core.async.impl.channels.t36871(val__$1,box__$1,meta36872));
});
}
return (new cljs.core.async.impl.channels.t36871(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_36874 = self__.takes.pop();if((taker_36874 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_36874))
{var take_cb_36875 = cljs.core.async.impl.protocols.commit.call(null,taker_36874);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_36875,taker_36874){
return (function (){return take_cb_36875.call(null,null);
});})(take_cb_36875,taker_36874))
);
} else
{}
{
