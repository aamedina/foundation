...
cljs.reader.read_char = (function read_char(reader){if((function (){var and__7629__auto__ = reader;if(and__7629__auto__)
...
{var x__8234__auto__ = (((reader == null))?null:reader);return (function (){var or__7638__auto__ = (cljs.reader.read_char[goog.typeOf(x__8234__auto__)]);if(or__7638__auto__)
{return or__7638__auto__;
} else
{var or__7638__auto____$1 = (cljs.reader.read_char["_"]);if(or__7638__auto____$1)
...
cljs.reader.unread = (function unread(reader,ch){if((function (){var and__7629__auto__ = reader;if(and__7629__auto__)
...
{var x__8234__auto__ = (((reader == null))?null:reader);return (function (){var or__7638__auto__ = (cljs.reader.unread[goog.typeOf(x__8234__auto__)]);if(or__7638__auto__)
{return or__7638__auto__;
} else
{var or__7638__auto____$1 = (cljs.reader.unread["_"]);if(or__7638__auto____$1)
{return or__7638__auto____$1;
} else
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__8175__auto__,writer__8176__auto__,opt__8177__auto__){return cljs.core._write.call(null,writer__8176__auto__,"cljs.reader/StringPushbackReader");
});
...
*/
cljs.reader.whitespace_QMARK_ = (function whitespace_QMARK_(ch){var or__7638__auto__ = goog.string.isBreakingWhitespace(ch);if(cljs.core.truth_(or__7638__auto__))
{return or__7638__auto__;
} else
{return ("," === ch);
}
...
reader_error.cljs$lang$applyTo = (function (arglist__36962){
var rdr = cljs.core.first(arglist__36962);
var msg = cljs.core.rest(arglist__36962);
...
;
cljs.reader.macro_terminating_QMARK_ = (function macro_terminating_QMARK_(ch){var and__7629__auto__ = !((ch === "#"));if(and__7629__auto__)
{var and__7629__auto____$1 = !((ch === "'"));if(and__7629__auto____$1)
{var and__7629__auto____$2 = !((ch === ":"));if(and__7629__auto____$2)
...
{{
var G__36963 = (function (){sb.append(ch);
return sb;
})();
var G__36964 = cljs.reader.read_char.call(null,rdr);
sb = G__36963;
ch = G__36964;
continue;
}
...
{{
var G__36965 = cljs.reader.read_char.call(null,rdr);
ch = G__36965;
continue;
}
} else
...
var G__36966 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__36966;
continue;
}
} else
...
var G__36967 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__36967;
continue;
}
}
...
if(cljs.core.truth_((function (){var or__7638__auto__ = (ch == null);if(or__7638__auto__)
{return or__7638__auto__;
} else
{var or__7638__auto____$1 = cljs.reader.whitespace_QMARK_.call(null,ch);if(or__7638__auto____$1)
{return or__7638__auto____$1;
} else
{return cljs.reader.macros.call(null,ch);
}
...
var s = buffer.toString();var or__7638__auto__ = cljs.reader.match_number.call(null,s);if(cljs.core.truth_(or__7638__auto__))
{return or__7638__auto__;
} else
...
{{
var G__36968 = (function (){buffer.append(ch);
return buffer;
})();
var G__36969 = cljs.reader.read_char.call(null,reader);
buffer = G__36968;
ch = G__36969;
continue;
}
...
{if(("\\" === ch))
{{
var G__36970 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__36971 = cljs.reader.read_char.call(null,reader);
buffer = G__36970;
ch = G__36971;
continue;
}
...
{{
var G__36972 = (function (){buffer.append(ch);
return buffer;
})();
var G__36973 = cljs.reader.read_char.call(null,reader);
buffer = G__36972;
ch = G__36973;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__36975 = o;if(G__36975)
{var bit__8257__auto__ = (G__36975.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__8257__auto__) || (G__36975.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__36975.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__36975);
} else
{return false;
}
}
...
{{
var G__36976 = reader;
var G__36977 = eof_is_error;
var G__36978 = sentinel;
var G__36979 = is_recursive;
reader = G__36976;
eof_is_error = G__36977;
sentinel = G__36978;
is_recursive = G__36979;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__36980 = cljs.reader.read_comment.call(null,reader,ch);
var G__36981 = eof_is_error;
var G__36982 = sentinel;
var G__36983 = is_recursive;
reader = G__36980;
eof_is_error = G__36981;
sentinel = G__36982;
is_recursive = G__36983;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__36984 = reader;
var G__36985 = eof_is_error;
var G__36986 = sentinel;
var G__36987 = is_recursive;
reader = G__36984;
eof_is_error = G__36985;
sentinel = G__36986;
is_recursive = G__36987;
continue;
}
} else
{return res;
...
cljs.reader.leap_year_QMARK_ = (function leap_year_QMARK_(year){var and__7629__auto__ = cljs.reader.divisible_QMARK_.call(null,year,4);if(cljs.core.truth_(and__7629__auto__))
{var or__7638__auto__ = cljs.reader.indivisible_QMARK_.call(null,year,100);if(cljs.core.truth_(or__7638__auto__))
{return or__7638__auto__;
} else
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__36990 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__36990,0,null);var years = cljs.core.nth.call(null,vec__36990,1,null);var months = cljs.core.nth.call(null,vec__36990,2,null);var days = cljs.core.nth.call(null,vec__36990,3,null);var hours = cljs.core.nth.call(null,vec__36990,4,null);var minutes = cljs.core.nth.call(null,vec__36990,5,null);var seconds = cljs.core.nth.call(null,vec__36990,6,null);var fraction = cljs.core.nth.call(null,vec__36990,7,null);var offset_sign = cljs.core.nth.call(null,vec__36990,8,null);var offset_hours = cljs.core.nth.call(null,vec__36990,9,null);var offset_minutes = cljs.core.nth.call(null,vec__36990,10,null);var v = vec__36990;if(cljs.core.not.call(null,v))
{return cljs.reader.reader_error.call(null,null,[cljs.core.str("Unrecognized date/time syntax: "),cljs.core.str(s)].join(''));
} else
{var years__$1 = cljs.reader.parse_int.call(null,years);var months__$1 = (function (){var or__7638__auto__ = cljs.reader.parse_int.call(null,months);if(cljs.core.truth_(or__7638__auto__))
{return or__7638__auto__;
} else
{return 1;
}
})();var days__$1 = (function (){var or__7638__auto__ = cljs.reader.parse_int.call(null,days);if(cljs.core.truth_(or__7638__auto__))
{return or__7638__auto__;
} else
{return 1;
}
})();var hours__$1 = (function (){var or__7638__auto__ = cljs.reader.parse_int.call(null,hours);if(cljs.core.truth_(or__7638__auto__))
{return or__7638__auto__;
} else
{return 0;
}
})();var minutes__$1 = (function (){var or__7638__auto__ = cljs.reader.parse_int.call(null,minutes);if(cljs.core.truth_(or__7638__auto__))
{return or__7638__auto__;
} else
{return 0;
}
})();var seconds__$1 = (function (){var or__7638__auto__ = cljs.reader.parse_int.call(null,seconds);if(cljs.core.truth_(or__7638__auto__))
{return or__7638__auto__;
} else
{return 0;
}
})();var fraction__$1 = (function (){var or__7638__auto__ = cljs.reader.parse_int.call(null,cljs.reader.zero_fill_right_and_truncate.call(null,fraction,3));if(cljs.core.truth_(or__7638__auto__))
{return or__7638__auto__;
} else
{return 0;
}
})();var offset_sign__$1 = ((cljs.core._EQ_.call(null,offset_sign,"-"))?-1:1);var offset_hours__$1 = (function (){var or__7638__auto__ = cljs.reader.parse_int.call(null,offset_hours);if(cljs.core.truth_(or__7638__auto__))
{return or__7638__auto__;
} else
{return 0;
}
})();var offset_minutes__$1 = (function (){var or__7638__auto__ = cljs.reader.parse_int.call(null,offset_minutes);if(cljs.core.truth_(or__7638__auto__))
{return or__7638__auto__;
} else
{return 0;
}
...
{var vec__36992 = temp__4090__auto__;var years = cljs.core.nth.call(null,vec__36992,0,null);var months = cljs.core.nth.call(null,vec__36992,1,null);var days = cljs.core.nth.call(null,vec__36992,2,null);var hours = cljs.core.nth.call(null,vec__36992,3,null);var minutes = cljs.core.nth.call(null,vec__36992,4,null);var seconds = cljs.core.nth.call(null,vec__36992,5,null);var ms = cljs.core.nth.call(null,vec__36992,6,null);var offset = cljs.core.nth.call(null,vec__36992,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
