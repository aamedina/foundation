...
{{
var G__21582 = cljs.core.pop.call(null,v__$1);
v__$1 = G__21582;
continue;
}
} else
...
{var pred__21586 = cljs.core._EQ_;var expr__21587 = limit;if(cljs.core.truth_(pred__21586.call(null,1,expr__21587)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__21586.call(null,2,expr__21587)))
...
var G__21589 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__21590 = (limit__$1 - 1);
var G__21591 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__21589;
limit__$1 = G__21590;
parts = G__21591;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___21593 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___21593))
{var replacement_21594 = temp__4090__auto___21593;buffer.append([cljs.core.str(replacement_21594)].join(''));
} else
{buffer.append(ch);
}
{
var G__21595 = (index + 1);
index = G__21595;
continue;
}
}
