...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__32625 = m;var map__32625__$1 = ((cljs.core.seq_QMARK_.call(null,map__32625))?cljs.core.apply.call(null,cljs.core.hash_map,map__32625):map__32625);var line = cljs.core.get.call(null,map__32625__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__32625__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__32627 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__32627))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__32627))
...
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"default","default",2558708147),(function (m){var _STAR_print_fn_STAR_32628 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6304__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6304__auto__))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_32628;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_32629 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6304__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6304__auto__))
{return or__6304__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_32629;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_32630 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6304__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6304__auto__))
{return or__6304__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___32631 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___32631))
{var message_32632 = temp__4098__auto___32631;cljs.core.println.call(null,message_32632);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_32630;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_32633 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6304__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6304__auto__))
{return or__6304__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___32634 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___32634))
{var message_32635 = temp__4098__auto___32634;cljs.core.println.call(null,message_32635);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_32636;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_32637 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6304__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6304__auto__))
{return or__6304__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_32637;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__32638){
var ns_sym = cljs.core.first(arglist__32638);
arglist__32638 = cljs.core.next(arglist__32638);
var fixture_type = cljs.core.first(arglist__32638);
var fixture_fns = cljs.core.rest(arglist__32638);
...
{var t = temp__4098__auto__;var _STAR_testing_vars_STAR_32641 = cemerick.cljs.test._STAR_testing_vars_STAR_;try{cemerick.cljs.test._STAR_testing_vars_STAR_ = cljs.core.conj.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_,(function (){var or__6304__auto__ = new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));if(cljs.core.truth_(or__6304__auto__))
{return or__6304__auto__;
} else
{return v;
}
...
try{t.call(null);
}catch (e32642){if((e32642 instanceof Error))
{var e_32643 = e32642;cemerick.cljs.test.do_report.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"message","message",1968829305),"Uncaught exception, not in assertion.",new cljs.core.Keyword(null,"expected","expected",3373152810),null,new cljs.core.Keyword(null,"actual","actual",3885931776),e_32643], null));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e32642;
} else
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_32641;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__32648 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__32649 = null;var count__32650 = 0;var i__32651 = 0;while(true){
if((i__32651 < count__32650))
{var v = cljs.core._nth.call(null,chunk__32649,i__32651);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__32648,chunk__32649,count__32650,i__32651,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__32648,chunk__32649,count__32650,i__32651,v))
);
} else
{}
{
var G__32652 = seq__32648;
var G__32653 = chunk__32649;
var G__32654 = count__32650;
var G__32655 = (i__32651 + 1);
seq__32648 = G__32652;
chunk__32649 = G__32653;
count__32650 = G__32654;
i__32651 = G__32655;
continue;
}
} else
{var temp__4098__auto__ = cljs.core.seq.call(null,seq__32648);if(temp__4098__auto__)
{var seq__32648__$1 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__32648__$1))
{var c__7028__auto__ = cljs.core.chunk_first.call(null,seq__32648__$1);{
var G__32656 = cljs.core.chunk_rest.call(null,seq__32648__$1);
var G__32657 = c__7028__auto__;
var G__32658 = cljs.core.count.call(null,c__7028__auto__);
var G__32659 = 0;
seq__32648 = G__32656;
chunk__32649 = G__32657;
count__32650 = G__32658;
i__32651 = G__32659;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__32648__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__32648,chunk__32649,count__32650,i__32651,v,seq__32648__$1,temp__4098__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__32648,chunk__32649,count__32650,i__32651,v,seq__32648__$1,temp__4098__auto__))
);
} else
{}
{
var G__32660 = cljs.core.next.call(null,seq__32648__$1);
var G__32661 = null;
var G__32662 = 0;
var G__32663 = 0;
seq__32648 = G__32660;
chunk__32649 = G__32661;
count__32650 = G__32662;
i__32651 = G__32663;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_32665 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4096__auto___32666 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4096__auto___32666))
{var test_hook_32667 = temp__4096__auto___32666;test_hook_32667.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_32665;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__32668){
var namespaces = cljs.core.seq(arglist__32668);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__32669_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__32669_SHARP_));
