...
{{
var G__32670 = cljs.core.pop.call(null,v__$1);
v__$1 = G__32670;
continue;
}
} else
...
{var pred__32674 = cljs.core._EQ_;var expr__32675 = limit;if(cljs.core.truth_(pred__32674.call(null,1,expr__32675)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__32674.call(null,2,expr__32675)))
...
var G__32677 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__32678 = (limit__$1 - 1);
var G__32679 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__32677;
limit__$1 = G__32678;
parts = G__32679;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___32681 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___32681))
{var replacement_32682 = temp__4096__auto___32681;buffer.append([cljs.core.str(replacement_32682)].join(''));
} else
{buffer.append(ch);
}
{
var G__32683 = (index + 1);
index = G__32683;
continue;
}
}
