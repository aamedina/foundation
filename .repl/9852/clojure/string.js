...
{{
var G__54299 = cljs.core.pop.call(null,v__$1);
v__$1 = G__54299;
continue;
}
} else
...
{var pred__54303 = cljs.core._EQ_;var expr__54304 = limit;if(cljs.core.truth_(pred__54303.call(null,1,expr__54304)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__54303.call(null,2,expr__54304)))
...
var G__54306 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__54307 = (limit__$1 - 1);
var G__54308 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__54306;
limit__$1 = G__54307;
parts = G__54308;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___54310 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___54310))
{var replacement_54311 = temp__4090__auto___54310;buffer.append([cljs.core.str(replacement_54311)].join(''));
} else
{buffer.append(ch);
}
{
var G__54312 = (index + 1);
index = G__54312;
continue;
}
}
