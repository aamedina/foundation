...
goog.require('clojure.set');
foundation.app.data.dependency.DependencyGraph = {};
foundation.app.data.dependency.immediate_dependencies = (function immediate_dependencies(graph,node){if((function (){var and__7430__auto__ = graph;if(and__7430__auto__)
...
{var x__8035__auto__ = (((graph == null))?null:graph);return (function (){var or__7439__auto__ = (foundation.app.data.dependency.immediate_dependencies[goog.typeOf(x__8035__auto__)]);if(or__7439__auto__)
{return or__7439__auto__;
} else
{var or__7439__auto____$1 = (foundation.app.data.dependency.immediate_dependencies["_"]);if(or__7439__auto____$1)
...
foundation.app.data.dependency.immediate_dependents = (function immediate_dependents(graph,node){if((function (){var and__7430__auto__ = graph;if(and__7430__auto__)
...
{var x__8035__auto__ = (((graph == null))?null:graph);return (function (){var or__7439__auto__ = (foundation.app.data.dependency.immediate_dependents[goog.typeOf(x__8035__auto__)]);if(or__7439__auto__)
{return or__7439__auto__;
} else
{var or__7439__auto____$1 = (foundation.app.data.dependency.immediate_dependents["_"]);if(or__7439__auto____$1)
{return or__7439__auto____$1;
} else
...
foundation.app.data.dependency.transitive_dependencies = (function transitive_dependencies(graph,node){if((function (){var and__7430__auto__ = graph;if(and__7430__auto__)
...
{var x__8035__auto__ = (((graph == null))?null:graph);return (function (){var or__7439__auto__ = (foundation.app.data.dependency.transitive_dependencies[goog.typeOf(x__8035__auto__)]);if(or__7439__auto__)
{return or__7439__auto__;
} else
{var or__7439__auto____$1 = (foundation.app.data.dependency.transitive_dependencies["_"]);if(or__7439__auto____$1)
{return or__7439__auto____$1;
} else
...
foundation.app.data.dependency.transitive_dependents = (function transitive_dependents(graph,node){if((function (){var and__7430__auto__ = graph;if(and__7430__auto__)
...
{var x__8035__auto__ = (((graph == null))?null:graph);return (function (){var or__7439__auto__ = (foundation.app.data.dependency.transitive_dependents[goog.typeOf(x__8035__auto__)]);if(or__7439__auto__)
{return or__7439__auto__;
} else
{var or__7439__auto____$1 = (foundation.app.data.dependency.transitive_dependents["_"]);if(or__7439__auto____$1)
{return or__7439__auto____$1;
} else
...
foundation.app.data.dependency.nodes = (function nodes(graph){if((function (){var and__7430__auto__ = graph;if(and__7430__auto__)
...
{var x__8035__auto__ = (((graph == null))?null:graph);return (function (){var or__7439__auto__ = (foundation.app.data.dependency.nodes[goog.typeOf(x__8035__auto__)]);if(or__7439__auto__)
{return or__7439__auto__;
} else
{var or__7439__auto____$1 = (foundation.app.data.dependency.nodes["_"]);if(or__7439__auto____$1)
{return or__7439__auto____$1;
} else
...
foundation.app.data.dependency.DependencyGraphUpdate = {};
foundation.app.data.dependency.depend = (function depend(graph,node,dep){if((function (){var and__7430__auto__ = graph;if(and__7430__auto__)
...
{var x__8035__auto__ = (((graph == null))?null:graph);return (function (){var or__7439__auto__ = (foundation.app.data.dependency.depend[goog.typeOf(x__8035__auto__)]);if(or__7439__auto__)
{return or__7439__auto__;
} else
{var or__7439__auto____$1 = (foundation.app.data.dependency.depend["_"]);if(or__7439__auto____$1)
{return or__7439__auto____$1;
} else
...
foundation.app.data.dependency.remove_edge = (function remove_edge(graph,node,dep){if((function (){var and__7430__auto__ = graph;if(and__7430__auto__)
...
{var x__8035__auto__ = (((graph == null))?null:graph);return (function (){var or__7439__auto__ = (foundation.app.data.dependency.remove_edge[goog.typeOf(x__8035__auto__)]);if(or__7439__auto__)
{return or__7439__auto__;
} else
{var or__7439__auto____$1 = (foundation.app.data.dependency.remove_edge["_"]);if(or__7439__auto____$1)
{return or__7439__auto____$1;
} else
...
foundation.app.data.dependency.remove_all = (function remove_all(graph,node){if((function (){var and__7430__auto__ = graph;if(and__7430__auto__)
...
{var x__8035__auto__ = (((graph == null))?null:graph);return (function (){var or__7439__auto__ = (foundation.app.data.dependency.remove_all[goog.typeOf(x__8035__auto__)]);if(or__7439__auto__)
{return or__7439__auto__;
} else
{var or__7439__auto____$1 = (foundation.app.data.dependency.remove_all["_"]);if(or__7439__auto____$1)
{return or__7439__auto____$1;
} else
...
foundation.app.data.dependency.remove_node = (function remove_node(graph,node){if((function (){var and__7430__auto__ = graph;if(and__7430__auto__)
...
{var x__8035__auto__ = (((graph == null))?null:graph);return (function (){var or__7439__auto__ = (foundation.app.data.dependency.remove_node[goog.typeOf(x__8035__auto__)]);if(or__7439__auto__)
{return or__7439__auto__;
} else
{var or__7439__auto____$1 = (foundation.app.data.dependency.remove_node["_"]);if(or__7439__auto____$1)
{return or__7439__auto____$1;
} else
...
foundation.app.data.dependency.remove_from_map = (function remove_from_map(amap,x){return cljs.core.reduce.call(null,(function (m,p__29905){var vec__29906 = p__29905;var k = cljs.core.nth.call(null,vec__29906,0,null);var vs = cljs.core.nth.call(null,vec__29906,1,null);return cljs.core.assoc.call(null,m,k,cljs.core.disj.call(null,vs,x));
...
foundation.app.data.dependency.MapDependencyGraph.cljs$lang$ctorPrWriter = (function (this__7976__auto__,writer__7977__auto__,opt__7978__auto__){return cljs.core._write.call(null,writer__7977__auto__,"foundation.app.data.dependency/MapDependencyGraph");
});
...
var graph__$1 = this;if(cljs.core.truth_((function (){var or__7439__auto__ = cljs.core._EQ_.call(null,node,dep);if(or__7439__auto__)
{return or__7439__auto__;
} else
{return foundation.app.data.dependency.depends_QMARK_.call(null,graph__$1,dep,node);
}
})()))
{throw (new foundation.app.data.dependency.Exception([cljs.core.str("Circular dependency between "),cljs.core.str(cljs.core.pr_str.call(null,node)),cljs.core.str(" and "),cljs.core.str(cljs.core.pr_str.call(null,dep))].join('')));
} else
{}
return (new foundation.app.data.dependency.MapDependencyGraph(cljs.core.update_in.call(null,self__.dependencies,cljs.core.PersistentVector.fromArray([node], true),foundation.app.data.dependency.set_conj,dep),cljs.core.update_in.call(null,self__.dependents,cljs.core.PersistentVector.fromArray([dep], true),foundation.app.data.dependency.set_conj,node)));
});
...
var graph__$1 = this;return (new foundation.app.data.dependency.MapDependencyGraph(cljs.core.update_in.call(null,self__.dependencies,cljs.core.PersistentVector.fromArray([node], true),cljs.core.disj,dep),cljs.core.update_in.call(null,self__.dependents,cljs.core.PersistentVector.fromArray([dep], true),cljs.core.disj,node)));
});
...
return (function (p1__29907_SHARP_){return cljs.core.empty_QMARK_.call(null,foundation.app.data.dependency.immediate_dependents.call(null,graph,p1__29907_SHARP_));
});})(sorted,g))
,foundation.app.data.dependency.nodes.call(null,graph)));while(true){
if(cljs.core.empty_QMARK_.call(null,todo))
{return sorted;
} else
{var vec__29910 = cljs.core.seq.call(null,todo);var node = cljs.core.nth.call(null,vec__29910,0,null);var more = cljs.core.nthnext.call(null,vec__29910,1);var deps = foundation.app.data.dependency.immediate_dependencies.call(null,g,node);var vec__29911 = (function (){var deps__$1 = deps;var g__$1 = g;var add = cljs.core.PersistentHashSet.EMPTY;while(true){
...
{{
var G__29912 = cljs.core.rest.call(null,deps__$1);
var G__29913 = g_SINGLEQUOTE_;
var G__29914 = cljs.core.conj.call(null,add,d);
deps__$1 = G__29912;
g__$1 = G__29913;
add = G__29914;
continue;
...
{{
var G__29915 = cljs.core.rest.call(null,deps__$1);
var G__29916 = g_SINGLEQUOTE_;
var G__29917 = add;
deps__$1 = G__29915;
g__$1 = G__29916;
add = G__29917;
...
{return cljs.core.PersistentVector.fromArray([add,g__$1], true);
}
break;
}
})();var add = cljs.core.nth.call(null,vec__29911,0,null);var g_SINGLEQUOTE_ = cljs.core.nth.call(null,vec__29911,1,null);{
var G__29918 = cljs.core.cons.call(null,node,sorted);
var G__29919 = foundation.app.data.dependency.remove_node.call(null,g_SINGLEQUOTE_,node);
var G__29920 = clojure.set.union.call(null,cljs.core.set.call(null,more),cljs.core.set.call(null,add));
sorted = G__29918;
g = G__29919;
todo = G__29920;
continue;
...
*/
foundation.app.data.dependency.topo_comparator = (function topo_comparator(graph){var pos = cljs.core.zipmap.call(null,foundation.app.data.dependency.topo_sort.call(null,graph),cljs.core.range.call(null));return (function (a,b){return cljs.core.compare.call(null,cljs.core.get.call(null,pos,a,Long.MAX_VALUE),cljs.core.get.call(null,pos,b,Long.MAX_VALUE));
});
});
