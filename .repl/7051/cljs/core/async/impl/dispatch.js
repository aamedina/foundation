...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_32469 = 0;while(true){
var m_32470 = cljs.core.async.impl.dispatch.tasks.pop();if((m_32470 == null))
{} else
{m_32470.call(null);
if((count_32469 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__32471 = (count_32469 + 1);
count_32469 = G__32471;
continue;
}
} else
{}
