...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_32446 = 0;while(true){
if((i_32446 < arr.length))
{(arr[i_32446] = null);
{
...
{var i_32453 = (self__.level + 1);while(true){
if((i_32453 <= (new_level + 1)))
{(update[i_32453] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_32455 = 0;while(true){
if((i_32455 <= self__.level))
{var links_32456 = (update[i_32455]).forward;if(((links_32456[i_32455]) === x__$1))
{(links_32456[i_32455] = (x__$1.forward[i_32455]));
{
var G__32457 = (i_32455 + 1);
i_32455 = G__32457;
continue;
}
} else
{{
var G__32458 = (i_32455 + 1);
i_32455 = G__32458;
continue;
}
}
