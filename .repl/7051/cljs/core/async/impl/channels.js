...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t32475 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t32475 = (function (val,box,meta32476){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t32475.cljs$lang$type = true;
cljs.core.async.impl.channels.t32475.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t32475";
cljs.core.async.impl.channels.t32475.cljs$lang$ctorPrWriter = (function (this__7976__auto__,writer__7977__auto__,opt__7978__auto__){return cljs.core._write.call(null,writer__7977__auto__,"cljs.core.async.impl.channels/t32475");
});
cljs.core.async.impl.channels.t32475.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t32475.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_32477){var self__ = this;
var _32477__$1 = this;return self__.meta32476;
});
cljs.core.async.impl.channels.t32475.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_32477,meta32476__$1){var self__ = this;
var _32477__$1 = this;return (new cljs.core.async.impl.channels.t32475(self__.val,self__.box,meta32476__$1));
});
cljs.core.async.impl.channels.__GT_t32475 = (function __GT_t32475(val__$1,box__$1,meta32476){return (new cljs.core.async.impl.channels.t32475(val__$1,box__$1,meta32476));
});
}
return (new cljs.core.async.impl.channels.t32475(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_32478 = self__.takes.pop();if((taker_32478 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_32478))
{var take_cb_32479 = cljs.core.async.impl.protocols.commit.call(null,taker_32478);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_32479,taker_32478){
return (function (){return take_cb_32479.call(null,null);
});})(take_cb_32479,taker_32478))
);
} else
{}
{
