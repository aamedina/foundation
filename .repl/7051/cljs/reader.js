...
reader_error.cljs$lang$applyTo = (function (arglist__32566){
var rdr = cljs.core.first(arglist__32566);
var msg = cljs.core.rest(arglist__32566);
...
{{
var G__32567 = (function (){sb.append(ch);
return sb;
})();
var G__32568 = cljs.reader.read_char.call(null,rdr);
sb = G__32567;
ch = G__32568;
continue;
}
...
{{
var G__32569 = cljs.reader.read_char.call(null,rdr);
ch = G__32569;
continue;
}
} else
...
var G__32570 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__32570;
continue;
}
} else
...
var G__32571 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__32571;
continue;
}
}
...
{{
var G__32572 = (function (){buffer.append(ch);
return buffer;
})();
var G__32573 = cljs.reader.read_char.call(null,reader);
buffer = G__32572;
ch = G__32573;
continue;
}
...
{if(("\\" === ch))
{{
var G__32574 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__32575 = cljs.reader.read_char.call(null,reader);
buffer = G__32574;
ch = G__32575;
continue;
}
...
{{
var G__32576 = (function (){buffer.append(ch);
return buffer;
})();
var G__32577 = cljs.reader.read_char.call(null,reader);
buffer = G__32576;
ch = G__32577;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__32579 = o;if(G__32579)
{var bit__8058__auto__ = (G__32579.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__8058__auto__) || (G__32579.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__32579.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__32579);
} else
{return false;
}
}
...
{{
var G__32580 = reader;
var G__32581 = eof_is_error;
var G__32582 = sentinel;
var G__32583 = is_recursive;
reader = G__32580;
eof_is_error = G__32581;
sentinel = G__32582;
is_recursive = G__32583;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__32584 = cljs.reader.read_comment.call(null,reader,ch);
var G__32585 = eof_is_error;
var G__32586 = sentinel;
var G__32587 = is_recursive;
reader = G__32584;
eof_is_error = G__32585;
sentinel = G__32586;
is_recursive = G__32587;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__32588 = reader;
var G__32589 = eof_is_error;
var G__32590 = sentinel;
var G__32591 = is_recursive;
reader = G__32588;
eof_is_error = G__32589;
sentinel = G__32590;
is_recursive = G__32591;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__32594 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__32594,0,null);var years = cljs.core.nth.call(null,vec__32594,1,null);var months = cljs.core.nth.call(null,vec__32594,2,null);var days = cljs.core.nth.call(null,vec__32594,3,null);var hours = cljs.core.nth.call(null,vec__32594,4,null);var minutes = cljs.core.nth.call(null,vec__32594,5,null);var seconds = cljs.core.nth.call(null,vec__32594,6,null);var fraction = cljs.core.nth.call(null,vec__32594,7,null);var offset_sign = cljs.core.nth.call(null,vec__32594,8,null);var offset_hours = cljs.core.nth.call(null,vec__32594,9,null);var offset_minutes = cljs.core.nth.call(null,vec__32594,10,null);var v = vec__32594;if(cljs.core.not.call(null,v))
...
{var vec__32596 = temp__4090__auto__;var years = cljs.core.nth.call(null,vec__32596,0,null);var months = cljs.core.nth.call(null,vec__32596,1,null);var days = cljs.core.nth.call(null,vec__32596,2,null);var hours = cljs.core.nth.call(null,vec__32596,3,null);var minutes = cljs.core.nth.call(null,vec__32596,4,null);var seconds = cljs.core.nth.call(null,vec__32596,5,null);var ms = cljs.core.nth.call(null,vec__32596,6,null);var offset = cljs.core.nth.call(null,vec__32596,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
