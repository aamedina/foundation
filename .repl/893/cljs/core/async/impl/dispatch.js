...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_119626 = 0;while(true){
var m_119627 = cljs.core.async.impl.dispatch.tasks.pop();if((m_119627 == null))
{} else
{m_119627.call(null);
if((count_119626 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__119628 = (count_119626 + 1);
count_119626 = G__119628;
continue;
}
} else
{}
