...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_119591 = 0;while(true){
if((i_119591 < arr.length))
{(arr[i_119591] = null);
{
var G__119592 = (i_119591 + 1);
i_119591 = G__119592;
continue;
}
} else
...
var G__119594 = x__$1;
var G__119595 = k;
var G__119596 = (level - 1);
var G__119597 = update;
x = G__119594;
k = G__119595;
level = G__119596;
update = G__119597;
...
{var i_119598 = (self__.level + 1);while(true){
if((i_119598 <= (new_level + 1)))
{(update[i_119598] = self__.header);
{
var G__119599 = (i_119598 + 1);
i_119598 = G__119599;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_119600 = 0;while(true){
if((i_119600 <= self__.level))
{var links_119601 = (update[i_119600]).forward;if(((links_119601[i_119600]) === x__$1))
{(links_119601[i_119600] = (x__$1.forward[i_119600]));
{
var G__119602 = (i_119600 + 1);
i_119600 = G__119602;
continue;
}
} else
{{
var G__119603 = (i_119600 + 1);
i_119600 = G__119603;
continue;
}
}
