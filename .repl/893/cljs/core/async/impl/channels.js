...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t119632 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t119632 = (function (val,box,meta119633){
this.val = val;
this.box = box;
this.meta119633 = meta119633;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t119632.cljs$lang$type = true;
cljs.core.async.impl.channels.t119632.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t119632";
cljs.core.async.impl.channels.t119632.cljs$lang$ctorPrWriter = (function (this__6833__auto__,writer__6834__auto__,opt__6835__auto__){return cljs.core._write.call(null,writer__6834__auto__,"cljs.core.async.impl.channels/t119632");
});
cljs.core.async.impl.channels.t119632.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t119632.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_119634){var self__ = this;
var _119634__$1 = this;return self__.meta119633;
});
cljs.core.async.impl.channels.t119632.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_119634,meta119633__$1){var self__ = this;
var _119634__$1 = this;return (new cljs.core.async.impl.channels.t119632(self__.val,self__.box,meta119633__$1));
});
cljs.core.async.impl.channels.__GT_t119632 = (function __GT_t119632(val__$1,box__$1,meta119633){return (new cljs.core.async.impl.channels.t119632(val__$1,box__$1,meta119633));
});
}
return (new cljs.core.async.impl.channels.t119632(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_119635 = self__.takes.pop();if((taker_119635 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_119635))
{var take_cb_119636 = cljs.core.async.impl.protocols.commit.call(null,taker_119635);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_119636,taker_119635){
return (function (){return take_cb_119636.call(null,null);
});})(take_cb_119636,taker_119635))
);
} else
{}
{
