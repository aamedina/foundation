...
{{
var G__120029 = cljs.core.pop.call(null,v__$1);
v__$1 = G__120029;
continue;
}
} else
...
{var pred__120033 = cljs.core._EQ_;var expr__120034 = limit;if(cljs.core.truth_(pred__120033.call(null,1,expr__120034)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__120033.call(null,2,expr__120034)))
...
var G__120036 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__120037 = (limit__$1 - 1);
var G__120038 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__120036;
limit__$1 = G__120037;
parts = G__120038;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___120040 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___120040))
{var replacement_120041 = temp__4096__auto___120040;buffer.append([cljs.core.str(replacement_120041)].join(''));
} else
{buffer.append(ch);
}
{
var G__120042 = (index + 1);
index = G__120042;
continue;
}
}
