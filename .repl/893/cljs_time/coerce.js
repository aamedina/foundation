...
goog.require('goog.date.DateTime');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj120701 = {};return obj120701;
})();
...
* which parses
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__6982__auto__ = (function iter__120710(s__120711){return (new cljs.core.LazySeq(null,(function (){var s__120711__$1 = s__120711;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__120711__$1);if(temp__4098__auto__)
{var s__120711__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__120711__$2))
{var c__6980__auto__ = cljs.core.chunk_first.call(null,s__120711__$2);var size__6981__auto__ = cljs.core.count.call(null,c__6980__auto__);var b__120713 = cljs.core.chunk_buffer.call(null,size__6981__auto__);if((function (){var i__120712 = 0;while(true){
if((i__120712 < size__6981__auto__))
{var f = cljs.core._nth.call(null,c__6980__auto__,i__120712);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e120716){if((e120716 instanceof Error))
{var e = e120716;return null;
} else
...
{cljs.core.chunk_append.call(null,b__120713,d);
{
var G__120718 = (i__120712 + 1);
i__120712 = G__120718;
continue;
}
} else
{{
var G__120719 = (i__120712 + 1);
i__120712 = G__120719;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__120713),iter__120710.call(null,cljs.core.chunk_rest.call(null,s__120711__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__120713),null);
}
} else
{var f = cljs.core.first.call(null,s__120711__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e120717){if((e120717 instanceof Error))
{var e = e120717;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e120717;
} else
...
{return cljs.core.cons.call(null,d,iter__120710.call(null,cljs.core.rest.call(null,s__120711__$2)));
} else
{{
var G__120720 = cljs.core.rest.call(null,s__120711__$2);
s__120711__$1 = G__120720;
continue;
}
}
}
