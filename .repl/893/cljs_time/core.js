...
goog.require('goog.date.DateTime');
goog.require('goog.i18n.TimeZone');
cljs_time.core.DateTimeProtocol = (function (){var obj120609 = {};return obj120609;
})();
...
*/
cljs_time.core.today_at_midnight = (function today_at_midnight(){var G__120611 = (new goog.date.UtcDateTime());G__120611.setHours(0);
G__120611.setMinutes(0);
G__120611.setSeconds(0);
G__120611.setMilliseconds(0);
return G__120611;
});
/**
* Returns a DateTime for the begining of the Unix epoch in the UTC time zone.
*/
cljs_time.core.epoch = (function epoch(){var G__120613 = (new goog.date.UtcDateTime());G__120613.setTime(0);
return G__120613;
});
/**
...
var G__120614__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.plus_,cljs_time.core.plus_.call(null,dt,p),ps);
};
var G__120614 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__120614__delegate.call(this,dt,p,ps);};
G__120614.cljs$lang$maxFixedArity = 2;
G__120614.cljs$lang$applyTo = (function (arglist__120615){
var dt = cljs.core.first(arglist__120615);
arglist__120615 = cljs.core.next(arglist__120615);
var p = cljs.core.first(arglist__120615);
var ps = cljs.core.rest(arglist__120615);
return G__120614__delegate(dt,p,ps);
});
G__120614.cljs$core$IFn$_invoke$arity$variadic = G__120614__delegate;
return G__120614;
})()
;
...
var G__120616__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.minus_,cljs_time.core.minus_.call(null,dt,p),ps);
};
var G__120616 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__120616__delegate.call(this,dt,p,ps);};
G__120616.cljs$lang$maxFixedArity = 2;
G__120616.cljs$lang$applyTo = (function (arglist__120617){
var dt = cljs.core.first(arglist__120617);
arglist__120617 = cljs.core.next(arglist__120617);
var p = cljs.core.first(arglist__120617);
var ps = cljs.core.rest(arglist__120617);
return G__120616__delegate(dt,p,ps);
});
G__120616.cljs$core$IFn$_invoke$arity$variadic = G__120616__delegate;
return G__120616;
})()
;
...
extend.cljs$lang$applyTo = (function (arglist__120618){
var in$ = cljs.core.first(arglist__120618);
var by = cljs.core.rest(arglist__120618);
...
cljs_time.core.to_period = (function to_period(in$){var pred__120622 = cljs.core._EQ_;var expr__120623 = cljs.core.type.call(null,in$);if(cljs.core.truth_(pred__120622.call(null,goog.date.Interval,expr__120623)))
{return in$;
} else
{if(cljs.core.truth_(pred__120622.call(null,goog.date.DateRange,expr__120623)))
{return (new goog.date.Interval(0,0,0,0,0,((cljs_time.core.in_millis.call(null,in$) / 1000) | 0)));
} else
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__120623)].join('')));
}
}
});
/**
...
;
cljs_time.core.last_day_of_the_month = (function last_day_of_the_month(dt){var G__120626 = dt;G__120626.setDate(cljs_time.core.number_of_days_in_the_month.call(null,dt));
return G__120626;
});
cljs_time.core.first_day_of_the_month = (function first_day_of_the_month(dt){var G__120628 = dt;G__120628.setDate(1);
return G__120628;
});
...
var today_at__4 = (function (hours,minutes,seconds,millis){return cljs_time.core.date_time.call(null,(function (){var G__120630 = cljs_time.core.now.call(null);G__120630.setHourOfDay(hours);
G__120630.setMinuteOfHour(minutes);
G__120630.setSecondOfMinute(seconds);
G__120630.setMillisOfSecond(millis);
return G__120630;
})());
});
...
;
cljs_time.core.do_at_STAR_ = (function do_at_STAR_(base_date_time,body_fn){var ms = (base_date_time.getTime() - cljs_time.core.now.call(null).getTime());var c__13409__auto__ = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__13410__auto__ = (function (){var switch__13309__auto__ = (function (state_120667){var state_val_120668 = (state_120667[1]);if((state_val_120668 === 5))
{var _ = cljs.core.async.impl.ioc_helpers.add_exception_frame.call(null,state_120667,4,Error,null,3);var inst_120663 = body_fn.call(null);var state_120667__$1 = state_120667;var statearr_120669_120681 = state_120667__$1;(statearr_120669_120681[2] = inst_120663);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_120667__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_120668 === 4))
{var inst_120659 = (state_120667[2]);var state_120667__$1 = (function (){var statearr_120670 = state_120667;(statearr_120670[7] = inst_120659);
return statearr_120670;
})();var statearr_120671_120682 = state_120667__$1;(statearr_120671_120682[2] = null);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_120667__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_120668 === 3))
{var inst_120665 = (state_120667[2]);var state_120667__$1 = state_120667;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_120667__$1,inst_120665);
} else
{if((state_val_120668 === 2))
{var inst_120658 = (state_120667[2]);var state_120667__$1 = (function (){var statearr_120672 = state_120667;(statearr_120672[8] = inst_120658);
return statearr_120672;
})();var statearr_120673_120683 = state_120667__$1;(statearr_120673_120683[2] = null);
(statearr_120673_120683[1] = 5);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_120668 === 1))
{var inst_120656 = cljs.core.async.timeout.call(null,ms);var state_120667__$1 = state_120667;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_120667__$1,2,inst_120656);
} else
{return null;
}
}
...
var state_machine__13310__auto____0 = (function (){var statearr_120677 = (new Array(9));(statearr_120677[0] = state_machine__13310__auto__);
(statearr_120677[1] = 1);
return statearr_120677;
});
var state_machine__13310__auto____1 = (function (state_120667){while(true){
var ret_value__13311__auto__ = (function (){try{while(true){
var result__13312__auto__ = switch__13309__auto__.call(null,state_120667);if(cljs.core.keyword_identical_QMARK_.call(null,result__13312__auto__,new cljs.core.Keyword(null,"recur","recur",1122293407)))
{{
continue;
}
} else
...
}catch (e120678){if((e120678 instanceof Object))
{var ex__13313__auto__ = e120678;var statearr_120679_120684 = state_120667;(statearr_120679_120684[5] = ex__13313__auto__);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_120667);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
...
{{
var G__120685 = state_120667;
state_120667 = G__120685;
continue;
}
} else
...
state_machine__13310__auto__ = function(state_120667){
switch(arguments.length){
case 0:
return state_machine__13310__auto____0.call(this);
case 1:
return state_machine__13310__auto____1.call(this,state_120667);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
})();var state__13411__auto__ = (function (){var statearr_120680 = f__13410__auto__.call(null);(statearr_120680[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__13409__auto__);
...
cljs_time.core.Mappable = (function (){var obj120687 = {};return obj120687;
})();
...
{{
var G__120688 = [cljs.core.str("0"),cljs.core.str(ns)].join('');
ns = G__120688;
continue;
}
} else
...
var G__120689__delegate = function (arg,more){return cljs.core.apply.call(null,f,arg,cljs.core.concat.call(null,args,more));
};
var G__120689 = function (arg,var_args){
var more = null;if (arguments.length > 1) {
  more = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__120689__delegate.call(this,arg,more);};
G__120689.cljs$lang$maxFixedArity = 1;
G__120689.cljs$lang$applyTo = (function (arglist__120690){
var arg = cljs.core.first(arglist__120690);
var more = cljs.core.rest(arglist__120690);
return G__120689__delegate(arg,more);
});
G__120689.cljs$core$IFn$_invoke$arity$variadic = G__120689__delegate;
return G__120689;
})()
;
};
...
fpartial.cljs$lang$applyTo = (function (arglist__120691){
var f = cljs.core.first(arglist__120691);
var args = cljs.core.rest(arglist__120691);
