...
var unparse__delegate = function (fmt,dt,p__120721){var map__120723 = p__120721;var map__120723__$1 = ((cljs.core.seq_QMARK_.call(null,map__120723))?cljs.core.apply.call(null,cljs.core.hash_map,map__120723):map__120723);var tz = cljs.core.get.call(null,map__120723__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__120721 = null;if (arguments.length > 2) {
  p__120721 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__120721);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__120724){
var fmt = cljs.core.first(arglist__120724);
arglist__120724 = cljs.core.next(arglist__120724);
var dt = cljs.core.first(arglist__120724);
var p__120721 = cljs.core.rest(arglist__120724);
return unparse__delegate(fmt,dt,p__120721);
});
...
var show_formatters__delegate = function (p__120725){var map__120731 = p__120725;var map__120731__$1 = ((cljs.core.seq_QMARK_.call(null,map__120731))?cljs.core.apply.call(null,cljs.core.hash_map,map__120731):map__120731);var date_like = cljs.core.get.call(null,map__120731__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__6982__auto__ = (function iter__120732(s__120733){return (new cljs.core.LazySeq(null,(function (){var s__120733__$1 = s__120733;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__120733__$1);if(temp__4098__auto__)
{var s__120733__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__120733__$2))
{var c__6980__auto__ = cljs.core.chunk_first.call(null,s__120733__$2);var size__6981__auto__ = cljs.core.count.call(null,c__6980__auto__);var b__120735 = cljs.core.chunk_buffer.call(null,size__6981__auto__);if((function (){var i__120734 = 0;while(true){
if((i__120734 < size__6981__auto__))
{var i = cljs.core._nth.call(null,c__6980__auto__,i__120734);cljs.core.chunk_append.call(null,b__120735,cljs_time.format.unparse.call(null,i,date_like));
{
var G__120736 = (i__120734 + 1);
i__120734 = G__120736;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__120735),iter__120732.call(null,cljs.core.chunk_rest.call(null,s__120733__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__120735),null);
}
} else
{var i = cljs.core.first.call(null,s__120733__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__120732.call(null,cljs.core.rest.call(null,s__120733__$2)));
}
} else
{return null;
}
...
var p__120725 = null;if (arguments.length > 0) {
  p__120725 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__120725);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__120737){
var p__120725 = cljs.core.seq(arglist__120737);
return show_formatters__delegate(p__120725);
});
