...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj107010 = {};return obj107010;
})();
cljs.reader.read_char = (function read_char(reader){if((function (){var and__6277__auto__ = reader;if(and__6277__auto__)
...
{var x__6892__auto__ = (((reader == null))?null:reader);return (function (){var or__6289__auto__ = (cljs.reader.read_char[goog.typeOf(x__6892__auto__)]);if(or__6289__auto__)
{return or__6289__auto__;
} else
{var or__6289__auto____$1 = (cljs.reader.read_char["_"]);if(or__6289__auto____$1)
...
cljs.reader.unread = (function unread(reader,ch){if((function (){var and__6277__auto__ = reader;if(and__6277__auto__)
...
{var x__6892__auto__ = (((reader == null))?null:reader);return (function (){var or__6289__auto__ = (cljs.reader.unread[goog.typeOf(x__6892__auto__)]);if(or__6289__auto__)
{return or__6289__auto__;
} else
{var or__6289__auto____$1 = (cljs.reader.unread["_"]);if(or__6289__auto____$1)
{return or__6289__auto____$1;
} else
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__6833__auto__,writer__6834__auto__,opt__6835__auto__){return cljs.core._write.call(null,writer__6834__auto__,"cljs.reader/StringPushbackReader");
});
...
*/
cljs.reader.whitespace_QMARK_ = (function whitespace_QMARK_(ch){var or__6289__auto__ = goog.string.isBreakingWhitespace(ch);if(cljs.core.truth_(or__6289__auto__))
{return or__6289__auto__;
} else
{return ("," === ch);
}
...
reader_error.cljs$lang$applyTo = (function (arglist__107011){
var rdr = cljs.core.first(arglist__107011);
var msg = cljs.core.rest(arglist__107011);
...
;
cljs.reader.macro_terminating_QMARK_ = (function macro_terminating_QMARK_(ch){var and__6277__auto__ = !((ch === "#"));if(and__6277__auto__)
{var and__6277__auto____$1 = !((ch === "'"));if(and__6277__auto____$1)
{var and__6277__auto____$2 = !((ch === ":"));if(and__6277__auto____$2)
...
{{
var G__107012 = (function (){sb.append(ch);
return sb;
})();
var G__107013 = cljs.reader.read_char.call(null,rdr);
sb = G__107012;
ch = G__107013;
continue;
}
...
{{
var G__107014 = cljs.reader.read_char.call(null,rdr);
ch = G__107014;
continue;
}
} else
...
{var temp__4096__auto__ = cljs.reader.macros.call(null,ch);if(cljs.core.truth_(temp__4096__auto__))
{var macrofn = temp__4096__auto__;var mret = macrofn.call(null,rdr,ch);{
var G__107015 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__107015;
continue;
}
} else
...
var G__107016 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__107016;
continue;
}
}
...
{var temp__4096__auto__ = cljs.reader.maybe_read_tagged_type.call(null,rdr,ch);if(cljs.core.truth_(temp__4096__auto__))
...
if(cljs.core.truth_((function (){var or__6289__auto__ = (ch == null);if(or__6289__auto__)
{return or__6289__auto__;
} else
{var or__6289__auto____$1 = cljs.reader.whitespace_QMARK_.call(null,ch);if(or__6289__auto____$1)
{return or__6289__auto____$1;
} else
{return cljs.reader.macros.call(null,ch);
}
...
var s = buffer.toString();var or__6289__auto__ = cljs.reader.match_number.call(null,s);if(cljs.core.truth_(or__6289__auto__))
{return or__6289__auto__;
} else
...
{{
var G__107017 = (function (){buffer.append(ch);
return buffer;
})();
var G__107018 = cljs.reader.read_char.call(null,reader);
buffer = G__107017;
ch = G__107018;
continue;
}
...
{if(("\\" === ch))
{{
var G__107019 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__107020 = cljs.reader.read_char.call(null,reader);
buffer = G__107019;
ch = G__107020;
continue;
}
...
{{
var G__107021 = (function (){buffer.append(ch);
return buffer;
})();
var G__107022 = cljs.reader.read_char.call(null,reader);
buffer = G__107021;
ch = G__107022;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__107024 = o;if(G__107024)
{var bit__6915__auto__ = (G__107024.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__6915__auto__) || (G__107024.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__107024.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__107024);
} else
{return false;
}
}
...
{{
var G__107025 = reader;
var G__107026 = eof_is_error;
var G__107027 = sentinel;
var G__107028 = is_recursive;
reader = G__107025;
eof_is_error = G__107026;
sentinel = G__107027;
is_recursive = G__107028;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__107029 = cljs.reader.read_comment.call(null,reader,ch);
var G__107030 = eof_is_error;
var G__107031 = sentinel;
var G__107032 = is_recursive;
reader = G__107029;
eof_is_error = G__107030;
sentinel = G__107031;
is_recursive = G__107032;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__107033 = reader;
var G__107034 = eof_is_error;
var G__107035 = sentinel;
var G__107036 = is_recursive;
reader = G__107033;
eof_is_error = G__107034;
sentinel = G__107035;
is_recursive = G__107036;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__107039 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__107039,0,null);var years = cljs.core.nth.call(null,vec__107039,1,null);var months = cljs.core.nth.call(null,vec__107039,2,null);var days = cljs.core.nth.call(null,vec__107039,3,null);var hours = cljs.core.nth.call(null,vec__107039,4,null);var minutes = cljs.core.nth.call(null,vec__107039,5,null);var seconds = cljs.core.nth.call(null,vec__107039,6,null);var fraction = cljs.core.nth.call(null,vec__107039,7,null);var offset_sign = cljs.core.nth.call(null,vec__107039,8,null);var offset_hours = cljs.core.nth.call(null,vec__107039,9,null);var offset_minutes = cljs.core.nth.call(null,vec__107039,10,null);var v = vec__107039;if(cljs.core.not.call(null,v))
{return cljs.reader.reader_error.call(null,null,[cljs.core.str("Unrecognized date/time syntax: "),cljs.core.str(s)].join(''));
} else
{var years__$1 = cljs.reader.parse_int.call(null,years);var months__$1 = (function (){var or__6289__auto__ = cljs.reader.parse_int.call(null,months);if(cljs.core.truth_(or__6289__auto__))
{return or__6289__auto__;
} else
{return 1;
}
})();var days__$1 = (function (){var or__6289__auto__ = cljs.reader.parse_int.call(null,days);if(cljs.core.truth_(or__6289__auto__))
{return or__6289__auto__;
} else
{return 1;
}
})();var hours__$1 = (function (){var or__6289__auto__ = cljs.reader.parse_int.call(null,hours);if(cljs.core.truth_(or__6289__auto__))
{return or__6289__auto__;
} else
{return 0;
}
})();var minutes__$1 = (function (){var or__6289__auto__ = cljs.reader.parse_int.call(null,minutes);if(cljs.core.truth_(or__6289__auto__))
{return or__6289__auto__;
} else
{return 0;
}
})();var seconds__$1 = (function (){var or__6289__auto__ = cljs.reader.parse_int.call(null,seconds);if(cljs.core.truth_(or__6289__auto__))
{return or__6289__auto__;
} else
{return 0;
}
})();var fraction__$1 = (function (){var or__6289__auto__ = cljs.reader.parse_int.call(null,cljs.reader.zero_fill_right_and_truncate.call(null,fraction,3));if(cljs.core.truth_(or__6289__auto__))
{return or__6289__auto__;
} else
{return 0;
}
})();var offset_sign__$1 = ((cljs.core._EQ_.call(null,offset_sign,"-"))?-1:1);var offset_hours__$1 = (function (){var or__6289__auto__ = cljs.reader.parse_int.call(null,offset_hours);if(cljs.core.truth_(or__6289__auto__))
{return or__6289__auto__;
} else
{return 0;
}
})();var offset_minutes__$1 = (function (){var or__6289__auto__ = cljs.reader.parse_int.call(null,offset_minutes);if(cljs.core.truth_(or__6289__auto__))
{return or__6289__auto__;
} else
{return 0;
}
...
cljs.reader.parse_timestamp = (function parse_timestamp(ts){var temp__4096__auto__ = cljs.reader.parse_and_validate_timestamp.call(null,ts);if(cljs.core.truth_(temp__4096__auto__))
{var vec__107041 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__107041,0,null);var months = cljs.core.nth.call(null,vec__107041,1,null);var days = cljs.core.nth.call(null,vec__107041,2,null);var hours = cljs.core.nth.call(null,vec__107041,3,null);var minutes = cljs.core.nth.call(null,vec__107041,4,null);var seconds = cljs.core.nth.call(null,vec__107041,5,null);var ms = cljs.core.nth.call(null,vec__107041,6,null);var offset = cljs.core.nth.call(null,vec__107041,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
