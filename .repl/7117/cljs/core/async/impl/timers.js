...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_106604 = 0;while(true){
if((i_106604 < arr.length))
{(arr[i_106604] = null);
{
var G__106605 = (i_106604 + 1);
i_106604 = G__106605;
continue;
}
} else
...
var G__106607 = x__$1;
var G__106608 = k;
var G__106609 = (level - 1);
var G__106610 = update;
x = G__106607;
k = G__106608;
level = G__106609;
update = G__106610;
...
{var i_106611 = (self__.level + 1);while(true){
if((i_106611 <= (new_level + 1)))
{(update[i_106611] = self__.header);
{
var G__106612 = (i_106611 + 1);
i_106611 = G__106612;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_106613 = 0;while(true){
if((i_106613 <= self__.level))
{var links_106614 = (update[i_106613]).forward;if(((links_106614[i_106613]) === x__$1))
{(links_106614[i_106613] = (x__$1.forward[i_106613]));
{
var G__106615 = (i_106613 + 1);
i_106613 = G__106615;
continue;
}
} else
{{
var G__106616 = (i_106613 + 1);
i_106613 = G__106616;
continue;
}
}
