...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_106639 = 0;while(true){
var m_106640 = cljs.core.async.impl.dispatch.tasks.pop();if((m_106640 == null))
{} else
{m_106640.call(null);
if((count_106639 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__106641 = (count_106639 + 1);
count_106639 = G__106641;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__6277__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__6277__auto__)
