...
{{
var G__107042 = cljs.core.pop.call(null,v__$1);
v__$1 = G__107042;
continue;
}
} else
...
{var pred__107046 = cljs.core._EQ_;var expr__107047 = limit;if(cljs.core.truth_(pred__107046.call(null,1,expr__107047)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__107046.call(null,2,expr__107047)))
...
var G__107049 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__107050 = (limit__$1 - 1);
var G__107051 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__107049;
limit__$1 = G__107050;
parts = G__107051;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___107053 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___107053))
{var replacement_107054 = temp__4096__auto___107053;buffer.append([cljs.core.str(replacement_107054)].join(''));
} else
{buffer.append(ch);
}
{
var G__107055 = (index + 1);
index = G__107055;
continue;
}
}
