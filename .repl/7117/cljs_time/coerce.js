...
goog.require('goog.date.DateTime');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj107714 = {};return obj107714;
})();
...
* which parses
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__6982__auto__ = (function iter__107723(s__107724){return (new cljs.core.LazySeq(null,(function (){var s__107724__$1 = s__107724;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__107724__$1);if(temp__4098__auto__)
{var s__107724__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__107724__$2))
{var c__6980__auto__ = cljs.core.chunk_first.call(null,s__107724__$2);var size__6981__auto__ = cljs.core.count.call(null,c__6980__auto__);var b__107726 = cljs.core.chunk_buffer.call(null,size__6981__auto__);if((function (){var i__107725 = 0;while(true){
if((i__107725 < size__6981__auto__))
{var f = cljs.core._nth.call(null,c__6980__auto__,i__107725);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e107729){if((e107729 instanceof Error))
{var e = e107729;return null;
} else
...
{cljs.core.chunk_append.call(null,b__107726,d);
{
var G__107731 = (i__107725 + 1);
i__107725 = G__107731;
continue;
}
} else
{{
var G__107732 = (i__107725 + 1);
i__107725 = G__107732;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__107726),iter__107723.call(null,cljs.core.chunk_rest.call(null,s__107724__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__107726),null);
}
} else
{var f = cljs.core.first.call(null,s__107724__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e107730){if((e107730 instanceof Error))
{var e = e107730;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e107730;
} else
...
{return cljs.core.cons.call(null,d,iter__107723.call(null,cljs.core.rest.call(null,s__107724__$2)));
} else
{{
var G__107733 = cljs.core.rest.call(null,s__107724__$2);
s__107724__$1 = G__107733;
continue;
}
}
}
