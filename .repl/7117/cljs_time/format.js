...
var unparse__delegate = function (fmt,dt,p__107734){var map__107736 = p__107734;var map__107736__$1 = ((cljs.core.seq_QMARK_.call(null,map__107736))?cljs.core.apply.call(null,cljs.core.hash_map,map__107736):map__107736);var tz = cljs.core.get.call(null,map__107736__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__107734 = null;if (arguments.length > 2) {
  p__107734 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__107734);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__107737){
var fmt = cljs.core.first(arglist__107737);
arglist__107737 = cljs.core.next(arglist__107737);
var dt = cljs.core.first(arglist__107737);
var p__107734 = cljs.core.rest(arglist__107737);
return unparse__delegate(fmt,dt,p__107734);
});
...
var show_formatters__delegate = function (p__107738){var map__107744 = p__107738;var map__107744__$1 = ((cljs.core.seq_QMARK_.call(null,map__107744))?cljs.core.apply.call(null,cljs.core.hash_map,map__107744):map__107744);var date_like = cljs.core.get.call(null,map__107744__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__6982__auto__ = (function iter__107745(s__107746){return (new cljs.core.LazySeq(null,(function (){var s__107746__$1 = s__107746;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__107746__$1);if(temp__4098__auto__)
{var s__107746__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__107746__$2))
{var c__6980__auto__ = cljs.core.chunk_first.call(null,s__107746__$2);var size__6981__auto__ = cljs.core.count.call(null,c__6980__auto__);var b__107748 = cljs.core.chunk_buffer.call(null,size__6981__auto__);if((function (){var i__107747 = 0;while(true){
if((i__107747 < size__6981__auto__))
{var i = cljs.core._nth.call(null,c__6980__auto__,i__107747);cljs.core.chunk_append.call(null,b__107748,cljs_time.format.unparse.call(null,i,date_like));
{
var G__107749 = (i__107747 + 1);
i__107747 = G__107749;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__107748),iter__107745.call(null,cljs.core.chunk_rest.call(null,s__107746__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__107748),null);
}
} else
{var i = cljs.core.first.call(null,s__107746__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__107745.call(null,cljs.core.rest.call(null,s__107746__$2)));
}
} else
{return null;
}
...
});return iter__6982__auto__.call(null,cljs.core.sort.call(null,cljs.core.vals.call(null,cljs_time.format.formatters)));
};
var show_formatters = function (var_args){
var p__107738 = null;if (arguments.length > 0) {
  p__107738 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__107738);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__107750){
var p__107738 = cljs.core.seq(arglist__107750);
return show_formatters__delegate(p__107738);
});
