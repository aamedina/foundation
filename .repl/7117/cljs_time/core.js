...
goog.require('goog.date.DateTime');
goog.require('goog.i18n.TimeZone');
cljs_time.core.DateTimeProtocol = (function (){var obj107622 = {};return obj107622;
})();
...
*/
cljs_time.core.today_at_midnight = (function today_at_midnight(){var G__107624 = (new goog.date.UtcDateTime());G__107624.setHours(0);
G__107624.setMinutes(0);
G__107624.setSeconds(0);
G__107624.setMilliseconds(0);
return G__107624;
});
/**
* Returns a DateTime for the begining of the Unix epoch in the UTC time zone.
*/
cljs_time.core.epoch = (function epoch(){var G__107626 = (new goog.date.UtcDateTime());G__107626.setTime(0);
return G__107626;
});
/**
...
var G__107627__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.plus_,cljs_time.core.plus_.call(null,dt,p),ps);
};
var G__107627 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__107627__delegate.call(this,dt,p,ps);};
G__107627.cljs$lang$maxFixedArity = 2;
G__107627.cljs$lang$applyTo = (function (arglist__107628){
var dt = cljs.core.first(arglist__107628);
arglist__107628 = cljs.core.next(arglist__107628);
var p = cljs.core.first(arglist__107628);
var ps = cljs.core.rest(arglist__107628);
return G__107627__delegate(dt,p,ps);
});
G__107627.cljs$core$IFn$_invoke$arity$variadic = G__107627__delegate;
return G__107627;
})()
;
...
var G__107629__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.minus_,cljs_time.core.minus_.call(null,dt,p),ps);
};
var G__107629 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__107629__delegate.call(this,dt,p,ps);};
G__107629.cljs$lang$maxFixedArity = 2;
G__107629.cljs$lang$applyTo = (function (arglist__107630){
var dt = cljs.core.first(arglist__107630);
arglist__107630 = cljs.core.next(arglist__107630);
var p = cljs.core.first(arglist__107630);
var ps = cljs.core.rest(arglist__107630);
return G__107629__delegate(dt,p,ps);
});
G__107629.cljs$core$IFn$_invoke$arity$variadic = G__107629__delegate;
return G__107629;
})()
;
...
extend.cljs$lang$applyTo = (function (arglist__107631){
var in$ = cljs.core.first(arglist__107631);
var by = cljs.core.rest(arglist__107631);
...
cljs_time.core.to_period = (function to_period(in$){var pred__107635 = cljs.core._EQ_;var expr__107636 = cljs.core.type.call(null,in$);if(cljs.core.truth_(pred__107635.call(null,goog.date.Interval,expr__107636)))
{return in$;
} else
{if(cljs.core.truth_(pred__107635.call(null,goog.date.DateRange,expr__107636)))
{return (new goog.date.Interval(0,0,0,0,0,((cljs_time.core.in_millis.call(null,in$) / 1000) | 0)));
} else
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__107636)].join('')));
}
}
});
/**
...
;
cljs_time.core.last_day_of_the_month = (function last_day_of_the_month(dt){var G__107639 = dt;G__107639.setDate(cljs_time.core.number_of_days_in_the_month.call(null,dt));
return G__107639;
});
cljs_time.core.first_day_of_the_month = (function first_day_of_the_month(dt){var G__107641 = dt;G__107641.setDate(1);
return G__107641;
});
...
var today_at__4 = (function (hours,minutes,seconds,millis){return cljs_time.core.date_time.call(null,(function (){var G__107643 = cljs_time.core.now.call(null);G__107643.setHourOfDay(hours);
G__107643.setMinuteOfHour(minutes);
G__107643.setSecondOfMinute(seconds);
G__107643.setMillisOfSecond(millis);
return G__107643;
})());
});
...
;
cljs_time.core.do_at_STAR_ = (function do_at_STAR_(base_date_time,body_fn){var ms = (base_date_time.getTime() - cljs_time.core.now.call(null).getTime());var c__13409__auto__ = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__13410__auto__ = (function (){var switch__13309__auto__ = (function (state_107680){var state_val_107681 = (state_107680[1]);if((state_val_107681 === 5))
{var _ = cljs.core.async.impl.ioc_helpers.add_exception_frame.call(null,state_107680,4,Error,null,3);var inst_107676 = body_fn.call(null);var state_107680__$1 = state_107680;var statearr_107682_107694 = state_107680__$1;(statearr_107682_107694[2] = inst_107676);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_107680__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_107681 === 4))
{var inst_107672 = (state_107680[2]);var state_107680__$1 = (function (){var statearr_107683 = state_107680;(statearr_107683[7] = inst_107672);
return statearr_107683;
})();var statearr_107684_107695 = state_107680__$1;(statearr_107684_107695[2] = null);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_107680__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_107681 === 3))
{var inst_107678 = (state_107680[2]);var state_107680__$1 = state_107680;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_107680__$1,inst_107678);
} else
{if((state_val_107681 === 2))
{var inst_107671 = (state_107680[2]);var state_107680__$1 = (function (){var statearr_107685 = state_107680;(statearr_107685[8] = inst_107671);
return statearr_107685;
})();var statearr_107686_107696 = state_107680__$1;(statearr_107686_107696[2] = null);
(statearr_107686_107696[1] = 5);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_107681 === 1))
{var inst_107669 = cljs.core.async.timeout.call(null,ms);var state_107680__$1 = state_107680;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_107680__$1,2,inst_107669);
} else
{return null;
}
}
...
var state_machine__13310__auto____0 = (function (){var statearr_107690 = (new Array(9));(statearr_107690[0] = state_machine__13310__auto__);
(statearr_107690[1] = 1);
return statearr_107690;
});
var state_machine__13310__auto____1 = (function (state_107680){while(true){
var ret_value__13311__auto__ = (function (){try{while(true){
var result__13312__auto__ = switch__13309__auto__.call(null,state_107680);if(cljs.core.keyword_identical_QMARK_.call(null,result__13312__auto__,new cljs.core.Keyword(null,"recur","recur",1122293407)))
{{
continue;
}
} else
...
}catch (e107691){if((e107691 instanceof Object))
{var ex__13313__auto__ = e107691;var statearr_107692_107697 = state_107680;(statearr_107692_107697[5] = ex__13313__auto__);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_107680);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
...
{{
var G__107698 = state_107680;
state_107680 = G__107698;
continue;
}
} else
...
state_machine__13310__auto__ = function(state_107680){
switch(arguments.length){
case 0:
return state_machine__13310__auto____0.call(this);
case 1:
return state_machine__13310__auto____1.call(this,state_107680);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
})();var state__13411__auto__ = (function (){var statearr_107693 = f__13410__auto__.call(null);(statearr_107693[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__13409__auto__);
return statearr_107693;
})();return cljs.core.async.impl.ioc_helpers.run_state_machine_wrapped.call(null,state__13411__auto__);
}));
return c__13409__auto__;
});
cljs_time.core.Mappable = (function (){var obj107700 = {};return obj107700;
})();
...
{{
var G__107701 = [cljs.core.str("0"),cljs.core.str(ns)].join('');
ns = G__107701;
continue;
}
} else
...
var G__107702__delegate = function (arg,more){return cljs.core.apply.call(null,f,arg,cljs.core.concat.call(null,args,more));
};
var G__107702 = function (arg,var_args){
var more = null;if (arguments.length > 1) {
  more = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__107702__delegate.call(this,arg,more);};
G__107702.cljs$lang$maxFixedArity = 1;
G__107702.cljs$lang$applyTo = (function (arglist__107703){
var arg = cljs.core.first(arglist__107703);
var more = cljs.core.rest(arglist__107703);
return G__107702__delegate(arg,more);
});
G__107702.cljs$core$IFn$_invoke$arity$variadic = G__107702__delegate;
return G__107702;
})()
;
};
...
fpartial.cljs$lang$applyTo = (function (arglist__107704){
var f = cljs.core.first(arglist__107704);
var args = cljs.core.rest(arglist__107704);
