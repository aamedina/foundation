...
{{
var G__144725 = cljs.core.pop.call(null,v__$1);
v__$1 = G__144725;
continue;
}
} else
...
{var pred__144729 = cljs.core._EQ_;var expr__144730 = limit;if(cljs.core.truth_(pred__144729.call(null,1,expr__144730)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__144729.call(null,2,expr__144730)))
...
var G__144732 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__144733 = (limit__$1 - 1);
var G__144734 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__144732;
limit__$1 = G__144733;
parts = G__144734;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___144736 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___144736))
{var replacement_144737 = temp__4096__auto___144736;buffer.append([cljs.core.str(replacement_144737)].join(''));
} else
{buffer.append(ch);
}
{
var G__144738 = (index + 1);
index = G__144738;
continue;
}
}
