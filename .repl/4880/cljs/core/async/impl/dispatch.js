...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_144322 = 0;while(true){
var m_144323 = cljs.core.async.impl.dispatch.tasks.pop();if((m_144323 == null))
{} else
{m_144323.call(null);
if((count_144322 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__144324 = (count_144322 + 1);
count_144322 = G__144324;
continue;
}
} else
{}
