...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t144328 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t144328 = (function (val,box,meta144329){
this.val = val;
this.box = box;
this.meta144329 = meta144329;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t144328.cljs$lang$type = true;
cljs.core.async.impl.channels.t144328.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t144328";
cljs.core.async.impl.channels.t144328.cljs$lang$ctorPrWriter = (function (this__6833__auto__,writer__6834__auto__,opt__6835__auto__){return cljs.core._write.call(null,writer__6834__auto__,"cljs.core.async.impl.channels/t144328");
});
cljs.core.async.impl.channels.t144328.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t144328.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_144330){var self__ = this;
var _144330__$1 = this;return self__.meta144329;
});
cljs.core.async.impl.channels.t144328.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_144330,meta144329__$1){var self__ = this;
var _144330__$1 = this;return (new cljs.core.async.impl.channels.t144328(self__.val,self__.box,meta144329__$1));
});
cljs.core.async.impl.channels.__GT_t144328 = (function __GT_t144328(val__$1,box__$1,meta144329){return (new cljs.core.async.impl.channels.t144328(val__$1,box__$1,meta144329));
});
}
return (new cljs.core.async.impl.channels.t144328(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__6836__auto__,writer__6837__auto__,opts__6838__auto__){return cljs.core._write.call(null,writer__6837__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__6833__auto__,writer__6834__auto__,opt__6835__auto__){return cljs.core._write.call(null,writer__6834__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_144331 = self__.takes.pop();if((taker_144331 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_144331))
{var take_cb_144332 = cljs.core.async.impl.protocols.commit.call(null,taker_144331);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_144332,taker_144331){
return (function (){return take_cb_144332.call(null,null);
});})(take_cb_144332,taker_144331))
);
} else
{}
{
