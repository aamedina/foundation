...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__6833__auto__,writer__6834__auto__,opt__6835__auto__){return cljs.core._write.call(null,writer__6834__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_144287 = 0;while(true){
if((i_144287 < arr.length))
{(arr[i_144287] = null);
{
var G__144288 = (i_144287 + 1);
i_144287 = G__144288;
continue;
}
} else
...
var G__144290 = x__$1;
var G__144291 = k;
var G__144292 = (level - 1);
var G__144293 = update;
x = G__144290;
k = G__144291;
level = G__144292;
update = G__144293;
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__6833__auto__,writer__6834__auto__,opt__6835__auto__){return cljs.core._write.call(null,writer__6834__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_144294 = (self__.level + 1);while(true){
if((i_144294 <= (new_level + 1)))
{(update[i_144294] = self__.header);
{
var G__144295 = (i_144294 + 1);
i_144294 = G__144295;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_144296 = 0;while(true){
if((i_144296 <= self__.level))
{var links_144297 = (update[i_144296]).forward;if(((links_144297[i_144296]) === x__$1))
{(links_144297[i_144296] = (x__$1.forward[i_144296]));
{
var G__144298 = (i_144296 + 1);
i_144296 = G__144298;
continue;
}
} else
{{
var G__144299 = (i_144296 + 1);
i_144296 = G__144299;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__6289__auto__ = (cljs.core.truth_((function (){var and__6277__auto__ = me;if(cljs.core.truth_(and__6277__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__6277__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__6289__auto__))
