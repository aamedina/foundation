...
var unparse__delegate = function (fmt,dt,p__145417){var map__145419 = p__145417;var map__145419__$1 = ((cljs.core.seq_QMARK_.call(null,map__145419))?cljs.core.apply.call(null,cljs.core.hash_map,map__145419):map__145419);var tz = cljs.core.get.call(null,map__145419__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__145417 = null;if (arguments.length > 2) {
  p__145417 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__145417);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__145420){
var fmt = cljs.core.first(arglist__145420);
arglist__145420 = cljs.core.next(arglist__145420);
var dt = cljs.core.first(arglist__145420);
var p__145417 = cljs.core.rest(arglist__145420);
return unparse__delegate(fmt,dt,p__145417);
});
...
var show_formatters__delegate = function (p__145421){var map__145427 = p__145421;var map__145427__$1 = ((cljs.core.seq_QMARK_.call(null,map__145427))?cljs.core.apply.call(null,cljs.core.hash_map,map__145427):map__145427);var date_like = cljs.core.get.call(null,map__145427__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__6982__auto__ = (function iter__145428(s__145429){return (new cljs.core.LazySeq(null,(function (){var s__145429__$1 = s__145429;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__145429__$1);if(temp__4098__auto__)
{var s__145429__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__145429__$2))
{var c__6980__auto__ = cljs.core.chunk_first.call(null,s__145429__$2);var size__6981__auto__ = cljs.core.count.call(null,c__6980__auto__);var b__145431 = cljs.core.chunk_buffer.call(null,size__6981__auto__);if((function (){var i__145430 = 0;while(true){
if((i__145430 < size__6981__auto__))
{var i = cljs.core._nth.call(null,c__6980__auto__,i__145430);cljs.core.chunk_append.call(null,b__145431,cljs_time.format.unparse.call(null,i,date_like));
{
var G__145432 = (i__145430 + 1);
i__145430 = G__145432;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__145431),iter__145428.call(null,cljs.core.chunk_rest.call(null,s__145429__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__145431),null);
}
} else
{var i = cljs.core.first.call(null,s__145429__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__145428.call(null,cljs.core.rest.call(null,s__145429__$2)));
}
} else
{return null;
}
...
var p__145421 = null;if (arguments.length > 0) {
  p__145421 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__145421);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__145433){
var p__145421 = cljs.core.seq(arglist__145433);
return show_formatters__delegate(p__145421);
});
