...
goog.require('goog.date.DateTime');
goog.require('goog.i18n.TimeZone');
cljs_time.core.DateTimeProtocol = (function (){var obj145305 = {};return obj145305;
})();
...
*/
cljs_time.core.today_at_midnight = (function today_at_midnight(){var G__145307 = (new goog.date.UtcDateTime());G__145307.setHours(0);
G__145307.setMinutes(0);
G__145307.setSeconds(0);
G__145307.setMilliseconds(0);
return G__145307;
});
/**
* Returns a DateTime for the begining of the Unix epoch in the UTC time zone.
*/
cljs_time.core.epoch = (function epoch(){var G__145309 = (new goog.date.UtcDateTime());G__145309.setTime(0);
return G__145309;
});
/**
...
var G__145310__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.plus_,cljs_time.core.plus_.call(null,dt,p),ps);
};
var G__145310 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__145310__delegate.call(this,dt,p,ps);};
G__145310.cljs$lang$maxFixedArity = 2;
G__145310.cljs$lang$applyTo = (function (arglist__145311){
var dt = cljs.core.first(arglist__145311);
arglist__145311 = cljs.core.next(arglist__145311);
var p = cljs.core.first(arglist__145311);
var ps = cljs.core.rest(arglist__145311);
return G__145310__delegate(dt,p,ps);
});
G__145310.cljs$core$IFn$_invoke$arity$variadic = G__145310__delegate;
return G__145310;
})()
;
...
var G__145312__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.minus_,cljs_time.core.minus_.call(null,dt,p),ps);
};
var G__145312 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__145312__delegate.call(this,dt,p,ps);};
G__145312.cljs$lang$maxFixedArity = 2;
G__145312.cljs$lang$applyTo = (function (arglist__145313){
var dt = cljs.core.first(arglist__145313);
arglist__145313 = cljs.core.next(arglist__145313);
var p = cljs.core.first(arglist__145313);
var ps = cljs.core.rest(arglist__145313);
return G__145312__delegate(dt,p,ps);
});
G__145312.cljs$core$IFn$_invoke$arity$variadic = G__145312__delegate;
return G__145312;
})()
;
...
extend.cljs$lang$applyTo = (function (arglist__145314){
var in$ = cljs.core.first(arglist__145314);
var by = cljs.core.rest(arglist__145314);
...
cljs_time.core.to_period = (function to_period(in$){var pred__145318 = cljs.core._EQ_;var expr__145319 = cljs.core.type.call(null,in$);if(cljs.core.truth_(pred__145318.call(null,goog.date.Interval,expr__145319)))
{return in$;
} else
{if(cljs.core.truth_(pred__145318.call(null,goog.date.DateRange,expr__145319)))
{return (new goog.date.Interval(0,0,0,0,0,((cljs_time.core.in_millis.call(null,in$) / 1000) | 0)));
} else
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__145319)].join('')));
}
}
});
/**
...
;
cljs_time.core.last_day_of_the_month = (function last_day_of_the_month(dt){var G__145322 = dt;G__145322.setDate(cljs_time.core.number_of_days_in_the_month.call(null,dt));
return G__145322;
});
cljs_time.core.first_day_of_the_month = (function first_day_of_the_month(dt){var G__145324 = dt;G__145324.setDate(1);
return G__145324;
});
...
var today_at__4 = (function (hours,minutes,seconds,millis){return cljs_time.core.date_time.call(null,(function (){var G__145326 = cljs_time.core.now.call(null);G__145326.setHourOfDay(hours);
G__145326.setMinuteOfHour(minutes);
G__145326.setSecondOfMinute(seconds);
G__145326.setMillisOfSecond(millis);
return G__145326;
})());
});
...
;
cljs_time.core.do_at_STAR_ = (function do_at_STAR_(base_date_time,body_fn){var ms = (base_date_time.getTime() - cljs_time.core.now.call(null).getTime());var c__13409__auto__ = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__13410__auto__ = (function (){var switch__13309__auto__ = (function (state_145363){var state_val_145364 = (state_145363[1]);if((state_val_145364 === 5))
{var _ = cljs.core.async.impl.ioc_helpers.add_exception_frame.call(null,state_145363,4,Error,null,3);var inst_145359 = body_fn.call(null);var state_145363__$1 = state_145363;var statearr_145365_145377 = state_145363__$1;(statearr_145365_145377[2] = inst_145359);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_145363__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_145364 === 4))
{var inst_145355 = (state_145363[2]);var state_145363__$1 = (function (){var statearr_145366 = state_145363;(statearr_145366[7] = inst_145355);
return statearr_145366;
})();var statearr_145367_145378 = state_145363__$1;(statearr_145367_145378[2] = null);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_145363__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_145364 === 3))
{var inst_145361 = (state_145363[2]);var state_145363__$1 = state_145363;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_145363__$1,inst_145361);
} else
{if((state_val_145364 === 2))
{var inst_145354 = (state_145363[2]);var state_145363__$1 = (function (){var statearr_145368 = state_145363;(statearr_145368[8] = inst_145354);
return statearr_145368;
})();var statearr_145369_145379 = state_145363__$1;(statearr_145369_145379[2] = null);
(statearr_145369_145379[1] = 5);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_145364 === 1))
{var inst_145352 = cljs.core.async.timeout.call(null,ms);var state_145363__$1 = state_145363;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_145363__$1,2,inst_145352);
} else
{return null;
}
}
...
var state_machine__13310__auto____0 = (function (){var statearr_145373 = (new Array(9));(statearr_145373[0] = state_machine__13310__auto__);
(statearr_145373[1] = 1);
return statearr_145373;
});
var state_machine__13310__auto____1 = (function (state_145363){while(true){
var ret_value__13311__auto__ = (function (){try{while(true){
var result__13312__auto__ = switch__13309__auto__.call(null,state_145363);if(cljs.core.keyword_identical_QMARK_.call(null,result__13312__auto__,new cljs.core.Keyword(null,"recur","recur",1122293407)))
{{
continue;
}
} else
...
}catch (e145374){if((e145374 instanceof Object))
{var ex__13313__auto__ = e145374;var statearr_145375_145380 = state_145363;(statearr_145375_145380[5] = ex__13313__auto__);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_145363);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
...
{{
var G__145381 = state_145363;
state_145363 = G__145381;
continue;
}
} else
...
state_machine__13310__auto__ = function(state_145363){
switch(arguments.length){
case 0:
return state_machine__13310__auto____0.call(this);
case 1:
return state_machine__13310__auto____1.call(this,state_145363);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
})();var state__13411__auto__ = (function (){var statearr_145376 = f__13410__auto__.call(null);(statearr_145376[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__13409__auto__);
return statearr_145376;
})();return cljs.core.async.impl.ioc_helpers.run_state_machine_wrapped.call(null,state__13411__auto__);
}));
return c__13409__auto__;
});
cljs_time.core.Mappable = (function (){var obj145383 = {};return obj145383;
})();
...
{{
var G__145384 = [cljs.core.str("0"),cljs.core.str(ns)].join('');
ns = G__145384;
continue;
}
} else
...
var G__145385__delegate = function (arg,more){return cljs.core.apply.call(null,f,arg,cljs.core.concat.call(null,args,more));
};
var G__145385 = function (arg,var_args){
var more = null;if (arguments.length > 1) {
  more = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__145385__delegate.call(this,arg,more);};
G__145385.cljs$lang$maxFixedArity = 1;
G__145385.cljs$lang$applyTo = (function (arglist__145386){
var arg = cljs.core.first(arglist__145386);
var more = cljs.core.rest(arglist__145386);
return G__145385__delegate(arg,more);
});
G__145385.cljs$core$IFn$_invoke$arity$variadic = G__145385__delegate;
return G__145385;
})()
;
};
...
fpartial.cljs$lang$applyTo = (function (arglist__145387){
var f = cljs.core.first(arglist__145387);
var args = cljs.core.rest(arglist__145387);
