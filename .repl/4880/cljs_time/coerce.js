...
goog.require('goog.date.DateTime');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj145397 = {};return obj145397;
})();
...
* which parses
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__6982__auto__ = (function iter__145406(s__145407){return (new cljs.core.LazySeq(null,(function (){var s__145407__$1 = s__145407;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__145407__$1);if(temp__4098__auto__)
{var s__145407__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__145407__$2))
{var c__6980__auto__ = cljs.core.chunk_first.call(null,s__145407__$2);var size__6981__auto__ = cljs.core.count.call(null,c__6980__auto__);var b__145409 = cljs.core.chunk_buffer.call(null,size__6981__auto__);if((function (){var i__145408 = 0;while(true){
if((i__145408 < size__6981__auto__))
{var f = cljs.core._nth.call(null,c__6980__auto__,i__145408);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e145412){if((e145412 instanceof Error))
{var e = e145412;return null;
} else
...
{cljs.core.chunk_append.call(null,b__145409,d);
{
var G__145414 = (i__145408 + 1);
i__145408 = G__145414;
continue;
}
} else
{{
var G__145415 = (i__145408 + 1);
i__145408 = G__145415;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__145409),iter__145406.call(null,cljs.core.chunk_rest.call(null,s__145407__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__145409),null);
}
} else
{var f = cljs.core.first.call(null,s__145407__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e145413){if((e145413 instanceof Error))
{var e = e145413;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e145413;
} else
...
{return cljs.core.cons.call(null,d,iter__145406.call(null,cljs.core.rest.call(null,s__145407__$2)));
} else
{{
var G__145416 = cljs.core.rest.call(null,s__145407__$2);
s__145407__$1 = G__145416;
continue;
}
}
}
