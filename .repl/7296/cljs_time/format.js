...
var unparse__delegate = function (fmt,dt,p__45303){var map__45305 = p__45303;var map__45305__$1 = ((cljs.core.seq_QMARK_.call(null,map__45305))?cljs.core.apply.call(null,cljs.core.hash_map,map__45305):map__45305);var tz = cljs.core.get.call(null,map__45305__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__45303 = null;if (arguments.length > 2) {
  p__45303 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__45303);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__45306){
var fmt = cljs.core.first(arglist__45306);
arglist__45306 = cljs.core.next(arglist__45306);
var dt = cljs.core.first(arglist__45306);
var p__45303 = cljs.core.rest(arglist__45306);
return unparse__delegate(fmt,dt,p__45303);
});
...
var show_formatters__delegate = function (p__45307){var map__45313 = p__45307;var map__45313__$1 = ((cljs.core.seq_QMARK_.call(null,map__45313))?cljs.core.apply.call(null,cljs.core.hash_map,map__45313):map__45313);var date_like = cljs.core.get.call(null,map__45313__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__34988__auto__ = (function iter__45314(s__45315){return (new cljs.core.LazySeq(null,(function (){var s__45315__$1 = s__45315;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__45315__$1);if(temp__4098__auto__)
{var s__45315__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__45315__$2))
{var c__34986__auto__ = cljs.core.chunk_first.call(null,s__45315__$2);var size__34987__auto__ = cljs.core.count.call(null,c__34986__auto__);var b__45317 = cljs.core.chunk_buffer.call(null,size__34987__auto__);if((function (){var i__45316 = 0;while(true){
if((i__45316 < size__34987__auto__))
{var i = cljs.core._nth.call(null,c__34986__auto__,i__45316);cljs.core.chunk_append.call(null,b__45317,cljs_time.format.unparse.call(null,i,date_like));
{
var G__45318 = (i__45316 + 1);
i__45316 = G__45318;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__45317),iter__45314.call(null,cljs.core.chunk_rest.call(null,s__45315__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__45317),null);
}
} else
{var i = cljs.core.first.call(null,s__45315__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__45314.call(null,cljs.core.rest.call(null,s__45315__$2)));
}
} else
{return null;
}
...
});return iter__34988__auto__.call(null,cljs.core.sort.call(null,cljs.core.vals.call(null,cljs_time.format.formatters)));
};
var show_formatters = function (var_args){
var p__45307 = null;if (arguments.length > 0) {
  p__45307 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__45307);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__45319){
var p__45307 = cljs.core.seq(arglist__45319);
return show_formatters__delegate(p__45307);
});
