...
goog.require('goog.date.DateTime');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj45283 = {};return obj45283;
})();
cljs_time.coerce.to_date_time = (function to_date_time(obj){if((function (){var and__34283__auto__ = obj;if(and__34283__auto__)
...
{var x__34898__auto__ = (((obj == null))?null:obj);return (function (){var or__34295__auto__ = (cljs_time.coerce.to_date_time[goog.typeOf(x__34898__auto__)]);if(or__34295__auto__)
{return or__34295__auto__;
} else
{var or__34295__auto____$1 = (cljs_time.coerce.to_date_time["_"]);if(or__34295__auto____$1)
...
* which parses
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__34988__auto__ = (function iter__45292(s__45293){return (new cljs.core.LazySeq(null,(function (){var s__45293__$1 = s__45293;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__45293__$1);if(temp__4098__auto__)
{var s__45293__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__45293__$2))
{var c__34986__auto__ = cljs.core.chunk_first.call(null,s__45293__$2);var size__34987__auto__ = cljs.core.count.call(null,c__34986__auto__);var b__45295 = cljs.core.chunk_buffer.call(null,size__34987__auto__);if((function (){var i__45294 = 0;while(true){
if((i__45294 < size__34987__auto__))
{var f = cljs.core._nth.call(null,c__34986__auto__,i__45294);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e45298){if((e45298 instanceof Error))
{var e = e45298;return null;
} else
...
{cljs.core.chunk_append.call(null,b__45295,d);
{
var G__45300 = (i__45294 + 1);
i__45294 = G__45300;
continue;
}
} else
{{
var G__45301 = (i__45294 + 1);
i__45294 = G__45301;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__45295),iter__45292.call(null,cljs.core.chunk_rest.call(null,s__45293__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__45295),null);
}
} else
{var f = cljs.core.first.call(null,s__45293__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e45299){if((e45299 instanceof Error))
{var e = e45299;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e45299;
} else
...
{return cljs.core.cons.call(null,d,iter__45292.call(null,cljs.core.rest.call(null,s__45293__$2)));
} else
{{
var G__45302 = cljs.core.rest.call(null,s__45293__$2);
s__45293__$1 = G__45302;
continue;
}
}
}
...
});return iter__34988__auto__.call(null,cljs.core.vals.call(null,cljs_time.format.formatters));
})());
});
/**
* Returns a DateTime instance in the UTC time zone corresponding to the given
...
*/
cljs_time.coerce.to_epoch = (function to_epoch(obj){var millis = cljs_time.coerce.to_long.call(null,obj);var and__34283__auto__ = millis;if(cljs.core.truth_(and__34283__auto__))
{return (millis / 1000);
} else
{return and__34283__auto__;
}
