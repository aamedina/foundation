...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj45242 = {};return obj45242;
})();
cljs.reader.read_char = (function read_char(reader){if((function (){var and__34283__auto__ = reader;if(and__34283__auto__)
...
{var x__34898__auto__ = (((reader == null))?null:reader);return (function (){var or__34295__auto__ = (cljs.reader.read_char[goog.typeOf(x__34898__auto__)]);if(or__34295__auto__)
{return or__34295__auto__;
} else
{var or__34295__auto____$1 = (cljs.reader.read_char["_"]);if(or__34295__auto____$1)
...
cljs.reader.unread = (function unread(reader,ch){if((function (){var and__34283__auto__ = reader;if(and__34283__auto__)
...
{var x__34898__auto__ = (((reader == null))?null:reader);return (function (){var or__34295__auto__ = (cljs.reader.unread[goog.typeOf(x__34898__auto__)]);if(or__34295__auto__)
{return or__34295__auto__;
} else
{var or__34295__auto____$1 = (cljs.reader.unread["_"]);if(or__34295__auto____$1)
{return or__34295__auto____$1;
} else
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__34839__auto__,writer__34840__auto__,opt__34841__auto__){return cljs.core._write.call(null,writer__34840__auto__,"cljs.reader/StringPushbackReader");
});
...
*/
cljs.reader.whitespace_QMARK_ = (function whitespace_QMARK_(ch){var or__34295__auto__ = goog.string.isBreakingWhitespace(ch);if(cljs.core.truth_(or__34295__auto__))
{return or__34295__auto__;
} else
{return ("," === ch);
}
...
reader_error.cljs$lang$applyTo = (function (arglist__45243){
var rdr = cljs.core.first(arglist__45243);
var msg = cljs.core.rest(arglist__45243);
...
;
cljs.reader.macro_terminating_QMARK_ = (function macro_terminating_QMARK_(ch){var and__34283__auto__ = !((ch === "#"));if(and__34283__auto__)
{var and__34283__auto____$1 = !((ch === "'"));if(and__34283__auto____$1)
{var and__34283__auto____$2 = !((ch === ":"));if(and__34283__auto____$2)
...
{{
var G__45244 = (function (){sb.append(ch);
return sb;
})();
var G__45245 = cljs.reader.read_char.call(null,rdr);
sb = G__45244;
ch = G__45245;
continue;
}
...
{{
var G__45246 = cljs.reader.read_char.call(null,rdr);
ch = G__45246;
continue;
}
} else
...
var G__45247 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__45247;
continue;
}
} else
...
var G__45248 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__45248;
continue;
}
}
...
if(cljs.core.truth_((function (){var or__34295__auto__ = (ch == null);if(or__34295__auto__)
{return or__34295__auto__;
} else
{var or__34295__auto____$1 = cljs.reader.whitespace_QMARK_.call(null,ch);if(or__34295__auto____$1)
{return or__34295__auto____$1;
} else
{return cljs.reader.macros.call(null,ch);
}
...
var s = buffer.toString();var or__34295__auto__ = cljs.reader.match_number.call(null,s);if(cljs.core.truth_(or__34295__auto__))
{return or__34295__auto__;
} else
...
{{
var G__45249 = (function (){buffer.append(ch);
return buffer;
})();
var G__45250 = cljs.reader.read_char.call(null,reader);
buffer = G__45249;
ch = G__45250;
continue;
}
...
{if(("\\" === ch))
{{
var G__45251 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__45252 = cljs.reader.read_char.call(null,reader);
buffer = G__45251;
ch = G__45252;
continue;
}
...
{{
var G__45253 = (function (){buffer.append(ch);
return buffer;
})();
var G__45254 = cljs.reader.read_char.call(null,reader);
buffer = G__45253;
ch = G__45254;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__45256 = o;if(G__45256)
{var bit__34921__auto__ = (G__45256.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__34921__auto__) || (G__45256.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__45256.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__45256);
} else
{return false;
}
}
...
{{
var G__45257 = reader;
var G__45258 = eof_is_error;
var G__45259 = sentinel;
var G__45260 = is_recursive;
reader = G__45257;
eof_is_error = G__45258;
sentinel = G__45259;
is_recursive = G__45260;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__45261 = cljs.reader.read_comment.call(null,reader,ch);
var G__45262 = eof_is_error;
var G__45263 = sentinel;
var G__45264 = is_recursive;
reader = G__45261;
eof_is_error = G__45262;
sentinel = G__45263;
is_recursive = G__45264;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__45265 = reader;
var G__45266 = eof_is_error;
var G__45267 = sentinel;
var G__45268 = is_recursive;
reader = G__45265;
eof_is_error = G__45266;
sentinel = G__45267;
is_recursive = G__45268;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__45271 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__45271,0,null);var years = cljs.core.nth.call(null,vec__45271,1,null);var months = cljs.core.nth.call(null,vec__45271,2,null);var days = cljs.core.nth.call(null,vec__45271,3,null);var hours = cljs.core.nth.call(null,vec__45271,4,null);var minutes = cljs.core.nth.call(null,vec__45271,5,null);var seconds = cljs.core.nth.call(null,vec__45271,6,null);var fraction = cljs.core.nth.call(null,vec__45271,7,null);var offset_sign = cljs.core.nth.call(null,vec__45271,8,null);var offset_hours = cljs.core.nth.call(null,vec__45271,9,null);var offset_minutes = cljs.core.nth.call(null,vec__45271,10,null);var v = vec__45271;if(cljs.core.not.call(null,v))
{return cljs.reader.reader_error.call(null,null,[cljs.core.str("Unrecognized date/time syntax: "),cljs.core.str(s)].join(''));
} else
{var years__$1 = cljs.reader.parse_int.call(null,years);var months__$1 = (function (){var or__34295__auto__ = cljs.reader.parse_int.call(null,months);if(cljs.core.truth_(or__34295__auto__))
{return or__34295__auto__;
} else
{return 1;
}
})();var days__$1 = (function (){var or__34295__auto__ = cljs.reader.parse_int.call(null,days);if(cljs.core.truth_(or__34295__auto__))
{return or__34295__auto__;
} else
{return 1;
}
})();var hours__$1 = (function (){var or__34295__auto__ = cljs.reader.parse_int.call(null,hours);if(cljs.core.truth_(or__34295__auto__))
{return or__34295__auto__;
} else
{return 0;
}
})();var minutes__$1 = (function (){var or__34295__auto__ = cljs.reader.parse_int.call(null,minutes);if(cljs.core.truth_(or__34295__auto__))
{return or__34295__auto__;
} else
{return 0;
}
})();var seconds__$1 = (function (){var or__34295__auto__ = cljs.reader.parse_int.call(null,seconds);if(cljs.core.truth_(or__34295__auto__))
{return or__34295__auto__;
} else
{return 0;
}
})();var fraction__$1 = (function (){var or__34295__auto__ = cljs.reader.parse_int.call(null,cljs.reader.zero_fill_right_and_truncate.call(null,fraction,3));if(cljs.core.truth_(or__34295__auto__))
{return or__34295__auto__;
} else
{return 0;
}
})();var offset_sign__$1 = ((cljs.core._EQ_.call(null,offset_sign,"-"))?-1:1);var offset_hours__$1 = (function (){var or__34295__auto__ = cljs.reader.parse_int.call(null,offset_hours);if(cljs.core.truth_(or__34295__auto__))
{return or__34295__auto__;
} else
{return 0;
}
})();var offset_minutes__$1 = (function (){var or__34295__auto__ = cljs.reader.parse_int.call(null,offset_minutes);if(cljs.core.truth_(or__34295__auto__))
{return or__34295__auto__;
} else
{return 0;
}
...
{var vec__45273 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__45273,0,null);var months = cljs.core.nth.call(null,vec__45273,1,null);var days = cljs.core.nth.call(null,vec__45273,2,null);var hours = cljs.core.nth.call(null,vec__45273,3,null);var minutes = cljs.core.nth.call(null,vec__45273,4,null);var seconds = cljs.core.nth.call(null,vec__45273,5,null);var ms = cljs.core.nth.call(null,vec__45273,6,null);var offset = cljs.core.nth.call(null,vec__45273,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
