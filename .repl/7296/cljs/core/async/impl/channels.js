...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t45180 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t45180 = (function (val,box,meta45181){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t45180.cljs$lang$type = true;
cljs.core.async.impl.channels.t45180.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t45180";
cljs.core.async.impl.channels.t45180.cljs$lang$ctorPrWriter = (function (this__34839__auto__,writer__34840__auto__,opt__34841__auto__){return cljs.core._write.call(null,writer__34840__auto__,"cljs.core.async.impl.channels/t45180");
});
cljs.core.async.impl.channels.t45180.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t45180.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_45182){var self__ = this;
var _45182__$1 = this;return self__.meta45181;
});
cljs.core.async.impl.channels.t45180.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_45182,meta45181__$1){var self__ = this;
var _45182__$1 = this;return (new cljs.core.async.impl.channels.t45180(self__.val,self__.box,meta45181__$1));
});
cljs.core.async.impl.channels.__GT_t45180 = (function __GT_t45180(val__$1,box__$1,meta45181){return (new cljs.core.async.impl.channels.t45180(val__$1,box__$1,meta45181));
});
}
return (new cljs.core.async.impl.channels.t45180(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__34842__auto__,writer__34843__auto__,opts__34844__auto__){return cljs.core._write.call(null,writer__34843__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__34839__auto__,writer__34840__auto__,opt__34841__auto__){return cljs.core._write.call(null,writer__34840__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_45183 = self__.takes.pop();if((taker_45183 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_45183))
{var take_cb_45184 = cljs.core.async.impl.protocols.commit.call(null,taker_45183);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_45184,taker_45183){
return (function (){return take_cb_45184.call(null,null);
});})(take_cb_45184,taker_45183))
);
} else
{}
{
