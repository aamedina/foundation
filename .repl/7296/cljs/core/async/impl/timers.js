...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__34839__auto__,writer__34840__auto__,opt__34841__auto__){return cljs.core._write.call(null,writer__34840__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_45139 = 0;while(true){
if((i_45139 < arr.length))
{(arr[i_45139] = null);
{
var G__45140 = (i_45139 + 1);
i_45139 = G__45140;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__34839__auto__,writer__34840__auto__,opt__34841__auto__){return cljs.core._write.call(null,writer__34840__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_45146 = (self__.level + 1);while(true){
if((i_45146 <= (new_level + 1)))
{(update[i_45146] = self__.header);
{
var G__45147 = (i_45146 + 1);
i_45146 = G__45147;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_45148 = 0;while(true){
if((i_45148 <= self__.level))
{var links_45149 = (update[i_45148]).forward;if(((links_45149[i_45148]) === x__$1))
{(links_45149[i_45148] = (x__$1.forward[i_45148]));
{
var G__45150 = (i_45148 + 1);
i_45148 = G__45150;
continue;
}
} else
{{
var G__45151 = (i_45148 + 1);
i_45148 = G__45151;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__34295__auto__ = (cljs.core.truth_((function (){var and__34283__auto__ = me;if(cljs.core.truth_(and__34283__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__34283__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__34295__auto__))
