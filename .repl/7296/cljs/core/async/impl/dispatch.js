...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_45174 = 0;while(true){
var m_45175 = cljs.core.async.impl.dispatch.tasks.pop();if((m_45175 == null))
{} else
{m_45175.call(null);
if((count_45174 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__45176 = (count_45174 + 1);
count_45174 = G__45176;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__34283__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__34283__auto__)
