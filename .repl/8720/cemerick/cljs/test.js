...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__18127 = m;var map__18127__$1 = ((cljs.core.seq_QMARK_.call(null,map__18127))?cljs.core.apply.call(null,cljs.core.hash_map,map__18127):map__18127);var line = cljs.core.get.call(null,map__18127__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__18127__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__18129 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__18129))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__18129))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_18130;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_18131 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6304__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6304__auto__))
{return or__6304__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_18131;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_18132 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6304__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6304__auto__))
{return or__6304__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___18133 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___18133))
{var message_18134 = temp__4098__auto___18133;cljs.core.println.call(null,message_18134);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_18132;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_18135 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6304__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6304__auto__))
{return or__6304__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___18136 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___18136))
{var message_18137 = temp__4098__auto___18136;cljs.core.println.call(null,message_18137);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_18135;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"summary","summary",3451231000),(function (m){var _STAR_print_fn_STAR_18138 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6304__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6304__auto__))
{return or__6304__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_18138;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_18139 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6304__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6304__auto__))
{return or__6304__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_18139;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__18140){
var ns_sym = cljs.core.first(arglist__18140);
arglist__18140 = cljs.core.next(arglist__18140);
var fixture_type = cljs.core.first(arglist__18140);
var fixture_fns = cljs.core.rest(arglist__18140);
...
{var t = temp__4098__auto__;var _STAR_testing_vars_STAR_18143 = cemerick.cljs.test._STAR_testing_vars_STAR_;try{cemerick.cljs.test._STAR_testing_vars_STAR_ = cljs.core.conj.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_,(function (){var or__6304__auto__ = new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));if(cljs.core.truth_(or__6304__auto__))
{return or__6304__auto__;
} else
{return v;
}
...
try{t.call(null);
}catch (e18144){if((e18144 instanceof Error))
{var e_18145 = e18144;cemerick.cljs.test.do_report.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"message","message",1968829305),"Uncaught exception, not in assertion.",new cljs.core.Keyword(null,"expected","expected",3373152810),null,new cljs.core.Keyword(null,"actual","actual",3885931776),e_18145], null));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e18144;
} else
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_18143;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__18150 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__18151 = null;var count__18152 = 0;var i__18153 = 0;while(true){
if((i__18153 < count__18152))
{var v = cljs.core._nth.call(null,chunk__18151,i__18153);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__18150,chunk__18151,count__18152,i__18153,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__18150,chunk__18151,count__18152,i__18153,v))
);
} else
{}
{
var G__18154 = seq__18150;
var G__18155 = chunk__18151;
var G__18156 = count__18152;
var G__18157 = (i__18153 + 1);
seq__18150 = G__18154;
chunk__18151 = G__18155;
count__18152 = G__18156;
i__18153 = G__18157;
continue;
}
} else
{var temp__4098__auto__ = cljs.core.seq.call(null,seq__18150);if(temp__4098__auto__)
{var seq__18150__$1 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__18150__$1))
{var c__7028__auto__ = cljs.core.chunk_first.call(null,seq__18150__$1);{
var G__18158 = cljs.core.chunk_rest.call(null,seq__18150__$1);
var G__18159 = c__7028__auto__;
var G__18160 = cljs.core.count.call(null,c__7028__auto__);
var G__18161 = 0;
seq__18150 = G__18158;
chunk__18151 = G__18159;
count__18152 = G__18160;
i__18153 = G__18161;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__18150__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__18150,chunk__18151,count__18152,i__18153,v,seq__18150__$1,temp__4098__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__18150,chunk__18151,count__18152,i__18153,v,seq__18150__$1,temp__4098__auto__))
);
} else
{}
{
var G__18162 = cljs.core.next.call(null,seq__18150__$1);
var G__18163 = null;
var G__18164 = 0;
var G__18165 = 0;
seq__18150 = G__18162;
chunk__18151 = G__18163;
count__18152 = G__18164;
i__18153 = G__18165;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_18167 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4096__auto___18168 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4096__auto___18168))
{var test_hook_18169 = temp__4096__auto___18168;test_hook_18169.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_18167;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__18170){
var namespaces = cljs.core.seq(arglist__18170);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__18171_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__18171_SHARP_));
