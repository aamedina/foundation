...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t22730 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t22730 = (function (val,box,meta22731){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t22730.cljs$lang$type = true;
cljs.core.async.impl.channels.t22730.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t22730";
cljs.core.async.impl.channels.t22730.cljs$lang$ctorPrWriter = (function (this__6848__auto__,writer__6849__auto__,opt__6850__auto__){return cljs.core._write.call(null,writer__6849__auto__,"cljs.core.async.impl.channels/t22730");
});
cljs.core.async.impl.channels.t22730.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t22730.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22732){var self__ = this;
var _22732__$1 = this;return self__.meta22731;
});
cljs.core.async.impl.channels.t22730.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22732,meta22731__$1){var self__ = this;
var _22732__$1 = this;return (new cljs.core.async.impl.channels.t22730(self__.val,self__.box,meta22731__$1));
});
cljs.core.async.impl.channels.__GT_t22730 = (function __GT_t22730(val__$1,box__$1,meta22731){return (new cljs.core.async.impl.channels.t22730(val__$1,box__$1,meta22731));
});
}
return (new cljs.core.async.impl.channels.t22730(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__6851__auto__,writer__6852__auto__,opts__6853__auto__){return cljs.core._write.call(null,writer__6852__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__6848__auto__,writer__6849__auto__,opt__6850__auto__){return cljs.core._write.call(null,writer__6849__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_22733 = self__.takes.pop();if((taker_22733 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_22733))
{var take_cb_22734 = cljs.core.async.impl.protocols.commit.call(null,taker_22733);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_22734,taker_22733){
return (function (){return take_cb_22734.call(null,null);
});})(take_cb_22734,taker_22733))
);
} else
{}
{
