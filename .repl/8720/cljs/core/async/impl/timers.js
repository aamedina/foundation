...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__6848__auto__,writer__6849__auto__,opt__6850__auto__){return cljs.core._write.call(null,writer__6849__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_22689 = 0;while(true){
if((i_22689 < arr.length))
{(arr[i_22689] = null);
{
var G__22690 = (i_22689 + 1);
i_22689 = G__22690;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__6848__auto__,writer__6849__auto__,opt__6850__auto__){return cljs.core._write.call(null,writer__6849__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_22696 = (self__.level + 1);while(true){
if((i_22696 <= (new_level + 1)))
{(update[i_22696] = self__.header);
{
var G__22697 = (i_22696 + 1);
i_22696 = G__22697;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_22698 = 0;while(true){
if((i_22698 <= self__.level))
{var links_22699 = (update[i_22698]).forward;if(((links_22699[i_22698]) === x__$1))
{(links_22699[i_22698] = (x__$1.forward[i_22698]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__6304__auto__ = (cljs.core.truth_((function (){var and__6292__auto__ = me;if(cljs.core.truth_(and__6292__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__6292__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__6304__auto__))
