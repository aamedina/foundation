...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_22724 = 0;while(true){
var m_22725 = cljs.core.async.impl.dispatch.tasks.pop();if((m_22725 == null))
{} else
{m_22725.call(null);
if((count_22724 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__22726 = (count_22724 + 1);
count_22724 = G__22726;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__6292__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__6292__auto__)
