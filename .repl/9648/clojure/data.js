...
{return cljs.core.reduce.call(null,(function (result,p__16823){var vec__16824 = p__16823;var k = cljs.core.nth.call(null,vec__16824,0,null);var v = cljs.core.nth.call(null,vec__16824,1,null);return cljs.core.assoc.call(null,result,k,v);
...
*/
clojure.data.diff_associative_key = (function diff_associative_key(a,b,k){var va = cljs.core.get.call(null,a,k);var vb = cljs.core.get.call(null,b,k);var vec__16826 = clojure.data.diff.call(null,va,vb);var a_STAR_ = cljs.core.nth.call(null,vec__16826,0,null);var b_STAR_ = cljs.core.nth.call(null,vec__16826,1,null);var ab = cljs.core.nth.call(null,vec__16826,2,null);var in_a = cljs.core.contains_QMARK_.call(null,a,k);var in_b = cljs.core.contains_QMARK_.call(null,b,k);var same = (in_a) && (in_b) && ((!((ab == null))) || (((va == null)) && ((vb == null))));return cljs.core.PersistentVector.fromArray([(((in_a) && ((!((a_STAR_ == null))) || (!(same))))?cljs.core.PersistentArrayMap.fromArray([k,a_STAR_], true):null),(((in_b) && ((!((b_STAR_ == null))) || (!(same))))?cljs.core.PersistentArrayMap.fromArray([k,b_STAR_], true):null),((same)?cljs.core.PersistentArrayMap.fromArray([k,ab], true):null)], true);
});
/**
...
(clojure.data.equality_partition["_"] = (function (x){if((function (){var G__16827 = x;if(G__16827)
{var bit__8058__auto__ = (G__16827.cljs$lang$protocol_mask$partition0$ & 1024);if((bit__8058__auto__) || (G__16827.cljs$core$IMap$))
{return true;
} else
{if((!G__16827.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__16827);
} else
{return false;
}
}
...
{if((function (){var G__16828 = x;if(G__16828)
{var bit__8058__auto__ = (G__16828.cljs$lang$protocol_mask$partition0$ & 4096);if((bit__8058__auto__) || (G__16828.cljs$core$ISet$))
{return true;
} else
{if((!G__16828.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISet,G__16828);
} else
{return false;
}
}
...
{if((function (){var G__16829 = x;if(G__16829)
{var bit__8058__auto__ = (G__16829.cljs$lang$protocol_mask$partition0$ & 16777216);if((bit__8058__auto__) || (G__16829.cljs$core$ISequential$))
{return true;
} else
{if((!G__16829.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISequential,G__16829);
} else
{return false;
}
}
...
(clojure.data.diff_similar["_"] = (function (a,b){return (function (){var G__16830 = clojure.data.equality_partition.call(null,a);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"map","map",1014012110),G__16830))
{return clojure.data.diff_associative;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"sequential","sequential",849892465),G__16830))
{return clojure.data.diff_sequential;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"set","set",1014018004),G__16830))
{return clojure.data.diff_set;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"atom","atom",1016908995),G__16830))
