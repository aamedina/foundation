...
{{
var G__20043 = cljs.core.pop.call(null,v__$1);
v__$1 = G__20043;
continue;
}
} else
...
{var pred__20047 = cljs.core._EQ_;var expr__20048 = limit;if(pred__20047.call(null,1,expr__20048))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__20047.call(null,2,expr__20048))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__20050 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__20051 = (limit__$1 - 1);
var G__20052 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__20050;
limit__$1 = G__20051;
parts = G__20052;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___20054 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___20054))
{var replacement_20055 = temp__4090__auto___20054;buffer.append([cljs.core.str(replacement_20055)].join(''));
} else
{buffer.append(ch);
}
{
var G__20056 = (index + 1);
index = G__20056;
continue;
}
}
