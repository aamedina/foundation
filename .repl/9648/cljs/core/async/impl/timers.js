...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__7976__auto__,writer__7977__auto__,opt__7978__auto__){return cljs.core._write.call(null,writer__7977__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_19740 = 0;while(true){
if((i_19740 < arr.length))
{(arr[i_19740] = null);
{
var G__19741 = (i_19740 + 1);
i_19740 = G__19741;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__7976__auto__,writer__7977__auto__,opt__7978__auto__){return cljs.core._write.call(null,writer__7977__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_19747 = (self__.level + 1);while(true){
if((i_19747 <= (new_level + 1)))
{(update[i_19747] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_19749 = 0;while(true){
if((i_19749 <= self__.level))
{var links_19750 = (update[i_19749]).forward;if(((links_19750[i_19749]) === x__$1))
{(links_19750[i_19749] = (x__$1.forward[i_19749]));
{
var G__19751 = (i_19749 + 1);
i_19749 = G__19751;
continue;
}
} else
{{
var G__19752 = (i_19749 + 1);
i_19749 = G__19752;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__7439__auto__ = (cljs.core.truth_((function (){var and__7430__auto__ = me;if(cljs.core.truth_(and__7430__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__7430__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__7439__auto__))
