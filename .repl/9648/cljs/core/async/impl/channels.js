...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t19769 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t19769 = (function (val,box,meta19770){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t19769.cljs$lang$type = true;
cljs.core.async.impl.channels.t19769.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t19769";
cljs.core.async.impl.channels.t19769.cljs$lang$ctorPrWriter = (function (this__7976__auto__,writer__7977__auto__,opt__7978__auto__){return cljs.core._write.call(null,writer__7977__auto__,"cljs.core.async.impl.channels/t19769");
});
cljs.core.async.impl.channels.t19769.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t19769.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_19771){var self__ = this;
var _19771__$1 = this;return self__.meta19770;
});
cljs.core.async.impl.channels.t19769.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_19771,meta19770__$1){var self__ = this;
var _19771__$1 = this;return (new cljs.core.async.impl.channels.t19769(self__.val,self__.box,meta19770__$1));
});
cljs.core.async.impl.channels.__GT_t19769 = (function __GT_t19769(val__$1,box__$1,meta19770){return (new cljs.core.async.impl.channels.t19769(val__$1,box__$1,meta19770));
});
}
return (new cljs.core.async.impl.channels.t19769(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_19772 = self__.takes.pop();if((taker_19772 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_19772))
{var take_cb_19773 = cljs.core.async.impl.protocols.commit.call(null,taker_19772);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_19773,taker_19772){
return (function (){return take_cb_19773.call(null,null);
});})(take_cb_19773,taker_19772))
);
} else
{}
{
