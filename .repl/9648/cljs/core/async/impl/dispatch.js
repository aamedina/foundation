...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_19763 = 0;while(true){
var m_19764 = cljs.core.async.impl.dispatch.tasks.pop();if((m_19764 == null))
{} else
{m_19764.call(null);
if((count_19763 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__19765 = (count_19763 + 1);
count_19763 = G__19765;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7430__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7430__auto__)
