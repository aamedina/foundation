...
{{
var G__35950 = cljs.core.pop.call(null,v__$1);
v__$1 = G__35950;
continue;
}
} else
...
{var pred__35954 = cljs.core._EQ_;var expr__35955 = limit;if(cljs.core.truth_(pred__35954.call(null,1,expr__35955)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__35954.call(null,2,expr__35955)))
...
var G__35957 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__35958 = (limit__$1 - 1);
var G__35959 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__35957;
limit__$1 = G__35958;
parts = G__35959;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___35961 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___35961))
{var replacement_35962 = temp__4090__auto___35961;buffer.append([cljs.core.str(replacement_35962)].join(''));
} else
{buffer.append(ch);
}
{
var G__35963 = (index + 1);
index = G__35963;
continue;
}
}
