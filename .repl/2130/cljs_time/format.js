...
var unparse__delegate = function (fmt,dt,p__35644){var map__35646 = p__35644;var map__35646__$1 = ((cljs.core.seq_QMARK_.call(null,map__35646))?cljs.core.apply.call(null,cljs.core.hash_map,map__35646):map__35646);var tz = cljs.core.get.call(null,map__35646__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
...
return unparse__delegate.call(this,fmt,dt,p__35644);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__35647){
var fmt = cljs.core.first(arglist__35647);
arglist__35647 = cljs.core.next(arglist__35647);
var dt = cljs.core.first(arglist__35647);
var p__35644 = cljs.core.rest(arglist__35647);
return unparse__delegate(fmt,dt,p__35644);
});
...
var show_formatters__delegate = function (p__35648){var map__35654 = p__35648;var map__35654__$1 = ((cljs.core.seq_QMARK_.call(null,map__35654))?cljs.core.apply.call(null,cljs.core.hash_map,map__35654):map__35654);var date_like = cljs.core.get.call(null,map__35654__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__5850__auto__ = (function iter__35655(s__35656){return (new cljs.core.LazySeq(null,(function (){var s__35656__$1 = s__35656;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__35656__$1);if(temp__4098__auto__)
{var s__35656__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__35656__$2))
{var c__5848__auto__ = cljs.core.chunk_first.call(null,s__35656__$2);var size__5849__auto__ = cljs.core.count.call(null,c__5848__auto__);var b__35658 = cljs.core.chunk_buffer.call(null,size__5849__auto__);if((function (){var i__35657 = 0;while(true){
if((i__35657 < size__5849__auto__))
{var i = cljs.core._nth.call(null,c__5848__auto__,i__35657);cljs.core.chunk_append.call(null,b__35658,cljs_time.format.unparse.call(null,i,date_like));
{
var G__35659 = (i__35657 + 1);
i__35657 = G__35659;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__35658),iter__35655.call(null,cljs.core.chunk_rest.call(null,s__35656__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__35658),null);
}
} else
{var i = cljs.core.first.call(null,s__35656__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__35655.call(null,cljs.core.rest.call(null,s__35656__$2)));
}
} else
{return null;
}
...
var p__35648 = null;if (arguments.length > 0) {
  p__35648 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__35648);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__35660){
var p__35648 = cljs.core.seq(arglist__35660);
return show_formatters__delegate(p__35648);
});
