...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_34549 = 0;while(true){
var m_34550 = cljs.core.async.impl.dispatch.tasks.pop();if((m_34550 == null))
{} else
{m_34550.call(null);
if((count_34549 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__34551 = (count_34549 + 1);
count_34549 = G__34551;
continue;
}
} else
{}
