...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t34555 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t34555 = (function (val,box,meta34556){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t34555.cljs$lang$type = true;
cljs.core.async.impl.channels.t34555.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t34555";
cljs.core.async.impl.channels.t34555.cljs$lang$ctorPrWriter = (function (this__5701__auto__,writer__5702__auto__,opt__5703__auto__){return cljs.core._write.call(null,writer__5702__auto__,"cljs.core.async.impl.channels/t34555");
});
cljs.core.async.impl.channels.t34555.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t34555.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_34557){var self__ = this;
var _34557__$1 = this;return self__.meta34556;
});
cljs.core.async.impl.channels.t34555.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_34557,meta34556__$1){var self__ = this;
var _34557__$1 = this;return (new cljs.core.async.impl.channels.t34555(self__.val,self__.box,meta34556__$1));
});
cljs.core.async.impl.channels.__GT_t34555 = (function __GT_t34555(val__$1,box__$1,meta34556){return (new cljs.core.async.impl.channels.t34555(val__$1,box__$1,meta34556));
});
}
return (new cljs.core.async.impl.channels.t34555(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_34558 = self__.takes.pop();if((taker_34558 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_34558))
{var take_cb_34559 = cljs.core.async.impl.protocols.commit.call(null,taker_34558);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_34559,taker_34558){
return (function (){return take_cb_34559.call(null,null);
});})(take_cb_34559,taker_34558))
);
} else
{}
{
