...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_34514 = 0;while(true){
if((i_34514 < arr.length))
{(arr[i_34514] = null);
{
var G__34515 = (i_34514 + 1);
i_34514 = G__34515;
continue;
}
} else
...
{var i_34521 = (self__.level + 1);while(true){
if((i_34521 <= (new_level + 1)))
{(update[i_34521] = self__.header);
{
var G__34522 = (i_34521 + 1);
i_34521 = G__34522;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_34523 = 0;while(true){
if((i_34523 <= self__.level))
{var links_34524 = (update[i_34523]).forward;if(((links_34524[i_34523]) === x__$1))
{(links_34524[i_34523] = (x__$1.forward[i_34523]));
{
