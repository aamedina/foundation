...
{{
var G__34952 = cljs.core.pop.call(null,v__$1);
v__$1 = G__34952;
continue;
}
} else
...
{var pred__34956 = cljs.core._EQ_;var expr__34957 = limit;if(cljs.core.truth_(pred__34956.call(null,1,expr__34957)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__34956.call(null,2,expr__34957)))
...
var G__34959 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__34960 = (limit__$1 - 1);
var G__34961 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__34959;
limit__$1 = G__34960;
parts = G__34961;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___34963 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___34963))
{var replacement_34964 = temp__4096__auto___34963;buffer.append([cljs.core.str(replacement_34964)].join(''));
} else
{buffer.append(ch);
}
{
var G__34965 = (index + 1);
index = G__34965;
continue;
}
}
