...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_168928 = 0;while(true){
var m_168929 = cljs.core.async.impl.dispatch.tasks.pop();if((m_168929 == null))
{} else
{m_168929.call(null);
if((count_168928 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__168930 = (count_168928 + 1);
count_168928 = G__168930;
continue;
}
} else
{}
