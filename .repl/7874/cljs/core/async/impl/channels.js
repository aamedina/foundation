...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t168934 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t168934 = (function (val,box,meta168935){
this.val = val;
this.box = box;
this.meta168935 = meta168935;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t168934.cljs$lang$type = true;
cljs.core.async.impl.channels.t168934.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t168934";
cljs.core.async.impl.channels.t168934.cljs$lang$ctorPrWriter = (function (this__6833__auto__,writer__6834__auto__,opt__6835__auto__){return cljs.core._write.call(null,writer__6834__auto__,"cljs.core.async.impl.channels/t168934");
});
cljs.core.async.impl.channels.t168934.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t168934.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_168936){var self__ = this;
var _168936__$1 = this;return self__.meta168935;
});
cljs.core.async.impl.channels.t168934.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_168936,meta168935__$1){var self__ = this;
var _168936__$1 = this;return (new cljs.core.async.impl.channels.t168934(self__.val,self__.box,meta168935__$1));
});
cljs.core.async.impl.channels.__GT_t168934 = (function __GT_t168934(val__$1,box__$1,meta168935){return (new cljs.core.async.impl.channels.t168934(val__$1,box__$1,meta168935));
});
}
return (new cljs.core.async.impl.channels.t168934(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_168937 = self__.takes.pop();if((taker_168937 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_168937))
{var take_cb_168938 = cljs.core.async.impl.protocols.commit.call(null,taker_168937);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_168938,taker_168937){
return (function (){return take_cb_168938.call(null,null);
});})(take_cb_168938,taker_168937))
);
} else
{}
{
