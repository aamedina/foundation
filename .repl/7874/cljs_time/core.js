...
goog.require('goog.date.DateTime');
goog.require('goog.i18n.TimeZone');
cljs_time.core.DateTimeProtocol = (function (){var obj169913 = {};return obj169913;
})();
...
*/
cljs_time.core.today_at_midnight = (function today_at_midnight(){var G__169915 = (new goog.date.UtcDateTime());G__169915.setHours(0);
G__169915.setMinutes(0);
G__169915.setSeconds(0);
G__169915.setMilliseconds(0);
return G__169915;
});
/**
* Returns a DateTime for the begining of the Unix epoch in the UTC time zone.
*/
cljs_time.core.epoch = (function epoch(){var G__169917 = (new goog.date.UtcDateTime());G__169917.setTime(0);
return G__169917;
});
/**
...
var G__169918__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.plus_,cljs_time.core.plus_.call(null,dt,p),ps);
};
var G__169918 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__169918__delegate.call(this,dt,p,ps);};
G__169918.cljs$lang$maxFixedArity = 2;
G__169918.cljs$lang$applyTo = (function (arglist__169919){
var dt = cljs.core.first(arglist__169919);
arglist__169919 = cljs.core.next(arglist__169919);
var p = cljs.core.first(arglist__169919);
var ps = cljs.core.rest(arglist__169919);
return G__169918__delegate(dt,p,ps);
});
G__169918.cljs$core$IFn$_invoke$arity$variadic = G__169918__delegate;
return G__169918;
})()
;
...
var G__169920__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.minus_,cljs_time.core.minus_.call(null,dt,p),ps);
};
var G__169920 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__169920__delegate.call(this,dt,p,ps);};
G__169920.cljs$lang$maxFixedArity = 2;
G__169920.cljs$lang$applyTo = (function (arglist__169921){
var dt = cljs.core.first(arglist__169921);
arglist__169921 = cljs.core.next(arglist__169921);
var p = cljs.core.first(arglist__169921);
var ps = cljs.core.rest(arglist__169921);
return G__169920__delegate(dt,p,ps);
});
G__169920.cljs$core$IFn$_invoke$arity$variadic = G__169920__delegate;
return G__169920;
})()
;
...
extend.cljs$lang$applyTo = (function (arglist__169922){
var in$ = cljs.core.first(arglist__169922);
var by = cljs.core.rest(arglist__169922);
...
cljs_time.core.to_period = (function to_period(in$){var pred__169926 = cljs.core._EQ_;var expr__169927 = cljs.core.type.call(null,in$);if(cljs.core.truth_(pred__169926.call(null,goog.date.Interval,expr__169927)))
{return in$;
} else
{if(cljs.core.truth_(pred__169926.call(null,goog.date.DateRange,expr__169927)))
{return (new goog.date.Interval(0,0,0,0,0,((cljs_time.core.in_millis.call(null,in$) / 1000) | 0)));
} else
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__169927)].join('')));
}
}
});
/**
...
;
cljs_time.core.last_day_of_the_month = (function last_day_of_the_month(dt){var G__169930 = dt;G__169930.setDate(cljs_time.core.number_of_days_in_the_month.call(null,dt));
return G__169930;
});
cljs_time.core.first_day_of_the_month = (function first_day_of_the_month(dt){var G__169932 = dt;G__169932.setDate(1);
return G__169932;
});
...
var today_at__4 = (function (hours,minutes,seconds,millis){return cljs_time.core.date_time.call(null,(function (){var G__169934 = cljs_time.core.now.call(null);G__169934.setHourOfDay(hours);
G__169934.setMinuteOfHour(minutes);
G__169934.setSecondOfMinute(seconds);
G__169934.setMillisOfSecond(millis);
return G__169934;
})());
});
...
;
cljs_time.core.do_at_STAR_ = (function do_at_STAR_(base_date_time,body_fn){var ms = (base_date_time.getTime() - cljs_time.core.now.call(null).getTime());var c__13409__auto__ = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__13410__auto__ = (function (){var switch__13309__auto__ = (function (state_169971){var state_val_169972 = (state_169971[1]);if((state_val_169972 === 5))
{var _ = cljs.core.async.impl.ioc_helpers.add_exception_frame.call(null,state_169971,4,Error,null,3);var inst_169967 = body_fn.call(null);var state_169971__$1 = state_169971;var statearr_169973_169985 = state_169971__$1;(statearr_169973_169985[2] = inst_169967);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_169971__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_169972 === 4))
{var inst_169963 = (state_169971[2]);var state_169971__$1 = (function (){var statearr_169974 = state_169971;(statearr_169974[7] = inst_169963);
return statearr_169974;
})();var statearr_169975_169986 = state_169971__$1;(statearr_169975_169986[2] = null);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_169971__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_169972 === 3))
{var inst_169969 = (state_169971[2]);var state_169971__$1 = state_169971;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_169971__$1,inst_169969);
} else
{if((state_val_169972 === 2))
{var inst_169962 = (state_169971[2]);var state_169971__$1 = (function (){var statearr_169976 = state_169971;(statearr_169976[8] = inst_169962);
return statearr_169976;
})();var statearr_169977_169987 = state_169971__$1;(statearr_169977_169987[2] = null);
(statearr_169977_169987[1] = 5);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_169972 === 1))
{var inst_169960 = cljs.core.async.timeout.call(null,ms);var state_169971__$1 = state_169971;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_169971__$1,2,inst_169960);
} else
{return null;
}
}
...
var state_machine__13310__auto____0 = (function (){var statearr_169981 = (new Array(9));(statearr_169981[0] = state_machine__13310__auto__);
(statearr_169981[1] = 1);
return statearr_169981;
});
var state_machine__13310__auto____1 = (function (state_169971){while(true){
var ret_value__13311__auto__ = (function (){try{while(true){
var result__13312__auto__ = switch__13309__auto__.call(null,state_169971);if(cljs.core.keyword_identical_QMARK_.call(null,result__13312__auto__,new cljs.core.Keyword(null,"recur","recur",1122293407)))
{{
continue;
}
} else
...
}catch (e169982){if((e169982 instanceof Object))
{var ex__13313__auto__ = e169982;var statearr_169983_169988 = state_169971;(statearr_169983_169988[5] = ex__13313__auto__);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_169971);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
...
{{
var G__169989 = state_169971;
state_169971 = G__169989;
continue;
}
} else
...
state_machine__13310__auto__ = function(state_169971){
switch(arguments.length){
case 0:
return state_machine__13310__auto____0.call(this);
case 1:
return state_machine__13310__auto____1.call(this,state_169971);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
})();var state__13411__auto__ = (function (){var statearr_169984 = f__13410__auto__.call(null);(statearr_169984[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__13409__auto__);
return statearr_169984;
})();return cljs.core.async.impl.ioc_helpers.run_state_machine_wrapped.call(null,state__13411__auto__);
}));
return c__13409__auto__;
});
cljs_time.core.Mappable = (function (){var obj169991 = {};return obj169991;
})();
...
{{
var G__169992 = [cljs.core.str("0"),cljs.core.str(ns)].join('');
ns = G__169992;
continue;
}
} else
...
var G__169993__delegate = function (arg,more){return cljs.core.apply.call(null,f,arg,cljs.core.concat.call(null,args,more));
};
var G__169993 = function (arg,var_args){
var more = null;if (arguments.length > 1) {
  more = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__169993__delegate.call(this,arg,more);};
G__169993.cljs$lang$maxFixedArity = 1;
G__169993.cljs$lang$applyTo = (function (arglist__169994){
var arg = cljs.core.first(arglist__169994);
var more = cljs.core.rest(arglist__169994);
return G__169993__delegate(arg,more);
});
G__169993.cljs$core$IFn$_invoke$arity$variadic = G__169993__delegate;
return G__169993;
})()
;
};
...
fpartial.cljs$lang$applyTo = (function (arglist__169995){
var f = cljs.core.first(arglist__169995);
var args = cljs.core.rest(arglist__169995);
