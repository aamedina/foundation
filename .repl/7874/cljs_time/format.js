...
var unparse__delegate = function (fmt,dt,p__170025){var map__170027 = p__170025;var map__170027__$1 = ((cljs.core.seq_QMARK_.call(null,map__170027))?cljs.core.apply.call(null,cljs.core.hash_map,map__170027):map__170027);var tz = cljs.core.get.call(null,map__170027__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__170025 = null;if (arguments.length > 2) {
  p__170025 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__170025);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__170028){
var fmt = cljs.core.first(arglist__170028);
arglist__170028 = cljs.core.next(arglist__170028);
var dt = cljs.core.first(arglist__170028);
var p__170025 = cljs.core.rest(arglist__170028);
return unparse__delegate(fmt,dt,p__170025);
});
...
var show_formatters__delegate = function (p__170029){var map__170035 = p__170029;var map__170035__$1 = ((cljs.core.seq_QMARK_.call(null,map__170035))?cljs.core.apply.call(null,cljs.core.hash_map,map__170035):map__170035);var date_like = cljs.core.get.call(null,map__170035__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__6982__auto__ = (function iter__170036(s__170037){return (new cljs.core.LazySeq(null,(function (){var s__170037__$1 = s__170037;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__170037__$1);if(temp__4098__auto__)
{var s__170037__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__170037__$2))
{var c__6980__auto__ = cljs.core.chunk_first.call(null,s__170037__$2);var size__6981__auto__ = cljs.core.count.call(null,c__6980__auto__);var b__170039 = cljs.core.chunk_buffer.call(null,size__6981__auto__);if((function (){var i__170038 = 0;while(true){
if((i__170038 < size__6981__auto__))
{var i = cljs.core._nth.call(null,c__6980__auto__,i__170038);cljs.core.chunk_append.call(null,b__170039,cljs_time.format.unparse.call(null,i,date_like));
{
var G__170040 = (i__170038 + 1);
i__170038 = G__170040;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__170039),iter__170036.call(null,cljs.core.chunk_rest.call(null,s__170037__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__170039),null);
}
} else
{var i = cljs.core.first.call(null,s__170037__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__170036.call(null,cljs.core.rest.call(null,s__170037__$2)));
}
} else
{return null;
}
...
var p__170029 = null;if (arguments.length > 0) {
  p__170029 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__170029);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__170041){
var p__170029 = cljs.core.seq(arglist__170041);
return show_formatters__delegate(p__170029);
});
