...
var unparse__delegate = function (fmt,dt,p__34852){var map__34854 = p__34852;var map__34854__$1 = ((cljs.core.seq_QMARK_.call(null,map__34854))?cljs.core.apply.call(null,cljs.core.hash_map,map__34854):map__34854);var tz = cljs.core.get.call(null,map__34854__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__34852 = null;if (arguments.length > 2) {
  p__34852 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__34852);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__34855){
var fmt = cljs.core.first(arglist__34855);
arglist__34855 = cljs.core.next(arglist__34855);
var dt = cljs.core.first(arglist__34855);
var p__34852 = cljs.core.rest(arglist__34855);
return unparse__delegate(fmt,dt,p__34852);
});
...
var show_formatters__delegate = function (p__34856){var map__34862 = p__34856;var map__34862__$1 = ((cljs.core.seq_QMARK_.call(null,map__34862))?cljs.core.apply.call(null,cljs.core.hash_map,map__34862):map__34862);var date_like = cljs.core.get.call(null,map__34862__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__6982__auto__ = (function iter__34863(s__34864){return (new cljs.core.LazySeq(null,(function (){var s__34864__$1 = s__34864;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__34864__$1);if(temp__4098__auto__)
{var s__34864__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__34864__$2))
{var c__6980__auto__ = cljs.core.chunk_first.call(null,s__34864__$2);var size__6981__auto__ = cljs.core.count.call(null,c__6980__auto__);var b__34866 = cljs.core.chunk_buffer.call(null,size__6981__auto__);if((function (){var i__34865 = 0;while(true){
if((i__34865 < size__6981__auto__))
{var i = cljs.core._nth.call(null,c__6980__auto__,i__34865);cljs.core.chunk_append.call(null,b__34866,cljs_time.format.unparse.call(null,i,date_like));
{
var G__34867 = (i__34865 + 1);
i__34865 = G__34867;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__34866),iter__34863.call(null,cljs.core.chunk_rest.call(null,s__34864__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__34866),null);
}
} else
{var i = cljs.core.first.call(null,s__34864__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__34863.call(null,cljs.core.rest.call(null,s__34864__$2)));
}
} else
{return null;
}
...
var p__34856 = null;if (arguments.length > 0) {
  p__34856 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__34856);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__34868){
var p__34856 = cljs.core.seq(arglist__34868);
return show_formatters__delegate(p__34856);
});
