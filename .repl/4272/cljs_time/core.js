...
goog.require('goog.date.DateTime');
goog.require('goog.i18n.TimeZone');
cljs_time.core.DateTimeProtocol = (function (){var obj34740 = {};return obj34740;
})();
...
*/
cljs_time.core.today_at_midnight = (function today_at_midnight(){var G__34742 = (new goog.date.UtcDateTime());G__34742.setHours(0);
G__34742.setMinutes(0);
G__34742.setSeconds(0);
G__34742.setMilliseconds(0);
return G__34742;
});
/**
* Returns a DateTime for the begining of the Unix epoch in the UTC time zone.
*/
cljs_time.core.epoch = (function epoch(){var G__34744 = (new goog.date.UtcDateTime());G__34744.setTime(0);
return G__34744;
});
/**
...
var G__34745__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.plus_,cljs_time.core.plus_.call(null,dt,p),ps);
};
var G__34745 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__34745__delegate.call(this,dt,p,ps);};
G__34745.cljs$lang$maxFixedArity = 2;
G__34745.cljs$lang$applyTo = (function (arglist__34746){
var dt = cljs.core.first(arglist__34746);
arglist__34746 = cljs.core.next(arglist__34746);
var p = cljs.core.first(arglist__34746);
var ps = cljs.core.rest(arglist__34746);
return G__34745__delegate(dt,p,ps);
});
...
var G__34747__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.minus_,cljs_time.core.minus_.call(null,dt,p),ps);
};
var G__34747 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__34747__delegate.call(this,dt,p,ps);};
G__34747.cljs$lang$maxFixedArity = 2;
G__34747.cljs$lang$applyTo = (function (arglist__34748){
var dt = cljs.core.first(arglist__34748);
arglist__34748 = cljs.core.next(arglist__34748);
var p = cljs.core.first(arglist__34748);
var ps = cljs.core.rest(arglist__34748);
return G__34747__delegate(dt,p,ps);
});
...
extend.cljs$lang$applyTo = (function (arglist__34749){
var in$ = cljs.core.first(arglist__34749);
var by = cljs.core.rest(arglist__34749);
...
cljs_time.core.to_period = (function to_period(in$){var pred__34753 = cljs.core._EQ_;var expr__34754 = cljs.core.type.call(null,in$);if(cljs.core.truth_(pred__34753.call(null,goog.date.Interval,expr__34754)))
{return in$;
} else
{if(cljs.core.truth_(pred__34753.call(null,goog.date.DateRange,expr__34754)))
{return (new goog.date.Interval(0,0,0,0,0,((cljs_time.core.in_millis.call(null,in$) / 1000) | 0)));
} else
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__34754)].join('')));
}
}
});
/**
...
;
cljs_time.core.last_day_of_the_month = (function last_day_of_the_month(dt){var G__34757 = dt;G__34757.setDate(cljs_time.core.number_of_days_in_the_month.call(null,dt));
return G__34757;
});
cljs_time.core.first_day_of_the_month = (function first_day_of_the_month(dt){var G__34759 = dt;G__34759.setDate(1);
return G__34759;
});
...
var today_at__4 = (function (hours,minutes,seconds,millis){return cljs_time.core.date_time.call(null,(function (){var G__34761 = cljs_time.core.now.call(null);G__34761.setHourOfDay(hours);
G__34761.setMinuteOfHour(minutes);
G__34761.setSecondOfMinute(seconds);
G__34761.setMillisOfSecond(millis);
return G__34761;
})());
});
...
;
cljs_time.core.do_at_STAR_ = (function do_at_STAR_(base_date_time,body_fn){var ms = (base_date_time.getTime() - cljs_time.core.now.call(null).getTime());var c__13409__auto__ = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__13410__auto__ = (function (){var switch__13309__auto__ = (function (state_34798){var state_val_34799 = (state_34798[1]);if((state_val_34799 === 5))
{var _ = cljs.core.async.impl.ioc_helpers.add_exception_frame.call(null,state_34798,4,Error,null,3);var inst_34794 = body_fn.call(null);var state_34798__$1 = state_34798;var statearr_34800_34812 = state_34798__$1;(statearr_34800_34812[2] = inst_34794);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_34798__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_34799 === 4))
{var inst_34790 = (state_34798[2]);var state_34798__$1 = (function (){var statearr_34801 = state_34798;(statearr_34801[7] = inst_34790);
return statearr_34801;
})();var statearr_34802_34813 = state_34798__$1;(statearr_34802_34813[2] = null);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_34798__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_34799 === 3))
{var inst_34796 = (state_34798[2]);var state_34798__$1 = state_34798;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_34798__$1,inst_34796);
} else
{if((state_val_34799 === 2))
{var inst_34789 = (state_34798[2]);var state_34798__$1 = (function (){var statearr_34803 = state_34798;(statearr_34803[8] = inst_34789);
return statearr_34803;
})();var statearr_34804_34814 = state_34798__$1;(statearr_34804_34814[2] = null);
(statearr_34804_34814[1] = 5);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_34799 === 1))
{var inst_34787 = cljs.core.async.timeout.call(null,ms);var state_34798__$1 = state_34798;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_34798__$1,2,inst_34787);
} else
{return null;
}
}
...
var state_machine__13310__auto____0 = (function (){var statearr_34808 = (new Array(9));(statearr_34808[0] = state_machine__13310__auto__);
(statearr_34808[1] = 1);
return statearr_34808;
});
var state_machine__13310__auto____1 = (function (state_34798){while(true){
var ret_value__13311__auto__ = (function (){try{while(true){
var result__13312__auto__ = switch__13309__auto__.call(null,state_34798);if(cljs.core.keyword_identical_QMARK_.call(null,result__13312__auto__,new cljs.core.Keyword(null,"recur","recur",1122293407)))
{{
continue;
}
} else
...
{var ex__13313__auto__ = e34809;var statearr_34810_34815 = state_34798;(statearr_34810_34815[5] = ex__13313__auto__);
...
{{
var G__34816 = state_34798;
state_34798 = G__34816;
continue;
}
} else
...
state_machine__13310__auto__ = function(state_34798){
switch(arguments.length){
case 0:
return state_machine__13310__auto____0.call(this);
case 1:
return state_machine__13310__auto____1.call(this,state_34798);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
})();var state__13411__auto__ = (function (){var statearr_34811 = f__13410__auto__.call(null);(statearr_34811[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__13409__auto__);
...
cljs_time.core.Mappable = (function (){var obj34818 = {};return obj34818;
})();
...
{{
var G__34819 = [cljs.core.str("0"),cljs.core.str(ns)].join('');
ns = G__34819;
continue;
}
} else
...
var G__34820__delegate = function (arg,more){return cljs.core.apply.call(null,f,arg,cljs.core.concat.call(null,args,more));
};
var G__34820 = function (arg,var_args){
var more = null;if (arguments.length > 1) {
  more = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__34820__delegate.call(this,arg,more);};
G__34820.cljs$lang$maxFixedArity = 1;
G__34820.cljs$lang$applyTo = (function (arglist__34821){
var arg = cljs.core.first(arglist__34821);
var more = cljs.core.rest(arglist__34821);
return G__34820__delegate(arg,more);
});
...
fpartial.cljs$lang$applyTo = (function (arglist__34822){
