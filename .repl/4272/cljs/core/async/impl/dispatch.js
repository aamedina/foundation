...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_33757 = 0;while(true){
var m_33758 = cljs.core.async.impl.dispatch.tasks.pop();if((m_33758 == null))
{} else
{m_33758.call(null);
if((count_33757 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__33759 = (count_33757 + 1);
count_33757 = G__33759;
continue;
}
} else
{}
