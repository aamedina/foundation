...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_33722 = 0;while(true){
if((i_33722 < arr.length))
{(arr[i_33722] = null);
{
var G__33723 = (i_33722 + 1);
i_33722 = G__33723;
continue;
}
} else
...
{var i_33729 = (self__.level + 1);while(true){
if((i_33729 <= (new_level + 1)))
{(update[i_33729] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_33731 = 0;while(true){
if((i_33731 <= self__.level))
{var links_33732 = (update[i_33731]).forward;if(((links_33732[i_33731]) === x__$1))
{(links_33732[i_33731] = (x__$1.forward[i_33731]));
{
var G__33733 = (i_33731 + 1);
i_33731 = G__33733;
continue;
}
} else
{{
var G__33734 = (i_33731 + 1);
i_33731 = G__33734;
continue;
}
}
