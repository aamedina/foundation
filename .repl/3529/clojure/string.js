...
{{
var G__98260 = cljs.core.pop.call(null,v__$1);
v__$1 = G__98260;
continue;
}
} else
...
{var pred__98264 = cljs.core._EQ_;var expr__98265 = limit;if(cljs.core.truth_(pred__98264.call(null,1,expr__98265)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__98264.call(null,2,expr__98265)))
...
var G__98267 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__98268 = (limit__$1 - 1);
var G__98269 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__98267;
limit__$1 = G__98268;
parts = G__98269;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___98271 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___98271))
{var replacement_98272 = temp__4090__auto___98271;buffer.append([cljs.core.str(replacement_98272)].join(''));
} else
{buffer.append(ch);
}
{
var G__98273 = (index + 1);
index = G__98273;
continue;
}
}
