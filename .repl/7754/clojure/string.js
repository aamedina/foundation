...
{{
var G__41556 = cljs.core.pop.call(null,v__$1);
v__$1 = G__41556;
continue;
}
} else
...
{var pred__41560 = cljs.core._EQ_;var expr__41561 = limit;if(cljs.core.truth_(pred__41560.call(null,1,expr__41561)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__41560.call(null,2,expr__41561)))
...
var G__41563 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__41564 = (limit__$1 - 1);
var G__41565 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__41563;
limit__$1 = G__41564;
parts = G__41565;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___41567 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___41567))
{var replacement_41568 = temp__4096__auto___41567;buffer.append([cljs.core.str(replacement_41568)].join(''));
} else
{buffer.append(ch);
}
{
var G__41569 = (index + 1);
index = G__41569;
continue;
}
}
