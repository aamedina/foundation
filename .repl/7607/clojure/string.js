...
{{
var G__21193 = cljs.core.pop.call(null,v__$1);
v__$1 = G__21193;
continue;
}
} else
...
{var pred__21197 = cljs.core._EQ_;var expr__21198 = limit;if(cljs.core.truth_(pred__21197.call(null,1,expr__21198)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__21197.call(null,2,expr__21198)))
...
var G__21200 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__21201 = (limit__$1 - 1);
var G__21202 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__21200;
limit__$1 = G__21201;
parts = G__21202;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___21204 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___21204))
{var replacement_21205 = temp__4096__auto___21204;buffer.append([cljs.core.str(replacement_21205)].join(''));
} else
{buffer.append(ch);
}
{
var G__21206 = (index + 1);
index = G__21206;
continue;
}
}
