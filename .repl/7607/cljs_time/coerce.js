...
goog.require('goog.date.DateTime');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj22192 = {};return obj22192;
})();
...
* which parses
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__5850__auto__ = (function iter__22201(s__22202){return (new cljs.core.LazySeq(null,(function (){var s__22202__$1 = s__22202;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__22202__$1);if(temp__4098__auto__)
{var s__22202__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__22202__$2))
{var c__5848__auto__ = cljs.core.chunk_first.call(null,s__22202__$2);var size__5849__auto__ = cljs.core.count.call(null,c__5848__auto__);var b__22204 = cljs.core.chunk_buffer.call(null,size__5849__auto__);if((function (){var i__22203 = 0;while(true){
if((i__22203 < size__5849__auto__))
{var f = cljs.core._nth.call(null,c__5848__auto__,i__22203);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e22207){if((e22207 instanceof Error))
{var e = e22207;return null;
} else
...
{cljs.core.chunk_append.call(null,b__22204,d);
{
...
{var f = cljs.core.first.call(null,s__22202__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e22208){if((e22208 instanceof Error))
{var e = e22208;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e22208;
} else
...
{return cljs.core.cons.call(null,d,iter__22201.call(null,cljs.core.rest.call(null,s__22202__$2)));
} else
{{
var G__22211 = cljs.core.rest.call(null,s__22202__$2);
s__22202__$1 = G__22211;
continue;
}
}
}
