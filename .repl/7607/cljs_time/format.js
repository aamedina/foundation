...
var unparse__delegate = function (fmt,dt,p__22212){var map__22214 = p__22212;var map__22214__$1 = ((cljs.core.seq_QMARK_.call(null,map__22214))?cljs.core.apply.call(null,cljs.core.hash_map,map__22214):map__22214);var tz = cljs.core.get.call(null,map__22214__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
...
return unparse__delegate.call(this,fmt,dt,p__22212);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__22215){
var fmt = cljs.core.first(arglist__22215);
arglist__22215 = cljs.core.next(arglist__22215);
var dt = cljs.core.first(arglist__22215);
var p__22212 = cljs.core.rest(arglist__22215);
return unparse__delegate(fmt,dt,p__22212);
});
...
var show_formatters__delegate = function (p__22216){var map__22222 = p__22216;var map__22222__$1 = ((cljs.core.seq_QMARK_.call(null,map__22222))?cljs.core.apply.call(null,cljs.core.hash_map,map__22222):map__22222);var date_like = cljs.core.get.call(null,map__22222__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__5850__auto__ = (function iter__22223(s__22224){return (new cljs.core.LazySeq(null,(function (){var s__22224__$1 = s__22224;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__22224__$1);if(temp__4098__auto__)
{var s__22224__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__22224__$2))
{var c__5848__auto__ = cljs.core.chunk_first.call(null,s__22224__$2);var size__5849__auto__ = cljs.core.count.call(null,c__5848__auto__);var b__22226 = cljs.core.chunk_buffer.call(null,size__5849__auto__);if((function (){var i__22225 = 0;while(true){
if((i__22225 < size__5849__auto__))
{var i = cljs.core._nth.call(null,c__5848__auto__,i__22225);cljs.core.chunk_append.call(null,b__22226,cljs_time.format.unparse.call(null,i,date_like));
{
var G__22227 = (i__22225 + 1);
i__22225 = G__22227;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__22226),iter__22223.call(null,cljs.core.chunk_rest.call(null,s__22224__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__22226),null);
}
} else
{var i = cljs.core.first.call(null,s__22224__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__22223.call(null,cljs.core.rest.call(null,s__22224__$2)));
}
} else
{return null;
}
...
var p__22216 = null;if (arguments.length > 0) {
  p__22216 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__22216);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__22228){
var p__22216 = cljs.core.seq(arglist__22228);
return show_formatters__delegate(p__22216);
});
