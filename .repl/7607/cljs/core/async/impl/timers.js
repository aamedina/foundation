...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__5701__auto__,writer__5702__auto__,opt__5703__auto__){return cljs.core._write.call(null,writer__5702__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_20755 = 0;while(true){
if((i_20755 < arr.length))
{(arr[i_20755] = null);
{
var G__20756 = (i_20755 + 1);
i_20755 = G__20756;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__5701__auto__,writer__5702__auto__,opt__5703__auto__){return cljs.core._write.call(null,writer__5702__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_20762 = (self__.level + 1);while(true){
if((i_20762 <= (new_level + 1)))
{(update[i_20762] = self__.header);
{
var G__20763 = (i_20762 + 1);
i_20762 = G__20763;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_20764 = 0;while(true){
if((i_20764 <= self__.level))
{var links_20765 = (update[i_20764]).forward;if(((links_20765[i_20764]) === x__$1))
{(links_20765[i_20764] = (x__$1.forward[i_20764]));
{
var G__20766 = (i_20764 + 1);
i_20764 = G__20766;
continue;
}
} else
{{
var G__20767 = (i_20764 + 1);
i_20764 = G__20767;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__5157__auto__ = (cljs.core.truth_((function (){var and__5145__auto__ = me;if(cljs.core.truth_(and__5145__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__5145__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__5157__auto__))
