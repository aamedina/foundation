...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t20796 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t20796 = (function (val,box,meta20797){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t20796.cljs$lang$type = true;
cljs.core.async.impl.channels.t20796.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t20796";
cljs.core.async.impl.channels.t20796.cljs$lang$ctorPrWriter = (function (this__5701__auto__,writer__5702__auto__,opt__5703__auto__){return cljs.core._write.call(null,writer__5702__auto__,"cljs.core.async.impl.channels/t20796");
});
cljs.core.async.impl.channels.t20796.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t20796.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_20798){var self__ = this;
var _20798__$1 = this;return self__.meta20797;
});
cljs.core.async.impl.channels.t20796.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_20798,meta20797__$1){var self__ = this;
var _20798__$1 = this;return (new cljs.core.async.impl.channels.t20796(self__.val,self__.box,meta20797__$1));
});
cljs.core.async.impl.channels.__GT_t20796 = (function __GT_t20796(val__$1,box__$1,meta20797){return (new cljs.core.async.impl.channels.t20796(val__$1,box__$1,meta20797));
});
}
return (new cljs.core.async.impl.channels.t20796(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__5704__auto__,writer__5705__auto__,opts__5706__auto__){return cljs.core._write.call(null,writer__5705__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__5701__auto__,writer__5702__auto__,opt__5703__auto__){return cljs.core._write.call(null,writer__5702__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_20799 = self__.takes.pop();if((taker_20799 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_20799))
{var take_cb_20800 = cljs.core.async.impl.protocols.commit.call(null,taker_20799);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_20800,taker_20799){
return (function (){return take_cb_20800.call(null,null);
});})(take_cb_20800,taker_20799))
);
} else
{}
{
