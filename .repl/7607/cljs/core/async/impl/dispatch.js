...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_20790 = 0;while(true){
var m_20791 = cljs.core.async.impl.dispatch.tasks.pop();if((m_20791 == null))
{} else
{m_20791.call(null);
if((count_20790 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__20792 = (count_20790 + 1);
count_20790 = G__20792;
continue;
}
} else
{}
