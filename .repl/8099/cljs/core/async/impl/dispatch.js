...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_69649 = 0;while(true){
var m_69650 = cljs.core.async.impl.dispatch.tasks.pop();if((m_69650 == null))
{} else
{m_69650.call(null);
if((count_69649 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__69651 = (count_69649 + 1);
count_69649 = G__69651;
continue;
}
} else
{}
