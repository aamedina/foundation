...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_69614 = 0;while(true){
if((i_69614 < arr.length))
{(arr[i_69614] = null);
{
var G__69615 = (i_69614 + 1);
i_69614 = G__69615;
continue;
}
} else
...
{var i_69621 = (self__.level + 1);while(true){
if((i_69621 <= (new_level + 1)))
{(update[i_69621] = self__.header);
{
var G__69622 = (i_69621 + 1);
i_69621 = G__69622;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_69623 = 0;while(true){
if((i_69623 <= self__.level))
{var links_69624 = (update[i_69623]).forward;if(((links_69624[i_69623]) === x__$1))
{(links_69624[i_69623] = (x__$1.forward[i_69623]));
{
var G__69625 = (i_69623 + 1);
i_69623 = G__69625;
continue;
}
} else
{{
var G__69626 = (i_69623 + 1);
i_69623 = G__69626;
continue;
}
}
