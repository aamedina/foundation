...
goog.require('goog.date.DateTime');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj70724 = {};return obj70724;
})();
...
* which parses
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__6982__auto__ = (function iter__70733(s__70734){return (new cljs.core.LazySeq(null,(function (){var s__70734__$1 = s__70734;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__70734__$1);if(temp__4098__auto__)
{var s__70734__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__70734__$2))
{var c__6980__auto__ = cljs.core.chunk_first.call(null,s__70734__$2);var size__6981__auto__ = cljs.core.count.call(null,c__6980__auto__);var b__70736 = cljs.core.chunk_buffer.call(null,size__6981__auto__);if((function (){var i__70735 = 0;while(true){
if((i__70735 < size__6981__auto__))
{var f = cljs.core._nth.call(null,c__6980__auto__,i__70735);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e70739){if((e70739 instanceof Error))
{var e = e70739;return null;
} else
...
{cljs.core.chunk_append.call(null,b__70736,d);
{
var G__70741 = (i__70735 + 1);
i__70735 = G__70741;
continue;
}
} else
{{
var G__70742 = (i__70735 + 1);
i__70735 = G__70742;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__70736),iter__70733.call(null,cljs.core.chunk_rest.call(null,s__70734__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__70736),null);
}
} else
{var f = cljs.core.first.call(null,s__70734__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e70740){if((e70740 instanceof Error))
{var e = e70740;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e70740;
} else
...
{return cljs.core.cons.call(null,d,iter__70733.call(null,cljs.core.rest.call(null,s__70734__$2)));
} else
{{
var G__70743 = cljs.core.rest.call(null,s__70734__$2);
s__70734__$1 = G__70743;
continue;
}
}
}
