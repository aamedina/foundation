...
var unparse__delegate = function (fmt,dt,p__70744){var map__70746 = p__70744;var map__70746__$1 = ((cljs.core.seq_QMARK_.call(null,map__70746))?cljs.core.apply.call(null,cljs.core.hash_map,map__70746):map__70746);var tz = cljs.core.get.call(null,map__70746__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__70744 = null;if (arguments.length > 2) {
  p__70744 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__70744);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__70747){
var fmt = cljs.core.first(arglist__70747);
arglist__70747 = cljs.core.next(arglist__70747);
var dt = cljs.core.first(arglist__70747);
var p__70744 = cljs.core.rest(arglist__70747);
return unparse__delegate(fmt,dt,p__70744);
});
...
var show_formatters__delegate = function (p__70748){var map__70754 = p__70748;var map__70754__$1 = ((cljs.core.seq_QMARK_.call(null,map__70754))?cljs.core.apply.call(null,cljs.core.hash_map,map__70754):map__70754);var date_like = cljs.core.get.call(null,map__70754__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__6982__auto__ = (function iter__70755(s__70756){return (new cljs.core.LazySeq(null,(function (){var s__70756__$1 = s__70756;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__70756__$1);if(temp__4098__auto__)
{var s__70756__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__70756__$2))
{var c__6980__auto__ = cljs.core.chunk_first.call(null,s__70756__$2);var size__6981__auto__ = cljs.core.count.call(null,c__6980__auto__);var b__70758 = cljs.core.chunk_buffer.call(null,size__6981__auto__);if((function (){var i__70757 = 0;while(true){
if((i__70757 < size__6981__auto__))
{var i = cljs.core._nth.call(null,c__6980__auto__,i__70757);cljs.core.chunk_append.call(null,b__70758,cljs_time.format.unparse.call(null,i,date_like));
{
var G__70759 = (i__70757 + 1);
i__70757 = G__70759;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__70758),iter__70755.call(null,cljs.core.chunk_rest.call(null,s__70756__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__70758),null);
}
} else
{var i = cljs.core.first.call(null,s__70756__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__70755.call(null,cljs.core.rest.call(null,s__70756__$2)));
}
} else
{return null;
}
...
var p__70748 = null;if (arguments.length > 0) {
  p__70748 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__70748);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__70760){
var p__70748 = cljs.core.seq(arglist__70760);
return show_formatters__delegate(p__70748);
});
