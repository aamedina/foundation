...
goog.require('goog.date.DateTime');
goog.require('goog.i18n.TimeZone');
cljs_time.core.DateTimeProtocol = (function (){var obj70632 = {};return obj70632;
})();
...
*/
cljs_time.core.today_at_midnight = (function today_at_midnight(){var G__70634 = (new goog.date.UtcDateTime());G__70634.setHours(0);
G__70634.setMinutes(0);
G__70634.setSeconds(0);
G__70634.setMilliseconds(0);
return G__70634;
});
/**
* Returns a DateTime for the begining of the Unix epoch in the UTC time zone.
*/
cljs_time.core.epoch = (function epoch(){var G__70636 = (new goog.date.UtcDateTime());G__70636.setTime(0);
return G__70636;
});
/**
...
var G__70637__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.plus_,cljs_time.core.plus_.call(null,dt,p),ps);
};
var G__70637 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__70637__delegate.call(this,dt,p,ps);};
G__70637.cljs$lang$maxFixedArity = 2;
G__70637.cljs$lang$applyTo = (function (arglist__70638){
var dt = cljs.core.first(arglist__70638);
arglist__70638 = cljs.core.next(arglist__70638);
var p = cljs.core.first(arglist__70638);
var ps = cljs.core.rest(arglist__70638);
return G__70637__delegate(dt,p,ps);
});
...
var G__70639__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.minus_,cljs_time.core.minus_.call(null,dt,p),ps);
};
var G__70639 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__70639__delegate.call(this,dt,p,ps);};
G__70639.cljs$lang$maxFixedArity = 2;
G__70639.cljs$lang$applyTo = (function (arglist__70640){
var dt = cljs.core.first(arglist__70640);
arglist__70640 = cljs.core.next(arglist__70640);
var p = cljs.core.first(arglist__70640);
var ps = cljs.core.rest(arglist__70640);
return G__70639__delegate(dt,p,ps);
});
...
extend.cljs$lang$applyTo = (function (arglist__70641){
var in$ = cljs.core.first(arglist__70641);
var by = cljs.core.rest(arglist__70641);
...
cljs_time.core.to_period = (function to_period(in$){var pred__70645 = cljs.core._EQ_;var expr__70646 = cljs.core.type.call(null,in$);if(cljs.core.truth_(pred__70645.call(null,goog.date.Interval,expr__70646)))
{return in$;
} else
{if(cljs.core.truth_(pred__70645.call(null,goog.date.DateRange,expr__70646)))
{return (new goog.date.Interval(0,0,0,0,0,((cljs_time.core.in_millis.call(null,in$) / 1000) | 0)));
} else
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__70646)].join('')));
}
}
});
/**
...
;
cljs_time.core.last_day_of_the_month = (function last_day_of_the_month(dt){var G__70649 = dt;G__70649.setDate(cljs_time.core.number_of_days_in_the_month.call(null,dt));
return G__70649;
});
cljs_time.core.first_day_of_the_month = (function first_day_of_the_month(dt){var G__70651 = dt;G__70651.setDate(1);
return G__70651;
});
...
var today_at__4 = (function (hours,minutes,seconds,millis){return cljs_time.core.date_time.call(null,(function (){var G__70653 = cljs_time.core.now.call(null);G__70653.setHourOfDay(hours);
G__70653.setMinuteOfHour(minutes);
G__70653.setSecondOfMinute(seconds);
G__70653.setMillisOfSecond(millis);
return G__70653;
})());
});
...
;
cljs_time.core.do_at_STAR_ = (function do_at_STAR_(base_date_time,body_fn){var ms = (base_date_time.getTime() - cljs_time.core.now.call(null).getTime());var c__13409__auto__ = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__13410__auto__ = (function (){var switch__13309__auto__ = (function (state_70690){var state_val_70691 = (state_70690[1]);if((state_val_70691 === 5))
{var _ = cljs.core.async.impl.ioc_helpers.add_exception_frame.call(null,state_70690,4,Error,null,3);var inst_70686 = body_fn.call(null);var state_70690__$1 = state_70690;var statearr_70692_70704 = state_70690__$1;(statearr_70692_70704[2] = inst_70686);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_70690__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_70691 === 4))
{var inst_70682 = (state_70690[2]);var state_70690__$1 = (function (){var statearr_70693 = state_70690;(statearr_70693[7] = inst_70682);
return statearr_70693;
})();var statearr_70694_70705 = state_70690__$1;(statearr_70694_70705[2] = null);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_70690__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_70691 === 3))
{var inst_70688 = (state_70690[2]);var state_70690__$1 = state_70690;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_70690__$1,inst_70688);
} else
{if((state_val_70691 === 2))
{var inst_70681 = (state_70690[2]);var state_70690__$1 = (function (){var statearr_70695 = state_70690;(statearr_70695[8] = inst_70681);
return statearr_70695;
})();var statearr_70696_70706 = state_70690__$1;(statearr_70696_70706[2] = null);
(statearr_70696_70706[1] = 5);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_70691 === 1))
{var inst_70679 = cljs.core.async.timeout.call(null,ms);var state_70690__$1 = state_70690;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_70690__$1,2,inst_70679);
} else
{return null;
}
}
...
var state_machine__13310__auto____0 = (function (){var statearr_70700 = (new Array(9));(statearr_70700[0] = state_machine__13310__auto__);
(statearr_70700[1] = 1);
return statearr_70700;
});
var state_machine__13310__auto____1 = (function (state_70690){while(true){
var ret_value__13311__auto__ = (function (){try{while(true){
var result__13312__auto__ = switch__13309__auto__.call(null,state_70690);if(cljs.core.keyword_identical_QMARK_.call(null,result__13312__auto__,new cljs.core.Keyword(null,"recur","recur",1122293407)))
{{
continue;
}
} else
...
}catch (e70701){if((e70701 instanceof Object))
{var ex__13313__auto__ = e70701;var statearr_70702_70707 = state_70690;(statearr_70702_70707[5] = ex__13313__auto__);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_70690);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
...
{{
var G__70708 = state_70690;
state_70690 = G__70708;
continue;
}
} else
...
state_machine__13310__auto__ = function(state_70690){
switch(arguments.length){
case 0:
return state_machine__13310__auto____0.call(this);
case 1:
return state_machine__13310__auto____1.call(this,state_70690);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
})();var state__13411__auto__ = (function (){var statearr_70703 = f__13410__auto__.call(null);(statearr_70703[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__13409__auto__);
...
cljs_time.core.Mappable = (function (){var obj70710 = {};return obj70710;
})();
...
{{
var G__70711 = [cljs.core.str("0"),cljs.core.str(ns)].join('');
ns = G__70711;
continue;
}
} else
...
var G__70712__delegate = function (arg,more){return cljs.core.apply.call(null,f,arg,cljs.core.concat.call(null,args,more));
};
var G__70712 = function (arg,var_args){
var more = null;if (arguments.length > 1) {
  more = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__70712__delegate.call(this,arg,more);};
G__70712.cljs$lang$maxFixedArity = 1;
G__70712.cljs$lang$applyTo = (function (arglist__70713){
var arg = cljs.core.first(arglist__70713);
var more = cljs.core.rest(arglist__70713);
return G__70712__delegate(arg,more);
});
G__70712.cljs$core$IFn$_invoke$arity$variadic = G__70712__delegate;
return G__70712;
})()
;
};
...
fpartial.cljs$lang$applyTo = (function (arglist__70714){
var f = cljs.core.first(arglist__70714);
var args = cljs.core.rest(arglist__70714);
