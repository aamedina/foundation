...
{{
var G__46467 = cljs.core.pop.call(null,v__$1);
v__$1 = G__46467;
continue;
}
} else
...
{var pred__46471 = cljs.core._EQ_;var expr__46472 = limit;if(pred__46471.call(null,1,expr__46472))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__46471.call(null,2,expr__46472))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__46474 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__46475 = (limit__$1 - 1);
var G__46476 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__46474;
limit__$1 = G__46475;
parts = G__46476;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___46478 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___46478))
{var replacement_46479 = temp__4090__auto___46478;buffer.append([cljs.core.str(replacement_46479)].join(''));
} else
{buffer.append(ch);
}
{
var G__46480 = (index + 1);
index = G__46480;
continue;
}
}
