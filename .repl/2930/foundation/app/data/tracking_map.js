...
foundation.app.data.tracking_map.TrackingMap.cljs$lang$ctorPrWriter = (function (this__7976__auto__,writer__7977__auto__,opt__7978__auto__){return cljs.core._write.call(null,writer__7977__auto__,"foundation.app.data.tracking-map/TrackingMap");
});
...
{return (new foundation.app.data.tracking_map.TrackingMap(self__.basis,v.map,cljs.core.update_in.call(null,self__.change_map,cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null,"context","context",1965435169)], true),cljs.core.fnil.call(null,cljs.core.conj,cljs.core.PersistentVector.EMPTY),k)));
} else
{if(cljs.core.map_QMARK_.call(null,v))
{return (new foundation.app.data.tracking_map.TrackingMap(self__.basis,v,cljs.core.update_in.call(null,self__.change_map,cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null,"context","context",1965435169)], true),cljs.core.fnil.call(null,cljs.core.conj,cljs.core.PersistentVector.EMPTY),k)));
} else
...
var G__48393 = null;
var G__48393__2 = (function (self__,k){var self__ = this;
var self____$1 = this;var _ = self____$1;return cljs.core._lookup.call(null,self__.map,k);
});
var G__48393__3 = (function (self__,k,not_found){var self__ = this;
var self____$1 = this;var _ = self____$1;return cljs.core._lookup.call(null,self__.map,k,not_found);
});
G__48393 = function(self__,k,not_found){
switch(arguments.length){
case 2:
return G__48393__2.call(this,self__,k);
case 3:
return G__48393__3.call(this,self__,k,not_found);
}
...
;
foundation.app.data.tracking_map.TrackingMap.prototype.apply = (function (self__,args48392){var self__ = this;
var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(args48392.slice()));
});
...
foundation.app.data.tracking_map.record_change = (function record_change(action,map,key,val,change_map){var map__48395 = change_map;var map__48395__$1 = ((cljs.core.seq_QMARK_.call(null,map__48395))?cljs.core.apply.call(null,cljs.core.hash_map,map__48395):map__48395);var cs = map__48395__$1;var updated = cljs.core.get.call(null,map__48395__$1,new cljs.core.Keyword(null,"updated","updated",779473965));var context = cljs.core.get.call(null,map__48395__$1,new cljs.core.Keyword(null,"context","context",1965435169));var change = ((cljs.core.seq.call(null,context))?cljs.core.conj.call(null,context,key):cljs.core.PersistentVector.fromArray([key], true));var cs__$1 = ((cljs.core._EQ_.call(null,action,new cljs.core.Keyword(null,"dissoc","dissoc",3977329067)))?cljs.core.update_in.call(null,cs,cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null,"removed","removed",2105740242)], true),cljs.core.fnil.call(null,cljs.core.conj,cljs.core.PersistentHashSet.EMPTY),change):(cljs.core.truth_((function (){var and__7430__auto__ = cljs.core.get.call(null,map,key);if(cljs.core.truth_(and__7430__auto__))
