...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_46187 = 0;while(true){
var m_46188 = cljs.core.async.impl.dispatch.tasks.pop();if((m_46188 == null))
{} else
{m_46188.call(null);
if((count_46187 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__46189 = (count_46187 + 1);
count_46187 = G__46189;
continue;
}
} else
{}
