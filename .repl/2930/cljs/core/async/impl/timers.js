...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_46164 = 0;while(true){
if((i_46164 < arr.length))
{(arr[i_46164] = null);
{
var G__46165 = (i_46164 + 1);
i_46164 = G__46165;
continue;
}
} else
...
{var i_46171 = (self__.level + 1);while(true){
if((i_46171 <= (new_level + 1)))
{(update[i_46171] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_46173 = 0;while(true){
if((i_46173 <= self__.level))
{var links_46174 = (update[i_46173]).forward;if(((links_46174[i_46173]) === x__$1))
{(links_46174[i_46173] = (x__$1.forward[i_46173]));
{
var G__46175 = (i_46173 + 1);
i_46173 = G__46175;
continue;
}
} else
{{
var G__46176 = (i_46173 + 1);
i_46173 = G__46176;
continue;
}
}
