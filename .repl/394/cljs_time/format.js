...
var unparse__delegate = function (fmt,dt,p__25627){var map__25629 = p__25627;var map__25629__$1 = ((cljs.core.seq_QMARK_.call(null,map__25629))?cljs.core.apply.call(null,cljs.core.hash_map,map__25629):map__25629);var tz = cljs.core.get.call(null,map__25629__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__25627 = null;if (arguments.length > 2) {
  p__25627 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__25627);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__25630){
var fmt = cljs.core.first(arglist__25630);
arglist__25630 = cljs.core.next(arglist__25630);
var dt = cljs.core.first(arglist__25630);
var p__25627 = cljs.core.rest(arglist__25630);
return unparse__delegate(fmt,dt,p__25627);
});
...
var show_formatters__delegate = function (p__25631){var map__25637 = p__25631;var map__25637__$1 = ((cljs.core.seq_QMARK_.call(null,map__25637))?cljs.core.apply.call(null,cljs.core.hash_map,map__25637):map__25637);var date_like = cljs.core.get.call(null,map__25637__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__8540__auto__ = (function iter__25638(s__25639){return (new cljs.core.LazySeq(null,(function (){var s__25639__$1 = s__25639;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__25639__$1);if(temp__4092__auto__)
{var s__25639__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__25639__$2))
{var c__8538__auto__ = cljs.core.chunk_first.call(null,s__25639__$2);var size__8539__auto__ = cljs.core.count.call(null,c__8538__auto__);var b__25641 = cljs.core.chunk_buffer.call(null,size__8539__auto__);if((function (){var i__25640 = 0;while(true){
if((i__25640 < size__8539__auto__))
{var i = cljs.core._nth.call(null,c__8538__auto__,i__25640);cljs.core.chunk_append.call(null,b__25641,cljs_time.format.unparse.call(null,i,date_like));
{
var G__25642 = (i__25640 + 1);
i__25640 = G__25642;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__25641),iter__25638.call(null,cljs.core.chunk_rest.call(null,s__25639__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__25641),null);
}
} else
{var i = cljs.core.first.call(null,s__25639__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__25638.call(null,cljs.core.rest.call(null,s__25639__$2)));
}
} else
{return null;
}
...
});return iter__8540__auto__.call(null,cljs.core.sort.call(null,cljs.core.vals.call(null,cljs_time.format.formatters)));
};
var show_formatters = function (var_args){
var p__25631 = null;if (arguments.length > 0) {
  p__25631 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__25631);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__25643){
var p__25631 = cljs.core.seq(arglist__25643);
return show_formatters__delegate(p__25631);
});
