...
{{
var G__24220 = cljs.core.pop.call(null,v__$1);
v__$1 = G__24220;
continue;
}
} else
...
{var pred__24224 = cljs.core._EQ_;var expr__24225 = limit;if(cljs.core.truth_(pred__24224.call(null,1,expr__24225)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__24224.call(null,2,expr__24225)))
...
var G__24227 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__24228 = (limit__$1 - 1);
var G__24229 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__24227;
limit__$1 = G__24228;
parts = G__24229;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___24231 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___24231))
{var replacement_24232 = temp__4090__auto___24231;buffer.append([cljs.core.str(replacement_24232)].join(''));
} else
{buffer.append(ch);
}
{
var G__24233 = (index + 1);
index = G__24233;
continue;
}
}
