...
{var vec__22581 = loc;var node = cljs.core.nth.call(null,vec__22581,0,null);var path = cljs.core.nth.call(null,vec__22581,1,null);var vec__22582 = clojure.zip.children.call(null,loc);var c = cljs.core.nth.call(null,vec__22582,0,null);var cnext = cljs.core.nthnext.call(null,vec__22582,1);var cs = vec__22582;if(cljs.core.truth_(cs))
...
* the top
*/
clojure.zip.up = (function up(loc){var vec__22585 = loc;var node = cljs.core.nth.call(null,vec__22585,0,null);var map__22586 = cljs.core.nth.call(null,vec__22585,1,null);var map__22586__$1 = ((cljs.core.seq_QMARK_.call(null,map__22586))?cljs.core.apply.call(null,cljs.core.hash_map,map__22586):map__22586);var path = map__22586__$1;var l = cljs.core.get.call(null,map__22586__$1,new cljs.core.Keyword(null,"l","l",1013904350));var ppath = cljs.core.get.call(null,map__22586__$1,new cljs.core.Keyword(null,"ppath","ppath",1120772103));var pnodes = cljs.core.get.call(null,map__22586__$1,new cljs.core.Keyword(null,"pnodes","pnodes",4325362611));var r = cljs.core.get.call(null,map__22586__$1,new cljs.core.Keyword(null,"r","r",1013904356));var changed_QMARK_ = cljs.core.get.call(null,map__22586__$1,new cljs.core.Keyword(null,"changed?","changed?",2446321533));if(cljs.core.truth_(pnodes))
{var pnode = cljs.core.peek.call(null,pnodes);return cljs.core.with_meta.call(null,(cljs.core.truth_(changed_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.zip.make_node.call(null,loc,pnode,cljs.core.concat.call(null,l,cljs.core.cons.call(null,node,r))),(function (){var and__7835__auto__ = ppath;if(cljs.core.truth_(and__7835__auto__))
...
*/
clojure.zip.right = (function right(loc){var vec__22591 = loc;var node = cljs.core.nth.call(null,vec__22591,0,null);var map__22592 = cljs.core.nth.call(null,vec__22591,1,null);var map__22592__$1 = ((cljs.core.seq_QMARK_.call(null,map__22592))?cljs.core.apply.call(null,cljs.core.hash_map,map__22592):map__22592);var path = map__22592__$1;var l = cljs.core.get.call(null,map__22592__$1,new cljs.core.Keyword(null,"l","l",1013904350));var vec__22593 = cljs.core.get.call(null,map__22592__$1,new cljs.core.Keyword(null,"r","r",1013904356));var r = cljs.core.nth.call(null,vec__22593,0,null);var rnext = cljs.core.nthnext.call(null,vec__22593,1);var rs = vec__22593;if(cljs.core.truth_((function (){var and__7835__auto__ = path;if(cljs.core.truth_(and__7835__auto__))
{return rs;
} else
{return and__7835__auto__;
}
...
*/
clojure.zip.rightmost = (function rightmost(loc){var vec__22596 = loc;var node = cljs.core.nth.call(null,vec__22596,0,null);var map__22597 = cljs.core.nth.call(null,vec__22596,1,null);var map__22597__$1 = ((cljs.core.seq_QMARK_.call(null,map__22597))?cljs.core.apply.call(null,cljs.core.hash_map,map__22597):map__22597);var path = map__22597__$1;var l = cljs.core.get.call(null,map__22597__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__22597__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__7835__auto__ = path;if(cljs.core.truth_(and__7835__auto__))
{return r;
} else
{return and__7835__auto__;
}
...
*/
clojure.zip.left = (function left(loc){var vec__22600 = loc;var node = cljs.core.nth.call(null,vec__22600,0,null);var map__22601 = cljs.core.nth.call(null,vec__22600,1,null);var map__22601__$1 = ((cljs.core.seq_QMARK_.call(null,map__22601))?cljs.core.apply.call(null,cljs.core.hash_map,map__22601):map__22601);var path = map__22601__$1;var l = cljs.core.get.call(null,map__22601__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__22601__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__7835__auto__ = path;if(cljs.core.truth_(and__7835__auto__))
...
*/
clojure.zip.leftmost = (function leftmost(loc){var vec__22604 = loc;var node = cljs.core.nth.call(null,vec__22604,0,null);var map__22605 = cljs.core.nth.call(null,vec__22604,1,null);var map__22605__$1 = ((cljs.core.seq_QMARK_.call(null,map__22605))?cljs.core.apply.call(null,cljs.core.hash_map,map__22605):map__22605);var path = map__22605__$1;var l = cljs.core.get.call(null,map__22605__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__22605__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__7835__auto__ = path;if(cljs.core.truth_(and__7835__auto__))
{return cljs.core.seq.call(null,l);
} else
{return and__7835__auto__;
}
...
* without moving
*/
clojure.zip.insert_left = (function insert_left(loc,item){var vec__22608 = loc;var node = cljs.core.nth.call(null,vec__22608,0,null);var map__22609 = cljs.core.nth.call(null,vec__22608,1,null);var map__22609__$1 = ((cljs.core.seq_QMARK_.call(null,map__22609))?cljs.core.apply.call(null,cljs.core.hash_map,map__22609):map__22609);var path = map__22609__$1;var l = cljs.core.get.call(null,map__22609__$1,new cljs.core.Keyword(null,"l","l",1013904350));if((path == null))
{throw "Insert at top";
} else
...
* without moving
*/
clojure.zip.insert_right = (function insert_right(loc,item){var vec__22612 = loc;var node = cljs.core.nth.call(null,vec__22612,0,null);var map__22613 = cljs.core.nth.call(null,vec__22612,1,null);var map__22613__$1 = ((cljs.core.seq_QMARK_.call(null,map__22613))?cljs.core.apply.call(null,cljs.core.hash_map,map__22613):map__22613);var path = map__22613__$1;var r = cljs.core.get.call(null,map__22613__$1,new cljs.core.Keyword(null,"r","r",1013904356));if((path == null))
{throw "Insert at top";
} else
...
edit.cljs$lang$applyTo = (function (arglist__22616){
var loc = cljs.core.first(arglist__22616);
...
{var or__7847__auto__ = (function (){var and__7835__auto__ = clojure.zip.branch_QMARK_.call(null,loc);if(cljs.core.truth_(and__7835__auto__))
...
{var or__7847__auto____$1 = clojure.zip.right.call(null,loc);if(cljs.core.truth_(or__7847__auto____$1))
{return or__7847__auto____$1;
} else
{var p = loc;while(true){
if(cljs.core.truth_(clojure.zip.up.call(null,p)))
{var or__7847__auto____$2 = clojure.zip.right.call(null,clojure.zip.up.call(null,p));if(cljs.core.truth_(or__7847__auto____$2))
{return or__7847__auto____$2;
} else
{{
var G__22617 = clojure.zip.up.call(null,p);
p = G__22617;
continue;
}
}
...
var temp__4090__auto____$1 = (function (){var and__7835__auto__ = clojure.zip.branch_QMARK_.call(null,loc__$1);if(cljs.core.truth_(and__7835__auto__))
...
var G__22618 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__22618;
continue;
}
} else
...
*/
clojure.zip.remove = (function remove(loc){var vec__22621 = loc;var node = cljs.core.nth.call(null,vec__22621,0,null);var map__22622 = cljs.core.nth.call(null,vec__22621,1,null);var map__22622__$1 = ((cljs.core.seq_QMARK_.call(null,map__22622))?cljs.core.apply.call(null,cljs.core.hash_map,map__22622):map__22622);var path = map__22622__$1;var l = cljs.core.get.call(null,map__22622__$1,new cljs.core.Keyword(null,"l","l",1013904350));var ppath = cljs.core.get.call(null,map__22622__$1,new cljs.core.Keyword(null,"ppath","ppath",1120772103));var pnodes = cljs.core.get.call(null,map__22622__$1,new cljs.core.Keyword(null,"pnodes","pnodes",4325362611));var rs = cljs.core.get.call(null,map__22622__$1,new cljs.core.Keyword(null,"r","r",1013904356));if((path == null))
{throw "Remove at top";
} else
...
var temp__4090__auto__ = (function (){var and__7835__auto__ = clojure.zip.branch_QMARK_.call(null,loc__$1);if(cljs.core.truth_(and__7835__auto__))
{return clojure.zip.down.call(null,loc__$1);
} else
{return and__7835__auto__;
}
...
var G__22623 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__22623;
continue;
}
} else
...
{return cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.zip.make_node.call(null,loc,cljs.core.peek.call(null,pnodes),rs),(function (){var and__7835__auto__ = ppath;if(cljs.core.truth_(and__7835__auto__))
{return cljs.core.assoc.call(null,ppath,new cljs.core.Keyword(null,"changed?","changed?",2446321533),true);
} else
{return and__7835__auto__;
}
