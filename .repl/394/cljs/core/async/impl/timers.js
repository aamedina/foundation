...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__8391__auto__,writer__8392__auto__,opt__8393__auto__){return cljs.core._write.call(null,writer__8392__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_22477 = 0;while(true){
if((i_22477 < arr.length))
{(arr[i_22477] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__8391__auto__,writer__8392__auto__,opt__8393__auto__){return cljs.core._write.call(null,writer__8392__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_22484 = (self__.level + 1);while(true){
if((i_22484 <= (new_level + 1)))
{(update[i_22484] = self__.header);
{
var G__22485 = (i_22484 + 1);
i_22484 = G__22485;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_22486 = 0;while(true){
if((i_22486 <= self__.level))
{var links_22487 = (update[i_22486]).forward;if(((links_22487[i_22486]) === x__$1))
{(links_22487[i_22486] = (x__$1.forward[i_22486]));
{
var G__22488 = (i_22486 + 1);
i_22486 = G__22488;
continue;
}
} else
{{
var G__22489 = (i_22486 + 1);
i_22486 = G__22489;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__7847__auto__ = (cljs.core.truth_((function (){var and__7835__auto__ = me;if(cljs.core.truth_(and__7835__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__7835__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__7847__auto__))
