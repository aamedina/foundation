...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t22518 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t22518 = (function (val,box,meta22519){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t22518.cljs$lang$type = true;
cljs.core.async.impl.channels.t22518.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t22518";
cljs.core.async.impl.channels.t22518.cljs$lang$ctorPrWriter = (function (this__8391__auto__,writer__8392__auto__,opt__8393__auto__){return cljs.core._write.call(null,writer__8392__auto__,"cljs.core.async.impl.channels/t22518");
});
cljs.core.async.impl.channels.t22518.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t22518.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22520){var self__ = this;
var _22520__$1 = this;return self__.meta22519;
});
cljs.core.async.impl.channels.t22518.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22520,meta22519__$1){var self__ = this;
var _22520__$1 = this;return (new cljs.core.async.impl.channels.t22518(self__.val,self__.box,meta22519__$1));
});
cljs.core.async.impl.channels.__GT_t22518 = (function __GT_t22518(val__$1,box__$1,meta22519){return (new cljs.core.async.impl.channels.t22518(val__$1,box__$1,meta22519));
});
}
return (new cljs.core.async.impl.channels.t22518(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8394__auto__,writer__8395__auto__,opts__8396__auto__){return cljs.core._write.call(null,writer__8395__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8391__auto__,writer__8392__auto__,opt__8393__auto__){return cljs.core._write.call(null,writer__8392__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_22521 = self__.takes.pop();if((taker_22521 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_22521))
{var take_cb_22522 = cljs.core.async.impl.protocols.commit.call(null,taker_22521);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_22522,taker_22521){
return (function (){return take_cb_22522.call(null,null);
});})(take_cb_22522,taker_22521))
);
} else
{}
{
