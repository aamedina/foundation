...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_22512 = 0;while(true){
var m_22513 = cljs.core.async.impl.dispatch.tasks.pop();if((m_22513 == null))
{} else
{m_22513.call(null);
if((count_22512 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__22514 = (count_22512 + 1);
count_22512 = G__22514;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7835__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7835__auto__)
