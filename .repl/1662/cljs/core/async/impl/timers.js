...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_156653 = 0;while(true){
if((i_156653 < arr.length))
{(arr[i_156653] = null);
{
var G__156654 = (i_156653 + 1);
i_156653 = G__156654;
continue;
}
} else
...
var G__156656 = x__$1;
var G__156657 = k;
var G__156658 = (level - 1);
var G__156659 = update;
x = G__156656;
k = G__156657;
level = G__156658;
update = G__156659;
...
{var i_156660 = (self__.level + 1);while(true){
if((i_156660 <= (new_level + 1)))
{(update[i_156660] = self__.header);
{
var G__156661 = (i_156660 + 1);
i_156660 = G__156661;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_156662 = 0;while(true){
if((i_156662 <= self__.level))
{var links_156663 = (update[i_156662]).forward;if(((links_156663[i_156662]) === x__$1))
{(links_156663[i_156662] = (x__$1.forward[i_156662]));
{
var G__156664 = (i_156662 + 1);
i_156662 = G__156664;
continue;
}
} else
{{
var G__156665 = (i_156662 + 1);
i_156662 = G__156665;
continue;
}
}
