...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_156688 = 0;while(true){
var m_156689 = cljs.core.async.impl.dispatch.tasks.pop();if((m_156689 == null))
{} else
{m_156689.call(null);
if((count_156688 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__156690 = (count_156688 + 1);
count_156688 = G__156690;
continue;
}
} else
{}
