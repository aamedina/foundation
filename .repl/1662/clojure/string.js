...
{{
var G__157091 = cljs.core.pop.call(null,v__$1);
v__$1 = G__157091;
continue;
}
} else
...
{var pred__157095 = cljs.core._EQ_;var expr__157096 = limit;if(cljs.core.truth_(pred__157095.call(null,1,expr__157096)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__157095.call(null,2,expr__157096)))
...
var G__157098 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__157099 = (limit__$1 - 1);
var G__157100 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__157098;
limit__$1 = G__157099;
parts = G__157100;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___157102 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___157102))
{var replacement_157103 = temp__4096__auto___157102;buffer.append([cljs.core.str(replacement_157103)].join(''));
} else
{buffer.append(ch);
}
{
var G__157104 = (index + 1);
index = G__157104;
continue;
}
}
