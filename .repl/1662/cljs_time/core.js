...
goog.require('goog.date.DateTime');
goog.require('goog.i18n.TimeZone');
cljs_time.core.DateTimeProtocol = (function (){var obj157671 = {};return obj157671;
})();
...
*/
cljs_time.core.today_at_midnight = (function today_at_midnight(){var G__157673 = (new goog.date.UtcDateTime());G__157673.setHours(0);
G__157673.setMinutes(0);
G__157673.setSeconds(0);
G__157673.setMilliseconds(0);
return G__157673;
});
/**
* Returns a DateTime for the begining of the Unix epoch in the UTC time zone.
*/
cljs_time.core.epoch = (function epoch(){var G__157675 = (new goog.date.UtcDateTime());G__157675.setTime(0);
return G__157675;
});
/**
...
var G__157676__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.plus_,cljs_time.core.plus_.call(null,dt,p),ps);
};
var G__157676 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__157676__delegate.call(this,dt,p,ps);};
G__157676.cljs$lang$maxFixedArity = 2;
G__157676.cljs$lang$applyTo = (function (arglist__157677){
var dt = cljs.core.first(arglist__157677);
arglist__157677 = cljs.core.next(arglist__157677);
var p = cljs.core.first(arglist__157677);
var ps = cljs.core.rest(arglist__157677);
return G__157676__delegate(dt,p,ps);
});
G__157676.cljs$core$IFn$_invoke$arity$variadic = G__157676__delegate;
return G__157676;
})()
;
...
var G__157678__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.minus_,cljs_time.core.minus_.call(null,dt,p),ps);
};
var G__157678 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__157678__delegate.call(this,dt,p,ps);};
G__157678.cljs$lang$maxFixedArity = 2;
G__157678.cljs$lang$applyTo = (function (arglist__157679){
var dt = cljs.core.first(arglist__157679);
arglist__157679 = cljs.core.next(arglist__157679);
var p = cljs.core.first(arglist__157679);
var ps = cljs.core.rest(arglist__157679);
return G__157678__delegate(dt,p,ps);
});
G__157678.cljs$core$IFn$_invoke$arity$variadic = G__157678__delegate;
return G__157678;
})()
;
...
extend.cljs$lang$applyTo = (function (arglist__157680){
var in$ = cljs.core.first(arglist__157680);
var by = cljs.core.rest(arglist__157680);
...
cljs_time.core.to_period = (function to_period(in$){var pred__157684 = cljs.core._EQ_;var expr__157685 = cljs.core.type.call(null,in$);if(cljs.core.truth_(pred__157684.call(null,goog.date.Interval,expr__157685)))
{return in$;
} else
{if(cljs.core.truth_(pred__157684.call(null,goog.date.DateRange,expr__157685)))
{return (new goog.date.Interval(0,0,0,0,0,((cljs_time.core.in_millis.call(null,in$) / 1000) | 0)));
} else
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__157685)].join('')));
}
}
});
/**
...
;
cljs_time.core.last_day_of_the_month = (function last_day_of_the_month(dt){var G__157688 = dt;G__157688.setDate(cljs_time.core.number_of_days_in_the_month.call(null,dt));
return G__157688;
});
cljs_time.core.first_day_of_the_month = (function first_day_of_the_month(dt){var G__157690 = dt;G__157690.setDate(1);
return G__157690;
});
...
var today_at__4 = (function (hours,minutes,seconds,millis){return cljs_time.core.date_time.call(null,(function (){var G__157692 = cljs_time.core.now.call(null);G__157692.setHourOfDay(hours);
G__157692.setMinuteOfHour(minutes);
G__157692.setSecondOfMinute(seconds);
G__157692.setMillisOfSecond(millis);
return G__157692;
})());
});
...
;
cljs_time.core.do_at_STAR_ = (function do_at_STAR_(base_date_time,body_fn){var ms = (base_date_time.getTime() - cljs_time.core.now.call(null).getTime());var c__13409__auto__ = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__13410__auto__ = (function (){var switch__13309__auto__ = (function (state_157729){var state_val_157730 = (state_157729[1]);if((state_val_157730 === 5))
{var _ = cljs.core.async.impl.ioc_helpers.add_exception_frame.call(null,state_157729,4,Error,null,3);var inst_157725 = body_fn.call(null);var state_157729__$1 = state_157729;var statearr_157731_157743 = state_157729__$1;(statearr_157731_157743[2] = inst_157725);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_157729__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_157730 === 4))
{var inst_157721 = (state_157729[2]);var state_157729__$1 = (function (){var statearr_157732 = state_157729;(statearr_157732[7] = inst_157721);
return statearr_157732;
})();var statearr_157733_157744 = state_157729__$1;(statearr_157733_157744[2] = null);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_157729__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_157730 === 3))
{var inst_157727 = (state_157729[2]);var state_157729__$1 = state_157729;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_157729__$1,inst_157727);
} else
{if((state_val_157730 === 2))
{var inst_157720 = (state_157729[2]);var state_157729__$1 = (function (){var statearr_157734 = state_157729;(statearr_157734[8] = inst_157720);
return statearr_157734;
})();var statearr_157735_157745 = state_157729__$1;(statearr_157735_157745[2] = null);
(statearr_157735_157745[1] = 5);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_157730 === 1))
{var inst_157718 = cljs.core.async.timeout.call(null,ms);var state_157729__$1 = state_157729;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_157729__$1,2,inst_157718);
} else
{return null;
}
}
...
var state_machine__13310__auto____0 = (function (){var statearr_157739 = (new Array(9));(statearr_157739[0] = state_machine__13310__auto__);
(statearr_157739[1] = 1);
return statearr_157739;
});
var state_machine__13310__auto____1 = (function (state_157729){while(true){
var ret_value__13311__auto__ = (function (){try{while(true){
var result__13312__auto__ = switch__13309__auto__.call(null,state_157729);if(cljs.core.keyword_identical_QMARK_.call(null,result__13312__auto__,new cljs.core.Keyword(null,"recur","recur",1122293407)))
{{
continue;
}
} else
...
}catch (e157740){if((e157740 instanceof Object))
{var ex__13313__auto__ = e157740;var statearr_157741_157746 = state_157729;(statearr_157741_157746[5] = ex__13313__auto__);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_157729);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
...
{{
var G__157747 = state_157729;
state_157729 = G__157747;
continue;
}
} else
...
state_machine__13310__auto__ = function(state_157729){
switch(arguments.length){
case 0:
return state_machine__13310__auto____0.call(this);
case 1:
return state_machine__13310__auto____1.call(this,state_157729);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
})();var state__13411__auto__ = (function (){var statearr_157742 = f__13410__auto__.call(null);(statearr_157742[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__13409__auto__);
return statearr_157742;
})();return cljs.core.async.impl.ioc_helpers.run_state_machine_wrapped.call(null,state__13411__auto__);
}));
return c__13409__auto__;
});
cljs_time.core.Mappable = (function (){var obj157749 = {};return obj157749;
})();
...
{{
var G__157750 = [cljs.core.str("0"),cljs.core.str(ns)].join('');
ns = G__157750;
continue;
}
} else
...
var G__157751__delegate = function (arg,more){return cljs.core.apply.call(null,f,arg,cljs.core.concat.call(null,args,more));
};
var G__157751 = function (arg,var_args){
var more = null;if (arguments.length > 1) {
  more = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__157751__delegate.call(this,arg,more);};
G__157751.cljs$lang$maxFixedArity = 1;
G__157751.cljs$lang$applyTo = (function (arglist__157752){
var arg = cljs.core.first(arglist__157752);
var more = cljs.core.rest(arglist__157752);
return G__157751__delegate(arg,more);
});
G__157751.cljs$core$IFn$_invoke$arity$variadic = G__157751__delegate;
return G__157751;
})()
;
};
...
fpartial.cljs$lang$applyTo = (function (arglist__157753){
var f = cljs.core.first(arglist__157753);
var args = cljs.core.rest(arglist__157753);
