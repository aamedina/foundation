...
var unparse__delegate = function (fmt,dt,p__157783){var map__157785 = p__157783;var map__157785__$1 = ((cljs.core.seq_QMARK_.call(null,map__157785))?cljs.core.apply.call(null,cljs.core.hash_map,map__157785):map__157785);var tz = cljs.core.get.call(null,map__157785__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__157783 = null;if (arguments.length > 2) {
  p__157783 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__157783);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__157786){
var fmt = cljs.core.first(arglist__157786);
arglist__157786 = cljs.core.next(arglist__157786);
var dt = cljs.core.first(arglist__157786);
var p__157783 = cljs.core.rest(arglist__157786);
return unparse__delegate(fmt,dt,p__157783);
});
...
var show_formatters__delegate = function (p__157787){var map__157793 = p__157787;var map__157793__$1 = ((cljs.core.seq_QMARK_.call(null,map__157793))?cljs.core.apply.call(null,cljs.core.hash_map,map__157793):map__157793);var date_like = cljs.core.get.call(null,map__157793__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__6982__auto__ = (function iter__157794(s__157795){return (new cljs.core.LazySeq(null,(function (){var s__157795__$1 = s__157795;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__157795__$1);if(temp__4098__auto__)
{var s__157795__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__157795__$2))
{var c__6980__auto__ = cljs.core.chunk_first.call(null,s__157795__$2);var size__6981__auto__ = cljs.core.count.call(null,c__6980__auto__);var b__157797 = cljs.core.chunk_buffer.call(null,size__6981__auto__);if((function (){var i__157796 = 0;while(true){
if((i__157796 < size__6981__auto__))
{var i = cljs.core._nth.call(null,c__6980__auto__,i__157796);cljs.core.chunk_append.call(null,b__157797,cljs_time.format.unparse.call(null,i,date_like));
{
...
{var i = cljs.core.first.call(null,s__157795__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__157794.call(null,cljs.core.rest.call(null,s__157795__$2)));
}
} else
{return null;
}
...
var p__157787 = null;if (arguments.length > 0) {
  p__157787 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__157787);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__157799){
var p__157787 = cljs.core.seq(arglist__157799);
return show_formatters__delegate(p__157787);
});
