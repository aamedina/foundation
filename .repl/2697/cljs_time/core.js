...
goog.require('goog.date.DateTime');
goog.require('goog.i18n.TimeZone');
cljs_time.core.DateTimeProtocol = (function (){var obj83282 = {};return obj83282;
})();
...
*/
cljs_time.core.today_at_midnight = (function today_at_midnight(){var G__83284 = (new goog.date.UtcDateTime());G__83284.setHours(0);
G__83284.setMinutes(0);
G__83284.setSeconds(0);
G__83284.setMilliseconds(0);
return G__83284;
});
/**
* Returns a DateTime for the begining of the Unix epoch in the UTC time zone.
*/
cljs_time.core.epoch = (function epoch(){var G__83286 = (new goog.date.UtcDateTime());G__83286.setTime(0);
return G__83286;
});
/**
...
var G__83287__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.plus_,cljs_time.core.plus_.call(null,dt,p),ps);
};
var G__83287 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__83287__delegate.call(this,dt,p,ps);};
G__83287.cljs$lang$maxFixedArity = 2;
G__83287.cljs$lang$applyTo = (function (arglist__83288){
var dt = cljs.core.first(arglist__83288);
arglist__83288 = cljs.core.next(arglist__83288);
var p = cljs.core.first(arglist__83288);
var ps = cljs.core.rest(arglist__83288);
return G__83287__delegate(dt,p,ps);
});
G__83287.cljs$core$IFn$_invoke$arity$variadic = G__83287__delegate;
return G__83287;
})()
;
...
var G__83289__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.minus_,cljs_time.core.minus_.call(null,dt,p),ps);
};
var G__83289 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__83289__delegate.call(this,dt,p,ps);};
G__83289.cljs$lang$maxFixedArity = 2;
G__83289.cljs$lang$applyTo = (function (arglist__83290){
var dt = cljs.core.first(arglist__83290);
arglist__83290 = cljs.core.next(arglist__83290);
var p = cljs.core.first(arglist__83290);
var ps = cljs.core.rest(arglist__83290);
return G__83289__delegate(dt,p,ps);
});
G__83289.cljs$core$IFn$_invoke$arity$variadic = G__83289__delegate;
return G__83289;
})()
;
...
extend.cljs$lang$applyTo = (function (arglist__83291){
var in$ = cljs.core.first(arglist__83291);
var by = cljs.core.rest(arglist__83291);
...
cljs_time.core.to_period = (function to_period(in$){var pred__83295 = cljs.core._EQ_;var expr__83296 = cljs.core.type.call(null,in$);if(cljs.core.truth_(pred__83295.call(null,goog.date.Interval,expr__83296)))
{return in$;
} else
{if(cljs.core.truth_(pred__83295.call(null,goog.date.DateRange,expr__83296)))
{return (new goog.date.Interval(0,0,0,0,0,((cljs_time.core.in_millis.call(null,in$) / 1000) | 0)));
} else
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__83296)].join('')));
}
}
});
/**
...
;
cljs_time.core.last_day_of_the_month = (function last_day_of_the_month(dt){var G__83299 = dt;G__83299.setDate(cljs_time.core.number_of_days_in_the_month.call(null,dt));
return G__83299;
});
cljs_time.core.first_day_of_the_month = (function first_day_of_the_month(dt){var G__83301 = dt;G__83301.setDate(1);
return G__83301;
});
...
var today_at__4 = (function (hours,minutes,seconds,millis){return cljs_time.core.date_time.call(null,(function (){var G__83303 = cljs_time.core.now.call(null);G__83303.setHourOfDay(hours);
G__83303.setMinuteOfHour(minutes);
G__83303.setSecondOfMinute(seconds);
G__83303.setMillisOfSecond(millis);
return G__83303;
})());
});
...
;
cljs_time.core.do_at_STAR_ = (function do_at_STAR_(base_date_time,body_fn){var ms = (base_date_time.getTime() - cljs_time.core.now.call(null).getTime());var c__13409__auto__ = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__13410__auto__ = (function (){var switch__13309__auto__ = (function (state_83340){var state_val_83341 = (state_83340[1]);if((state_val_83341 === 5))
{var _ = cljs.core.async.impl.ioc_helpers.add_exception_frame.call(null,state_83340,4,Error,null,3);var inst_83336 = body_fn.call(null);var state_83340__$1 = state_83340;var statearr_83342_83354 = state_83340__$1;(statearr_83342_83354[2] = inst_83336);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_83340__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_83341 === 4))
{var inst_83332 = (state_83340[2]);var state_83340__$1 = (function (){var statearr_83343 = state_83340;(statearr_83343[7] = inst_83332);
return statearr_83343;
})();var statearr_83344_83355 = state_83340__$1;(statearr_83344_83355[2] = null);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_83340__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_83341 === 3))
{var inst_83338 = (state_83340[2]);var state_83340__$1 = state_83340;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_83340__$1,inst_83338);
} else
{if((state_val_83341 === 2))
{var inst_83331 = (state_83340[2]);var state_83340__$1 = (function (){var statearr_83345 = state_83340;(statearr_83345[8] = inst_83331);
return statearr_83345;
})();var statearr_83346_83356 = state_83340__$1;(statearr_83346_83356[2] = null);
(statearr_83346_83356[1] = 5);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_83341 === 1))
{var inst_83329 = cljs.core.async.timeout.call(null,ms);var state_83340__$1 = state_83340;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_83340__$1,2,inst_83329);
} else
{return null;
}
}
...
var state_machine__13310__auto____0 = (function (){var statearr_83350 = (new Array(9));(statearr_83350[0] = state_machine__13310__auto__);
(statearr_83350[1] = 1);
return statearr_83350;
});
var state_machine__13310__auto____1 = (function (state_83340){while(true){
var ret_value__13311__auto__ = (function (){try{while(true){
var result__13312__auto__ = switch__13309__auto__.call(null,state_83340);if(cljs.core.keyword_identical_QMARK_.call(null,result__13312__auto__,new cljs.core.Keyword(null,"recur","recur",1122293407)))
{{
continue;
}
} else
...
}catch (e83351){if((e83351 instanceof Object))
{var ex__13313__auto__ = e83351;var statearr_83352_83357 = state_83340;(statearr_83352_83357[5] = ex__13313__auto__);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_83340);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
...
{{
var G__83358 = state_83340;
state_83340 = G__83358;
continue;
}
} else
...
state_machine__13310__auto__ = function(state_83340){
switch(arguments.length){
case 0:
return state_machine__13310__auto____0.call(this);
case 1:
return state_machine__13310__auto____1.call(this,state_83340);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
})();var state__13411__auto__ = (function (){var statearr_83353 = f__13410__auto__.call(null);(statearr_83353[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__13409__auto__);
...
cljs_time.core.Mappable = (function (){var obj83360 = {};return obj83360;
})();
...
{{
var G__83361 = [cljs.core.str("0"),cljs.core.str(ns)].join('');
ns = G__83361;
continue;
}
} else
...
var G__83362__delegate = function (arg,more){return cljs.core.apply.call(null,f,arg,cljs.core.concat.call(null,args,more));
};
var G__83362 = function (arg,var_args){
var more = null;if (arguments.length > 1) {
  more = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__83362__delegate.call(this,arg,more);};
G__83362.cljs$lang$maxFixedArity = 1;
G__83362.cljs$lang$applyTo = (function (arglist__83363){
var arg = cljs.core.first(arglist__83363);
var more = cljs.core.rest(arglist__83363);
return G__83362__delegate(arg,more);
});
G__83362.cljs$core$IFn$_invoke$arity$variadic = G__83362__delegate;
return G__83362;
})()
;
};
...
fpartial.cljs$lang$applyTo = (function (arglist__83364){
var f = cljs.core.first(arglist__83364);
var args = cljs.core.rest(arglist__83364);
