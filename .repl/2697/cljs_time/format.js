...
var unparse__delegate = function (fmt,dt,p__83394){var map__83396 = p__83394;var map__83396__$1 = ((cljs.core.seq_QMARK_.call(null,map__83396))?cljs.core.apply.call(null,cljs.core.hash_map,map__83396):map__83396);var tz = cljs.core.get.call(null,map__83396__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__83394 = null;if (arguments.length > 2) {
  p__83394 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__83394);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__83397){
var fmt = cljs.core.first(arglist__83397);
arglist__83397 = cljs.core.next(arglist__83397);
var dt = cljs.core.first(arglist__83397);
var p__83394 = cljs.core.rest(arglist__83397);
return unparse__delegate(fmt,dt,p__83394);
});
...
var show_formatters__delegate = function (p__83398){var map__83404 = p__83398;var map__83404__$1 = ((cljs.core.seq_QMARK_.call(null,map__83404))?cljs.core.apply.call(null,cljs.core.hash_map,map__83404):map__83404);var date_like = cljs.core.get.call(null,map__83404__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__6982__auto__ = (function iter__83405(s__83406){return (new cljs.core.LazySeq(null,(function (){var s__83406__$1 = s__83406;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__83406__$1);if(temp__4098__auto__)
{var s__83406__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__83406__$2))
{var c__6980__auto__ = cljs.core.chunk_first.call(null,s__83406__$2);var size__6981__auto__ = cljs.core.count.call(null,c__6980__auto__);var b__83408 = cljs.core.chunk_buffer.call(null,size__6981__auto__);if((function (){var i__83407 = 0;while(true){
if((i__83407 < size__6981__auto__))
{var i = cljs.core._nth.call(null,c__6980__auto__,i__83407);cljs.core.chunk_append.call(null,b__83408,cljs_time.format.unparse.call(null,i,date_like));
{
var G__83409 = (i__83407 + 1);
i__83407 = G__83409;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__83408),iter__83405.call(null,cljs.core.chunk_rest.call(null,s__83406__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__83408),null);
}
} else
{var i = cljs.core.first.call(null,s__83406__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__83405.call(null,cljs.core.rest.call(null,s__83406__$2)));
}
} else
{return null;
}
...
var p__83398 = null;if (arguments.length > 0) {
  p__83398 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__83398);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__83410){
var p__83398 = cljs.core.seq(arglist__83410);
return show_formatters__delegate(p__83398);
});
