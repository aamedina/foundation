...
goog.require('goog.date.DateTime');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj83374 = {};return obj83374;
})();
...
* which parses
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__6982__auto__ = (function iter__83383(s__83384){return (new cljs.core.LazySeq(null,(function (){var s__83384__$1 = s__83384;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__83384__$1);if(temp__4098__auto__)
{var s__83384__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__83384__$2))
{var c__6980__auto__ = cljs.core.chunk_first.call(null,s__83384__$2);var size__6981__auto__ = cljs.core.count.call(null,c__6980__auto__);var b__83386 = cljs.core.chunk_buffer.call(null,size__6981__auto__);if((function (){var i__83385 = 0;while(true){
if((i__83385 < size__6981__auto__))
{var f = cljs.core._nth.call(null,c__6980__auto__,i__83385);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e83389){if((e83389 instanceof Error))
{var e = e83389;return null;
} else
...
{cljs.core.chunk_append.call(null,b__83386,d);
{
var G__83391 = (i__83385 + 1);
i__83385 = G__83391;
continue;
}
} else
{{
var G__83392 = (i__83385 + 1);
i__83385 = G__83392;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__83386),iter__83383.call(null,cljs.core.chunk_rest.call(null,s__83384__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__83386),null);
}
} else
{var f = cljs.core.first.call(null,s__83384__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e83390){if((e83390 instanceof Error))
{var e = e83390;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e83390;
} else
...
{return cljs.core.cons.call(null,d,iter__83383.call(null,cljs.core.rest.call(null,s__83384__$2)));
} else
{{
var G__83393 = cljs.core.rest.call(null,s__83384__$2);
s__83384__$1 = G__83393;
continue;
}
}
}
