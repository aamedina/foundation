...
{{
var G__82702 = cljs.core.pop.call(null,v__$1);
v__$1 = G__82702;
continue;
}
} else
...
{var pred__82706 = cljs.core._EQ_;var expr__82707 = limit;if(cljs.core.truth_(pred__82706.call(null,1,expr__82707)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__82706.call(null,2,expr__82707)))
...
var G__82709 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__82710 = (limit__$1 - 1);
var G__82711 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__82709;
limit__$1 = G__82710;
parts = G__82711;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___82713 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___82713))
{var replacement_82714 = temp__4096__auto___82713;buffer.append([cljs.core.str(replacement_82714)].join(''));
} else
{buffer.append(ch);
}
{
var G__82715 = (index + 1);
index = G__82715;
continue;
}
}
