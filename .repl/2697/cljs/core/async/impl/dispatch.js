...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_82299 = 0;while(true){
var m_82300 = cljs.core.async.impl.dispatch.tasks.pop();if((m_82300 == null))
{} else
{m_82300.call(null);
if((count_82299 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__82301 = (count_82299 + 1);
count_82299 = G__82301;
continue;
}
} else
{}
