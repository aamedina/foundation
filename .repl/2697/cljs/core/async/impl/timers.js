...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_82264 = 0;while(true){
if((i_82264 < arr.length))
{(arr[i_82264] = null);
{
var G__82265 = (i_82264 + 1);
i_82264 = G__82265;
continue;
}
} else
...
{var i_82271 = (self__.level + 1);while(true){
if((i_82271 <= (new_level + 1)))
{(update[i_82271] = self__.header);
{
var G__82272 = (i_82271 + 1);
i_82271 = G__82272;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_82273 = 0;while(true){
if((i_82273 <= self__.level))
{var links_82274 = (update[i_82273]).forward;if(((links_82274[i_82273]) === x__$1))
{(links_82274[i_82273] = (x__$1.forward[i_82273]));
{
var G__82275 = (i_82273 + 1);
i_82273 = G__82275;
continue;
}
} else
{{
var G__82276 = (i_82273 + 1);
i_82273 = G__82276;
continue;
}
}
