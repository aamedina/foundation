...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj49981 = {};return obj49981;
})();
cljs.reader.read_char = (function read_char(reader){if((function (){var and__5145__auto__ = reader;if(and__5145__auto__)
...
{var x__5760__auto__ = (((reader == null))?null:reader);return (function (){var or__5157__auto__ = (cljs.reader.read_char[goog.typeOf(x__5760__auto__)]);if(or__5157__auto__)
{return or__5157__auto__;
} else
{var or__5157__auto____$1 = (cljs.reader.read_char["_"]);if(or__5157__auto____$1)
...
cljs.reader.unread = (function unread(reader,ch){if((function (){var and__5145__auto__ = reader;if(and__5145__auto__)
...
{var x__5760__auto__ = (((reader == null))?null:reader);return (function (){var or__5157__auto__ = (cljs.reader.unread[goog.typeOf(x__5760__auto__)]);if(or__5157__auto__)
{return or__5157__auto__;
} else
{var or__5157__auto____$1 = (cljs.reader.unread["_"]);if(or__5157__auto____$1)
{return or__5157__auto____$1;
} else
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__5701__auto__,writer__5702__auto__,opt__5703__auto__){return cljs.core._write.call(null,writer__5702__auto__,"cljs.reader/StringPushbackReader");
});
...
*/
cljs.reader.whitespace_QMARK_ = (function whitespace_QMARK_(ch){var or__5157__auto__ = goog.string.isBreakingWhitespace(ch);if(cljs.core.truth_(or__5157__auto__))
{return or__5157__auto__;
} else
{return ("," === ch);
}
...
reader_error.cljs$lang$applyTo = (function (arglist__49982){
var rdr = cljs.core.first(arglist__49982);
var msg = cljs.core.rest(arglist__49982);
...
;
cljs.reader.macro_terminating_QMARK_ = (function macro_terminating_QMARK_(ch){var and__5145__auto__ = !((ch === "#"));if(and__5145__auto__)
{var and__5145__auto____$1 = !((ch === "'"));if(and__5145__auto____$1)
{var and__5145__auto____$2 = !((ch === ":"));if(and__5145__auto____$2)
...
{{
var G__49983 = (function (){sb.append(ch);
return sb;
})();
var G__49984 = cljs.reader.read_char.call(null,rdr);
sb = G__49983;
ch = G__49984;
continue;
}
...
{{
var G__49985 = cljs.reader.read_char.call(null,rdr);
ch = G__49985;
continue;
}
} else
...
var G__49986 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__49986;
continue;
}
} else
...
var G__49987 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__49987;
continue;
}
}
...
if(cljs.core.truth_((function (){var or__5157__auto__ = (ch == null);if(or__5157__auto__)
{return or__5157__auto__;
} else
{var or__5157__auto____$1 = cljs.reader.whitespace_QMARK_.call(null,ch);if(or__5157__auto____$1)
{return or__5157__auto____$1;
} else
{return cljs.reader.macros.call(null,ch);
}
...
var s = buffer.toString();var or__5157__auto__ = cljs.reader.match_number.call(null,s);if(cljs.core.truth_(or__5157__auto__))
{return or__5157__auto__;
} else
...
{{
var G__49988 = (function (){buffer.append(ch);
return buffer;
})();
var G__49989 = cljs.reader.read_char.call(null,reader);
buffer = G__49988;
ch = G__49989;
continue;
}
...
{if(("\\" === ch))
{{
var G__49990 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__49991 = cljs.reader.read_char.call(null,reader);
buffer = G__49990;
ch = G__49991;
continue;
}
...
{{
var G__49992 = (function (){buffer.append(ch);
return buffer;
})();
var G__49993 = cljs.reader.read_char.call(null,reader);
buffer = G__49992;
ch = G__49993;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__49995 = o;if(G__49995)
{var bit__5783__auto__ = (G__49995.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5783__auto__) || (G__49995.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__49995.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__49995);
} else
{return false;
}
}
...
{{
var G__49996 = reader;
var G__49997 = eof_is_error;
var G__49998 = sentinel;
var G__49999 = is_recursive;
reader = G__49996;
eof_is_error = G__49997;
sentinel = G__49998;
is_recursive = G__49999;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__50000 = cljs.reader.read_comment.call(null,reader,ch);
var G__50001 = eof_is_error;
var G__50002 = sentinel;
var G__50003 = is_recursive;
reader = G__50000;
eof_is_error = G__50001;
sentinel = G__50002;
is_recursive = G__50003;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__50004 = reader;
var G__50005 = eof_is_error;
var G__50006 = sentinel;
var G__50007 = is_recursive;
reader = G__50004;
eof_is_error = G__50005;
sentinel = G__50006;
is_recursive = G__50007;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__50010 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__50010,0,null);var years = cljs.core.nth.call(null,vec__50010,1,null);var months = cljs.core.nth.call(null,vec__50010,2,null);var days = cljs.core.nth.call(null,vec__50010,3,null);var hours = cljs.core.nth.call(null,vec__50010,4,null);var minutes = cljs.core.nth.call(null,vec__50010,5,null);var seconds = cljs.core.nth.call(null,vec__50010,6,null);var fraction = cljs.core.nth.call(null,vec__50010,7,null);var offset_sign = cljs.core.nth.call(null,vec__50010,8,null);var offset_hours = cljs.core.nth.call(null,vec__50010,9,null);var offset_minutes = cljs.core.nth.call(null,vec__50010,10,null);var v = vec__50010;if(cljs.core.not.call(null,v))
{return cljs.reader.reader_error.call(null,null,[cljs.core.str("Unrecognized date/time syntax: "),cljs.core.str(s)].join(''));
} else
{var years__$1 = cljs.reader.parse_int.call(null,years);var months__$1 = (function (){var or__5157__auto__ = cljs.reader.parse_int.call(null,months);if(cljs.core.truth_(or__5157__auto__))
{return or__5157__auto__;
} else
{return 1;
}
})();var days__$1 = (function (){var or__5157__auto__ = cljs.reader.parse_int.call(null,days);if(cljs.core.truth_(or__5157__auto__))
{return or__5157__auto__;
} else
{return 1;
}
})();var hours__$1 = (function (){var or__5157__auto__ = cljs.reader.parse_int.call(null,hours);if(cljs.core.truth_(or__5157__auto__))
{return or__5157__auto__;
} else
{return 0;
}
})();var minutes__$1 = (function (){var or__5157__auto__ = cljs.reader.parse_int.call(null,minutes);if(cljs.core.truth_(or__5157__auto__))
{return or__5157__auto__;
} else
{return 0;
}
})();var seconds__$1 = (function (){var or__5157__auto__ = cljs.reader.parse_int.call(null,seconds);if(cljs.core.truth_(or__5157__auto__))
{return or__5157__auto__;
} else
{return 0;
}
})();var fraction__$1 = (function (){var or__5157__auto__ = cljs.reader.parse_int.call(null,cljs.reader.zero_fill_right_and_truncate.call(null,fraction,3));if(cljs.core.truth_(or__5157__auto__))
{return or__5157__auto__;
} else
{return 0;
}
})();var offset_sign__$1 = ((cljs.core._EQ_.call(null,offset_sign,"-"))?-1:1);var offset_hours__$1 = (function (){var or__5157__auto__ = cljs.reader.parse_int.call(null,offset_hours);if(cljs.core.truth_(or__5157__auto__))
{return or__5157__auto__;
} else
{return 0;
}
})();var offset_minutes__$1 = (function (){var or__5157__auto__ = cljs.reader.parse_int.call(null,offset_minutes);if(cljs.core.truth_(or__5157__auto__))
{return or__5157__auto__;
} else
{return 0;
}
...
{var vec__50012 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__50012,0,null);var months = cljs.core.nth.call(null,vec__50012,1,null);var days = cljs.core.nth.call(null,vec__50012,2,null);var hours = cljs.core.nth.call(null,vec__50012,3,null);var minutes = cljs.core.nth.call(null,vec__50012,4,null);var seconds = cljs.core.nth.call(null,vec__50012,5,null);var ms = cljs.core.nth.call(null,vec__50012,6,null);var offset = cljs.core.nth.call(null,vec__50012,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
