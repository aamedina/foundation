...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_49575 = 0;while(true){
if((i_49575 < arr.length))
{(arr[i_49575] = null);
{
var G__49576 = (i_49575 + 1);
i_49575 = G__49576;
continue;
}
} else
...
{var i_49582 = (self__.level + 1);while(true){
if((i_49582 <= (new_level + 1)))
{(update[i_49582] = self__.header);
{
var G__49583 = (i_49582 + 1);
i_49582 = G__49583;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_49584 = 0;while(true){
if((i_49584 <= self__.level))
{var links_49585 = (update[i_49584]).forward;if(((links_49585[i_49584]) === x__$1))
{(links_49585[i_49584] = (x__$1.forward[i_49584]));
{
var G__49586 = (i_49584 + 1);
i_49584 = G__49586;
continue;
}
} else
{{
var G__49587 = (i_49584 + 1);
i_49584 = G__49587;
continue;
}
}
