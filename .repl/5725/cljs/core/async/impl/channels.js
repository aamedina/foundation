...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t49616 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t49616 = (function (val,box,meta49617){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t49616.cljs$lang$type = true;
cljs.core.async.impl.channels.t49616.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t49616";
cljs.core.async.impl.channels.t49616.cljs$lang$ctorPrWriter = (function (this__5701__auto__,writer__5702__auto__,opt__5703__auto__){return cljs.core._write.call(null,writer__5702__auto__,"cljs.core.async.impl.channels/t49616");
});
cljs.core.async.impl.channels.t49616.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t49616.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_49618){var self__ = this;
var _49618__$1 = this;return self__.meta49617;
});
cljs.core.async.impl.channels.t49616.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_49618,meta49617__$1){var self__ = this;
var _49618__$1 = this;return (new cljs.core.async.impl.channels.t49616(self__.val,self__.box,meta49617__$1));
});
cljs.core.async.impl.channels.__GT_t49616 = (function __GT_t49616(val__$1,box__$1,meta49617){return (new cljs.core.async.impl.channels.t49616(val__$1,box__$1,meta49617));
});
}
return (new cljs.core.async.impl.channels.t49616(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_49619 = self__.takes.pop();if((taker_49619 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_49619))
{var take_cb_49620 = cljs.core.async.impl.protocols.commit.call(null,taker_49619);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_49620,taker_49619){
return (function (){return take_cb_49620.call(null,null);
});})(take_cb_49620,taker_49619))
);
} else
{}
{
