...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_49610 = 0;while(true){
var m_49611 = cljs.core.async.impl.dispatch.tasks.pop();if((m_49611 == null))
{} else
{m_49611.call(null);
if((count_49610 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__49612 = (count_49610 + 1);
count_49610 = G__49612;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__5145__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__5145__auto__)
