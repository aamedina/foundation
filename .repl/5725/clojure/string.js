...
{{
var G__50013 = cljs.core.pop.call(null,v__$1);
v__$1 = G__50013;
continue;
}
} else
...
{var pred__50017 = cljs.core._EQ_;var expr__50018 = limit;if(cljs.core.truth_(pred__50017.call(null,1,expr__50018)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__50017.call(null,2,expr__50018)))
...
var G__50020 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__50021 = (limit__$1 - 1);
var G__50022 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__50020;
limit__$1 = G__50021;
parts = G__50022;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___50024 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___50024))
{var replacement_50025 = temp__4096__auto___50024;buffer.append([cljs.core.str(replacement_50025)].join(''));
} else
{buffer.append(ch);
}
{
var G__50026 = (index + 1);
index = G__50026;
continue;
}
}
