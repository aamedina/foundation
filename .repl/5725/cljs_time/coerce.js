...
goog.require('goog.date.DateTime');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj50685 = {};return obj50685;
})();
...
* which parses
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__5850__auto__ = (function iter__50694(s__50695){return (new cljs.core.LazySeq(null,(function (){var s__50695__$1 = s__50695;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__50695__$1);if(temp__4098__auto__)
{var s__50695__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__50695__$2))
{var c__5848__auto__ = cljs.core.chunk_first.call(null,s__50695__$2);var size__5849__auto__ = cljs.core.count.call(null,c__5848__auto__);var b__50697 = cljs.core.chunk_buffer.call(null,size__5849__auto__);if((function (){var i__50696 = 0;while(true){
if((i__50696 < size__5849__auto__))
{var f = cljs.core._nth.call(null,c__5848__auto__,i__50696);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e50700){if((e50700 instanceof Error))
{var e = e50700;return null;
} else
...
{cljs.core.chunk_append.call(null,b__50697,d);
{
var G__50702 = (i__50696 + 1);
i__50696 = G__50702;
continue;
}
} else
{{
var G__50703 = (i__50696 + 1);
i__50696 = G__50703;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__50697),iter__50694.call(null,cljs.core.chunk_rest.call(null,s__50695__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__50697),null);
}
} else
{var f = cljs.core.first.call(null,s__50695__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e50701){if((e50701 instanceof Error))
{var e = e50701;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e50701;
} else
...
{return cljs.core.cons.call(null,d,iter__50694.call(null,cljs.core.rest.call(null,s__50695__$2)));
} else
{{
var G__50704 = cljs.core.rest.call(null,s__50695__$2);
s__50695__$1 = G__50704;
continue;
}
}
}
