...
var unparse__delegate = function (fmt,dt,p__50705){var map__50707 = p__50705;var map__50707__$1 = ((cljs.core.seq_QMARK_.call(null,map__50707))?cljs.core.apply.call(null,cljs.core.hash_map,map__50707):map__50707);var tz = cljs.core.get.call(null,map__50707__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__50705 = null;if (arguments.length > 2) {
  p__50705 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__50705);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__50708){
var fmt = cljs.core.first(arglist__50708);
arglist__50708 = cljs.core.next(arglist__50708);
var dt = cljs.core.first(arglist__50708);
var p__50705 = cljs.core.rest(arglist__50708);
return unparse__delegate(fmt,dt,p__50705);
});
...
var show_formatters__delegate = function (p__50709){var map__50715 = p__50709;var map__50715__$1 = ((cljs.core.seq_QMARK_.call(null,map__50715))?cljs.core.apply.call(null,cljs.core.hash_map,map__50715):map__50715);var date_like = cljs.core.get.call(null,map__50715__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__5850__auto__ = (function iter__50716(s__50717){return (new cljs.core.LazySeq(null,(function (){var s__50717__$1 = s__50717;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__50717__$1);if(temp__4098__auto__)
{var s__50717__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__50717__$2))
{var c__5848__auto__ = cljs.core.chunk_first.call(null,s__50717__$2);var size__5849__auto__ = cljs.core.count.call(null,c__5848__auto__);var b__50719 = cljs.core.chunk_buffer.call(null,size__5849__auto__);if((function (){var i__50718 = 0;while(true){
if((i__50718 < size__5849__auto__))
{var i = cljs.core._nth.call(null,c__5848__auto__,i__50718);cljs.core.chunk_append.call(null,b__50719,cljs_time.format.unparse.call(null,i,date_like));
{
var G__50720 = (i__50718 + 1);
i__50718 = G__50720;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__50719),iter__50716.call(null,cljs.core.chunk_rest.call(null,s__50717__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__50719),null);
}
} else
{var i = cljs.core.first.call(null,s__50717__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__50716.call(null,cljs.core.rest.call(null,s__50717__$2)));
}
} else
{return null;
}
...
});return iter__5850__auto__.call(null,cljs.core.sort.call(null,cljs.core.vals.call(null,cljs_time.format.formatters)));
};
var show_formatters = function (var_args){
var p__50709 = null;if (arguments.length > 0) {
  p__50709 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__50709);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__50721){
var p__50709 = cljs.core.seq(arglist__50721);
return show_formatters__delegate(p__50709);
});
