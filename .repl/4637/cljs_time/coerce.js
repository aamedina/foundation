...
goog.require('goog.date.DateTime');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj26792 = {};return obj26792;
})();
...
* which parses
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__8521__auto__ = (function iter__26801(s__26802){return (new cljs.core.LazySeq(null,(function (){var s__26802__$1 = s__26802;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__26802__$1);if(temp__4092__auto__)
{var s__26802__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__26802__$2))
{var c__8519__auto__ = cljs.core.chunk_first.call(null,s__26802__$2);var size__8520__auto__ = cljs.core.count.call(null,c__8519__auto__);var b__26804 = cljs.core.chunk_buffer.call(null,size__8520__auto__);if((function (){var i__26803 = 0;while(true){
if((i__26803 < size__8520__auto__))
{var f = cljs.core._nth.call(null,c__8519__auto__,i__26803);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e26807){if((e26807 instanceof Error))
{var e = e26807;return null;
} else
...
{cljs.core.chunk_append.call(null,b__26804,d);
{
...
{var f = cljs.core.first.call(null,s__26802__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e26808){if((e26808 instanceof Error))
{var e = e26808;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e26808;
} else
...
{return cljs.core.cons.call(null,d,iter__26801.call(null,cljs.core.rest.call(null,s__26802__$2)));
} else
{{
var G__26811 = cljs.core.rest.call(null,s__26802__$2);
s__26802__$1 = G__26811;
continue;
}
}
}
