...
var unparse__delegate = function (fmt,dt,p__26812){var map__26814 = p__26812;var map__26814__$1 = ((cljs.core.seq_QMARK_.call(null,map__26814))?cljs.core.apply.call(null,cljs.core.hash_map,map__26814):map__26814);var tz = cljs.core.get.call(null,map__26814__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__26812 = null;if (arguments.length > 2) {
  p__26812 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__26812);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__26815){
var fmt = cljs.core.first(arglist__26815);
arglist__26815 = cljs.core.next(arglist__26815);
var dt = cljs.core.first(arglist__26815);
var p__26812 = cljs.core.rest(arglist__26815);
return unparse__delegate(fmt,dt,p__26812);
});
...
var show_formatters__delegate = function (p__26816){var map__26822 = p__26816;var map__26822__$1 = ((cljs.core.seq_QMARK_.call(null,map__26822))?cljs.core.apply.call(null,cljs.core.hash_map,map__26822):map__26822);var date_like = cljs.core.get.call(null,map__26822__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__8521__auto__ = (function iter__26823(s__26824){return (new cljs.core.LazySeq(null,(function (){var s__26824__$1 = s__26824;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__26824__$1);if(temp__4092__auto__)
{var s__26824__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__26824__$2))
{var c__8519__auto__ = cljs.core.chunk_first.call(null,s__26824__$2);var size__8520__auto__ = cljs.core.count.call(null,c__8519__auto__);var b__26826 = cljs.core.chunk_buffer.call(null,size__8520__auto__);if((function (){var i__26825 = 0;while(true){
if((i__26825 < size__8520__auto__))
{var i = cljs.core._nth.call(null,c__8519__auto__,i__26825);cljs.core.chunk_append.call(null,b__26826,cljs_time.format.unparse.call(null,i,date_like));
{
var G__26827 = (i__26825 + 1);
i__26825 = G__26827;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__26826),iter__26823.call(null,cljs.core.chunk_rest.call(null,s__26824__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__26826),null);
}
} else
{var i = cljs.core.first.call(null,s__26824__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__26823.call(null,cljs.core.rest.call(null,s__26824__$2)));
}
} else
{return null;
}
...
});return iter__8521__auto__.call(null,cljs.core.sort.call(null,cljs.core.vals.call(null,cljs_time.format.formatters)));
};
var show_formatters = function (var_args){
var p__26816 = null;if (arguments.length > 0) {
  p__26816 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__26816);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__26828){
var p__26816 = cljs.core.seq(arglist__26828);
return show_formatters__delegate(p__26816);
});
