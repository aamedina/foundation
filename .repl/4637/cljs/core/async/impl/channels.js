...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t23703 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t23703 = (function (val,box,meta23704){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t23703.cljs$lang$type = true;
cljs.core.async.impl.channels.t23703.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t23703";
cljs.core.async.impl.channels.t23703.cljs$lang$ctorPrWriter = (function (this__8372__auto__,writer__8373__auto__,opt__8374__auto__){return cljs.core._write.call(null,writer__8373__auto__,"cljs.core.async.impl.channels/t23703");
});
cljs.core.async.impl.channels.t23703.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t23703.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_23705){var self__ = this;
var _23705__$1 = this;return self__.meta23704;
});
cljs.core.async.impl.channels.t23703.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_23705,meta23704__$1){var self__ = this;
var _23705__$1 = this;return (new cljs.core.async.impl.channels.t23703(self__.val,self__.box,meta23704__$1));
});
cljs.core.async.impl.channels.__GT_t23703 = (function __GT_t23703(val__$1,box__$1,meta23704){return (new cljs.core.async.impl.channels.t23703(val__$1,box__$1,meta23704));
});
}
return (new cljs.core.async.impl.channels.t23703(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8375__auto__,writer__8376__auto__,opts__8377__auto__){return cljs.core._write.call(null,writer__8376__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8372__auto__,writer__8373__auto__,opt__8374__auto__){return cljs.core._write.call(null,writer__8373__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_23706 = self__.takes.pop();if((taker_23706 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_23706))
{var take_cb_23707 = cljs.core.async.impl.protocols.commit.call(null,taker_23706);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_23707,taker_23706){
return (function (){return take_cb_23707.call(null,null);
});})(take_cb_23707,taker_23706))
);
} else
{}
{
