...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_23697 = 0;while(true){
var m_23698 = cljs.core.async.impl.dispatch.tasks.pop();if((m_23698 == null))
{} else
{m_23698.call(null);
if((count_23697 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__23699 = (count_23697 + 1);
count_23697 = G__23699;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7816__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7816__auto__)
