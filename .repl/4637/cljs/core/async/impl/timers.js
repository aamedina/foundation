...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_23662 = 0;while(true){
if((i_23662 < arr.length))
{(arr[i_23662] = null);
{
...
{var i_23669 = (self__.level + 1);while(true){
if((i_23669 <= (new_level + 1)))
{(update[i_23669] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_23671 = 0;while(true){
if((i_23671 <= self__.level))
{var links_23672 = (update[i_23671]).forward;if(((links_23672[i_23671]) === x__$1))
{(links_23672[i_23671] = (x__$1.forward[i_23671]));
{
var G__23673 = (i_23671 + 1);
i_23671 = G__23673;
continue;
}
} else
{{
var G__23674 = (i_23671 + 1);
i_23671 = G__23674;
continue;
}
}
