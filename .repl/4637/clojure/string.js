...
{{
var G__25405 = cljs.core.pop.call(null,v__$1);
v__$1 = G__25405;
continue;
}
} else
...
{var pred__25409 = cljs.core._EQ_;var expr__25410 = limit;if(cljs.core.truth_(pred__25409.call(null,1,expr__25410)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__25409.call(null,2,expr__25410)))
...
var G__25412 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__25413 = (limit__$1 - 1);
var G__25414 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__25412;
limit__$1 = G__25413;
parts = G__25414;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___25416 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___25416))
{var replacement_25417 = temp__4090__auto___25416;buffer.append([cljs.core.str(replacement_25417)].join(''));
} else
{buffer.append(ch);
}
{
var G__25418 = (index + 1);
index = G__25418;
continue;
}
}
