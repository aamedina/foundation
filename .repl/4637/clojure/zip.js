...
{var vec__23766 = loc;var node = cljs.core.nth.call(null,vec__23766,0,null);var path = cljs.core.nth.call(null,vec__23766,1,null);var vec__23767 = clojure.zip.children.call(null,loc);var c = cljs.core.nth.call(null,vec__23767,0,null);var cnext = cljs.core.nthnext.call(null,vec__23767,1);var cs = vec__23767;if(cljs.core.truth_(cs))
...
* the top
*/
clojure.zip.up = (function up(loc){var vec__23770 = loc;var node = cljs.core.nth.call(null,vec__23770,0,null);var map__23771 = cljs.core.nth.call(null,vec__23770,1,null);var map__23771__$1 = ((cljs.core.seq_QMARK_.call(null,map__23771))?cljs.core.apply.call(null,cljs.core.hash_map,map__23771):map__23771);var path = map__23771__$1;var l = cljs.core.get.call(null,map__23771__$1,new cljs.core.Keyword(null,"l","l",1013904350));var ppath = cljs.core.get.call(null,map__23771__$1,new cljs.core.Keyword(null,"ppath","ppath",1120772103));var pnodes = cljs.core.get.call(null,map__23771__$1,new cljs.core.Keyword(null,"pnodes","pnodes",4325362611));var r = cljs.core.get.call(null,map__23771__$1,new cljs.core.Keyword(null,"r","r",1013904356));var changed_QMARK_ = cljs.core.get.call(null,map__23771__$1,new cljs.core.Keyword(null,"changed?","changed?",2446321533));if(cljs.core.truth_(pnodes))
...
*/
clojure.zip.right = (function right(loc){var vec__23776 = loc;var node = cljs.core.nth.call(null,vec__23776,0,null);var map__23777 = cljs.core.nth.call(null,vec__23776,1,null);var map__23777__$1 = ((cljs.core.seq_QMARK_.call(null,map__23777))?cljs.core.apply.call(null,cljs.core.hash_map,map__23777):map__23777);var path = map__23777__$1;var l = cljs.core.get.call(null,map__23777__$1,new cljs.core.Keyword(null,"l","l",1013904350));var vec__23778 = cljs.core.get.call(null,map__23777__$1,new cljs.core.Keyword(null,"r","r",1013904356));var r = cljs.core.nth.call(null,vec__23778,0,null);var rnext = cljs.core.nthnext.call(null,vec__23778,1);var rs = vec__23778;if(cljs.core.truth_((function (){var and__7816__auto__ = path;if(cljs.core.truth_(and__7816__auto__))
{return rs;
} else
{return and__7816__auto__;
}
...
*/
clojure.zip.rightmost = (function rightmost(loc){var vec__23781 = loc;var node = cljs.core.nth.call(null,vec__23781,0,null);var map__23782 = cljs.core.nth.call(null,vec__23781,1,null);var map__23782__$1 = ((cljs.core.seq_QMARK_.call(null,map__23782))?cljs.core.apply.call(null,cljs.core.hash_map,map__23782):map__23782);var path = map__23782__$1;var l = cljs.core.get.call(null,map__23782__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__23782__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__7816__auto__ = path;if(cljs.core.truth_(and__7816__auto__))
{return r;
} else
{return and__7816__auto__;
}
...
*/
clojure.zip.left = (function left(loc){var vec__23785 = loc;var node = cljs.core.nth.call(null,vec__23785,0,null);var map__23786 = cljs.core.nth.call(null,vec__23785,1,null);var map__23786__$1 = ((cljs.core.seq_QMARK_.call(null,map__23786))?cljs.core.apply.call(null,cljs.core.hash_map,map__23786):map__23786);var path = map__23786__$1;var l = cljs.core.get.call(null,map__23786__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__23786__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__7816__auto__ = path;if(cljs.core.truth_(and__7816__auto__))
...
*/
clojure.zip.leftmost = (function leftmost(loc){var vec__23789 = loc;var node = cljs.core.nth.call(null,vec__23789,0,null);var map__23790 = cljs.core.nth.call(null,vec__23789,1,null);var map__23790__$1 = ((cljs.core.seq_QMARK_.call(null,map__23790))?cljs.core.apply.call(null,cljs.core.hash_map,map__23790):map__23790);var path = map__23790__$1;var l = cljs.core.get.call(null,map__23790__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__23790__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__7816__auto__ = path;if(cljs.core.truth_(and__7816__auto__))
{return cljs.core.seq.call(null,l);
} else
{return and__7816__auto__;
}
...
* without moving
*/
clojure.zip.insert_left = (function insert_left(loc,item){var vec__23793 = loc;var node = cljs.core.nth.call(null,vec__23793,0,null);var map__23794 = cljs.core.nth.call(null,vec__23793,1,null);var map__23794__$1 = ((cljs.core.seq_QMARK_.call(null,map__23794))?cljs.core.apply.call(null,cljs.core.hash_map,map__23794):map__23794);var path = map__23794__$1;var l = cljs.core.get.call(null,map__23794__$1,new cljs.core.Keyword(null,"l","l",1013904350));if((path == null))
{throw "Insert at top";
} else
...
* without moving
*/
clojure.zip.insert_right = (function insert_right(loc,item){var vec__23797 = loc;var node = cljs.core.nth.call(null,vec__23797,0,null);var map__23798 = cljs.core.nth.call(null,vec__23797,1,null);var map__23798__$1 = ((cljs.core.seq_QMARK_.call(null,map__23798))?cljs.core.apply.call(null,cljs.core.hash_map,map__23798):map__23798);var path = map__23798__$1;var r = cljs.core.get.call(null,map__23798__$1,new cljs.core.Keyword(null,"r","r",1013904356));if((path == null))
{throw "Insert at top";
} else
...
edit.cljs$lang$applyTo = (function (arglist__23801){
var loc = cljs.core.first(arglist__23801);
...
{{
var G__23802 = clojure.zip.up.call(null,p);
p = G__23802;
continue;
}
}
...
var G__23803 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__23803;
continue;
}
} else
...
*/
clojure.zip.remove = (function remove(loc){var vec__23806 = loc;var node = cljs.core.nth.call(null,vec__23806,0,null);var map__23807 = cljs.core.nth.call(null,vec__23806,1,null);var map__23807__$1 = ((cljs.core.seq_QMARK_.call(null,map__23807))?cljs.core.apply.call(null,cljs.core.hash_map,map__23807):map__23807);var path = map__23807__$1;var l = cljs.core.get.call(null,map__23807__$1,new cljs.core.Keyword(null,"l","l",1013904350));var ppath = cljs.core.get.call(null,map__23807__$1,new cljs.core.Keyword(null,"ppath","ppath",1120772103));var pnodes = cljs.core.get.call(null,map__23807__$1,new cljs.core.Keyword(null,"pnodes","pnodes",4325362611));var rs = cljs.core.get.call(null,map__23807__$1,new cljs.core.Keyword(null,"r","r",1013904356));if((path == null))
{throw "Remove at top";
} else
...
var G__23808 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__23808;
continue;
}
} else
