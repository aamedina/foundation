...
goog.require('clojure.set');
foundation.app.query.tuplify = (function tuplify(m){var hashcode = cljs.core.hash.call(null,m);return cljs.core.mapv.call(null,(function (p1__50640_SHARP_){return (new cljs.core.PersistentVector(null,3,5,cljs.core.PersistentVector.EMPTY_NODE,[hashcode,p1__50640_SHARP_,cljs.core.get.call(null,m,p1__50640_SHARP_)],null));
}),cljs.core.keys.call(null,m));
});
foundation.app.query.TupleSource = (function (){var obj50642 = {};return obj50642;
})();
...
{var iter__6997__auto__ = (function iter__50653(s__50654){return (new cljs.core.LazySeq(null,(function (){var s__50654__$1 = s__50654;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__50654__$1);if(temp__4098__auto__)
{var xs__4588__auto__ = temp__4098__auto__;var x = cljs.core.first.call(null,xs__4588__auto__);var iterys__6993__auto__ = ((function (s__50654__$1,x,xs__4588__auto__,temp__4098__auto__){
return (function iter__50655(s__50656){return (new cljs.core.LazySeq(null,((function (s__50654__$1,x,xs__4588__auto__,temp__4098__auto__){
return (function (){var s__50656__$1 = s__50656;while(true){
var temp__4098__auto____$1 = cljs.core.seq.call(null,s__50656__$1);if(temp__4098__auto____$1)
{var s__50656__$2 = temp__4098__auto____$1;if(cljs.core.chunked_seq_QMARK_.call(null,s__50656__$2))
{var c__6995__auto__ = cljs.core.chunk_first.call(null,s__50656__$2);var size__6996__auto__ = cljs.core.count.call(null,c__6995__auto__);var b__50658 = cljs.core.chunk_buffer.call(null,size__6996__auto__);if((function (){var i__50657 = 0;while(true){
if((i__50657 < size__6996__auto__))
{var y = cljs.core._nth.call(null,c__6995__auto__,i__50657);if(cljs.core._EQ_.call(null,cljs.core.select_keys.call(null,x,ks),cljs.core.select_keys.call(null,y,ks)))
{cljs.core.chunk_append.call(null,b__50658,cljs.core.merge.call(null,x,y));
{
var G__50659 = (i__50657 + 1);
i__50657 = G__50659;
continue;
}
} else
{{
var G__50660 = (i__50657 + 1);
i__50657 = G__50660;
continue;
}
}
...
{var y = cljs.core.first.call(null,s__50656__$2);if(cljs.core._EQ_.call(null,cljs.core.select_keys.call(null,x,ks),cljs.core.select_keys.call(null,y,ks)))
{return cljs.core.cons.call(null,cljs.core.merge.call(null,x,y),iter__50655.call(null,cljs.core.rest.call(null,s__50656__$2)));
} else
{{
var G__50661 = cljs.core.rest.call(null,s__50656__$2);
s__50656__$1 = G__50661;
continue;
}
}
}
...
});})(s__50654__$1,x,xs__4588__auto__,temp__4098__auto__))
,null,null));
});})(s__50654__$1,x,xs__4588__auto__,temp__4098__auto__))
;var fs__6994__auto__ = cljs.core.seq.call(null,iterys__6993__auto__.call(null,tail));if(fs__6994__auto__)
{return cljs.core.concat.call(null,fs__6994__auto__,iter__50653.call(null,cljs.core.rest.call(null,s__50654__$1)));
} else
{{
var G__50662 = cljs.core.rest.call(null,s__50654__$1);
s__50654__$1 = G__50662;
continue;
}
}
} else
...
var G__50663 = cljs.core.reduce.call(null,((function (unifiers){
...
{if((function (){var G__50665 = data;if(G__50665)
...
{return G__50665.foundation$app$query$TupleSource$;
}
})()))
{return true;
} else
{if((!G__50665.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,foundation.app.query.TupleSource,G__50665);
} else
{return false;
}
}
...
var q__delegate = function (query,sources){var map__50668 = foundation.app.query.parse_query.call(null,query);var map__50668__$1 = ((cljs.core.seq_QMARK_.call(null,map__50668))?cljs.core.apply.call(null,cljs.core.hash_map,map__50668):map__50668);var in$ = cljs.core.get.call(null,map__50668__$1,new cljs.core.Keyword(null,"in","in",1013907607));var find = cljs.core.get.call(null,map__50668__$1,new cljs.core.Keyword(null,"find","find",1017047339));var clauses = cljs.core.get.call(null,map__50668__$1,new cljs.core.Keyword(null,"clauses","clauses",1867584598));if(cljs.core._EQ_.call(null,cljs.core.count.call(null,sources),cljs.core.count.call(null,in$)))
{} else
...
q.cljs$lang$applyTo = (function (arglist__50669){
var query = cljs.core.first(arglist__50669);
var sources = cljs.core.rest(arglist__50669);
