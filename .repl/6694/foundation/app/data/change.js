...
foundation.app.data.change.descendent_QMARK_ = (function descendent_QMARK_(path_a,path_b){var vec__53226 = (((cljs.core.count.call(null,path_a) < cljs.core.count.call(null,path_b)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [path_a,path_b], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [path_b,path_a], null));var small = cljs.core.nth.call(null,vec__53226,0,null);var large = cljs.core.nth.call(null,vec__53226,1,null);return cljs.core._EQ_.call(null,small,cljs.core.take.call(null,cljs.core.count.call(null,small),large));
});
foundation.app.data.change.remove_redundant_updates = (function remove_redundant_updates(updates){return cljs.core.reduce.call(null,(function (a,update){if(cljs.core.truth_(cljs.core.some.call(null,(function (p1__53227_SHARP_){return foundation.app.data.change.descendent_QMARK_.call(null,p1__53227_SHARP_,update);
}),a)))
{return a;
} else
...
foundation.app.data.change.remove_redundant_adds = (function remove_redundant_adds(adds){return cljs.core.reduce.call(null,(function (a,add){if(cljs.core.truth_(cljs.core.some.call(null,(function (p1__53228_SHARP_){return foundation.app.data.change.descendent_QMARK_.call(null,p1__53228_SHARP_,add);
}),a)))
{return a;
} else
...
foundation.app.data.change.compact = (function compact(old_m,new_m,p__53229){var map__53233 = p__53229;var map__53233__$1 = ((cljs.core.seq_QMARK_.call(null,map__53233))?cljs.core.apply.call(null,cljs.core.hash_map,map__53233):map__53233);var change = map__53233__$1;var inspect = cljs.core.get.call(null,map__53233__$1,new cljs.core.Keyword(null,"inspect","inspect",2971358598));var removed = cljs.core.get.call(null,map__53233__$1,new cljs.core.Keyword(null,"removed","removed",2105740242));var updated = cljs.core.get.call(null,map__53233__$1,new cljs.core.Keyword(null,"updated","updated",779473965));var added = cljs.core.get.call(null,map__53233__$1,new cljs.core.Keyword(null,"added","added",1106564210));var change__$1 = cljs.core.reduce.call(null,(function (a,change_path){return foundation.app.data.change.find_changes.call(null,a,old_m,new_m,change_path);
}),change,inspect);var change__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"updated","updated",779473965).cljs$core$IFn$_invoke$arity$1(change__$1))?cljs.core.update_in.call(null,change__$1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"updated","updated",779473965)], null),foundation.app.data.change.remove_redundant_updates):change__$1);var change__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"added","added",1106564210).cljs$core$IFn$_invoke$arity$1(change__$2))?cljs.core.update_in.call(null,change__$2,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"added","added",1106564210)], null),foundation.app.data.change.remove_redundant_adds):change__$2);var change__$4 = (cljs.core.truth_(new cljs.core.Keyword(null,"updated","updated",779473965).cljs$core$IFn$_invoke$arity$1(change__$3))?cljs.core.update_in.call(null,change__$3,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"updated","updated",779473965)], null),foundation.app.data.change.remove_updates_covered_by_adds,new cljs.core.Keyword(null,"added","added",1106564210).cljs$core$IFn$_invoke$arity$1(change__$3)):change__$3);var change__$5 = (cljs.core.truth_(new cljs.core.Keyword(null,"updated","updated",779473965).cljs$core$IFn$_invoke$arity$1(change__$4))?cljs.core.update_in.call(null,change__$4,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"updated","updated",779473965)], null),foundation.app.data.change.remove_updates_covered_by_removes,new cljs.core.Keyword(null,"removed","removed",2105740242).cljs$core$IFn$_invoke$arity$1(change__$4)):change__$4);return cljs.core.reduce.call(null,(function (a,p__53234){var vec__53235 = p__53234;var k = cljs.core.nth.call(null,vec__53235,0,null);var v = cljs.core.nth.call(null,vec__53235,1,null);if(cljs.core.empty_QMARK_.call(null,v))
{return a;
} else
