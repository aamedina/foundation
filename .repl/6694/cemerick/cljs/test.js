...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__50671 = m;var map__50671__$1 = ((cljs.core.seq_QMARK_.call(null,map__50671))?cljs.core.apply.call(null,cljs.core.hash_map,map__50671):map__50671);var line = cljs.core.get.call(null,map__50671__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__50671__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__50673 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__50673))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__50673))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_50674;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_50675 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6304__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6304__auto__))
{return or__6304__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_50675;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_50676 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6304__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6304__auto__))
{return or__6304__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___50677 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___50677))
{var message_50678 = temp__4098__auto___50677;cljs.core.println.call(null,message_50678);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_50676;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_50679 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6304__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6304__auto__))
{return or__6304__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___50680 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___50680))
{var message_50681 = temp__4098__auto___50680;cljs.core.println.call(null,message_50681);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_50679;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"summary","summary",3451231000),(function (m){var _STAR_print_fn_STAR_50682 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6304__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6304__auto__))
{return or__6304__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_50682;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_50683 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6304__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6304__auto__))
{return or__6304__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_50683;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__50684){
var ns_sym = cljs.core.first(arglist__50684);
arglist__50684 = cljs.core.next(arglist__50684);
var fixture_type = cljs.core.first(arglist__50684);
var fixture_fns = cljs.core.rest(arglist__50684);
...
{var t = temp__4098__auto__;var _STAR_testing_vars_STAR_50687 = cemerick.cljs.test._STAR_testing_vars_STAR_;try{cemerick.cljs.test._STAR_testing_vars_STAR_ = cljs.core.conj.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_,(function (){var or__6304__auto__ = new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));if(cljs.core.truth_(or__6304__auto__))
{return or__6304__auto__;
} else
{return v;
}
...
{var e_50689 = e50688;cemerick.cljs.test.do_report.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"message","message",1968829305),"Uncaught exception, not in assertion.",new cljs.core.Keyword(null,"expected","expected",3373152810),null,new cljs.core.Keyword(null,"actual","actual",3885931776),e_50689], null));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e50688;
} else
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_50687;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__50694 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__50695 = null;var count__50696 = 0;var i__50697 = 0;while(true){
if((i__50697 < count__50696))
{var v = cljs.core._nth.call(null,chunk__50695,i__50697);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__50694,chunk__50695,count__50696,i__50697,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__50694,chunk__50695,count__50696,i__50697,v))
);
} else
{}
{
var G__50698 = seq__50694;
var G__50699 = chunk__50695;
var G__50700 = count__50696;
var G__50701 = (i__50697 + 1);
seq__50694 = G__50698;
chunk__50695 = G__50699;
count__50696 = G__50700;
i__50697 = G__50701;
continue;
}
} else
{var temp__4098__auto__ = cljs.core.seq.call(null,seq__50694);if(temp__4098__auto__)
{var seq__50694__$1 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__50694__$1))
{var c__7028__auto__ = cljs.core.chunk_first.call(null,seq__50694__$1);{
var G__50702 = cljs.core.chunk_rest.call(null,seq__50694__$1);
var G__50703 = c__7028__auto__;
var G__50704 = cljs.core.count.call(null,c__7028__auto__);
var G__50705 = 0;
seq__50694 = G__50702;
chunk__50695 = G__50703;
count__50696 = G__50704;
i__50697 = G__50705;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__50694__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__50694,chunk__50695,count__50696,i__50697,v,seq__50694__$1,temp__4098__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__50694,chunk__50695,count__50696,i__50697,v,seq__50694__$1,temp__4098__auto__))
);
} else
{}
{
var G__50706 = cljs.core.next.call(null,seq__50694__$1);
var G__50707 = null;
var G__50708 = 0;
var G__50709 = 0;
seq__50694 = G__50706;
chunk__50695 = G__50707;
count__50696 = G__50708;
i__50697 = G__50709;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_50711 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4096__auto___50712 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4096__auto___50712))
{var test_hook_50713 = temp__4096__auto___50712;test_hook_50713.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_50711;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__50714){
var namespaces = cljs.core.seq(arglist__50714);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__50715_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__50715_SHARP_));
