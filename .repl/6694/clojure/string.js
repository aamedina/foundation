...
{{
var G__50716 = cljs.core.pop.call(null,v__$1);
v__$1 = G__50716;
continue;
}
} else
...
{var pred__50720 = cljs.core._EQ_;var expr__50721 = limit;if(cljs.core.truth_(pred__50720.call(null,1,expr__50721)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__50720.call(null,2,expr__50721)))
...
var G__50723 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__50724 = (limit__$1 - 1);
var G__50725 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__50723;
limit__$1 = G__50724;
parts = G__50725;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___50727 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___50727))
{var replacement_50728 = temp__4096__auto___50727;buffer.append([cljs.core.str(replacement_50728)].join(''));
} else
{buffer.append(ch);
}
{
var G__50729 = (index + 1);
index = G__50729;
continue;
}
}
