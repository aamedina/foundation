...
goog.require('goog.date.DateTime');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj95765 = {};return obj95765;
})();
...
* which parses
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__6982__auto__ = (function iter__95774(s__95775){return (new cljs.core.LazySeq(null,(function (){var s__95775__$1 = s__95775;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__95775__$1);if(temp__4098__auto__)
{var s__95775__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__95775__$2))
{var c__6980__auto__ = cljs.core.chunk_first.call(null,s__95775__$2);var size__6981__auto__ = cljs.core.count.call(null,c__6980__auto__);var b__95777 = cljs.core.chunk_buffer.call(null,size__6981__auto__);if((function (){var i__95776 = 0;while(true){
if((i__95776 < size__6981__auto__))
{var f = cljs.core._nth.call(null,c__6980__auto__,i__95776);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e95780){if((e95780 instanceof Error))
{var e = e95780;return null;
} else
...
{cljs.core.chunk_append.call(null,b__95777,d);
{
var G__95782 = (i__95776 + 1);
i__95776 = G__95782;
continue;
}
} else
{{
var G__95783 = (i__95776 + 1);
i__95776 = G__95783;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__95777),iter__95774.call(null,cljs.core.chunk_rest.call(null,s__95775__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__95777),null);
}
} else
{var f = cljs.core.first.call(null,s__95775__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e95781){if((e95781 instanceof Error))
{var e = e95781;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e95781;
} else
...
{return cljs.core.cons.call(null,d,iter__95774.call(null,cljs.core.rest.call(null,s__95775__$2)));
} else
{{
var G__95784 = cljs.core.rest.call(null,s__95775__$2);
s__95775__$1 = G__95784;
continue;
}
}
}
