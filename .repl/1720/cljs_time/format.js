...
var unparse__delegate = function (fmt,dt,p__95785){var map__95787 = p__95785;var map__95787__$1 = ((cljs.core.seq_QMARK_.call(null,map__95787))?cljs.core.apply.call(null,cljs.core.hash_map,map__95787):map__95787);var tz = cljs.core.get.call(null,map__95787__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__95785 = null;if (arguments.length > 2) {
  p__95785 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__95785);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__95788){
var fmt = cljs.core.first(arglist__95788);
arglist__95788 = cljs.core.next(arglist__95788);
var dt = cljs.core.first(arglist__95788);
var p__95785 = cljs.core.rest(arglist__95788);
return unparse__delegate(fmt,dt,p__95785);
});
...
var show_formatters__delegate = function (p__95789){var map__95795 = p__95789;var map__95795__$1 = ((cljs.core.seq_QMARK_.call(null,map__95795))?cljs.core.apply.call(null,cljs.core.hash_map,map__95795):map__95795);var date_like = cljs.core.get.call(null,map__95795__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__6982__auto__ = (function iter__95796(s__95797){return (new cljs.core.LazySeq(null,(function (){var s__95797__$1 = s__95797;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__95797__$1);if(temp__4098__auto__)
{var s__95797__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__95797__$2))
{var c__6980__auto__ = cljs.core.chunk_first.call(null,s__95797__$2);var size__6981__auto__ = cljs.core.count.call(null,c__6980__auto__);var b__95799 = cljs.core.chunk_buffer.call(null,size__6981__auto__);if((function (){var i__95798 = 0;while(true){
if((i__95798 < size__6981__auto__))
{var i = cljs.core._nth.call(null,c__6980__auto__,i__95798);cljs.core.chunk_append.call(null,b__95799,cljs_time.format.unparse.call(null,i,date_like));
{
var G__95800 = (i__95798 + 1);
i__95798 = G__95800;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__95799),iter__95796.call(null,cljs.core.chunk_rest.call(null,s__95797__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__95799),null);
}
} else
{var i = cljs.core.first.call(null,s__95797__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__95796.call(null,cljs.core.rest.call(null,s__95797__$2)));
}
} else
{return null;
}
...
var p__95789 = null;if (arguments.length > 0) {
  p__95789 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__95789);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__95801){
var p__95789 = cljs.core.seq(arglist__95801);
return show_formatters__delegate(p__95789);
});
