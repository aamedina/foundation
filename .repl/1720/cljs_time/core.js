...
goog.require('goog.date.DateTime');
goog.require('goog.i18n.TimeZone');
cljs_time.core.DateTimeProtocol = (function (){var obj95673 = {};return obj95673;
})();
...
*/
cljs_time.core.today_at_midnight = (function today_at_midnight(){var G__95675 = (new goog.date.UtcDateTime());G__95675.setHours(0);
G__95675.setMinutes(0);
G__95675.setSeconds(0);
G__95675.setMilliseconds(0);
return G__95675;
});
/**
* Returns a DateTime for the begining of the Unix epoch in the UTC time zone.
*/
cljs_time.core.epoch = (function epoch(){var G__95677 = (new goog.date.UtcDateTime());G__95677.setTime(0);
return G__95677;
});
/**
...
var G__95678__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.plus_,cljs_time.core.plus_.call(null,dt,p),ps);
};
var G__95678 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__95678__delegate.call(this,dt,p,ps);};
G__95678.cljs$lang$maxFixedArity = 2;
G__95678.cljs$lang$applyTo = (function (arglist__95679){
var dt = cljs.core.first(arglist__95679);
arglist__95679 = cljs.core.next(arglist__95679);
var p = cljs.core.first(arglist__95679);
var ps = cljs.core.rest(arglist__95679);
return G__95678__delegate(dt,p,ps);
});
G__95678.cljs$core$IFn$_invoke$arity$variadic = G__95678__delegate;
return G__95678;
})()
;
...
var G__95680__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.minus_,cljs_time.core.minus_.call(null,dt,p),ps);
};
var G__95680 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__95680__delegate.call(this,dt,p,ps);};
G__95680.cljs$lang$maxFixedArity = 2;
G__95680.cljs$lang$applyTo = (function (arglist__95681){
var dt = cljs.core.first(arglist__95681);
arglist__95681 = cljs.core.next(arglist__95681);
var p = cljs.core.first(arglist__95681);
var ps = cljs.core.rest(arglist__95681);
return G__95680__delegate(dt,p,ps);
});
...
extend.cljs$lang$applyTo = (function (arglist__95682){
var in$ = cljs.core.first(arglist__95682);
var by = cljs.core.rest(arglist__95682);
...
cljs_time.core.to_period = (function to_period(in$){var pred__95686 = cljs.core._EQ_;var expr__95687 = cljs.core.type.call(null,in$);if(cljs.core.truth_(pred__95686.call(null,goog.date.Interval,expr__95687)))
{return in$;
} else
{if(cljs.core.truth_(pred__95686.call(null,goog.date.DateRange,expr__95687)))
{return (new goog.date.Interval(0,0,0,0,0,((cljs_time.core.in_millis.call(null,in$) / 1000) | 0)));
} else
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__95687)].join('')));
}
}
});
/**
...
;
cljs_time.core.last_day_of_the_month = (function last_day_of_the_month(dt){var G__95690 = dt;G__95690.setDate(cljs_time.core.number_of_days_in_the_month.call(null,dt));
return G__95690;
});
cljs_time.core.first_day_of_the_month = (function first_day_of_the_month(dt){var G__95692 = dt;G__95692.setDate(1);
return G__95692;
});
...
var today_at__4 = (function (hours,minutes,seconds,millis){return cljs_time.core.date_time.call(null,(function (){var G__95694 = cljs_time.core.now.call(null);G__95694.setHourOfDay(hours);
G__95694.setMinuteOfHour(minutes);
G__95694.setSecondOfMinute(seconds);
G__95694.setMillisOfSecond(millis);
return G__95694;
})());
});
...
;
cljs_time.core.do_at_STAR_ = (function do_at_STAR_(base_date_time,body_fn){var ms = (base_date_time.getTime() - cljs_time.core.now.call(null).getTime());var c__13409__auto__ = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__13410__auto__ = (function (){var switch__13309__auto__ = (function (state_95731){var state_val_95732 = (state_95731[1]);if((state_val_95732 === 5))
{var _ = cljs.core.async.impl.ioc_helpers.add_exception_frame.call(null,state_95731,4,Error,null,3);var inst_95727 = body_fn.call(null);var state_95731__$1 = state_95731;var statearr_95733_95745 = state_95731__$1;(statearr_95733_95745[2] = inst_95727);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_95731__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_95732 === 4))
{var inst_95723 = (state_95731[2]);var state_95731__$1 = (function (){var statearr_95734 = state_95731;(statearr_95734[7] = inst_95723);
return statearr_95734;
})();var statearr_95735_95746 = state_95731__$1;(statearr_95735_95746[2] = null);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_95731__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_95732 === 3))
{var inst_95729 = (state_95731[2]);var state_95731__$1 = state_95731;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_95731__$1,inst_95729);
} else
{if((state_val_95732 === 2))
{var inst_95722 = (state_95731[2]);var state_95731__$1 = (function (){var statearr_95736 = state_95731;(statearr_95736[8] = inst_95722);
return statearr_95736;
})();var statearr_95737_95747 = state_95731__$1;(statearr_95737_95747[2] = null);
(statearr_95737_95747[1] = 5);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_95732 === 1))
{var inst_95720 = cljs.core.async.timeout.call(null,ms);var state_95731__$1 = state_95731;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_95731__$1,2,inst_95720);
} else
{return null;
}
}
...
var state_machine__13310__auto____0 = (function (){var statearr_95741 = (new Array(9));(statearr_95741[0] = state_machine__13310__auto__);
(statearr_95741[1] = 1);
return statearr_95741;
});
var state_machine__13310__auto____1 = (function (state_95731){while(true){
var ret_value__13311__auto__ = (function (){try{while(true){
var result__13312__auto__ = switch__13309__auto__.call(null,state_95731);if(cljs.core.keyword_identical_QMARK_.call(null,result__13312__auto__,new cljs.core.Keyword(null,"recur","recur",1122293407)))
{{
continue;
}
} else
...
}catch (e95742){if((e95742 instanceof Object))
{var ex__13313__auto__ = e95742;var statearr_95743_95748 = state_95731;(statearr_95743_95748[5] = ex__13313__auto__);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_95731);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
...
{{
var G__95749 = state_95731;
state_95731 = G__95749;
continue;
}
} else
...
state_machine__13310__auto__ = function(state_95731){
switch(arguments.length){
case 0:
return state_machine__13310__auto____0.call(this);
case 1:
return state_machine__13310__auto____1.call(this,state_95731);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
})();var state__13411__auto__ = (function (){var statearr_95744 = f__13410__auto__.call(null);(statearr_95744[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__13409__auto__);
return statearr_95744;
})();return cljs.core.async.impl.ioc_helpers.run_state_machine_wrapped.call(null,state__13411__auto__);
}));
return c__13409__auto__;
});
cljs_time.core.Mappable = (function (){var obj95751 = {};return obj95751;
})();
...
{{
var G__95752 = [cljs.core.str("0"),cljs.core.str(ns)].join('');
ns = G__95752;
continue;
}
} else
...
var G__95753__delegate = function (arg,more){return cljs.core.apply.call(null,f,arg,cljs.core.concat.call(null,args,more));
};
var G__95753 = function (arg,var_args){
var more = null;if (arguments.length > 1) {
  more = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__95753__delegate.call(this,arg,more);};
G__95753.cljs$lang$maxFixedArity = 1;
G__95753.cljs$lang$applyTo = (function (arglist__95754){
var arg = cljs.core.first(arglist__95754);
var more = cljs.core.rest(arglist__95754);
return G__95753__delegate(arg,more);
});
G__95753.cljs$core$IFn$_invoke$arity$variadic = G__95753__delegate;
return G__95753;
})()
;
};
...
fpartial.cljs$lang$applyTo = (function (arglist__95755){
var f = cljs.core.first(arglist__95755);
var args = cljs.core.rest(arglist__95755);
