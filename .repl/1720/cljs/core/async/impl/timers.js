...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_94655 = 0;while(true){
if((i_94655 < arr.length))
{(arr[i_94655] = null);
{
var G__94656 = (i_94655 + 1);
i_94655 = G__94656;
continue;
}
} else
...
{var i_94662 = (self__.level + 1);while(true){
if((i_94662 <= (new_level + 1)))
{(update[i_94662] = self__.header);
{
var G__94663 = (i_94662 + 1);
i_94662 = G__94663;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_94664 = 0;while(true){
if((i_94664 <= self__.level))
{var links_94665 = (update[i_94664]).forward;if(((links_94665[i_94664]) === x__$1))
{(links_94665[i_94664] = (x__$1.forward[i_94664]));
{
var G__94666 = (i_94664 + 1);
i_94664 = G__94666;
continue;
}
} else
{{
var G__94667 = (i_94664 + 1);
i_94664 = G__94667;
continue;
}
}
