...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_94690 = 0;while(true){
var m_94691 = cljs.core.async.impl.dispatch.tasks.pop();if((m_94691 == null))
{} else
{m_94691.call(null);
if((count_94690 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__94692 = (count_94690 + 1);
count_94690 = G__94692;
continue;
}
} else
{}
