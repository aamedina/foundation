...
{{
var G__95093 = cljs.core.pop.call(null,v__$1);
v__$1 = G__95093;
continue;
}
} else
...
{var pred__95097 = cljs.core._EQ_;var expr__95098 = limit;if(cljs.core.truth_(pred__95097.call(null,1,expr__95098)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__95097.call(null,2,expr__95098)))
...
var G__95100 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__95101 = (limit__$1 - 1);
var G__95102 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__95100;
limit__$1 = G__95101;
parts = G__95102;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___95104 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___95104))
{var replacement_95105 = temp__4096__auto___95104;buffer.append([cljs.core.str(replacement_95105)].join(''));
} else
{buffer.append(ch);
}
{
var G__95106 = (index + 1);
index = G__95106;
continue;
}
}
