...
{{
var G__18535 = cljs.core.pop.call(null,v__$1);
v__$1 = G__18535;
continue;
}
} else
...
{var pred__18539 = cljs.core._EQ_;var expr__18540 = limit;if(cljs.core.truth_(pred__18539.call(null,1,expr__18540)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__18539.call(null,2,expr__18540)))
...
var G__18542 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__18543 = (limit__$1 - 1);
var G__18544 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__18542;
limit__$1 = G__18543;
parts = G__18544;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___18546 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___18546))
{var replacement_18547 = temp__4096__auto___18546;buffer.append([cljs.core.str(replacement_18547)].join(''));
} else
{buffer.append(ch);
}
{
var G__18548 = (index + 1);
index = G__18548;
continue;
}
}
