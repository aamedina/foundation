...
goog.require('goog.date.DateTime');
goog.require('goog.i18n.TimeZone');
cljs_time.core.DateTimeProtocol = (function (){var obj19856 = {};return obj19856;
})();
...
*/
cljs_time.core.today_at_midnight = (function today_at_midnight(){var G__19858 = (new goog.date.UtcDateTime());G__19858.setHours(0);
G__19858.setMinutes(0);
G__19858.setSeconds(0);
G__19858.setMilliseconds(0);
return G__19858;
});
/**
* Returns a DateTime for the begining of the Unix epoch in the UTC time zone.
*/
cljs_time.core.epoch = (function epoch(){var G__19860 = (new goog.date.UtcDateTime());G__19860.setTime(0);
return G__19860;
});
/**
...
var G__19861__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.plus_,cljs_time.core.plus_.call(null,dt,p),ps);
};
var G__19861 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__19861__delegate.call(this,dt,p,ps);};
G__19861.cljs$lang$maxFixedArity = 2;
G__19861.cljs$lang$applyTo = (function (arglist__19862){
var dt = cljs.core.first(arglist__19862);
arglist__19862 = cljs.core.next(arglist__19862);
var p = cljs.core.first(arglist__19862);
var ps = cljs.core.rest(arglist__19862);
return G__19861__delegate(dt,p,ps);
});
...
var G__19863__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.minus_,cljs_time.core.minus_.call(null,dt,p),ps);
};
var G__19863 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__19863__delegate.call(this,dt,p,ps);};
G__19863.cljs$lang$maxFixedArity = 2;
G__19863.cljs$lang$applyTo = (function (arglist__19864){
var dt = cljs.core.first(arglist__19864);
arglist__19864 = cljs.core.next(arglist__19864);
var p = cljs.core.first(arglist__19864);
var ps = cljs.core.rest(arglist__19864);
return G__19863__delegate(dt,p,ps);
});
...
extend.cljs$lang$applyTo = (function (arglist__19865){
var in$ = cljs.core.first(arglist__19865);
var by = cljs.core.rest(arglist__19865);
...
cljs_time.core.to_period = (function to_period(in$){var pred__19869 = cljs.core._EQ_;var expr__19870 = cljs.core.type.call(null,in$);if(cljs.core.truth_(pred__19869.call(null,goog.date.Interval,expr__19870)))
{return in$;
} else
{if(cljs.core.truth_(pred__19869.call(null,goog.date.DateRange,expr__19870)))
{return (new goog.date.Interval(0,0,0,0,0,((cljs_time.core.in_millis.call(null,in$) / 1000) | 0)));
} else
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__19870)].join('')));
}
}
});
/**
...
;
cljs_time.core.last_day_of_the_month = (function last_day_of_the_month(dt){var G__19873 = dt;G__19873.setDate(cljs_time.core.number_of_days_in_the_month.call(null,dt));
return G__19873;
});
cljs_time.core.first_day_of_the_month = (function first_day_of_the_month(dt){var G__19875 = dt;G__19875.setDate(1);
return G__19875;
});
...
var today_at__4 = (function (hours,minutes,seconds,millis){return cljs_time.core.date_time.call(null,(function (){var G__19877 = cljs_time.core.now.call(null);G__19877.setHourOfDay(hours);
G__19877.setMinuteOfHour(minutes);
G__19877.setSecondOfMinute(seconds);
G__19877.setMillisOfSecond(millis);
return G__19877;
})());
});
...
;
cljs_time.core.do_at_STAR_ = (function do_at_STAR_(base_date_time,body_fn){var ms = (base_date_time.getTime() - cljs_time.core.now.call(null).getTime());var c__13409__auto__ = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__13410__auto__ = (function (){var switch__13309__auto__ = (function (state_19914){var state_val_19915 = (state_19914[1]);if((state_val_19915 === 5))
{var _ = cljs.core.async.impl.ioc_helpers.add_exception_frame.call(null,state_19914,4,Error,null,3);var inst_19910 = body_fn.call(null);var state_19914__$1 = state_19914;var statearr_19916_19928 = state_19914__$1;(statearr_19916_19928[2] = inst_19910);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_19914__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_19915 === 4))
{var inst_19906 = (state_19914[2]);var state_19914__$1 = (function (){var statearr_19917 = state_19914;(statearr_19917[7] = inst_19906);
return statearr_19917;
})();var statearr_19918_19929 = state_19914__$1;(statearr_19918_19929[2] = null);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_19914__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_19915 === 3))
{var inst_19912 = (state_19914[2]);var state_19914__$1 = state_19914;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_19914__$1,inst_19912);
} else
{if((state_val_19915 === 2))
{var inst_19905 = (state_19914[2]);var state_19914__$1 = (function (){var statearr_19919 = state_19914;(statearr_19919[8] = inst_19905);
return statearr_19919;
})();var statearr_19920_19930 = state_19914__$1;(statearr_19920_19930[2] = null);
(statearr_19920_19930[1] = 5);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_19915 === 1))
{var inst_19903 = cljs.core.async.timeout.call(null,ms);var state_19914__$1 = state_19914;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_19914__$1,2,inst_19903);
} else
{return null;
}
}
...
var state_machine__13310__auto____0 = (function (){var statearr_19924 = (new Array(9));(statearr_19924[0] = state_machine__13310__auto__);
(statearr_19924[1] = 1);
return statearr_19924;
});
var state_machine__13310__auto____1 = (function (state_19914){while(true){
var ret_value__13311__auto__ = (function (){try{while(true){
var result__13312__auto__ = switch__13309__auto__.call(null,state_19914);if(cljs.core.keyword_identical_QMARK_.call(null,result__13312__auto__,new cljs.core.Keyword(null,"recur","recur",1122293407)))
{{
continue;
}
} else
...
{var ex__13313__auto__ = e19925;var statearr_19926_19931 = state_19914;(statearr_19926_19931[5] = ex__13313__auto__);
...
{{
var G__19932 = state_19914;
state_19914 = G__19932;
continue;
}
} else
...
state_machine__13310__auto__ = function(state_19914){
switch(arguments.length){
case 0:
return state_machine__13310__auto____0.call(this);
case 1:
return state_machine__13310__auto____1.call(this,state_19914);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
})();var state__13411__auto__ = (function (){var statearr_19927 = f__13410__auto__.call(null);(statearr_19927[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__13409__auto__);
...
cljs_time.core.Mappable = (function (){var obj19934 = {};return obj19934;
})();
...
{{
var G__19935 = [cljs.core.str("0"),cljs.core.str(ns)].join('');
ns = G__19935;
continue;
}
} else
...
var G__19936__delegate = function (arg,more){return cljs.core.apply.call(null,f,arg,cljs.core.concat.call(null,args,more));
};
var G__19936 = function (arg,var_args){
var more = null;if (arguments.length > 1) {
  more = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__19936__delegate.call(this,arg,more);};
G__19936.cljs$lang$maxFixedArity = 1;
G__19936.cljs$lang$applyTo = (function (arglist__19937){
var arg = cljs.core.first(arglist__19937);
var more = cljs.core.rest(arglist__19937);
return G__19936__delegate(arg,more);
});
...
fpartial.cljs$lang$applyTo = (function (arglist__19938){
var f = cljs.core.first(arglist__19938);
