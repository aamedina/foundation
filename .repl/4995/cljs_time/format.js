...
var unparse__delegate = function (fmt,dt,p__22603){var map__22605 = p__22603;var map__22605__$1 = ((cljs.core.seq_QMARK_.call(null,map__22605))?cljs.core.apply.call(null,cljs.core.hash_map,map__22605):map__22605);var tz = cljs.core.get.call(null,map__22605__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__22603 = null;if (arguments.length > 2) {
  p__22603 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__22603);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__22606){
var fmt = cljs.core.first(arglist__22606);
arglist__22606 = cljs.core.next(arglist__22606);
var dt = cljs.core.first(arglist__22606);
var p__22603 = cljs.core.rest(arglist__22606);
return unparse__delegate(fmt,dt,p__22603);
});
...
var show_formatters__delegate = function (p__22607){var map__22613 = p__22607;var map__22613__$1 = ((cljs.core.seq_QMARK_.call(null,map__22613))?cljs.core.apply.call(null,cljs.core.hash_map,map__22613):map__22613);var date_like = cljs.core.get.call(null,map__22613__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__6982__auto__ = (function iter__22614(s__22615){return (new cljs.core.LazySeq(null,(function (){var s__22615__$1 = s__22615;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__22615__$1);if(temp__4098__auto__)
{var s__22615__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__22615__$2))
{var c__6980__auto__ = cljs.core.chunk_first.call(null,s__22615__$2);var size__6981__auto__ = cljs.core.count.call(null,c__6980__auto__);var b__22617 = cljs.core.chunk_buffer.call(null,size__6981__auto__);if((function (){var i__22616 = 0;while(true){
if((i__22616 < size__6981__auto__))
{var i = cljs.core._nth.call(null,c__6980__auto__,i__22616);cljs.core.chunk_append.call(null,b__22617,cljs_time.format.unparse.call(null,i,date_like));
{
var G__22618 = (i__22616 + 1);
i__22616 = G__22618;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__22617),iter__22614.call(null,cljs.core.chunk_rest.call(null,s__22615__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__22617),null);
}
} else
{var i = cljs.core.first.call(null,s__22615__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__22614.call(null,cljs.core.rest.call(null,s__22615__$2)));
}
} else
{return null;
}
...
var p__22607 = null;if (arguments.length > 0) {
  p__22607 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__22607);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__22619){
var p__22607 = cljs.core.seq(arglist__22619);
return show_formatters__delegate(p__22607);
});
