...
goog.require('goog.date.DateTime');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj22583 = {};return obj22583;
})();
...
* which parses
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__6982__auto__ = (function iter__22592(s__22593){return (new cljs.core.LazySeq(null,(function (){var s__22593__$1 = s__22593;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__22593__$1);if(temp__4098__auto__)
{var s__22593__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__22593__$2))
{var c__6980__auto__ = cljs.core.chunk_first.call(null,s__22593__$2);var size__6981__auto__ = cljs.core.count.call(null,c__6980__auto__);var b__22595 = cljs.core.chunk_buffer.call(null,size__6981__auto__);if((function (){var i__22594 = 0;while(true){
if((i__22594 < size__6981__auto__))
{var f = cljs.core._nth.call(null,c__6980__auto__,i__22594);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e22598){if((e22598 instanceof Error))
{var e = e22598;return null;
} else
...
{cljs.core.chunk_append.call(null,b__22595,d);
{
var G__22600 = (i__22594 + 1);
i__22594 = G__22600;
continue;
}
} else
{{
var G__22601 = (i__22594 + 1);
i__22594 = G__22601;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__22595),iter__22592.call(null,cljs.core.chunk_rest.call(null,s__22593__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__22595),null);
}
} else
{var f = cljs.core.first.call(null,s__22593__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e22599){if((e22599 instanceof Error))
{var e = e22599;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e22599;
} else
...
{return cljs.core.cons.call(null,d,iter__22592.call(null,cljs.core.rest.call(null,s__22593__$2)));
} else
{{
var G__22602 = cljs.core.rest.call(null,s__22593__$2);
s__22593__$1 = G__22602;
continue;
}
}
}
