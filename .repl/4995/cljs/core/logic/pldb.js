...
cljs.core.logic.pldb.facts_for = (function facts_for(dbs,kname){return cljs.core.mapcat.call(null,(function (p1__19716_SHARP_){return cljs.core.get_in.call(null,p1__19716_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [kname,new cljs.core.Keyword("cljs.core.logic.pldb","unindexed","cljs.core.logic.pldb/unindexed",3813484278)], null));
}),dbs);
});
cljs.core.logic.pldb.facts_using_index = (function facts_using_index(dbs,kname,index,val){return cljs.core.mapcat.call(null,(function (p1__19717_SHARP_){return cljs.core.get_in.call(null,p1__19717_SHARP_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [kname,index,val], null));
}),dbs);
});
...
cljs.core.logic.pldb.index_for_query = (function index_for_query(s,q,indexes){var indexable = cljs.core.map.call(null,(function (p1__19718_SHARP_){return cljs.core.logic.pldb.ground_QMARK_.call(null,s,p1__19718_SHARP_);
}),q);var triples = cljs.core.map.call(null,cljs.core.vector,cljs.core.range.call(null),indexable,indexes);return cljs.core.first.call(null,(function (){var iter__6982__auto__ = (function iter__19727(s__19728){return (new cljs.core.LazySeq(null,(function (){var s__19728__$1 = s__19728;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__19728__$1);if(temp__4098__auto__)
{var s__19728__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__19728__$2))
{var c__6980__auto__ = cljs.core.chunk_first.call(null,s__19728__$2);var size__6981__auto__ = cljs.core.count.call(null,c__6980__auto__);var b__19730 = cljs.core.chunk_buffer.call(null,size__6981__auto__);if((function (){var i__19729 = 0;while(true){
if((i__19729 < size__6981__auto__))
{var vec__19733 = cljs.core._nth.call(null,c__6980__auto__,i__19729);var i = cljs.core.nth.call(null,vec__19733,0,null);var indexable__$1 = cljs.core.nth.call(null,vec__19733,1,null);var indexed = cljs.core.nth.call(null,vec__19733,2,null);if(cljs.core.truth_((function (){var and__6277__auto__ = indexable__$1;if(cljs.core.truth_(and__6277__auto__))
{return indexed;
} else
{return and__6277__auto__;
}
})()))
{cljs.core.chunk_append.call(null,b__19730,i);
{
...
{var vec__19734 = cljs.core.first.call(null,s__19728__$2);var i = cljs.core.nth.call(null,vec__19734,0,null);var indexable__$1 = cljs.core.nth.call(null,vec__19734,1,null);var indexed = cljs.core.nth.call(null,vec__19734,2,null);if(cljs.core.truth_((function (){var and__6277__auto__ = indexable__$1;if(cljs.core.truth_(and__6277__auto__))
{return indexed;
} else
{return and__6277__auto__;
}
})()))
{return cljs.core.cons.call(null,i,iter__19727.call(null,cljs.core.rest.call(null,s__19728__$2)));
} else
{{
var G__19737 = cljs.core.rest.call(null,s__19728__$2);
s__19728__$1 = G__19737;
continue;
}
}
}
...
return (function (p1__19738_SHARP_){return add_to_set.call(null,p1__19738_SHARP_,args);
});})(key,add_to_set))
...
return (function (db__$1,p__19742){var vec__19743 = p__19742;var is_indexed = cljs.core.nth.call(null,vec__19743,0,null);var index_num = cljs.core.nth.call(null,vec__19743,1,null);var val = cljs.core.nth.call(null,vec__19743,2,null);if(cljs.core.truth_(is_indexed))
{return cljs.core.update_in.call(null,db__$1,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [key,index_num,val], null),((function (vec__19743,is_indexed,index_num,val,key,add_to_set,db_with_fact,indexes_to_update){
return (function (p1__19739_SHARP_){return add_to_set.call(null,p1__19739_SHARP_,args);
});})(vec__19743,is_indexed,index_num,val,key,add_to_set,db_with_fact,indexes_to_update))
);
} else
{return db__$1;
}
...
db_fact.cljs$lang$applyTo = (function (arglist__19744){
var db = cljs.core.first(arglist__19744);
arglist__19744 = cljs.core.next(arglist__19744);
var rel = cljs.core.first(arglist__19744);
...
return (function (p1__19745_SHARP_){return cljs.core.disj.call(null,p1__19745_SHARP_,args);
});})(key))
...
return (function (db__$1,p__19748){var vec__19749 = p__19748;var is_indexed = cljs.core.nth.call(null,vec__19749,0,null);var index_num = cljs.core.nth.call(null,vec__19749,1,null);var val = cljs.core.nth.call(null,vec__19749,2,null);if(cljs.core.truth_(is_indexed))
...
db_retraction.cljs$lang$applyTo = (function (arglist__19750){
var db = cljs.core.first(arglist__19750);
arglist__19750 = cljs.core.next(arglist__19750);
var rel = cljs.core.first(arglist__19750);
...
var db_facts__delegate = function (base_db,facts){return cljs.core.reduce.call(null,(function (p1__19751_SHARP_,p2__19752_SHARP_){return cljs.core.apply.call(null,cljs.core.logic.pldb.db_fact,p1__19751_SHARP_,p2__19752_SHARP_);
}),base_db,facts);
};
...
db_facts.cljs$lang$applyTo = (function (arglist__19753){
var base_db = cljs.core.first(arglist__19753);
var facts = cljs.core.rest(arglist__19753);
...
db.cljs$lang$applyTo = (function (arglist__19754){
var facts = cljs.core.seq(arglist__19754);
...
var db_retractions__delegate = function (base_db,retractions){return cljs.core.reduce.call(null,(function (p1__19755_SHARP_,p2__19756_SHARP_){return cljs.core.apply.call(null,cljs.core.logic.pldb.db_retraction,p1__19755_SHARP_,p2__19756_SHARP_);
}),base_db,retractions);
};
...
db_retractions.cljs$lang$applyTo = (function (arglist__19757){
var base_db = cljs.core.first(arglist__19757);
var retractions = cljs.core.rest(arglist__19757);
