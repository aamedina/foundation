...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_22472 = 0;while(true){
if((i_22472 < arr.length))
{(arr[i_22472] = null);
{
var G__22473 = (i_22472 + 1);
i_22472 = G__22473;
continue;
}
} else
...
{var i_22479 = (self__.level + 1);while(true){
if((i_22479 <= (new_level + 1)))
{(update[i_22479] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_22481 = 0;while(true){
if((i_22481 <= self__.level))
{var links_22482 = (update[i_22481]).forward;if(((links_22482[i_22481]) === x__$1))
{(links_22482[i_22481] = (x__$1.forward[i_22481]));
{
var G__22483 = (i_22481 + 1);
i_22481 = G__22483;
continue;
}
} else
{{
var G__22484 = (i_22481 + 1);
i_22481 = G__22484;
continue;
}
}
