...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t22513 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t22513 = (function (val,box,meta22514){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t22513.cljs$lang$type = true;
cljs.core.async.impl.channels.t22513.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t22513";
cljs.core.async.impl.channels.t22513.cljs$lang$ctorPrWriter = (function (this__6833__auto__,writer__6834__auto__,opt__6835__auto__){return cljs.core._write.call(null,writer__6834__auto__,"cljs.core.async.impl.channels/t22513");
});
cljs.core.async.impl.channels.t22513.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t22513.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22515){var self__ = this;
var _22515__$1 = this;return self__.meta22514;
});
cljs.core.async.impl.channels.t22513.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22515,meta22514__$1){var self__ = this;
var _22515__$1 = this;return (new cljs.core.async.impl.channels.t22513(self__.val,self__.box,meta22514__$1));
});
cljs.core.async.impl.channels.__GT_t22513 = (function __GT_t22513(val__$1,box__$1,meta22514){return (new cljs.core.async.impl.channels.t22513(val__$1,box__$1,meta22514));
});
}
return (new cljs.core.async.impl.channels.t22513(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_22516 = self__.takes.pop();if((taker_22516 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_22516))
{var take_cb_22517 = cljs.core.async.impl.protocols.commit.call(null,taker_22516);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_22517,taker_22516){
return (function (){return take_cb_22517.call(null,null);
});})(take_cb_22517,taker_22516))
);
} else
{}
{
