...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_22507 = 0;while(true){
var m_22508 = cljs.core.async.impl.dispatch.tasks.pop();if((m_22508 == null))
{} else
{m_22508.call(null);
if((count_22507 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__22509 = (count_22507 + 1);
count_22507 = G__22509;
continue;
}
} else
{}
