...
var unparse__delegate = function (fmt,dt,p__62421){var map__62423 = p__62421;var map__62423__$1 = ((cljs.core.seq_QMARK_.call(null,map__62423))?cljs.core.apply.call(null,cljs.core.hash_map,map__62423):map__62423);var tz = cljs.core.get.call(null,map__62423__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__62421 = null;if (arguments.length > 2) {
  p__62421 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__62421);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__62424){
var fmt = cljs.core.first(arglist__62424);
arglist__62424 = cljs.core.next(arglist__62424);
var dt = cljs.core.first(arglist__62424);
var p__62421 = cljs.core.rest(arglist__62424);
return unparse__delegate(fmt,dt,p__62421);
});
...
var show_formatters__delegate = function (p__62425){var map__62431 = p__62425;var map__62431__$1 = ((cljs.core.seq_QMARK_.call(null,map__62431))?cljs.core.apply.call(null,cljs.core.hash_map,map__62431):map__62431);var date_like = cljs.core.get.call(null,map__62431__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__8707__auto__ = (function iter__62432(s__62433){return (new cljs.core.LazySeq(null,(function (){var s__62433__$1 = s__62433;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__62433__$1);if(temp__4092__auto__)
{var s__62433__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__62433__$2))
{var c__8705__auto__ = cljs.core.chunk_first.call(null,s__62433__$2);var size__8706__auto__ = cljs.core.count.call(null,c__8705__auto__);var b__62435 = cljs.core.chunk_buffer.call(null,size__8706__auto__);if((function (){var i__62434 = 0;while(true){
if((i__62434 < size__8706__auto__))
{var i = cljs.core._nth.call(null,c__8705__auto__,i__62434);cljs.core.chunk_append.call(null,b__62435,cljs_time.format.unparse.call(null,i,date_like));
{
var G__62436 = (i__62434 + 1);
i__62434 = G__62436;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__62435),iter__62432.call(null,cljs.core.chunk_rest.call(null,s__62433__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__62435),null);
}
} else
{var i = cljs.core.first.call(null,s__62433__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__62432.call(null,cljs.core.rest.call(null,s__62433__$2)));
}
} else
{return null;
}
...
});return iter__8707__auto__.call(null,cljs.core.sort.call(null,cljs.core.vals.call(null,cljs_time.format.formatters)));
};
var show_formatters = function (var_args){
var p__62425 = null;if (arguments.length > 0) {
  p__62425 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__62425);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__62437){
var p__62425 = cljs.core.seq(arglist__62437);
return show_formatters__delegate(p__62425);
});
