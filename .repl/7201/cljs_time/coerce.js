...
goog.require('goog.date.DateTime');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj62401 = {};return obj62401;
})();
cljs_time.coerce.to_date_time = (function to_date_time(obj){if((function (){var and__8002__auto__ = obj;if(and__8002__auto__)
...
{var x__8617__auto__ = (((obj == null))?null:obj);return (function (){var or__8014__auto__ = (cljs_time.coerce.to_date_time[goog.typeOf(x__8617__auto__)]);if(or__8014__auto__)
{return or__8014__auto__;
} else
{var or__8014__auto____$1 = (cljs_time.coerce.to_date_time["_"]);if(or__8014__auto____$1)
...
* which parses
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__8707__auto__ = (function iter__62410(s__62411){return (new cljs.core.LazySeq(null,(function (){var s__62411__$1 = s__62411;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__62411__$1);if(temp__4092__auto__)
{var s__62411__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__62411__$2))
{var c__8705__auto__ = cljs.core.chunk_first.call(null,s__62411__$2);var size__8706__auto__ = cljs.core.count.call(null,c__8705__auto__);var b__62413 = cljs.core.chunk_buffer.call(null,size__8706__auto__);if((function (){var i__62412 = 0;while(true){
if((i__62412 < size__8706__auto__))
{var f = cljs.core._nth.call(null,c__8705__auto__,i__62412);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e62416){if((e62416 instanceof Error))
{var e = e62416;return null;
} else
...
{cljs.core.chunk_append.call(null,b__62413,d);
{
var G__62418 = (i__62412 + 1);
i__62412 = G__62418;
continue;
}
} else
{{
var G__62419 = (i__62412 + 1);
i__62412 = G__62419;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__62413),iter__62410.call(null,cljs.core.chunk_rest.call(null,s__62411__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__62413),null);
}
} else
{var f = cljs.core.first.call(null,s__62411__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e62417){if((e62417 instanceof Error))
{var e = e62417;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e62417;
} else
...
{return cljs.core.cons.call(null,d,iter__62410.call(null,cljs.core.rest.call(null,s__62411__$2)));
} else
{{
var G__62420 = cljs.core.rest.call(null,s__62411__$2);
s__62411__$1 = G__62420;
continue;
}
}
}
...
});return iter__8707__auto__.call(null,cljs.core.vals.call(null,cljs_time.format.formatters));
})());
});
/**
* Returns a DateTime instance in the UTC time zone corresponding to the given
...
*/
cljs_time.coerce.to_epoch = (function to_epoch(obj){var millis = cljs_time.coerce.to_long.call(null,obj);var and__8002__auto__ = millis;if(cljs.core.truth_(and__8002__auto__))
{return (millis / 1000);
} else
{return and__8002__auto__;
}
