...
{{
var G__62438 = cljs.core.pop.call(null,v__$1);
v__$1 = G__62438;
continue;
}
} else
...
{var pred__62442 = cljs.core._EQ_;var expr__62443 = limit;if(cljs.core.truth_(pred__62442.call(null,1,expr__62443)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__62442.call(null,2,expr__62443)))
...
var G__62445 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__62446 = (limit__$1 - 1);
var G__62447 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__62445;
limit__$1 = G__62446;
parts = G__62447;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___62449 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___62449))
{var replacement_62450 = temp__4090__auto___62449;buffer.append([cljs.core.str(replacement_62450)].join(''));
} else
{buffer.append(ch);
}
{
var G__62451 = (index + 1);
index = G__62451;
continue;
}
}
