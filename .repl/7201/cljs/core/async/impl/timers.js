...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__8558__auto__,writer__8559__auto__,opt__8560__auto__){return cljs.core._write.call(null,writer__8559__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_60690 = 0;while(true){
if((i_60690 < arr.length))
{(arr[i_60690] = null);
{
var G__60691 = (i_60690 + 1);
i_60690 = G__60691;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__8558__auto__,writer__8559__auto__,opt__8560__auto__){return cljs.core._write.call(null,writer__8559__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_60697 = (self__.level + 1);while(true){
if((i_60697 <= (new_level + 1)))
{(update[i_60697] = self__.header);
{
var G__60698 = (i_60697 + 1);
i_60697 = G__60698;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_60699 = 0;while(true){
if((i_60699 <= self__.level))
{var links_60700 = (update[i_60699]).forward;if(((links_60700[i_60699]) === x__$1))
{(links_60700[i_60699] = (x__$1.forward[i_60699]));
{
var G__60701 = (i_60699 + 1);
i_60699 = G__60701;
continue;
}
} else
{{
var G__60702 = (i_60699 + 1);
i_60699 = G__60702;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__8014__auto__ = (cljs.core.truth_((function (){var and__8002__auto__ = me;if(cljs.core.truth_(and__8002__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__8002__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__8014__auto__))
