...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t60731 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t60731 = (function (val,box,meta60732){
this.val = val;
this.box = box;
this.meta60732 = meta60732;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t60731.cljs$lang$type = true;
cljs.core.async.impl.channels.t60731.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t60731";
cljs.core.async.impl.channels.t60731.cljs$lang$ctorPrWriter = (function (this__8558__auto__,writer__8559__auto__,opt__8560__auto__){return cljs.core._write.call(null,writer__8559__auto__,"cljs.core.async.impl.channels/t60731");
});
cljs.core.async.impl.channels.t60731.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t60731.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60733){var self__ = this;
var _60733__$1 = this;return self__.meta60732;
});
cljs.core.async.impl.channels.t60731.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60733,meta60732__$1){var self__ = this;
var _60733__$1 = this;return (new cljs.core.async.impl.channels.t60731(self__.val,self__.box,meta60732__$1));
});
cljs.core.async.impl.channels.__GT_t60731 = (function __GT_t60731(val__$1,box__$1,meta60732){return (new cljs.core.async.impl.channels.t60731(val__$1,box__$1,meta60732));
});
}
return (new cljs.core.async.impl.channels.t60731(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8561__auto__,writer__8562__auto__,opts__8563__auto__){return cljs.core._write.call(null,writer__8562__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8558__auto__,writer__8559__auto__,opt__8560__auto__){return cljs.core._write.call(null,writer__8559__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_60734 = self__.takes.pop();if((taker_60734 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_60734))
{var take_cb_60735 = cljs.core.async.impl.protocols.commit.call(null,taker_60734);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_60735,taker_60734){
return (function (){return take_cb_60735.call(null,null);
});})(take_cb_60735,taker_60734))
);
} else
{}
{
