...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_60725 = 0;while(true){
var m_60726 = cljs.core.async.impl.dispatch.tasks.pop();if((m_60726 == null))
{} else
{m_60726.call(null);
if((count_60725 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__60727 = (count_60725 + 1);
count_60725 = G__60727;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__8002__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__8002__auto__)
