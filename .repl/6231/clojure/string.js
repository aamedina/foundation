...
{{
var G__76170 = cljs.core.pop.call(null,v__$1);
v__$1 = G__76170;
continue;
}
} else
...
{var pred__76174 = cljs.core._EQ_;var expr__76175 = limit;if(cljs.core.truth_(pred__76174.call(null,1,expr__76175)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__76174.call(null,2,expr__76175)))
...
var G__76177 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__76178 = (limit__$1 - 1);
var G__76179 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__76177;
limit__$1 = G__76178;
parts = G__76179;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___76181 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___76181))
{var replacement_76182 = temp__4090__auto___76181;buffer.append([cljs.core.str(replacement_76182)].join(''));
} else
{buffer.append(ch);
}
{
var G__76183 = (index + 1);
index = G__76183;
continue;
}
}
