...
var unparse__delegate = function (fmt,dt,p__133163){var map__133165 = p__133163;var map__133165__$1 = ((cljs.core.seq_QMARK_.call(null,map__133165))?cljs.core.apply.call(null,cljs.core.hash_map,map__133165):map__133165);var tz = cljs.core.get.call(null,map__133165__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__133163 = null;if (arguments.length > 2) {
  p__133163 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__133163);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__133166){
var fmt = cljs.core.first(arglist__133166);
arglist__133166 = cljs.core.next(arglist__133166);
var dt = cljs.core.first(arglist__133166);
var p__133163 = cljs.core.rest(arglist__133166);
return unparse__delegate(fmt,dt,p__133163);
});
...
var show_formatters__delegate = function (p__133167){var map__133173 = p__133167;var map__133173__$1 = ((cljs.core.seq_QMARK_.call(null,map__133173))?cljs.core.apply.call(null,cljs.core.hash_map,map__133173):map__133173);var date_like = cljs.core.get.call(null,map__133173__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__6982__auto__ = (function iter__133174(s__133175){return (new cljs.core.LazySeq(null,(function (){var s__133175__$1 = s__133175;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__133175__$1);if(temp__4098__auto__)
{var s__133175__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__133175__$2))
{var c__6980__auto__ = cljs.core.chunk_first.call(null,s__133175__$2);var size__6981__auto__ = cljs.core.count.call(null,c__6980__auto__);var b__133177 = cljs.core.chunk_buffer.call(null,size__6981__auto__);if((function (){var i__133176 = 0;while(true){
if((i__133176 < size__6981__auto__))
{var i = cljs.core._nth.call(null,c__6980__auto__,i__133176);cljs.core.chunk_append.call(null,b__133177,cljs_time.format.unparse.call(null,i,date_like));
{
var G__133178 = (i__133176 + 1);
i__133176 = G__133178;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__133177),iter__133174.call(null,cljs.core.chunk_rest.call(null,s__133175__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__133177),null);
}
} else
{var i = cljs.core.first.call(null,s__133175__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__133174.call(null,cljs.core.rest.call(null,s__133175__$2)));
}
} else
{return null;
}
...
var p__133167 = null;if (arguments.length > 0) {
  p__133167 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__133167);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__133179){
var p__133167 = cljs.core.seq(arglist__133179);
return show_formatters__delegate(p__133167);
});
