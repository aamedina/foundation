...
goog.require('goog.date.DateTime');
goog.require('goog.i18n.TimeZone');
cljs_time.core.DateTimeProtocol = (function (){var obj133051 = {};return obj133051;
})();
...
*/
cljs_time.core.today_at_midnight = (function today_at_midnight(){var G__133053 = (new goog.date.UtcDateTime());G__133053.setHours(0);
G__133053.setMinutes(0);
G__133053.setSeconds(0);
G__133053.setMilliseconds(0);
return G__133053;
});
/**
* Returns a DateTime for the begining of the Unix epoch in the UTC time zone.
*/
cljs_time.core.epoch = (function epoch(){var G__133055 = (new goog.date.UtcDateTime());G__133055.setTime(0);
return G__133055;
});
/**
...
var G__133056__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.plus_,cljs_time.core.plus_.call(null,dt,p),ps);
};
var G__133056 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__133056__delegate.call(this,dt,p,ps);};
G__133056.cljs$lang$maxFixedArity = 2;
G__133056.cljs$lang$applyTo = (function (arglist__133057){
var dt = cljs.core.first(arglist__133057);
arglist__133057 = cljs.core.next(arglist__133057);
var p = cljs.core.first(arglist__133057);
var ps = cljs.core.rest(arglist__133057);
return G__133056__delegate(dt,p,ps);
});
G__133056.cljs$core$IFn$_invoke$arity$variadic = G__133056__delegate;
return G__133056;
})()
;
...
var G__133058__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.minus_,cljs_time.core.minus_.call(null,dt,p),ps);
};
var G__133058 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__133058__delegate.call(this,dt,p,ps);};
G__133058.cljs$lang$maxFixedArity = 2;
G__133058.cljs$lang$applyTo = (function (arglist__133059){
var dt = cljs.core.first(arglist__133059);
arglist__133059 = cljs.core.next(arglist__133059);
var p = cljs.core.first(arglist__133059);
var ps = cljs.core.rest(arglist__133059);
return G__133058__delegate(dt,p,ps);
});
G__133058.cljs$core$IFn$_invoke$arity$variadic = G__133058__delegate;
return G__133058;
})()
;
...
extend.cljs$lang$applyTo = (function (arglist__133060){
var in$ = cljs.core.first(arglist__133060);
var by = cljs.core.rest(arglist__133060);
...
cljs_time.core.to_period = (function to_period(in$){var pred__133064 = cljs.core._EQ_;var expr__133065 = cljs.core.type.call(null,in$);if(cljs.core.truth_(pred__133064.call(null,goog.date.Interval,expr__133065)))
{return in$;
} else
{if(cljs.core.truth_(pred__133064.call(null,goog.date.DateRange,expr__133065)))
{return (new goog.date.Interval(0,0,0,0,0,((cljs_time.core.in_millis.call(null,in$) / 1000) | 0)));
} else
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__133065)].join('')));
}
}
});
/**
...
;
cljs_time.core.last_day_of_the_month = (function last_day_of_the_month(dt){var G__133068 = dt;G__133068.setDate(cljs_time.core.number_of_days_in_the_month.call(null,dt));
return G__133068;
});
cljs_time.core.first_day_of_the_month = (function first_day_of_the_month(dt){var G__133070 = dt;G__133070.setDate(1);
return G__133070;
});
...
var today_at__4 = (function (hours,minutes,seconds,millis){return cljs_time.core.date_time.call(null,(function (){var G__133072 = cljs_time.core.now.call(null);G__133072.setHourOfDay(hours);
G__133072.setMinuteOfHour(minutes);
G__133072.setSecondOfMinute(seconds);
G__133072.setMillisOfSecond(millis);
return G__133072;
})());
});
...
;
cljs_time.core.do_at_STAR_ = (function do_at_STAR_(base_date_time,body_fn){var ms = (base_date_time.getTime() - cljs_time.core.now.call(null).getTime());var c__13409__auto__ = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__13410__auto__ = (function (){var switch__13309__auto__ = (function (state_133109){var state_val_133110 = (state_133109[1]);if((state_val_133110 === 5))
{var _ = cljs.core.async.impl.ioc_helpers.add_exception_frame.call(null,state_133109,4,Error,null,3);var inst_133105 = body_fn.call(null);var state_133109__$1 = state_133109;var statearr_133111_133123 = state_133109__$1;(statearr_133111_133123[2] = inst_133105);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_133109__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_133110 === 4))
{var inst_133101 = (state_133109[2]);var state_133109__$1 = (function (){var statearr_133112 = state_133109;(statearr_133112[7] = inst_133101);
return statearr_133112;
})();var statearr_133113_133124 = state_133109__$1;(statearr_133113_133124[2] = null);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_133109__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_133110 === 3))
{var inst_133107 = (state_133109[2]);var state_133109__$1 = state_133109;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_133109__$1,inst_133107);
} else
{if((state_val_133110 === 2))
{var inst_133100 = (state_133109[2]);var state_133109__$1 = (function (){var statearr_133114 = state_133109;(statearr_133114[8] = inst_133100);
return statearr_133114;
})();var statearr_133115_133125 = state_133109__$1;(statearr_133115_133125[2] = null);
(statearr_133115_133125[1] = 5);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_133110 === 1))
{var inst_133098 = cljs.core.async.timeout.call(null,ms);var state_133109__$1 = state_133109;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_133109__$1,2,inst_133098);
} else
{return null;
}
}
...
var state_machine__13310__auto____0 = (function (){var statearr_133119 = (new Array(9));(statearr_133119[0] = state_machine__13310__auto__);
(statearr_133119[1] = 1);
return statearr_133119;
});
var state_machine__13310__auto____1 = (function (state_133109){while(true){
var ret_value__13311__auto__ = (function (){try{while(true){
var result__13312__auto__ = switch__13309__auto__.call(null,state_133109);if(cljs.core.keyword_identical_QMARK_.call(null,result__13312__auto__,new cljs.core.Keyword(null,"recur","recur",1122293407)))
{{
continue;
}
} else
...
}catch (e133120){if((e133120 instanceof Object))
{var ex__13313__auto__ = e133120;var statearr_133121_133126 = state_133109;(statearr_133121_133126[5] = ex__13313__auto__);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_133109);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
...
{{
var G__133127 = state_133109;
state_133109 = G__133127;
continue;
}
} else
...
state_machine__13310__auto__ = function(state_133109){
switch(arguments.length){
case 0:
return state_machine__13310__auto____0.call(this);
case 1:
return state_machine__13310__auto____1.call(this,state_133109);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
})();var state__13411__auto__ = (function (){var statearr_133122 = f__13410__auto__.call(null);(statearr_133122[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__13409__auto__);
...
cljs_time.core.Mappable = (function (){var obj133129 = {};return obj133129;
})();
...
{{
var G__133130 = [cljs.core.str("0"),cljs.core.str(ns)].join('');
ns = G__133130;
continue;
}
} else
...
var G__133131__delegate = function (arg,more){return cljs.core.apply.call(null,f,arg,cljs.core.concat.call(null,args,more));
};
var G__133131 = function (arg,var_args){
var more = null;if (arguments.length > 1) {
  more = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__133131__delegate.call(this,arg,more);};
G__133131.cljs$lang$maxFixedArity = 1;
G__133131.cljs$lang$applyTo = (function (arglist__133132){
var arg = cljs.core.first(arglist__133132);
var more = cljs.core.rest(arglist__133132);
return G__133131__delegate(arg,more);
});
G__133131.cljs$core$IFn$_invoke$arity$variadic = G__133131__delegate;
return G__133131;
})()
;
};
...
fpartial.cljs$lang$applyTo = (function (arglist__133133){
var f = cljs.core.first(arglist__133133);
var args = cljs.core.rest(arglist__133133);
