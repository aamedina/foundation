...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t132074 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t132074 = (function (val,box,meta132075){
this.val = val;
this.box = box;
this.meta132075 = meta132075;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t132074.cljs$lang$type = true;
cljs.core.async.impl.channels.t132074.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t132074";
cljs.core.async.impl.channels.t132074.cljs$lang$ctorPrWriter = (function (this__6833__auto__,writer__6834__auto__,opt__6835__auto__){return cljs.core._write.call(null,writer__6834__auto__,"cljs.core.async.impl.channels/t132074");
});
cljs.core.async.impl.channels.t132074.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t132074.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_132076){var self__ = this;
var _132076__$1 = this;return self__.meta132075;
});
cljs.core.async.impl.channels.t132074.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_132076,meta132075__$1){var self__ = this;
var _132076__$1 = this;return (new cljs.core.async.impl.channels.t132074(self__.val,self__.box,meta132075__$1));
});
cljs.core.async.impl.channels.__GT_t132074 = (function __GT_t132074(val__$1,box__$1,meta132075){return (new cljs.core.async.impl.channels.t132074(val__$1,box__$1,meta132075));
});
}
return (new cljs.core.async.impl.channels.t132074(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_132077 = self__.takes.pop();if((taker_132077 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_132077))
{var take_cb_132078 = cljs.core.async.impl.protocols.commit.call(null,taker_132077);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_132078,taker_132077){
return (function (){return take_cb_132078.call(null,null);
});})(take_cb_132078,taker_132077))
);
} else
{}
{
