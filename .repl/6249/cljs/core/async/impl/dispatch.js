...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_132068 = 0;while(true){
var m_132069 = cljs.core.async.impl.dispatch.tasks.pop();if((m_132069 == null))
{} else
{m_132069.call(null);
if((count_132068 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__132070 = (count_132068 + 1);
count_132068 = G__132070;
continue;
}
} else
{}
