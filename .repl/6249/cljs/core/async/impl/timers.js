...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_132033 = 0;while(true){
if((i_132033 < arr.length))
{(arr[i_132033] = null);
{
var G__132034 = (i_132033 + 1);
i_132033 = G__132034;
continue;
}
} else
...
var G__132036 = x__$1;
var G__132037 = k;
var G__132038 = (level - 1);
var G__132039 = update;
x = G__132036;
k = G__132037;
level = G__132038;
update = G__132039;
...
{var i_132040 = (self__.level + 1);while(true){
if((i_132040 <= (new_level + 1)))
{(update[i_132040] = self__.header);
{
var G__132041 = (i_132040 + 1);
i_132040 = G__132041;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_132042 = 0;while(true){
if((i_132042 <= self__.level))
{var links_132043 = (update[i_132042]).forward;if(((links_132043[i_132042]) === x__$1))
{(links_132043[i_132042] = (x__$1.forward[i_132042]));
{
var G__132044 = (i_132042 + 1);
i_132042 = G__132044;
continue;
}
} else
{{
var G__132045 = (i_132042 + 1);
i_132042 = G__132045;
continue;
}
}
