...
{{
var G__132471 = cljs.core.pop.call(null,v__$1);
v__$1 = G__132471;
continue;
}
} else
...
{var pred__132475 = cljs.core._EQ_;var expr__132476 = limit;if(cljs.core.truth_(pred__132475.call(null,1,expr__132476)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__132475.call(null,2,expr__132476)))
...
var G__132478 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__132479 = (limit__$1 - 1);
var G__132480 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__132478;
limit__$1 = G__132479;
parts = G__132480;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___132482 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___132482))
{var replacement_132483 = temp__4096__auto___132482;buffer.append([cljs.core.str(replacement_132483)].join(''));
} else
{buffer.append(ch);
}
{
var G__132484 = (index + 1);
index = G__132484;
continue;
}
}
