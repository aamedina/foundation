...
{return cljs.core.reduce.call(null,(function (result,p__18261){var vec__18262 = p__18261;var k = cljs.core.nth.call(null,vec__18262,0,null);var v = cljs.core.nth.call(null,vec__18262,1,null);return cljs.core.assoc.call(null,result,k,v);
...
*/
clojure.data.diff_associative_key = (function diff_associative_key(a,b,k){var va = cljs.core.get.call(null,a,k);var vb = cljs.core.get.call(null,b,k);var vec__18264 = clojure.data.diff.call(null,va,vb);var a_STAR_ = cljs.core.nth.call(null,vec__18264,0,null);var b_STAR_ = cljs.core.nth.call(null,vec__18264,1,null);var ab = cljs.core.nth.call(null,vec__18264,2,null);var in_a = cljs.core.contains_QMARK_.call(null,a,k);var in_b = cljs.core.contains_QMARK_.call(null,b,k);var same = (in_a) && (in_b) && ((!((ab == null))) || (((va == null)) && ((vb == null))));return cljs.core.PersistentVector.fromArray([(((in_a) && ((!((a_STAR_ == null))) || (!(same))))?cljs.core.PersistentArrayMap.fromArray([k,a_STAR_], true):null),(((in_b) && ((!((b_STAR_ == null))) || (!(same))))?cljs.core.PersistentArrayMap.fromArray([k,b_STAR_], true):null),((same)?cljs.core.PersistentArrayMap.fromArray([k,ab], true):null)], true);
});
/**
...
clojure.data.equality_partition = (function equality_partition(x){if((function (){var and__7629__auto__ = x;if(and__7629__auto__)
...
{var x__8234__auto__ = (((x == null))?null:x);return (function (){var or__7638__auto__ = (clojure.data.equality_partition[goog.typeOf(x__8234__auto__)]);if(or__7638__auto__)
{return or__7638__auto__;
} else
{var or__7638__auto____$1 = (clojure.data.equality_partition["_"]);if(or__7638__auto____$1)
...
clojure.data.Diff = {};
clojure.data.diff_similar = (function diff_similar(a,b){if((function (){var and__7629__auto__ = a;if(and__7629__auto__)
...
{var x__8234__auto__ = (((a == null))?null:a);return (function (){var or__7638__auto__ = (clojure.data.diff_similar[goog.typeOf(x__8234__auto__)]);if(or__7638__auto__)
{return or__7638__auto__;
} else
{var or__7638__auto____$1 = (clojure.data.diff_similar["_"]);if(or__7638__auto____$1)
{return or__7638__auto____$1;
} else
...
(clojure.data.equality_partition["_"] = (function (x){if((function (){var G__18265 = x;if(G__18265)
{var bit__8257__auto__ = (G__18265.cljs$lang$protocol_mask$partition0$ & 1024);if((bit__8257__auto__) || (G__18265.cljs$core$IMap$))
{return true;
} else
{if((!G__18265.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__18265);
} else
{return false;
}
}
...
{if((function (){var G__18266 = x;if(G__18266)
{var bit__8257__auto__ = (G__18266.cljs$lang$protocol_mask$partition0$ & 4096);if((bit__8257__auto__) || (G__18266.cljs$core$ISet$))
{return true;
} else
{if((!G__18266.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISet,G__18266);
} else
{return false;
}
}
...
{if((function (){var G__18267 = x;if(G__18267)
{var bit__8257__auto__ = (G__18267.cljs$lang$protocol_mask$partition0$ & 16777216);if((bit__8257__auto__) || (G__18267.cljs$core$ISequential$))
{return true;
} else
{if((!G__18267.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISequential,G__18267);
} else
{return false;
}
}
...
(clojure.data.diff_similar["_"] = (function (a,b){return (function (){var G__18268 = clojure.data.equality_partition.call(null,a);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"map","map",1014012110),G__18268))
{return clojure.data.diff_associative;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"sequential","sequential",849892465),G__18268))
{return clojure.data.diff_sequential;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"set","set",1014018004),G__18268))
{return clojure.data.diff_set;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"atom","atom",1016908995),G__18268))
