...
{{
var G__21481 = cljs.core.pop.call(null,v__$1);
v__$1 = G__21481;
continue;
}
} else
...
{var pred__21485 = cljs.core._EQ_;var expr__21486 = limit;if(pred__21485.call(null,1,expr__21486))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__21485.call(null,2,expr__21486))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__21488 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__21489 = (limit__$1 - 1);
var G__21490 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__21488;
limit__$1 = G__21489;
parts = G__21490;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___21492 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___21492))
{var replacement_21493 = temp__4090__auto___21492;buffer.append([cljs.core.str(replacement_21493)].join(''));
} else
{buffer.append(ch);
}
{
var G__21494 = (index + 1);
index = G__21494;
continue;
}
}
