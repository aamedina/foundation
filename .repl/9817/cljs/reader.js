...
reader_error.cljs$lang$applyTo = (function (arglist__21298){
var rdr = cljs.core.first(arglist__21298);
var msg = cljs.core.rest(arglist__21298);
...
{{
var G__21299 = (function (){sb.append(ch);
return sb;
})();
var G__21300 = cljs.reader.read_char.call(null,rdr);
sb = G__21299;
ch = G__21300;
continue;
}
...
{{
var G__21301 = cljs.reader.read_char.call(null,rdr);
ch = G__21301;
continue;
}
} else
...
var G__21302 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__21302;
continue;
}
} else
...
var G__21303 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__21303;
continue;
}
}
...
{{
var G__21304 = (function (){buffer.append(ch);
return buffer;
})();
var G__21305 = cljs.reader.read_char.call(null,reader);
buffer = G__21304;
ch = G__21305;
continue;
}
...
{if(("\\" === ch))
{{
var G__21306 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__21307 = cljs.reader.read_char.call(null,reader);
buffer = G__21306;
ch = G__21307;
continue;
}
...
{{
var G__21308 = (function (){buffer.append(ch);
return buffer;
})();
var G__21309 = cljs.reader.read_char.call(null,reader);
buffer = G__21308;
ch = G__21309;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__21311 = o;if(G__21311)
{var bit__8257__auto__ = (G__21311.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__8257__auto__) || (G__21311.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__21311.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__21311);
} else
{return false;
}
}
...
{{
var G__21312 = reader;
var G__21313 = eof_is_error;
var G__21314 = sentinel;
var G__21315 = is_recursive;
reader = G__21312;
eof_is_error = G__21313;
sentinel = G__21314;
is_recursive = G__21315;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__21316 = cljs.reader.read_comment.call(null,reader,ch);
var G__21317 = eof_is_error;
var G__21318 = sentinel;
var G__21319 = is_recursive;
reader = G__21316;
eof_is_error = G__21317;
sentinel = G__21318;
is_recursive = G__21319;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__21320 = reader;
var G__21321 = eof_is_error;
var G__21322 = sentinel;
var G__21323 = is_recursive;
reader = G__21320;
eof_is_error = G__21321;
sentinel = G__21322;
is_recursive = G__21323;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__21326 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__21326,0,null);var years = cljs.core.nth.call(null,vec__21326,1,null);var months = cljs.core.nth.call(null,vec__21326,2,null);var days = cljs.core.nth.call(null,vec__21326,3,null);var hours = cljs.core.nth.call(null,vec__21326,4,null);var minutes = cljs.core.nth.call(null,vec__21326,5,null);var seconds = cljs.core.nth.call(null,vec__21326,6,null);var fraction = cljs.core.nth.call(null,vec__21326,7,null);var offset_sign = cljs.core.nth.call(null,vec__21326,8,null);var offset_hours = cljs.core.nth.call(null,vec__21326,9,null);var offset_minutes = cljs.core.nth.call(null,vec__21326,10,null);var v = vec__21326;if(cljs.core.not.call(null,v))
...
{var vec__21328 = temp__4090__auto__;var years = cljs.core.nth.call(null,vec__21328,0,null);var months = cljs.core.nth.call(null,vec__21328,1,null);var days = cljs.core.nth.call(null,vec__21328,2,null);var hours = cljs.core.nth.call(null,vec__21328,3,null);var minutes = cljs.core.nth.call(null,vec__21328,4,null);var seconds = cljs.core.nth.call(null,vec__21328,5,null);var ms = cljs.core.nth.call(null,vec__21328,6,null);var offset = cljs.core.nth.call(null,vec__21328,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
