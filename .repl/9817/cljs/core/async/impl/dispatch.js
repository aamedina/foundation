...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_21174 = 0;while(true){
var m_21175 = cljs.core.async.impl.dispatch.tasks.pop();if((m_21175 == null))
{} else
{m_21175.call(null);
if((count_21174 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__21176 = (count_21174 + 1);
count_21174 = G__21176;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7629__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7629__auto__)
