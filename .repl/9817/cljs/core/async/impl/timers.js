...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_21151 = 0;while(true){
if((i_21151 < arr.length))
{(arr[i_21151] = null);
{
var G__21152 = (i_21151 + 1);
i_21151 = G__21152;
continue;
}
} else
...
{var i_21158 = (self__.level + 1);while(true){
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_21160 = 0;while(true){
if((i_21160 <= self__.level))
{var links_21161 = (update[i_21160]).forward;if(((links_21161[i_21160]) === x__$1))
