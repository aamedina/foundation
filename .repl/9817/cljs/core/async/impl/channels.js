...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t21180 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t21180 = (function (val,box,meta21181){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t21180.cljs$lang$type = true;
cljs.core.async.impl.channels.t21180.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t21180";
cljs.core.async.impl.channels.t21180.cljs$lang$ctorPrWriter = (function (this__8175__auto__,writer__8176__auto__,opt__8177__auto__){return cljs.core._write.call(null,writer__8176__auto__,"cljs.core.async.impl.channels/t21180");
});
cljs.core.async.impl.channels.t21180.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t21180.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_21182){var self__ = this;
var _21182__$1 = this;return self__.meta21181;
});
cljs.core.async.impl.channels.t21180.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_21182,meta21181__$1){var self__ = this;
var _21182__$1 = this;return (new cljs.core.async.impl.channels.t21180(self__.val,self__.box,meta21181__$1));
});
cljs.core.async.impl.channels.__GT_t21180 = (function __GT_t21180(val__$1,box__$1,meta21181){return (new cljs.core.async.impl.channels.t21180(val__$1,box__$1,meta21181));
});
}
return (new cljs.core.async.impl.channels.t21180(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8178__auto__,writer__8179__auto__,opts__8180__auto__){return cljs.core._write.call(null,writer__8179__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8175__auto__,writer__8176__auto__,opt__8177__auto__){return cljs.core._write.call(null,writer__8176__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_21183 = self__.takes.pop();if((taker_21183 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_21183))
{var take_cb_21184 = cljs.core.async.impl.protocols.commit.call(null,taker_21183);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_21184,taker_21183){
return (function (){return take_cb_21184.call(null,null);
});})(take_cb_21184,taker_21183))
);
} else
{}
{
