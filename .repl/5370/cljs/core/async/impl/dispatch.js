...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_181058 = 0;while(true){
var m_181059 = cljs.core.async.impl.dispatch.tasks.pop();if((m_181059 == null))
{} else
{m_181059.call(null);
if((count_181058 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__181060 = (count_181058 + 1);
count_181058 = G__181060;
continue;
}
} else
{}
