...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_181023 = 0;while(true){
if((i_181023 < arr.length))
{(arr[i_181023] = null);
{
var G__181024 = (i_181023 + 1);
i_181023 = G__181024;
continue;
}
} else
...
var G__181026 = x__$1;
var G__181027 = k;
var G__181028 = (level - 1);
var G__181029 = update;
x = G__181026;
k = G__181027;
level = G__181028;
update = G__181029;
...
{var i_181030 = (self__.level + 1);while(true){
if((i_181030 <= (new_level + 1)))
{(update[i_181030] = self__.header);
{
var G__181031 = (i_181030 + 1);
i_181030 = G__181031;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_181032 = 0;while(true){
if((i_181032 <= self__.level))
{var links_181033 = (update[i_181032]).forward;if(((links_181033[i_181032]) === x__$1))
{(links_181033[i_181032] = (x__$1.forward[i_181032]));
{
var G__181034 = (i_181032 + 1);
i_181032 = G__181034;
continue;
}
} else
{{
var G__181035 = (i_181032 + 1);
i_181032 = G__181035;
continue;
}
}
