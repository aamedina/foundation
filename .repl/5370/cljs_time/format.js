...
var unparse__delegate = function (fmt,dt,p__182155){var map__182157 = p__182155;var map__182157__$1 = ((cljs.core.seq_QMARK_.call(null,map__182157))?cljs.core.apply.call(null,cljs.core.hash_map,map__182157):map__182157);var tz = cljs.core.get.call(null,map__182157__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__182155 = null;if (arguments.length > 2) {
  p__182155 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__182155);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__182158){
var fmt = cljs.core.first(arglist__182158);
arglist__182158 = cljs.core.next(arglist__182158);
var dt = cljs.core.first(arglist__182158);
var p__182155 = cljs.core.rest(arglist__182158);
return unparse__delegate(fmt,dt,p__182155);
});
...
var show_formatters__delegate = function (p__182159){var map__182165 = p__182159;var map__182165__$1 = ((cljs.core.seq_QMARK_.call(null,map__182165))?cljs.core.apply.call(null,cljs.core.hash_map,map__182165):map__182165);var date_like = cljs.core.get.call(null,map__182165__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__6982__auto__ = (function iter__182166(s__182167){return (new cljs.core.LazySeq(null,(function (){var s__182167__$1 = s__182167;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__182167__$1);if(temp__4098__auto__)
{var s__182167__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__182167__$2))
{var c__6980__auto__ = cljs.core.chunk_first.call(null,s__182167__$2);var size__6981__auto__ = cljs.core.count.call(null,c__6980__auto__);var b__182169 = cljs.core.chunk_buffer.call(null,size__6981__auto__);if((function (){var i__182168 = 0;while(true){
if((i__182168 < size__6981__auto__))
{var i = cljs.core._nth.call(null,c__6980__auto__,i__182168);cljs.core.chunk_append.call(null,b__182169,cljs_time.format.unparse.call(null,i,date_like));
{
var G__182170 = (i__182168 + 1);
i__182168 = G__182170;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__182169),iter__182166.call(null,cljs.core.chunk_rest.call(null,s__182167__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__182169),null);
}
} else
{var i = cljs.core.first.call(null,s__182167__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__182166.call(null,cljs.core.rest.call(null,s__182167__$2)));
}
} else
{return null;
}
...
var p__182159 = null;if (arguments.length > 0) {
  p__182159 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__182159);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__182171){
var p__182159 = cljs.core.seq(arglist__182171);
return show_formatters__delegate(p__182159);
});
