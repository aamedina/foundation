...
{{
var G__45353 = cljs.core.pop.call(null,v__$1);
v__$1 = G__45353;
continue;
}
} else
...
{var pred__45357 = cljs.core._EQ_;var expr__45358 = limit;if(cljs.core.truth_(pred__45357.call(null,1,expr__45358)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__45357.call(null,2,expr__45358)))
...
var G__45360 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__45361 = (limit__$1 - 1);
var G__45362 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__45360;
limit__$1 = G__45361;
parts = G__45362;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___45364 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___45364))
{var replacement_45365 = temp__4090__auto___45364;buffer.append([cljs.core.str(replacement_45365)].join(''));
} else
{buffer.append(ch);
}
{
var G__45366 = (index + 1);
index = G__45366;
continue;
}
}
