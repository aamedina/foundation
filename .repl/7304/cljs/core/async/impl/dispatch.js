...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_23991 = 0;while(true){
var m_23992 = cljs.core.async.impl.dispatch.tasks.pop();if((m_23992 == null))
{} else
{m_23992.call(null);
if((count_23991 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__23993 = (count_23991 + 1);
count_23991 = G__23993;
continue;
}
} else
{}
