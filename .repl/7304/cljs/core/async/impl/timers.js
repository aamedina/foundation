...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__8372__auto__,writer__8373__auto__,opt__8374__auto__){return cljs.core._write.call(null,writer__8373__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_23956 = 0;while(true){
if((i_23956 < arr.length))
{(arr[i_23956] = null);
{
var G__23957 = (i_23956 + 1);
i_23956 = G__23957;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__8372__auto__,writer__8373__auto__,opt__8374__auto__){return cljs.core._write.call(null,writer__8373__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_23963 = (self__.level + 1);while(true){
if((i_23963 <= (new_level + 1)))
{(update[i_23963] = self__.header);
{
var G__23964 = (i_23963 + 1);
i_23963 = G__23964;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_23965 = 0;while(true){
if((i_23965 <= self__.level))
{var links_23966 = (update[i_23965]).forward;if(((links_23966[i_23965]) === x__$1))
{(links_23966[i_23965] = (x__$1.forward[i_23965]));
{
var G__23967 = (i_23965 + 1);
i_23965 = G__23967;
continue;
}
} else
{{
var G__23968 = (i_23965 + 1);
i_23965 = G__23968;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__7828__auto__ = (cljs.core.truth_((function (){var and__7816__auto__ = me;if(cljs.core.truth_(and__7816__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__7816__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__7828__auto__))
