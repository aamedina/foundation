...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj24109 = {};return obj24109;
})();
...
reader_error.cljs$lang$applyTo = (function (arglist__24110){
var rdr = cljs.core.first(arglist__24110);
var msg = cljs.core.rest(arglist__24110);
...
{{
var G__24111 = (function (){sb.append(ch);
return sb;
})();
var G__24112 = cljs.reader.read_char.call(null,rdr);
sb = G__24111;
ch = G__24112;
continue;
}
...
{{
var G__24113 = cljs.reader.read_char.call(null,rdr);
ch = G__24113;
continue;
}
} else
...
var G__24114 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__24114;
continue;
}
} else
...
var G__24115 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__24115;
continue;
}
}
...
{{
var G__24116 = (function (){buffer.append(ch);
return buffer;
})();
var G__24117 = cljs.reader.read_char.call(null,reader);
buffer = G__24116;
ch = G__24117;
continue;
}
...
{if(("\\" === ch))
{{
var G__24118 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__24119 = cljs.reader.read_char.call(null,reader);
buffer = G__24118;
ch = G__24119;
continue;
}
...
{{
var G__24120 = (function (){buffer.append(ch);
return buffer;
})();
var G__24121 = cljs.reader.read_char.call(null,reader);
buffer = G__24120;
ch = G__24121;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__24123 = o;if(G__24123)
{var bit__8454__auto__ = (G__24123.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__8454__auto__) || (G__24123.cljs$core$IWithMeta$))
{return true;
} else
...
{{
var G__24128 = cljs.reader.read_comment.call(null,reader,ch);
var G__24129 = eof_is_error;
var G__24130 = sentinel;
var G__24131 = is_recursive;
reader = G__24128;
eof_is_error = G__24129;
sentinel = G__24130;
is_recursive = G__24131;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__24132 = reader;
var G__24133 = eof_is_error;
var G__24134 = sentinel;
var G__24135 = is_recursive;
reader = G__24132;
eof_is_error = G__24133;
sentinel = G__24134;
is_recursive = G__24135;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__24138 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__24138,0,null);var years = cljs.core.nth.call(null,vec__24138,1,null);var months = cljs.core.nth.call(null,vec__24138,2,null);var days = cljs.core.nth.call(null,vec__24138,3,null);var hours = cljs.core.nth.call(null,vec__24138,4,null);var minutes = cljs.core.nth.call(null,vec__24138,5,null);var seconds = cljs.core.nth.call(null,vec__24138,6,null);var fraction = cljs.core.nth.call(null,vec__24138,7,null);var offset_sign = cljs.core.nth.call(null,vec__24138,8,null);var offset_hours = cljs.core.nth.call(null,vec__24138,9,null);var offset_minutes = cljs.core.nth.call(null,vec__24138,10,null);var v = vec__24138;if(cljs.core.not.call(null,v))
...
{var vec__24140 = temp__4090__auto__;var years = cljs.core.nth.call(null,vec__24140,0,null);var months = cljs.core.nth.call(null,vec__24140,1,null);var days = cljs.core.nth.call(null,vec__24140,2,null);var hours = cljs.core.nth.call(null,vec__24140,3,null);var minutes = cljs.core.nth.call(null,vec__24140,4,null);var seconds = cljs.core.nth.call(null,vec__24140,5,null);var ms = cljs.core.nth.call(null,vec__24140,6,null);var offset = cljs.core.nth.call(null,vec__24140,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
