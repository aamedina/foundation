...
{return cljs.core.map.call(null,(function (p1__25122_SHARP_){return cljs.core.conj.call(null,p1__25122_SHARP_,cljs.core.name.call(null,item));
}),end);
} else
{if(typeof item === 'string')
{return cljs.core.map.call(null,(function (p1__25123_SHARP_){return cljs.core.conj.call(null,p1__25123_SHARP_,item);
}),end);
} else
{if(cljs.core.set_QMARK_.call(null,item))
{return cljs.core.reduce.call(null,(function (r1,it){return cljs.core.concat.call(null,r1,cljs.core.map.call(null,(function (p1__25124_SHARP_){return cljs.core.conj.call(null,p1__25124_SHARP_,it);
}),end));
...
return (function (p1__25125_SHARP_){return cljs.core.apply.call(null,cljs.core.str,p1__25125_SHARP_);
});})(x1))
,sel_to_str.call(null,item));var iter__8521__auto__ = (function iter__25132(s__25133){return (new cljs.core.LazySeq(null,(function (){var s__25133__$1 = s__25133;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__25133__$1);if(temp__4092__auto__)
{var xs__4579__auto__ = temp__4092__auto__;var s = cljs.core.first.call(null,xs__4579__auto__);var iterys__8517__auto__ = ((function (s__25133__$1,s,xs__4579__auto__,temp__4092__auto__){
return (function iter__25134(s__25135){return (new cljs.core.LazySeq(null,((function (s__25133__$1,s,xs__4579__auto__,temp__4092__auto__){
return (function (){var s__25135__$1 = s__25135;while(true){
var temp__4092__auto____$1 = cljs.core.seq.call(null,s__25135__$1);if(temp__4092__auto____$1)
{var s__25135__$2 = temp__4092__auto____$1;if(cljs.core.chunked_seq_QMARK_.call(null,s__25135__$2))
{var c__8519__auto__ = cljs.core.chunk_first.call(null,s__25135__$2);var size__8520__auto__ = cljs.core.count.call(null,c__8519__auto__);var b__25137 = cljs.core.chunk_buffer.call(null,size__8520__auto__);if((function (){var i__25136 = 0;while(true){
if((i__25136 < size__8520__auto__))
{var e = cljs.core._nth.call(null,c__8519__auto__,i__25136);cljs.core.chunk_append.call(null,b__25137,(function (){cljs.core.println.call(null,s,e);
return cljs.core.conj.call(null,e,s);
})());
{
var G__25138 = (i__25136 + 1);
i__25136 = G__25138;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__25137),iter__25134.call(null,cljs.core.chunk_rest.call(null,s__25135__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__25137),null);
}
} else
{var e = cljs.core.first.call(null,s__25135__$2);return cljs.core.cons.call(null,(function (){cljs.core.println.call(null,s,e);
return cljs.core.conj.call(null,e,s);
})(),iter__25134.call(null,cljs.core.rest.call(null,s__25135__$2)));
}
} else
{return null;
}
...
});})(s__25133__$1,s,xs__4579__auto__,temp__4092__auto__))
,null,null));
});})(s__25133__$1,s,xs__4579__auto__,temp__4092__auto__))
;var fs__8518__auto__ = cljs.core.seq.call(null,iterys__8517__auto__.call(null,end));if(fs__8518__auto__)
{return cljs.core.concat.call(null,fs__8518__auto__,iter__25132.call(null,cljs.core.rest.call(null,s__25133__$1)));
} else
{{
var G__25139 = cljs.core.rest.call(null,s__25133__$1);
s__25133__$1 = G__25139;
continue;
}
}
} else
...
});return iter__8521__auto__.call(null,sub);
} else
...
enfocus.enlive.syntax.attr_pairs = (function attr_pairs(op,elms){var ts = (function (p__25142){var vec__25143 = p__25142;var x = cljs.core.nth.call(null,vec__25143,0,null);var y = cljs.core.nth.call(null,vec__25143,1,null);return [cljs.core.str("["),cljs.core.str(cljs.core.name.call(null,x)),cljs.core.str(op),cljs.core.str("='"),cljs.core.str(y),cljs.core.str("']")].join('');
...
var attr_QMARK___delegate = function (elms){return cljs.core.apply.call(null,cljs.core.str,cljs.core.map.call(null,(function (p1__25144_SHARP_){return [cljs.core.str("["),cljs.core.str(cljs.core.name.call(null,p1__25144_SHARP_)),cljs.core.str("]")].join('');
}),elms));
};
...
attr_QMARK_.cljs$lang$applyTo = (function (arglist__25145){
var elms = cljs.core.seq(arglist__25145);
...
attr_EQ_.cljs$lang$applyTo = (function (arglist__25146){
var elms = cljs.core.seq(arglist__25146);
...
attr_has.cljs$lang$applyTo = (function (arglist__25147){
var x = cljs.core.first(arglist__25147);
var vals = cljs.core.rest(arglist__25147);
...
attr_starts.cljs$lang$applyTo = (function (arglist__25148){
var elms = cljs.core.seq(arglist__25148);
...
attr_ends.cljs$lang$applyTo = (function (arglist__25149){
var elms = cljs.core.seq(arglist__25149);
...
attr_contains.cljs$lang$applyTo = (function (arglist__25150){
var elms = cljs.core.seq(arglist__25150);
...
attr_BAR__EQ_.cljs$lang$applyTo = (function (arglist__25151){
var elms = cljs.core.seq(arglist__25151);
...
but.cljs$lang$applyTo = (function (arglist__25152){
var sel = cljs.core.seq(arglist__25152);
