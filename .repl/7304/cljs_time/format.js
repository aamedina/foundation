...
var unparse__delegate = function (fmt,dt,p__28927){var map__28929 = p__28927;var map__28929__$1 = ((cljs.core.seq_QMARK_.call(null,map__28929))?cljs.core.apply.call(null,cljs.core.hash_map,map__28929):map__28929);var tz = cljs.core.get.call(null,map__28929__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
...
return unparse__delegate.call(this,fmt,dt,p__28927);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__28930){
var fmt = cljs.core.first(arglist__28930);
arglist__28930 = cljs.core.next(arglist__28930);
var dt = cljs.core.first(arglist__28930);
var p__28927 = cljs.core.rest(arglist__28930);
return unparse__delegate(fmt,dt,p__28927);
});
...
var show_formatters__delegate = function (p__28931){var map__28937 = p__28931;var map__28937__$1 = ((cljs.core.seq_QMARK_.call(null,map__28937))?cljs.core.apply.call(null,cljs.core.hash_map,map__28937):map__28937);var date_like = cljs.core.get.call(null,map__28937__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__8521__auto__ = (function iter__28938(s__28939){return (new cljs.core.LazySeq(null,(function (){var s__28939__$1 = s__28939;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__28939__$1);if(temp__4092__auto__)
{var s__28939__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__28939__$2))
{var c__8519__auto__ = cljs.core.chunk_first.call(null,s__28939__$2);var size__8520__auto__ = cljs.core.count.call(null,c__8519__auto__);var b__28941 = cljs.core.chunk_buffer.call(null,size__8520__auto__);if((function (){var i__28940 = 0;while(true){
if((i__28940 < size__8520__auto__))
{var i = cljs.core._nth.call(null,c__8519__auto__,i__28940);cljs.core.chunk_append.call(null,b__28941,cljs_time.format.unparse.call(null,i,date_like));
{
var G__28942 = (i__28940 + 1);
i__28940 = G__28942;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__28941),iter__28938.call(null,cljs.core.chunk_rest.call(null,s__28939__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__28941),null);
}
} else
{var i = cljs.core.first.call(null,s__28939__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__28938.call(null,cljs.core.rest.call(null,s__28939__$2)));
}
} else
{return null;
}
...
var p__28931 = null;if (arguments.length > 0) {
  p__28931 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__28931);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__28943){
var p__28931 = cljs.core.seq(arglist__28943);
return show_formatters__delegate(p__28931);
});
