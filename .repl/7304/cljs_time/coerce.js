...
goog.require('goog.date.DateTime');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj28907 = {};return obj28907;
})();
cljs_time.coerce.to_date_time = (function to_date_time(obj){if((function (){var and__7816__auto__ = obj;if(and__7816__auto__)
...
{var x__8431__auto__ = (((obj == null))?null:obj);return (function (){var or__7828__auto__ = (cljs_time.coerce.to_date_time[goog.typeOf(x__8431__auto__)]);if(or__7828__auto__)
{return or__7828__auto__;
} else
{var or__7828__auto____$1 = (cljs_time.coerce.to_date_time["_"]);if(or__7828__auto____$1)
...
* which parses
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__8521__auto__ = (function iter__28916(s__28917){return (new cljs.core.LazySeq(null,(function (){var s__28917__$1 = s__28917;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__28917__$1);if(temp__4092__auto__)
{var s__28917__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__28917__$2))
{var c__8519__auto__ = cljs.core.chunk_first.call(null,s__28917__$2);var size__8520__auto__ = cljs.core.count.call(null,c__8519__auto__);var b__28919 = cljs.core.chunk_buffer.call(null,size__8520__auto__);if((function (){var i__28918 = 0;while(true){
if((i__28918 < size__8520__auto__))
{var f = cljs.core._nth.call(null,c__8519__auto__,i__28918);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e28922){if((e28922 instanceof Error))
{var e = e28922;return null;
} else
...
{cljs.core.chunk_append.call(null,b__28919,d);
{
var G__28924 = (i__28918 + 1);
i__28918 = G__28924;
continue;
}
} else
{{
var G__28925 = (i__28918 + 1);
i__28918 = G__28925;
continue;
}
}
...
{var f = cljs.core.first.call(null,s__28917__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e28923){if((e28923 instanceof Error))
{var e = e28923;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e28923;
} else
...
{return cljs.core.cons.call(null,d,iter__28916.call(null,cljs.core.rest.call(null,s__28917__$2)));
} else
{{
var G__28926 = cljs.core.rest.call(null,s__28917__$2);
s__28917__$1 = G__28926;
continue;
}
}
}
...
});return iter__8521__auto__.call(null,cljs.core.vals.call(null,cljs_time.format.formatters));
})());
});
/**
* Returns a DateTime instance in the UTC time zone corresponding to the given
...
*/
cljs_time.coerce.to_epoch = (function to_epoch(obj){var millis = cljs_time.coerce.to_long.call(null,obj);var and__7816__auto__ = millis;if(cljs.core.truth_(and__7816__auto__))
{return (millis / 1000);
} else
{return and__7816__auto__;
}
