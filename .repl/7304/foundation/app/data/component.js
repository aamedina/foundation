...
goog.require('foundation.app.data.dependency');
foundation.app.data.component.Lifecycle = (function (){var obj28945 = {};return obj28945;
})();
foundation.app.data.component.start = (function start(component){if((function (){var and__7816__auto__ = component;if(and__7816__auto__)
...
{var x__8431__auto__ = (((component == null))?null:component);return (function (){var or__7828__auto__ = (foundation.app.data.component.start[goog.typeOf(x__8431__auto__)]);if(or__7828__auto__)
{return or__7828__auto__;
} else
{var or__7828__auto____$1 = (foundation.app.data.component.start["_"]);if(or__7828__auto____$1)
...
foundation.app.data.component.stop = (function stop(component){if((function (){var and__7816__auto__ = component;if(and__7816__auto__)
...
{var x__8431__auto__ = (((component == null))?null:component);return (function (){var or__7828__auto__ = (foundation.app.data.component.stop[goog.typeOf(x__8431__auto__)]);if(or__7828__auto__)
{return or__7828__auto__;
} else
{var or__7828__auto____$1 = (foundation.app.data.component.stop["_"]);if(or__7828__auto____$1)
{return or__7828__auto____$1;
} else
...
*/
foundation.app.data.component.dependency_graph = (function dependency_graph(system,component_keys){return cljs.core.reduce_kv.call(null,(function (graph,key,component){return cljs.core.reduce.call(null,(function (p1__28946_SHARP_,p2__28947_SHARP_){return foundation.app.data.dependency.depend.call(null,p1__28946_SHARP_,key,p2__28947_SHARP_);
...
foundation.app.data.component.assoc_dependencies = (function assoc_dependencies(component,system){return cljs.core.reduce_kv.call(null,(function (p1__28948_SHARP_,p2__28949_SHARP_,p3__28950_SHARP_){return foundation.app.data.component.assoc_dependency.call(null,system,p1__28948_SHARP_,p2__28949_SHARP_,p3__28950_SHARP_);
...
foundation.app.data.component.get_component = (function get_component(system,key){var or__7828__auto__ = cljs.core.get.call(null,system,key);if(cljs.core.truth_(or__7828__auto__))
{return or__7828__auto__;
} else
{throw cljs.core.ex_info.call(null,"Missing component from system",new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"reason","reason",4373906870),new cljs.core.Keyword("foundation.app.data.component","missing-component","foundation.app.data.component/missing-component",3557566423),new cljs.core.Keyword(null,"component-key","component-key",2719177985),key,new cljs.core.Keyword(null,"system","system",4421543329),system], null));
}
...
update_system.cljs$lang$applyTo = (function (arglist__28953){
var system = cljs.core.first(arglist__28953);
arglist__28953 = cljs.core.next(arglist__28953);
var component_keys = cljs.core.first(arglist__28953);
arglist__28953 = cljs.core.next(arglist__28953);
var f = cljs.core.first(arglist__28953);
var args = cljs.core.rest(arglist__28953);
...
update_system_reverse.cljs$lang$applyTo = (function (arglist__28954){
var system = cljs.core.first(arglist__28954);
arglist__28954 = cljs.core.next(arglist__28954);
var component_keys = cljs.core.first(arglist__28954);
arglist__28954 = cljs.core.next(arglist__28954);
var f = cljs.core.first(arglist__28954);
