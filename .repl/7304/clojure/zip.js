...
{var vec__25155 = loc;var node = cljs.core.nth.call(null,vec__25155,0,null);var path = cljs.core.nth.call(null,vec__25155,1,null);var vec__25156 = clojure.zip.children.call(null,loc);var c = cljs.core.nth.call(null,vec__25156,0,null);var cnext = cljs.core.nthnext.call(null,vec__25156,1);var cs = vec__25156;if(cljs.core.truth_(cs))
...
* the top
*/
clojure.zip.up = (function up(loc){var vec__25159 = loc;var node = cljs.core.nth.call(null,vec__25159,0,null);var map__25160 = cljs.core.nth.call(null,vec__25159,1,null);var map__25160__$1 = ((cljs.core.seq_QMARK_.call(null,map__25160))?cljs.core.apply.call(null,cljs.core.hash_map,map__25160):map__25160);var path = map__25160__$1;var l = cljs.core.get.call(null,map__25160__$1,new cljs.core.Keyword(null,"l","l",1013904350));var ppath = cljs.core.get.call(null,map__25160__$1,new cljs.core.Keyword(null,"ppath","ppath",1120772103));var pnodes = cljs.core.get.call(null,map__25160__$1,new cljs.core.Keyword(null,"pnodes","pnodes",4325362611));var r = cljs.core.get.call(null,map__25160__$1,new cljs.core.Keyword(null,"r","r",1013904356));var changed_QMARK_ = cljs.core.get.call(null,map__25160__$1,new cljs.core.Keyword(null,"changed?","changed?",2446321533));if(cljs.core.truth_(pnodes))
{var pnode = cljs.core.peek.call(null,pnodes);return cljs.core.with_meta.call(null,(cljs.core.truth_(changed_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.zip.make_node.call(null,loc,pnode,cljs.core.concat.call(null,l,cljs.core.cons.call(null,node,r))),(function (){var and__7816__auto__ = ppath;if(cljs.core.truth_(and__7816__auto__))
...
*/
clojure.zip.right = (function right(loc){var vec__25165 = loc;var node = cljs.core.nth.call(null,vec__25165,0,null);var map__25166 = cljs.core.nth.call(null,vec__25165,1,null);var map__25166__$1 = ((cljs.core.seq_QMARK_.call(null,map__25166))?cljs.core.apply.call(null,cljs.core.hash_map,map__25166):map__25166);var path = map__25166__$1;var l = cljs.core.get.call(null,map__25166__$1,new cljs.core.Keyword(null,"l","l",1013904350));var vec__25167 = cljs.core.get.call(null,map__25166__$1,new cljs.core.Keyword(null,"r","r",1013904356));var r = cljs.core.nth.call(null,vec__25167,0,null);var rnext = cljs.core.nthnext.call(null,vec__25167,1);var rs = vec__25167;if(cljs.core.truth_((function (){var and__7816__auto__ = path;if(cljs.core.truth_(and__7816__auto__))
{return rs;
} else
{return and__7816__auto__;
}
...
*/
clojure.zip.rightmost = (function rightmost(loc){var vec__25170 = loc;var node = cljs.core.nth.call(null,vec__25170,0,null);var map__25171 = cljs.core.nth.call(null,vec__25170,1,null);var map__25171__$1 = ((cljs.core.seq_QMARK_.call(null,map__25171))?cljs.core.apply.call(null,cljs.core.hash_map,map__25171):map__25171);var path = map__25171__$1;var l = cljs.core.get.call(null,map__25171__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__25171__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__7816__auto__ = path;if(cljs.core.truth_(and__7816__auto__))
{return r;
} else
{return and__7816__auto__;
}
...
*/
clojure.zip.left = (function left(loc){var vec__25174 = loc;var node = cljs.core.nth.call(null,vec__25174,0,null);var map__25175 = cljs.core.nth.call(null,vec__25174,1,null);var map__25175__$1 = ((cljs.core.seq_QMARK_.call(null,map__25175))?cljs.core.apply.call(null,cljs.core.hash_map,map__25175):map__25175);var path = map__25175__$1;var l = cljs.core.get.call(null,map__25175__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__25175__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__7816__auto__ = path;if(cljs.core.truth_(and__7816__auto__))
...
*/
clojure.zip.leftmost = (function leftmost(loc){var vec__25178 = loc;var node = cljs.core.nth.call(null,vec__25178,0,null);var map__25179 = cljs.core.nth.call(null,vec__25178,1,null);var map__25179__$1 = ((cljs.core.seq_QMARK_.call(null,map__25179))?cljs.core.apply.call(null,cljs.core.hash_map,map__25179):map__25179);var path = map__25179__$1;var l = cljs.core.get.call(null,map__25179__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__25179__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__7816__auto__ = path;if(cljs.core.truth_(and__7816__auto__))
{return cljs.core.seq.call(null,l);
} else
{return and__7816__auto__;
}
...
* without moving
*/
clojure.zip.insert_left = (function insert_left(loc,item){var vec__25182 = loc;var node = cljs.core.nth.call(null,vec__25182,0,null);var map__25183 = cljs.core.nth.call(null,vec__25182,1,null);var map__25183__$1 = ((cljs.core.seq_QMARK_.call(null,map__25183))?cljs.core.apply.call(null,cljs.core.hash_map,map__25183):map__25183);var path = map__25183__$1;var l = cljs.core.get.call(null,map__25183__$1,new cljs.core.Keyword(null,"l","l",1013904350));if((path == null))
{throw "Insert at top";
} else
...
* without moving
*/
clojure.zip.insert_right = (function insert_right(loc,item){var vec__25186 = loc;var node = cljs.core.nth.call(null,vec__25186,0,null);var map__25187 = cljs.core.nth.call(null,vec__25186,1,null);var map__25187__$1 = ((cljs.core.seq_QMARK_.call(null,map__25187))?cljs.core.apply.call(null,cljs.core.hash_map,map__25187):map__25187);var path = map__25187__$1;var r = cljs.core.get.call(null,map__25187__$1,new cljs.core.Keyword(null,"r","r",1013904356));if((path == null))
{throw "Insert at top";
} else
...
edit.cljs$lang$applyTo = (function (arglist__25190){
var loc = cljs.core.first(arglist__25190);
arglist__25190 = cljs.core.next(arglist__25190);
...
{var or__7828__auto__ = (function (){var and__7816__auto__ = clojure.zip.branch_QMARK_.call(null,loc);if(cljs.core.truth_(and__7816__auto__))
...
{var or__7828__auto____$1 = clojure.zip.right.call(null,loc);if(cljs.core.truth_(or__7828__auto____$1))
{return or__7828__auto____$1;
} else
{var p = loc;while(true){
if(cljs.core.truth_(clojure.zip.up.call(null,p)))
{var or__7828__auto____$2 = clojure.zip.right.call(null,clojure.zip.up.call(null,p));if(cljs.core.truth_(or__7828__auto____$2))
{return or__7828__auto____$2;
} else
{{
var G__25191 = clojure.zip.up.call(null,p);
p = G__25191;
continue;
}
}
...
var temp__4090__auto____$1 = (function (){var and__7816__auto__ = clojure.zip.branch_QMARK_.call(null,loc__$1);if(cljs.core.truth_(and__7816__auto__))
...
var G__25192 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__25192;
continue;
}
} else
...
*/
clojure.zip.remove = (function remove(loc){var vec__25195 = loc;var node = cljs.core.nth.call(null,vec__25195,0,null);var map__25196 = cljs.core.nth.call(null,vec__25195,1,null);var map__25196__$1 = ((cljs.core.seq_QMARK_.call(null,map__25196))?cljs.core.apply.call(null,cljs.core.hash_map,map__25196):map__25196);var path = map__25196__$1;var l = cljs.core.get.call(null,map__25196__$1,new cljs.core.Keyword(null,"l","l",1013904350));var ppath = cljs.core.get.call(null,map__25196__$1,new cljs.core.Keyword(null,"ppath","ppath",1120772103));var pnodes = cljs.core.get.call(null,map__25196__$1,new cljs.core.Keyword(null,"pnodes","pnodes",4325362611));var rs = cljs.core.get.call(null,map__25196__$1,new cljs.core.Keyword(null,"r","r",1013904356));if((path == null))
{throw "Remove at top";
} else
...
var temp__4090__auto__ = (function (){var and__7816__auto__ = clojure.zip.branch_QMARK_.call(null,loc__$1);if(cljs.core.truth_(and__7816__auto__))
{return clojure.zip.down.call(null,loc__$1);
} else
{return and__7816__auto__;
}
...
var G__25197 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__25197;
continue;
}
} else
...
{return cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.zip.make_node.call(null,loc,cljs.core.peek.call(null,pnodes),rs),(function (){var and__7816__auto__ = ppath;if(cljs.core.truth_(and__7816__auto__))
{return cljs.core.assoc.call(null,ppath,new cljs.core.Keyword(null,"changed?","changed?",2446321533),true);
} else
{return and__7816__auto__;
}
