...
{{
var G__24058 = cljs.core.pop.call(null,v__$1);
v__$1 = G__24058;
continue;
}
} else
...
{var pred__24062 = cljs.core._EQ_;var expr__24063 = limit;if(cljs.core.truth_(pred__24062.call(null,1,expr__24063)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__24062.call(null,2,expr__24063)))
...
var G__24065 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__24066 = (limit__$1 - 1);
var G__24067 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__24065;
limit__$1 = G__24066;
parts = G__24067;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___24069 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___24069))
{var replacement_24070 = temp__4090__auto___24069;buffer.append([cljs.core.str(replacement_24070)].join(''));
} else
{buffer.append(ch);
}
{
var G__24071 = (index + 1);
index = G__24071;
continue;
}
}
