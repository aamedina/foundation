...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_45751 = 0;while(true){
var m_45752 = cljs.core.async.impl.dispatch.tasks.pop();if((m_45752 == null))
{} else
{m_45752.call(null);
if((count_45751 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__45753 = (count_45751 + 1);
count_45751 = G__45753;
continue;
}
} else
{}
