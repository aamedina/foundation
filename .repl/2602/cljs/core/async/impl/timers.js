...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_45716 = 0;while(true){
if((i_45716 < arr.length))
{(arr[i_45716] = null);
{
var G__45717 = (i_45716 + 1);
i_45716 = G__45717;
continue;
}
} else
...
{var i_45723 = (self__.level + 1);while(true){
if((i_45723 <= (new_level + 1)))
{(update[i_45723] = self__.header);
{
var G__45724 = (i_45723 + 1);
i_45723 = G__45724;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_45725 = 0;while(true){
if((i_45725 <= self__.level))
{var links_45726 = (update[i_45725]).forward;if(((links_45726[i_45725]) === x__$1))
{(links_45726[i_45725] = (x__$1.forward[i_45725]));
{
var G__45727 = (i_45725 + 1);
i_45725 = G__45727;
continue;
}
} else
{{
var G__45728 = (i_45725 + 1);
i_45725 = G__45728;
continue;
}
}
