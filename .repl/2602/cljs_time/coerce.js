...
goog.require('goog.date.DateTime');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj46826 = {};return obj46826;
})();
...
* which parses
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__6982__auto__ = (function iter__46835(s__46836){return (new cljs.core.LazySeq(null,(function (){var s__46836__$1 = s__46836;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__46836__$1);if(temp__4098__auto__)
{var s__46836__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__46836__$2))
{var c__6980__auto__ = cljs.core.chunk_first.call(null,s__46836__$2);var size__6981__auto__ = cljs.core.count.call(null,c__6980__auto__);var b__46838 = cljs.core.chunk_buffer.call(null,size__6981__auto__);if((function (){var i__46837 = 0;while(true){
if((i__46837 < size__6981__auto__))
{var f = cljs.core._nth.call(null,c__6980__auto__,i__46837);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e46841){if((e46841 instanceof Error))
{var e = e46841;return null;
} else
...
{cljs.core.chunk_append.call(null,b__46838,d);
{
var G__46843 = (i__46837 + 1);
i__46837 = G__46843;
continue;
}
} else
{{
var G__46844 = (i__46837 + 1);
i__46837 = G__46844;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__46838),iter__46835.call(null,cljs.core.chunk_rest.call(null,s__46836__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__46838),null);
}
} else
{var f = cljs.core.first.call(null,s__46836__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e46842){if((e46842 instanceof Error))
{var e = e46842;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e46842;
} else
...
{return cljs.core.cons.call(null,d,iter__46835.call(null,cljs.core.rest.call(null,s__46836__$2)));
} else
{{
var G__46845 = cljs.core.rest.call(null,s__46836__$2);
s__46836__$1 = G__46845;
continue;
}
}
}
