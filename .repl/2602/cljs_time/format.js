...
var unparse__delegate = function (fmt,dt,p__46846){var map__46848 = p__46846;var map__46848__$1 = ((cljs.core.seq_QMARK_.call(null,map__46848))?cljs.core.apply.call(null,cljs.core.hash_map,map__46848):map__46848);var tz = cljs.core.get.call(null,map__46848__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__46846 = null;if (arguments.length > 2) {
  p__46846 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__46846);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__46849){
var fmt = cljs.core.first(arglist__46849);
arglist__46849 = cljs.core.next(arglist__46849);
var dt = cljs.core.first(arglist__46849);
var p__46846 = cljs.core.rest(arglist__46849);
return unparse__delegate(fmt,dt,p__46846);
});
...
var show_formatters__delegate = function (p__46850){var map__46856 = p__46850;var map__46856__$1 = ((cljs.core.seq_QMARK_.call(null,map__46856))?cljs.core.apply.call(null,cljs.core.hash_map,map__46856):map__46856);var date_like = cljs.core.get.call(null,map__46856__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__6982__auto__ = (function iter__46857(s__46858){return (new cljs.core.LazySeq(null,(function (){var s__46858__$1 = s__46858;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__46858__$1);if(temp__4098__auto__)
{var s__46858__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__46858__$2))
{var c__6980__auto__ = cljs.core.chunk_first.call(null,s__46858__$2);var size__6981__auto__ = cljs.core.count.call(null,c__6980__auto__);var b__46860 = cljs.core.chunk_buffer.call(null,size__6981__auto__);if((function (){var i__46859 = 0;while(true){
if((i__46859 < size__6981__auto__))
{var i = cljs.core._nth.call(null,c__6980__auto__,i__46859);cljs.core.chunk_append.call(null,b__46860,cljs_time.format.unparse.call(null,i,date_like));
{
var G__46861 = (i__46859 + 1);
i__46859 = G__46861;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__46860),iter__46857.call(null,cljs.core.chunk_rest.call(null,s__46858__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__46860),null);
}
} else
{var i = cljs.core.first.call(null,s__46858__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__46857.call(null,cljs.core.rest.call(null,s__46858__$2)));
}
} else
{return null;
}
...
var p__46850 = null;if (arguments.length > 0) {
  p__46850 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__46850);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__46862){
var p__46850 = cljs.core.seq(arglist__46862);
return show_formatters__delegate(p__46850);
});
