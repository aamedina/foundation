...
goog.require('goog.date.DateTime');
goog.require('goog.i18n.TimeZone');
cljs_time.core.DateTimeProtocol = (function (){var obj46734 = {};return obj46734;
})();
...
*/
cljs_time.core.today_at_midnight = (function today_at_midnight(){var G__46736 = (new goog.date.UtcDateTime());G__46736.setHours(0);
G__46736.setMinutes(0);
G__46736.setSeconds(0);
G__46736.setMilliseconds(0);
return G__46736;
});
/**
* Returns a DateTime for the begining of the Unix epoch in the UTC time zone.
*/
cljs_time.core.epoch = (function epoch(){var G__46738 = (new goog.date.UtcDateTime());G__46738.setTime(0);
return G__46738;
});
/**
...
var G__46739__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.plus_,cljs_time.core.plus_.call(null,dt,p),ps);
};
var G__46739 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__46739__delegate.call(this,dt,p,ps);};
G__46739.cljs$lang$maxFixedArity = 2;
G__46739.cljs$lang$applyTo = (function (arglist__46740){
var dt = cljs.core.first(arglist__46740);
arglist__46740 = cljs.core.next(arglist__46740);
var p = cljs.core.first(arglist__46740);
var ps = cljs.core.rest(arglist__46740);
return G__46739__delegate(dt,p,ps);
});
G__46739.cljs$core$IFn$_invoke$arity$variadic = G__46739__delegate;
return G__46739;
})()
;
...
var G__46741__delegate = function (dt,p,ps){return cljs.core.reduce.call(null,cljs_time.core.minus_,cljs_time.core.minus_.call(null,dt,p),ps);
};
var G__46741 = function (dt,p,var_args){
var ps = null;if (arguments.length > 2) {
  ps = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return G__46741__delegate.call(this,dt,p,ps);};
G__46741.cljs$lang$maxFixedArity = 2;
G__46741.cljs$lang$applyTo = (function (arglist__46742){
var dt = cljs.core.first(arglist__46742);
arglist__46742 = cljs.core.next(arglist__46742);
var p = cljs.core.first(arglist__46742);
var ps = cljs.core.rest(arglist__46742);
return G__46741__delegate(dt,p,ps);
});
...
extend.cljs$lang$applyTo = (function (arglist__46743){
var in$ = cljs.core.first(arglist__46743);
var by = cljs.core.rest(arglist__46743);
...
cljs_time.core.to_period = (function to_period(in$){var pred__46747 = cljs.core._EQ_;var expr__46748 = cljs.core.type.call(null,in$);if(cljs.core.truth_(pred__46747.call(null,goog.date.Interval,expr__46748)))
{return in$;
} else
{if(cljs.core.truth_(pred__46747.call(null,goog.date.DateRange,expr__46748)))
{return (new goog.date.Interval(0,0,0,0,0,((cljs_time.core.in_millis.call(null,in$) / 1000) | 0)));
} else
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__46748)].join('')));
}
}
});
/**
...
;
cljs_time.core.last_day_of_the_month = (function last_day_of_the_month(dt){var G__46751 = dt;G__46751.setDate(cljs_time.core.number_of_days_in_the_month.call(null,dt));
return G__46751;
});
cljs_time.core.first_day_of_the_month = (function first_day_of_the_month(dt){var G__46753 = dt;G__46753.setDate(1);
return G__46753;
});
...
var today_at__4 = (function (hours,minutes,seconds,millis){return cljs_time.core.date_time.call(null,(function (){var G__46755 = cljs_time.core.now.call(null);G__46755.setHourOfDay(hours);
G__46755.setMinuteOfHour(minutes);
G__46755.setSecondOfMinute(seconds);
G__46755.setMillisOfSecond(millis);
return G__46755;
})());
});
...
;
cljs_time.core.do_at_STAR_ = (function do_at_STAR_(base_date_time,body_fn){var ms = (base_date_time.getTime() - cljs_time.core.now.call(null).getTime());var c__13409__auto__ = cljs.core.async.chan.call(null,1);cljs.core.async.impl.dispatch.run.call(null,(function (){var f__13410__auto__ = (function (){var switch__13309__auto__ = (function (state_46792){var state_val_46793 = (state_46792[1]);if((state_val_46793 === 5))
{var _ = cljs.core.async.impl.ioc_helpers.add_exception_frame.call(null,state_46792,4,Error,null,3);var inst_46788 = body_fn.call(null);var state_46792__$1 = state_46792;var statearr_46794_46806 = state_46792__$1;(statearr_46794_46806[2] = inst_46788);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_46792__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_46793 === 4))
{var inst_46784 = (state_46792[2]);var state_46792__$1 = (function (){var statearr_46795 = state_46792;(statearr_46795[7] = inst_46784);
return statearr_46795;
})();var statearr_46796_46807 = state_46792__$1;(statearr_46796_46807[2] = null);
cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_46792__$1);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_46793 === 3))
{var inst_46790 = (state_46792[2]);var state_46792__$1 = state_46792;return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_46792__$1,inst_46790);
} else
{if((state_val_46793 === 2))
{var inst_46783 = (state_46792[2]);var state_46792__$1 = (function (){var statearr_46797 = state_46792;(statearr_46797[8] = inst_46783);
return statearr_46797;
})();var statearr_46798_46808 = state_46792__$1;(statearr_46798_46808[2] = null);
(statearr_46798_46808[1] = 5);
return new cljs.core.Keyword(null,"recur","recur",1122293407);
} else
{if((state_val_46793 === 1))
{var inst_46781 = cljs.core.async.timeout.call(null,ms);var state_46792__$1 = state_46792;return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_46792__$1,2,inst_46781);
} else
{return null;
}
}
...
var state_machine__13310__auto____0 = (function (){var statearr_46802 = (new Array(9));(statearr_46802[0] = state_machine__13310__auto__);
(statearr_46802[1] = 1);
return statearr_46802;
});
var state_machine__13310__auto____1 = (function (state_46792){while(true){
var ret_value__13311__auto__ = (function (){try{while(true){
var result__13312__auto__ = switch__13309__auto__.call(null,state_46792);if(cljs.core.keyword_identical_QMARK_.call(null,result__13312__auto__,new cljs.core.Keyword(null,"recur","recur",1122293407)))
{{
continue;
}
} else
...
{var ex__13313__auto__ = e46803;var statearr_46804_46809 = state_46792;(statearr_46804_46809[5] = ex__13313__auto__);
...
{{
var G__46810 = state_46792;
state_46792 = G__46810;
continue;
}
} else
...
state_machine__13310__auto__ = function(state_46792){
switch(arguments.length){
case 0:
return state_machine__13310__auto____0.call(this);
case 1:
return state_machine__13310__auto____1.call(this,state_46792);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
})();var state__13411__auto__ = (function (){var statearr_46805 = f__13410__auto__.call(null);(statearr_46805[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__13409__auto__);
...
cljs_time.core.Mappable = (function (){var obj46812 = {};return obj46812;
})();
...
{{
var G__46813 = [cljs.core.str("0"),cljs.core.str(ns)].join('');
ns = G__46813;
continue;
}
} else
...
var G__46814__delegate = function (arg,more){return cljs.core.apply.call(null,f,arg,cljs.core.concat.call(null,args,more));
};
var G__46814 = function (arg,var_args){
var more = null;if (arguments.length > 1) {
  more = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__46814__delegate.call(this,arg,more);};
G__46814.cljs$lang$maxFixedArity = 1;
G__46814.cljs$lang$applyTo = (function (arglist__46815){
var arg = cljs.core.first(arglist__46815);
var more = cljs.core.rest(arglist__46815);
return G__46814__delegate(arg,more);
});
...
fpartial.cljs$lang$applyTo = (function (arglist__46816){
var f = cljs.core.first(arglist__46816);
