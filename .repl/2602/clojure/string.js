...
{{
var G__46154 = cljs.core.pop.call(null,v__$1);
v__$1 = G__46154;
continue;
}
} else
...
{var pred__46158 = cljs.core._EQ_;var expr__46159 = limit;if(cljs.core.truth_(pred__46158.call(null,1,expr__46159)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__46158.call(null,2,expr__46159)))
...
var G__46161 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__46162 = (limit__$1 - 1);
var G__46163 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__46161;
limit__$1 = G__46162;
parts = G__46163;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___46165 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___46165))
{var replacement_46166 = temp__4096__auto___46165;buffer.append([cljs.core.str(replacement_46166)].join(''));
} else
{buffer.append(ch);
}
{
var G__46167 = (index + 1);
index = G__46167;
continue;
}
}
