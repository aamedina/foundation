...
var unparse__delegate = function (fmt,dt,p__21517){var map__21519 = p__21517;var map__21519__$1 = ((cljs.core.seq_QMARK_.call(null,map__21519))?cljs.core.apply.call(null,cljs.core.hash_map,map__21519):map__21519);var tz = cljs.core.get.call(null,map__21519__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__21517 = null;if (arguments.length > 2) {
  p__21517 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__21517);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__21520){
var fmt = cljs.core.first(arglist__21520);
arglist__21520 = cljs.core.next(arglist__21520);
var dt = cljs.core.first(arglist__21520);
var p__21517 = cljs.core.rest(arglist__21520);
return unparse__delegate(fmt,dt,p__21517);
});
...
var show_formatters__delegate = function (p__21521){var map__21527 = p__21521;var map__21527__$1 = ((cljs.core.seq_QMARK_.call(null,map__21527))?cljs.core.apply.call(null,cljs.core.hash_map,map__21527):map__21527);var date_like = cljs.core.get.call(null,map__21527__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__5850__auto__ = (function iter__21528(s__21529){return (new cljs.core.LazySeq(null,(function (){var s__21529__$1 = s__21529;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__21529__$1);if(temp__4098__auto__)
{var s__21529__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__21529__$2))
{var c__5848__auto__ = cljs.core.chunk_first.call(null,s__21529__$2);var size__5849__auto__ = cljs.core.count.call(null,c__5848__auto__);var b__21531 = cljs.core.chunk_buffer.call(null,size__5849__auto__);if((function (){var i__21530 = 0;while(true){
if((i__21530 < size__5849__auto__))
{var i = cljs.core._nth.call(null,c__5848__auto__,i__21530);cljs.core.chunk_append.call(null,b__21531,cljs_time.format.unparse.call(null,i,date_like));
{
...
{var i = cljs.core.first.call(null,s__21529__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__21528.call(null,cljs.core.rest.call(null,s__21529__$2)));
}
} else
{return null;
}
...
var p__21521 = null;if (arguments.length > 0) {
  p__21521 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__21521);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__21533){
var p__21521 = cljs.core.seq(arglist__21533);
return show_formatters__delegate(p__21521);
});
