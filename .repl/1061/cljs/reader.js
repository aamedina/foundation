...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj20793 = {};return obj20793;
})();
...
reader_error.cljs$lang$applyTo = (function (arglist__20794){
var rdr = cljs.core.first(arglist__20794);
var msg = cljs.core.rest(arglist__20794);
...
{{
var G__20795 = (function (){sb.append(ch);
return sb;
})();
var G__20796 = cljs.reader.read_char.call(null,rdr);
sb = G__20795;
ch = G__20796;
continue;
}
...
{{
var G__20797 = cljs.reader.read_char.call(null,rdr);
ch = G__20797;
continue;
}
} else
...
var G__20798 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__20798;
continue;
}
} else
...
var G__20799 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__20799;
continue;
}
}
...
{{
var G__20800 = (function (){buffer.append(ch);
return buffer;
})();
var G__20801 = cljs.reader.read_char.call(null,reader);
buffer = G__20800;
ch = G__20801;
continue;
}
...
{if(("\\" === ch))
{{
var G__20802 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__20803 = cljs.reader.read_char.call(null,reader);
buffer = G__20802;
ch = G__20803;
continue;
}
...
{{
var G__20804 = (function (){buffer.append(ch);
return buffer;
})();
var G__20805 = cljs.reader.read_char.call(null,reader);
buffer = G__20804;
ch = G__20805;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__20807 = o;if(G__20807)
{var bit__5783__auto__ = (G__20807.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5783__auto__) || (G__20807.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__20807.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__20807);
} else
{return false;
}
}
...
{{
var G__20808 = reader;
var G__20809 = eof_is_error;
var G__20810 = sentinel;
var G__20811 = is_recursive;
reader = G__20808;
eof_is_error = G__20809;
sentinel = G__20810;
is_recursive = G__20811;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__20812 = cljs.reader.read_comment.call(null,reader,ch);
var G__20813 = eof_is_error;
var G__20814 = sentinel;
var G__20815 = is_recursive;
reader = G__20812;
eof_is_error = G__20813;
sentinel = G__20814;
is_recursive = G__20815;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__20816 = reader;
var G__20817 = eof_is_error;
var G__20818 = sentinel;
var G__20819 = is_recursive;
reader = G__20816;
eof_is_error = G__20817;
sentinel = G__20818;
is_recursive = G__20819;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__20822 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__20822,0,null);var years = cljs.core.nth.call(null,vec__20822,1,null);var months = cljs.core.nth.call(null,vec__20822,2,null);var days = cljs.core.nth.call(null,vec__20822,3,null);var hours = cljs.core.nth.call(null,vec__20822,4,null);var minutes = cljs.core.nth.call(null,vec__20822,5,null);var seconds = cljs.core.nth.call(null,vec__20822,6,null);var fraction = cljs.core.nth.call(null,vec__20822,7,null);var offset_sign = cljs.core.nth.call(null,vec__20822,8,null);var offset_hours = cljs.core.nth.call(null,vec__20822,9,null);var offset_minutes = cljs.core.nth.call(null,vec__20822,10,null);var v = vec__20822;if(cljs.core.not.call(null,v))
...
{var vec__20824 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__20824,0,null);var months = cljs.core.nth.call(null,vec__20824,1,null);var days = cljs.core.nth.call(null,vec__20824,2,null);var hours = cljs.core.nth.call(null,vec__20824,3,null);var minutes = cljs.core.nth.call(null,vec__20824,4,null);var seconds = cljs.core.nth.call(null,vec__20824,5,null);var ms = cljs.core.nth.call(null,vec__20824,6,null);var offset = cljs.core.nth.call(null,vec__20824,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
