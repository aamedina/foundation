...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_20387 = 0;while(true){
if((i_20387 < arr.length))
{(arr[i_20387] = null);
{
...
{var i_20394 = (self__.level + 1);while(true){
if((i_20394 <= (new_level + 1)))
{(update[i_20394] = self__.header);
{
var G__20395 = (i_20394 + 1);
i_20394 = G__20395;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_20396 = 0;while(true){
if((i_20396 <= self__.level))
{var links_20397 = (update[i_20396]).forward;if(((links_20397[i_20396]) === x__$1))
{(links_20397[i_20396] = (x__$1.forward[i_20396]));
{
var G__20398 = (i_20396 + 1);
i_20396 = G__20398;
continue;
}
} else
{{
var G__20399 = (i_20396 + 1);
i_20396 = G__20399;
continue;
}
}
