...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_20422 = 0;while(true){
var m_20423 = cljs.core.async.impl.dispatch.tasks.pop();if((m_20423 == null))
{} else
{m_20423.call(null);
if((count_20422 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__20424 = (count_20422 + 1);
count_20422 = G__20424;
continue;
}
} else
{}
