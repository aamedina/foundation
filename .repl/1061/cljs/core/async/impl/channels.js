...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t20428 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t20428 = (function (val,box,meta20429){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t20428.cljs$lang$type = true;
cljs.core.async.impl.channels.t20428.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t20428";
cljs.core.async.impl.channels.t20428.cljs$lang$ctorPrWriter = (function (this__5701__auto__,writer__5702__auto__,opt__5703__auto__){return cljs.core._write.call(null,writer__5702__auto__,"cljs.core.async.impl.channels/t20428");
});
cljs.core.async.impl.channels.t20428.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t20428.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_20430){var self__ = this;
var _20430__$1 = this;return self__.meta20429;
});
cljs.core.async.impl.channels.t20428.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_20430,meta20429__$1){var self__ = this;
var _20430__$1 = this;return (new cljs.core.async.impl.channels.t20428(self__.val,self__.box,meta20429__$1));
});
cljs.core.async.impl.channels.__GT_t20428 = (function __GT_t20428(val__$1,box__$1,meta20429){return (new cljs.core.async.impl.channels.t20428(val__$1,box__$1,meta20429));
});
}
return (new cljs.core.async.impl.channels.t20428(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_20431 = self__.takes.pop();if((taker_20431 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_20431))
{var take_cb_20432 = cljs.core.async.impl.protocols.commit.call(null,taker_20431);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_20432,taker_20431){
return (function (){return take_cb_20432.call(null,null);
});})(take_cb_20432,taker_20431))
);
} else
{}
{
