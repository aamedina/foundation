...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__8265__auto__,writer__8266__auto__,opt__8267__auto__){return cljs.core._write.call(null,writer__8266__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_18474 = 0;while(true){
if((i_18474 < arr.length))
{(arr[i_18474] = null);
{
var G__18475 = (i_18474 + 1);
i_18474 = G__18475;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__8265__auto__,writer__8266__auto__,opt__8267__auto__){return cljs.core._write.call(null,writer__8266__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_18481 = (self__.level + 1);while(true){
if((i_18481 <= (new_level + 1)))
{(update[i_18481] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_18483 = 0;while(true){
if((i_18483 <= self__.level))
{var links_18484 = (update[i_18483]).forward;if(((links_18484[i_18483]) === x__$1))
{(links_18484[i_18483] = (x__$1.forward[i_18483]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__7721__auto__ = (cljs.core.truth_((function (){var and__7709__auto__ = me;if(cljs.core.truth_(and__7709__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__7709__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__7721__auto__))
