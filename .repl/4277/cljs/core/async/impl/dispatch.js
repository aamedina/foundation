...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_18509 = 0;while(true){
var m_18510 = cljs.core.async.impl.dispatch.tasks.pop();if((m_18510 == null))
{} else
{m_18510.call(null);
if((count_18509 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__18511 = (count_18509 + 1);
count_18509 = G__18511;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7709__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7709__auto__)
