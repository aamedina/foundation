...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t18515 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t18515 = (function (val,box,meta18516){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t18515.cljs$lang$type = true;
cljs.core.async.impl.channels.t18515.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t18515";
cljs.core.async.impl.channels.t18515.cljs$lang$ctorPrWriter = (function (this__8265__auto__,writer__8266__auto__,opt__8267__auto__){return cljs.core._write.call(null,writer__8266__auto__,"cljs.core.async.impl.channels/t18515");
});
cljs.core.async.impl.channels.t18515.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t18515.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_18517){var self__ = this;
var _18517__$1 = this;return self__.meta18516;
});
cljs.core.async.impl.channels.t18515.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_18517,meta18516__$1){var self__ = this;
var _18517__$1 = this;return (new cljs.core.async.impl.channels.t18515(self__.val,self__.box,meta18516__$1));
});
cljs.core.async.impl.channels.__GT_t18515 = (function __GT_t18515(val__$1,box__$1,meta18516){return (new cljs.core.async.impl.channels.t18515(val__$1,box__$1,meta18516));
});
}
return (new cljs.core.async.impl.channels.t18515(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8268__auto__,writer__8269__auto__,opts__8270__auto__){return cljs.core._write.call(null,writer__8269__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8265__auto__,writer__8266__auto__,opt__8267__auto__){return cljs.core._write.call(null,writer__8266__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_18518 = self__.takes.pop();if((taker_18518 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_18518))
{var take_cb_18519 = cljs.core.async.impl.protocols.commit.call(null,taker_18518);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_18519,taker_18518){
return (function (){return take_cb_18519.call(null,null);
});})(take_cb_18519,taker_18518))
);
} else
{}
{
