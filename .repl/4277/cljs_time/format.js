...
var unparse__delegate = function (fmt,dt,p__19470){var map__19472 = p__19470;var map__19472__$1 = ((cljs.core.seq_QMARK_.call(null,map__19472))?cljs.core.apply.call(null,cljs.core.hash_map,map__19472):map__19472);var tz = cljs.core.get.call(null,map__19472__$1,new cljs.core.Keyword(null,"tz","tz",1013907960));var tz__$1 = ((typeof tz === 'number')?cljs_time.core.time_zone_for_offset.call(null,tz):((typeof tz === 'string')?cljs_time.core.time_zone_for_id.call(null,tz):null));return cljs_time.format.formatter.call(null,fmt,tz__$1).format(dt);
};
var unparse = function (fmt,dt,var_args){
var p__19470 = null;if (arguments.length > 2) {
  p__19470 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unparse__delegate.call(this,fmt,dt,p__19470);};
unparse.cljs$lang$maxFixedArity = 2;
unparse.cljs$lang$applyTo = (function (arglist__19473){
var fmt = cljs.core.first(arglist__19473);
arglist__19473 = cljs.core.next(arglist__19473);
var dt = cljs.core.first(arglist__19473);
var p__19470 = cljs.core.rest(arglist__19473);
return unparse__delegate(fmt,dt,p__19470);
});
...
var show_formatters__delegate = function (p__19474){var map__19480 = p__19474;var map__19480__$1 = ((cljs.core.seq_QMARK_.call(null,map__19480))?cljs.core.apply.call(null,cljs.core.hash_map,map__19480):map__19480);var date_like = cljs.core.get.call(null,map__19480__$1,new cljs.core.Keyword(null,"date-like","date-like",718631368),cljs_time.core.now.call(null));var iter__8414__auto__ = (function iter__19481(s__19482){return (new cljs.core.LazySeq(null,(function (){var s__19482__$1 = s__19482;while(true){
var temp__4098__auto__ = cljs.core.seq.call(null,s__19482__$1);if(temp__4098__auto__)
{var s__19482__$2 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__19482__$2))
{var c__8412__auto__ = cljs.core.chunk_first.call(null,s__19482__$2);var size__8413__auto__ = cljs.core.count.call(null,c__8412__auto__);var b__19484 = cljs.core.chunk_buffer.call(null,size__8413__auto__);if((function (){var i__19483 = 0;while(true){
if((i__19483 < size__8413__auto__))
{var i = cljs.core._nth.call(null,c__8412__auto__,i__19483);cljs.core.chunk_append.call(null,b__19484,cljs_time.format.unparse.call(null,i,date_like));
{
var G__19485 = (i__19483 + 1);
i__19483 = G__19485;
continue;
}
} else
...
{var i = cljs.core.first.call(null,s__19482__$2);return cljs.core.cons.call(null,cljs_time.format.unparse.call(null,i,date_like),iter__19481.call(null,cljs.core.rest.call(null,s__19482__$2)));
}
} else
{return null;
}
...
});return iter__8414__auto__.call(null,cljs.core.sort.call(null,cljs.core.vals.call(null,cljs_time.format.formatters)));
};
var show_formatters = function (var_args){
var p__19474 = null;if (arguments.length > 0) {
  p__19474 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return show_formatters__delegate.call(this,p__19474);};
show_formatters.cljs$lang$maxFixedArity = 0;
show_formatters.cljs$lang$applyTo = (function (arglist__19486){
var p__19474 = cljs.core.seq(arglist__19486);
return show_formatters__delegate(p__19474);
});
