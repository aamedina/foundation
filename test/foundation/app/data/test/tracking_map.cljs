...
(ns foundation.app.data.test.tracking-map
  (:require [clojure.set :refer [difference]]
            [foundation.app.data.tracking-map :refer [tracking-map changes]])
  (:require-macros [foundation.app.test-macros :refer [is-changed]]))
