(ns user
  ...
  (:require
   ...
   [compojure.handler]
   [cemerick.austin]
   [cemerick.austin.repls :refer (browser-repl-env browser-connected-repl-js exec)]
...
(deftemplate index
  ...
  (enlive/append
   ...
   (enlive/html [:script (str "goog.require(\"" (:main aspect) "\");")])
   (enlive/html [:script (str (:main aspect) ".main();")])
